...
public class Class298_Sub16 extends Class298 {
    ...
    AbstractToolkit aClass_ra_Sub3_7288;
    int[] anIntArray7289;
    int anInt7290 = 0;
    int anInt7291;
    int anInt7292;
	...
	if (((Class298_Sub16) this).anInt7284 != -1) {
	    TextureMetrics class53 = ((Class298_Sub16) this).aClass_ra_Sub3_7288.anInterface_ma5299.getTexture(((Class298_Sub16) this).anInt7284, 833044999);
	...
	if ((((AbstractToolkit) ((Class298_Sub16) this).aClass_ra_Sub3_7288).anInt8346) == 0) {
	...
	byte i_24_ = 10;
	if (i >= 0) {
	    TextureMetrics class53 = ((Class298_Sub16) this).aClass_ra_Sub3_7288.anInterface_ma5299.getTexture(i, 1520533155);
	    if (class53.effectId > 0)
		i_24_ = class53.effectId;
	}
