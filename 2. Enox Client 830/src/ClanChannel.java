...
public class ClanChannel extends Class298 {
	...
	try {
		...
		((ClanChannel) this).anIntArray7357 = new int[649879491 * anInt7356];
	...
	try {
	    ...
	    if ((i_2_ & 0x1) != 0)
		((ClanChannel) this).aBoolean7353 = true;
	    if ((i_2_ & 0x2) != 0)
		((ClanChannel) this).aBoolean7354 = true;
	    ...
	    aByte7355 = stream.readByte();
	    aByte7360 = stream.readByte();
		...
		for (int i_3_ = 0; i_3_ < anInt7356 * 649879491; i_3_++) {
		    ...
		    if (((ClanChannel) this).aBoolean7353)
			stream.readLong((short) 26032);
		    if (((ClanChannel) this).aBoolean7354)
			class163.aString1681 = stream.readString(254031265);
		    class163.aByte1683 = stream.readByte();
	...
	try {
	    MapDetails class298_sub37_sub13 = Class301.method3705(((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]);
		...
		((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = class298_sub37_sub13.name;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    int i_6_ = (((Class403) class403).anIntArray5257[1883543357 * ((Class403) class403).anInt5259]);
	    Long var_long = (Long) Class313.anObjectArray3298[i_6_];
	    if (var_long == null)
		((Class403) class403).aLongArray5251[((((Class403) class403).anInt5245 += -682569305) * 1685767703) - 1] = -1L;
	    else
		((Class403) class403).aLongArray5251[((((Class403) class403).anInt5245 += -682569305) * 1685767703) - 1] = var_long.longValue();
	}
	catch (RuntimeException runtimeexception) {
