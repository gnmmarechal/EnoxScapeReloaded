...
public abstract class Class137 {
	...
	protected AbstractToolkit aClass_ra_Sub3_1520;
	...
	public void method1509(TextureMetrics class53) {
		switch (class53.effectParam1) {
		case 1:
			aFloat1521 = 32.0F;
			aFloat1513 = 0.5F;
			break;
	...
	Class137(AbstractToolkit class_ra_sub3) {
