...
public class Class256 {
	...
	try {
	    ...
	    byte[] is;
	    if (i >= 32768)
		is = ((Class256) this).aClass243_2797.getFile(0, i & 0x7fff);
	    else
		is = ((Class256) this).aClass243_2796.getFile(0, i);
	...
	if (((Class256) this).aClass243_2796 != null)
	    ((Class256) this).aClass243_2796.getFileCountForArchive(0, 1395155699);
	if (((Class256) this).aClass243_2797 != null)
	    ((Class256) this).aClass243_2797.getFileCountForArchive(0, 393673779);
    }
	...
	try {
	    ...
	    int i_5_ = (((Class403) class403).anIntArray5244[1 + ((Class403) class403).anInt5239 * 681479919]);
	    Class505 class505 = Class322.method3931(BillBoardDefinitions.idx29, i_5_, 0, (byte) 57);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class505.method6262(string, i_4_, Class130_Sub2.aClass57Array6959, 1970071925);
	}
	catch (RuntimeException runtimeexception) {
