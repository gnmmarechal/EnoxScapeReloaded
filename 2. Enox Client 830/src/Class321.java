...
public class Class321 {
    ...
    void method3916(Toolkit class_ra, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_) {
	try {
    ...
    public Class321(Toolkit class_ra, int i, RsByteBuffer class298_sub53, int i_12_) {
	...
	i_16_ = (1 << i >> 1) + (i_16_ << i);
	int i_22_ = (Class294.HSL_TABLE != null ? (Class294.HSL_TABLE[class298_sub53.readUnsignedShort()]) : (Class379.anIntArray4096[BillBoardDefinitions.method1823(class298_sub53.readUnsignedShort(), (byte) 0) & 0xffff]));
	...
	try {
	    int i_24_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]);
	    if (null != pb.aString8804 && i_24_ < -1801543887 * Class489.anInt6071)
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = (-1071570519 * Class82_Sub6.aClass7Array6846[i_24_].anInt95);
	    else
	...
	try {
	    ...
	    GraphicDefinition.method4922(string, 655510254);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    String string = (String) (((Class403) class403).anObjectArray5240[-203050393 * ((Class403) class403).anInt5241]);
	    String string_25_ = ((String) (((Class403) class403).anObjectArray5240[-203050393 * ((Class403) class403).anInt5241 + 1]));
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = new StringBuilder().append(string).append(string_25_).toString();
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    int i_26_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]);
	    int i_27_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 1]);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class77.method841(i_26_, i_27_, (byte) -125) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (Class372.aClass323_4052.pressingKey(82, -596957727))
	...
	try {
	    ((Class403) class403).anInt5239 -= -783761378;
	    class105.anInt1241 = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]) * 381202251;
	    class105.anInt1252 = (-283274507 * (((Class403) class403).anIntArray5244[1 + ((Class403) class403).anInt5239 * 681479919]));
	...
	try {
		...
		if (i == 1)
		    ...
		    Class333 class333 = (pb.aClass283_8716.method2675(-1611682495).aClass333_3512);
		    class333.aBoolean3583 = !class333.aBoolean3583;
		} else if (i == 8)
		    pb.aBoolean8667 = true;
		else if (27 == i)
		    pb.aBoolean8667 = false;
		else if (i == 22)
		    pb.aClass442_8650.method5869(355993737);
		else if (16 == i) {
		    ...
		    Class255.method2435((BillBoardConfig.aClass305_770.method264(-242181565) ? "Success" : "Failure"), 1719326530);
		else if (2 == i)
		    ...
		    pb.aClass283_8716.aLong3045 = Class122.method1319((byte) 1) * 3385627052850178407L;
		    pb.aClass283_8716.aBoolean3008 = true;
		    ...
		    Class217 class217 = (Class287.myPlayer.method4337().aClass217_2599);
		    Class255.method2435(new StringBuilder().append("").append(pb.aClass283_8716.method2675(-1611682495).aClass_xaArray3517[(Class287.myPlayer.plane)].method6341((int) class217.aFloat2451 >> 9, (int) class217.aFloat2454 >> 9, (byte) -102)).toString(), 417961088);
		} else if (i == 3) {
		    ...
		    pb.aBoolean8668 = !pb.aBoolean8668;
		    Class373.activeToolkit.method5061(pb.aBoolean8668);
		    Class422_Sub1.method5626(-1727592457);
		} else if (11 == i) {
		    pb.anInt8814 = 0;
		    pb.aClass283_8716.method2667(72202504);
		} else if (9 == i) {
		    pb.anInt8814 = 1482609571;
		    pb.aClass283_8716.method2667(418889356);
		} else if (28 == i) {
		    pb.anInt8814 = -1329748154;
		    pb.aClass283_8716.method2667(989855246);
		}
	    }
