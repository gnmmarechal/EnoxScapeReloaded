...
public class Class108 {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = pb.aBoolean8640 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.CLOSE_INTERFACE_PACKET, pb.aClass25_8711.aClass449_330, (byte) 111);
	    pb.aClass25_8711.method390(class298_sub36, (byte) -21);
	    for (Interface class298_sub51 = ((Interface) pb.aClass437_8841.method5816(1892786919)); null != class298_sub51; class298_sub51 = ((Interface) pb.aClass437_8841.method5815((byte) -93))) {
		if (!class298_sub51.method2840(-629325116)) {
		    class298_sub51 = ((Interface) pb.aClass437_8841.method5816(1676096674));
		...
		if (0 == class298_sub51.clipped * 27137839)
		    BillBoardDefinitions.method1821(class298_sub51, true, bool, -113822480);
	    }
	    if (pb.aClass105_8652 != null) {
		Tradution.method6054(pb.aClass105_8652, -1209330591);
	...
	try {
	    ...
	    ((Class298_Sub37_Sub12) class298_sub37_sub12).type = 1274450087 * i_6_;
	}
	catch (RuntimeException runtimeexception) {
