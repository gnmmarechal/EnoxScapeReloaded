...
public class Class371 {
	...
	byte[] is = class243.getTextureData((-363169051 * Class380.aClass380_4104.anInt4108), (byte) 61);
	method4580(new RsByteBuffer(is), -1224635914);
    }

    static void method4581(Class403 class403, short i) {
	try {
	    ((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 2] = (Class316.aClass362_3318.method4307((((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 2]), 245040087).method4564(Class128.aClass148_6331, (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 - 1]), 236962620)) ? 1 : 0;
	...
	try {
	    ...
	    if (i_9_ != i_10_) {
		if (ObjectOverride.method5804(pb.anInt8752 * -1233866115, (byte) 44)) {
		    if (i_10_ == 0 && -1256171511 * Class300.anInt3207 != -1) {
			Class477.method6096(Class374_Sub1.idx6, -1256171511 * Class300.anInt3207, 0, i_9_, false, -2115031871);
	...
	try {
	    ...
	    Class426.method5744(Class373.activeToolkit, -1982421296);
	    Class346.method4173(Class373.activeToolkit, Class158.idx8, 556232880);
	    ...
	    else if (pb.anInt8752 * -1233866115 == 11 || pb.anInt8752 * -1233866115 == 7)
	...
	try {
	    ...
	    pb.aShort8923 = (short) (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
	    if (pb.aShort8923 <= 0)
		pb.aShort8923 = (short) 256;
	    pb.aShort8931 = (short) (((Class403) class403).anIntArray5244[1 + 681479919 * ((Class403) class403).anInt5239]);
	    if (pb.aShort8931 <= 0)
		pb.aShort8931 = (short) 320;
	}
	catch (RuntimeException runtimeexception) {
