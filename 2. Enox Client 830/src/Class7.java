...
public class Class7 {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = pb.GRAND_EXCHANGE_SLOTS[i_0_].method2401((byte) 8);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static void method314(Toolkit class_ra, int i) {
	try {
	
	    if ((Class436.anInt5506 * -278777595 >= 2 || pb.aBoolean8835) && null == pb.aClass105_8850) {
		
		String string;
		if (pb.aBoolean8835 && -278777595 * Class436.anInt5506 < 2)
		    string = new StringBuilder().append(pb.aString8838).append(Tradution.aClass470_5916.method6049(Class321.aClass429_3357, -875414210)).append(pb.aString8754).append(" ").append(Class26.aString351).toString();
		...
		if (Class436.aClass105_5486 != null) {
		    Class264 class264 = (Class436.aClass105_5486.method1112(Class497.aClass197_6105, pb.anInterface10_8700, 2046154242));
		    if (null == class264)
			class264 = Class101.aClass264_1084;
		    class264.method2485(string, -828992241 * Class436.anInt5487, 1604938967 * Class436.anInt5502, -2093041337 * Class436.aClass105_5486.anInt1156, Class436.aClass105_5486.anInt1162 * 457937409, 1045422783 * Class436.aClass105_5486.anInt1170, -2065110161 * Class436.aClass105_5486.anInt1251, 872550387 * Class436.aClass105_5486.anInt1214, -1594110459 * Class436.aClass105_5486.anInt1124, pb.aRandom8702, 1401020893 * Class368.anInt4005, pb.anIntArray8899, Class436.aClass57Array5501, Class422_Sub3.anIntArray8372, -1153250817);
		    Class227.method2112(pb.anIntArray8899[0], pb.anIntArray8899[1], pb.anIntArray8899[2], pb.anIntArray8899[3], (byte) 2);
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
