...
public class Class229 implements Interface12 {
	...
	try {
	    if (((Class229) this).aClass_ra6456 != Class373.activeToolkit) {
		((Class229) this).aClass_ra6456 = Class373.activeToolkit;
	...
	try {
		...
		if (null != Class231.aFrame2589) {
			...
			if (Class298_Sub36.aFrame7403 == container) {
			    ...
			    pb.anInt6472 -= (insets.bottom + insets.top) * -2115832951;
			}
			...
			if (Class190.method1859((byte) -55) != 1)
			    ...
			    pb.anInt6473 = ((-639974669 * Class78.anInt733 - 775068819 * pb.anInt8794) / 2 * -753018213);
			...
			if (null != Class373.activeToolkit)
			    Class373.activeToolkit.method5173(Class52_Sub2_Sub1.aCanvas9079, Class462.anInt5683 * -2110394505, -1111710645 * Class298_Sub40_Sub9.anInt9716, (byte) 20);
			if (container == Class298_Sub36.aFrame7403) {
			    Insets insets = Class298_Sub36.aFrame7403.getInsets();
			    Class52_Sub2_Sub1.aCanvas9079.setLocation(insets.left + pb.anInt6473 * 1898544019, pb.anInt6474 * 540368727 + insets.top);
			} else
			    Class52_Sub2_Sub1.aCanvas9079.setLocation(pb.anInt6473 * 1898544019, pb.anInt6474 * 540368727);
