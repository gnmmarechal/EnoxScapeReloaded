...
public class Class365_Sub1_Sub1_Sub1 extends Class365_Sub1_Sub1 {
    ...
    ParticleSystem aClass351_10061;
	...
	try {
		...
		if (0 != (((Class365_Sub1_Sub1_Sub1) this).anInt10043 * 132125965)) {
			...
			if (-442628795 * pb.playerIndex == i_6_)
			    class365_sub1_sub1_sub2 = Class287.myPlayer;
			else
			    class365_sub1_sub1_sub2 = (pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_6_]);
		    } else {
			int i_7_ = ((132125965 * ((Class365_Sub1_Sub1_Sub1) this).anInt10043) - 1);
			Class298_Sub29 class298_sub29 = ((Class298_Sub29) pb.aClass437_8696.get((long) i_7_));
    ...
    final void method4375(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_17_, int i_18_, boolean bool) {
    ...
    boolean method4350(Toolkit class_ra, int i, int i_20_, byte i_21_) {
	try {
	    return false;
	}
	catch (RuntimeException runtimeexception) {
    ...
    final void method4355(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_22_, int i_23_, boolean bool, int i_24_) {
	try {
	    throw new IllegalStateException();
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Model class387 = method4410(class_ra, 2048, -1431142826);
	    if (class387 == null)
		return null;
    ...
    void method4408(Toolkit class_ra, Model class387, Class222 class222, int i) {
	try {
		...
		((Class365_Sub1_Sub1_Sub1) this).aClass351_10061 = ParticleSystem.method4232(pb.ticketCycle * 443738891, true);
	    if (((Class365_Sub1_Sub1_Sub1) this).aClass351_10061 != null) {
		((Class365_Sub1_Sub1_Sub1) this).aClass351_10061.method4231(class_ra, (long) (443738891 * pb.ticketCycle), class85s, class68s, false);
	...
	Model class387 = method4410(class_ra, 0, -1431142826);
	if (null != class387) {
	    Class222 class222 = method4347();
	    ((Class365_Sub1_Sub1_Sub1) this).anInt10059 = class387.YA() * -1389603713;
	    class387.n();
    ...
    boolean method4372(Toolkit class_ra, int i, int i_25_) {
	return false;
    }

    boolean method4385(Toolkit class_ra, int i, int i_26_) {
	return false;
    }

    boolean method4352(Toolkit class_ra, int i, int i_27_) {
	return false;
    }
    ...
    final void method4388(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_28_, int i_29_, boolean bool) {
	throw new IllegalStateException();
    }
    ...
    Model method4410(Toolkit class_ra, int i, int i_30_) {
	try {
	    GraphicDefinition class398 = (Class158_Sub1.aClass389_8568.getGraphicDefinition(1528803725 * ((Class365_Sub1_Sub1_Sub1) this).anInt10046, -1880515681));
	...
	int i_44_ = (Class158_Sub1.aClass389_8568.getGraphicDefinition(((Class365_Sub1_Sub1_Sub1) this).anInt10046 * 1528803725, -1811500435).animation) * 1505778629;
