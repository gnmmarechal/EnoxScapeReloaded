...
public class Class39 {
    ...
    GLToolkit aClass_ra_Sub2_429;
    int anInt430;
    static int anInt431 = 34336;
	@Override
	public void finalize() throws Throwable {
	    aClass_ra_Sub2_429.deleteProg(anInt430);
		super.finalize();
	}
	
	
    static Class39 method477(GLToolkit class_ra_sub2, int i, String string) {
    ...
    Class39(GLToolkit class_ra_sub2, int i, int i_1_) {
