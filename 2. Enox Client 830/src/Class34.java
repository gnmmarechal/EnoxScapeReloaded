...
public class Class34 {
    OpenGlArrayBufferPointer aClass32_399;
    int anInt400 = 1600;
    int anInt401 = 64;
    static float aFloat402;
    Interface1 anInterface1_403;
    OpenGlArrayBufferPointer aClass32_404;
    OpenGlArrayBufferPointer aClass32_405;
    int anInt406 = 768;
    ...
    void method436(GLToolkit class_ra_sub2, Class69 class69) {
	if (((GLToolkit) class_ra_sub2).aClass233_8110 != null) {
	    method438(class_ra_sub2);
	    float f = (((GLToolkit) class_ra_sub2).aClass233_8110.aFloatArray2594[2]);
	    float f_0_ = (((GLToolkit) class_ra_sub2).aClass233_8110.aFloatArray2594[6]);
	    float f_1_ = (((GLToolkit) class_ra_sub2).aClass233_8110.aFloatArray2594[10]);
	    float f_2_ = (((GLToolkit) class_ra_sub2).aClass233_8110.aFloatArray2594[14]);
	    try {
		int i = 0;
		int i_3_ = 2147483647;
		int i_4_ = 0;
		...
		for (Class302_Sub3 class302_sub3_5_ = class302_sub3.aClass302_Sub3_7650; class302_sub3_5_ != class302_sub3; class302_sub3_5_ = class302_sub3_5_.aClass302_Sub3_7650) {
		    ...
		    int i_6_ = (int) (f * (float) (class302_sub3_sub1.x >> 12) + f_0_ * (float) (class302_sub3_sub1.y >> 12) + f_1_ * (float) (class302_sub3_sub1.z >> 12) + f_2_);
		    if (i_6_ > i_4_)
			i_4_ = i_6_;
		    if (i_6_ < i_3_)
			i_3_ = i_6_;
		...
		while (class302_sub3_9_ != class302_sub3) {
		    ...
		    if (bool && (((GLToolkit) class_ra_sub2).aFloat8130 != aFloat402))
			class_ra_sub2.IA(aFloat402);
		    else if (((GLToolkit) class_ra_sub2).aFloat8130 != 1.0F)
    ...
    void method437(GLToolkit class_ra_sub2, int i) {
	...
	if (((GLToolkit) class_ra_sub2).aBoolean8143) {
		...
		if (i_30_ > 0) {
			...
			int i_32_ = class302_sub3_sub1.colour;
			byte i_33_ = (byte) (i_32_ >> 16);
			byte i_34_ = (byte) (i_32_ >> 8);
			byte i_35_ = (byte) i_32_;
			byte i_36_ = (byte) (i_32_ >>> 24);
			float f_37_ = (float) (class302_sub3_sub1.x >> 12);
			float f_38_ = (float) (class302_sub3_sub1.y >> 12);
			float f_39_ = (float) (class302_sub3_sub1.z >> 12);
			int i_40_ = class302_sub3_sub1.size >> 12;
			...
			for (int i_42_ = ((Class34) this).anIntArray412[i_41_] - 1; i_42_ >= 0; i_42_--) {
			    ...
			    int i_43_ = class302_sub3_sub1.colour;
			    byte i_44_ = (byte) (i_43_ >> 16);
			    byte i_45_ = (byte) (i_43_ >> 8);
			    byte i_46_ = (byte) i_43_;
			    byte i_47_ = (byte) (i_43_ >>> 24);
			    float f_48_ = (float) (class302_sub3_sub1.x >> 12);
			    float f_49_ = (float) (class302_sub3_sub1.y >> 12);
			    float f_50_ = (float) (class302_sub3_sub1.z >> 12);
			    int i_51_ = class302_sub3_sub1.size >> 12;
			    ((Class34) this).aClass298_Sub53_Sub1_407.method3658(0.0F);
			    ((Class34) this).aClass298_Sub53_Sub1_407.method3658(0.0F);
		...
		if (i_53_ > 0) {
			...
			int i_55_ = class302_sub3_sub1.colour;
			byte i_56_ = (byte) (i_55_ >> 16);
			byte i_57_ = (byte) (i_55_ >> 8);
			byte i_58_ = (byte) i_55_;
			byte i_59_ = (byte) (i_55_ >>> 24);
			float f_60_ = (float) (class302_sub3_sub1.x >> 12);
			float f_61_ = (float) (class302_sub3_sub1.y >> 12);
			float f_62_ = (float) (class302_sub3_sub1.z >> 12);
			int i_63_ = class302_sub3_sub1.size >> 12;
			...
			for (int i_65_ = ((Class34) this).anIntArray412[i_64_] - 1; i_65_ >= 0; i_65_--) {
			    ...
			    int i_66_ = class302_sub3_sub1.colour;
			    byte i_67_ = (byte) (i_66_ >> 16);
			    byte i_68_ = (byte) (i_66_ >> 8);
			    byte i_69_ = (byte) i_66_;
			    byte i_70_ = (byte) (i_66_ >>> 24);
			    float f_71_ = (float) (class302_sub3_sub1.x >> 12);
			    float f_72_ = (float) (class302_sub3_sub1.y >> 12);
			    float f_73_ = (float) (class302_sub3_sub1.z >> 12);
			    int i_74_ = class302_sub3_sub1.size >> 12;
			    ((Class34) this).aClass298_Sub53_Sub1_407.method3659(0.0F);
			    ((Class34) this).aClass298_Sub53_Sub1_407.method3659(0.0F);
    ...
    void method438(GLToolkit class_ra_sub2) {
	aFloat402 = ((GLToolkit) class_ra_sub2).aFloat8130;
    ...
    void method439(GLToolkit class_ra_sub2) {
	((Class34) this).anInterface1_403 = class_ra_sub2.method5244(24, null, 196584, true);
	((Class34) this).aClass32_404 = new OpenGlArrayBufferPointer(((Class34) this).anInterface1_403, 5126, 2, 0);
	((Class34) this).aClass32_405 = new OpenGlArrayBufferPointer(((Class34) this).anInterface1_403, 5126, 3, 8);
	((Class34) this).aClass32_399 = new OpenGlArrayBufferPointer(((Class34) this).anInterface1_403, 5121, 4, 20);
    }

    void method440(GLToolkit class_ra_sub2) {
	class_ra_sub2.method5281(true);
	OpenGL.glEnable(16384);
	OpenGL.glEnable(16385);
	if (((GLToolkit) class_ra_sub2).aFloat8130 != aFloat402)
	    class_ra_sub2.IA(aFloat402);
    }
}
