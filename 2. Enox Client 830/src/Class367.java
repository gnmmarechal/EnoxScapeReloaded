...
public class Class367 {
    ...
    public static Sprite aClass57_4001;
	...
	try {
		...
		((Class403) class403).aClass162_5252 = Class225.aClass162_2512;
	    } else
	...
	try {
	    Class117 class117 = class105.method1116(Class373.activeToolkit, 1629882987);
	    if (null != class117) {
		Class373.activeToolkit.r(i, i_5_, -2093041337 * class105.anInt1156 + i, (i_5_ + class105.anInt1162 * 457937409));
		if (Class3.anInt56 * -64305285 < 3) {
		    int i_7_ = (int) -pb.aFloat8949;
		    i_7_ = i_7_ + -1840255270 * pb.anInt8801 & 0x3fff;
		    i_7_ <<= 2;
		    ...
		    Class373.activeToolkit.DA(-16777216, class117.aClass_ta1397, i, i_5_);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.aBoolean1161 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
