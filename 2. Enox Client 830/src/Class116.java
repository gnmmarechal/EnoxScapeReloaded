...
public class Class116 {
	...
	try {
		...
		for (int i_4_ = 0; i_4_ < ((Class116) this).aClass298_Sub31Array1390.length; i_4_++) {
			...
			((Class116) this).aClass437_1392.method5817(class298_sub31_5_, (class298_sub31_5_.hash * 7051297995265073167L));
		}
	...
	try {
		...
		for (int i_10_ = 0; i_10_ < class365_sub1_sub1_sub2.anIntArray10092.length; i_10_++) {
			...
			if (-1073741824 == (i_11_ & ~0x3fffffff)) {
			    ...
			    i_14_ = ((int) class217.aFloat2451 - (256 + 512 * (i_17_ - (class341.x * -1760580017))));
			    i_15_ = ((int) class217.aFloat2454 - (256 + ((i_18_ - 283514611 * class341.y) * 512)));
			} else if ((i_11_ & 0x8000) != 0) {
			    int i_19_ = i_11_ & 0x7fff;
			    Player class365_sub1_sub1_sub2_sub2 = (pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_19_]);
			    ...
			    Class298_Sub29 class298_sub29 = ((Class298_Sub29) pb.aClass437_8696.get((long) i_11_));
	...
	try {
		...
		i_22_ = 5;
	    int i_23_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 3]);
	    if (i_23_ < 0)
		i_23_ = 0;
	    else if (i_23_ > 5)
		i_23_ = 5;
	...
	try {
	    ...
	    pb.aClass283_8716.method2640((byte) 54).method4324(286817156);
