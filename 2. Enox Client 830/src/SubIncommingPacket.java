...
public class SubIncommingPacket {
    ...
    static Sprite[] radar_mark_icons;
	...
	try {
	    ...
	    try {
		class476 = Class86.method962("2", pb.gametype.aString5317, false, -1804643872);
	...
	try {
	    Class365_Sub1_Sub1_Sub6.method4494(Class373.activeToolkit, 556951212);
	    if (1855729883 * Class99.anInt952 != 191260743 * pb.anInt8792)
	...
	try {
	    if (Class299.method3682(-1233866115 * pb.anInt8752, 1765230881) || Class413.method5584(-1233866115 * pb.anInt8752, 1927636725))
		Class216.method2001(false, (byte) 23);
	    else {
		Class422_Sub21.aClass318_8414 = pb.aClass25_8711.method387(537308016);
		pb.aClass25_8711.method385(865497912);
	...
	try {
	    ...
	    ((Class298_Sub37_Sub12) class298_sub37_sub12).type = 1274450087 * type;
	    ((Class298_Sub37_Sub12) class298_sub37_sub12).value = value * 293101103;
	...
	try {
		...
		((Class403) class403).anObjectArray5234 = new Object[1787035509 * class298_sub37_sub17.anInt9680];
		if ((class298_sub37_sub17.aClass502_9678 == Class502.aClass502_6727) || (Class502.aClass502_6721 == class298_sub37_sub17.aClass502_9678) || (Class502.aClass502_6718 == class298_sub37_sub17.aClass502_9678)) {
		    ...
		    ((Class403) class403).anIntArray5248[0] = (Class165.aClass319_6366.method3894((byte) -93) - i_8_);
		    ((Class403) class403).anIntArray5248[1] = (Class165.aClass319_6366.method3883((byte) -71) - i_9_);
		} else if (class298_sub37_sub17.aClass502_9678 == Class502.aClass502_6716)
		    ((Class403) class403).anIntArray5248[0] = 1782404151 * ((Class403) class403).anInt5255;
