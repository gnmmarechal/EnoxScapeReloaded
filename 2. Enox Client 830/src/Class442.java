...
public class Class442 {
	...
	try {
		...
		Class298 class298 = Class301_Sub1.aClass437_7637.get((long) i_0_);
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Class365_Sub1) ((Class403) class403).anInterface3_5233).method4363((byte) 23);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = pb.aBoolean8646 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = class352.aString3792;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = class105.method1109(i_2_, class497.aString6101, 2117840940);
	    else
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = class105.method1117(i_2_, -388931549 * class497.anInt6100, -659898667);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class190.method1859((byte) -52);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    pb.aClass283_8716.method2641(1725751477).method5794(5, (byte) 49);
	    ...
	    ConfigEntry.aClass487_1463.method6163(5, -718074838);
	    ...
	    Shadow.aClass491_9686.method6174(5, (byte) 1);
	    ...
	    pb.aClass348_8780.method4186(5, -1305461493);
	    pb.aClass348_8898.method4186(5, -659243138);
	    pb.aClass348_8697.method4186(5, -2138729636);
