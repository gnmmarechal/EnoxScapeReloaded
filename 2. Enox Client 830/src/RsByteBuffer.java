...
public class RsByteBuffer extends Class298 {
	...
	public void writeMedInt(long l) {
		try {
	...
	public void writeSmart(int i, byte i_9_) {
		try {
			if (i >= 0 && i < 128)
				writeByte(i);
			else if (i >= 0 && i < 32768)
	...
	public void method3593(int i, long l) {
		try {
			buffer[(index += 116413311) * 385051775 - 1] = (byte) ((i >> 24));
			buffer[(index += 116413311) * 385051775 - 1] = (byte) (i >> 16);
			buffer[(index += 116413311) * 385051775 - 1] = (byte) (i >> 8);
	...
	static final void method3653(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = string.toLowerCase();
		}
		catch (RuntimeException runtimeexception) {
	...
	static final void method3654(Class403 class403, int i) {
		try {
			int i_89_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]);
	...
	static final void method3655(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub13_7549.method5674(-484902399) && Class373.activeToolkit.method5032()) ? 1 : 0;
		}
		catch (RuntimeException runtimeexception) {
	...
	static void method3656(int i, int i_90_, int i_91_, short i_92_) {
		try {
			...
			((Class298_Sub37_Sub12) class298_sub37_sub12).type = 1274450087 * i_90_;
			((Class298_Sub37_Sub12) class298_sub37_sub12).value = 293101103 * i_91_;
		}
		catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("acx.aw(").append(')').toString());
		}
	...
	static final void method3657(Class403 class403, byte i) {
		try {
			String string = (String) (((Class403) class403).anObjectArray5240[(((Class403) class403).anInt5241 -= 969361751) * -203050393]);
			int i_93_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]);
			if (-1 == i_93_)
				throw new RuntimeException("");
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = new StringBuilder().append(string).append((char) i_93_).toString();
		}
		catch (RuntimeException runtimeexception) {
	...
	public float method14506(int i) {
		return Float.intBitsToFloat(readInt((byte) 0));
	}
