...
public class Class365_Sub1_Sub3_Sub2 extends Class365_Sub1_Sub3 implements Interface3 {
    ...
    Shadow aClass_na9924;
    Model aClass387_9925;
    int anInt9926;
    byte aByte9927;
    byte aByte9928;
    ...
    Model method4510(Toolkit class_ra, int i, int i_0_) {
	try {
	    ...
	    Tuple class454 = method4511(class_ra, i, false, -1045378786);
	    if (class454 != null)
	...
	try {
		...
		Tuple class454 = method4511(class_ra, 262144, true, -1658395754);
	...
	try {
	    Model class387 = method4510(class_ra, 131072, 1991691041);
	    if (class387 != null) {
	...
	try {
		...
		Tuple class454 = method4511(class_ra, 262144, true, 443427270);
	...
	Shadow class_na;
	if (((Class365_Sub1_Sub3_Sub2) this).aClass_na9924 == null && ((Class365_Sub1_Sub3_Sub2) this).aBoolean9931) {
	    Tuple class454 = method4511(class_ra, 262144, true, -1081449109);
	    class_na = (Shadow) (null != class454 ? class454.second : null);
	} else {
	    class_na = ((Class365_Sub1_Sub3_Sub2) this).aClass_na9924;
	    ((Class365_Sub1_Sub3_Sub2) this).aClass_na9924 = null;
	...
	Shadow class_na;
	if (null == ((Class365_Sub1_Sub3_Sub2) this).aClass_na9924 && ((Class365_Sub1_Sub3_Sub2) this).aBoolean9931) {
	    Tuple class454 = method4511(class_ra, 262144, true, 1299260710);
	    class_na = (Shadow) (class454 != null ? class454.second : null);
	} else {
	    class_na = ((Class365_Sub1_Sub3_Sub2) this).aClass_na9924;
	    ((Class365_Sub1_Sub3_Sub2) this).aClass_na9924 = null;
    ...
    public Class365_Sub1_Sub3_Sub2(Class331 class331, Toolkit class_ra, Class433 class433, ObjectDefinitions class432, int i, int i_3_, int i_4_, int i_5_, int i_6_, boolean bool, int i_7_, int i_8_, int i_9_, int i_10_) {
	super(class331, i_4_, i_5_, i_6_, i, i_3_, i_7_, i_8_);
	((Class365_Sub1_Sub3_Sub2) this).aClass433_9923 = class433;
	((Class365_Sub1_Sub3_Sub2) this).anInt9926 = class432.objectId * 1469074669;
	...
	if (class432.aBoolean5441)
	    i_11_ |= 0x80000;
	Tuple class454 = method4511(class_ra, i_11_, ((Class365_Sub1_Sub3_Sub2) this).aBoolean9931, -772904584);
	if (null != class454) {
	    ((Class365_Sub1_Sub3_Sub2) this).aClass387_9925 = (Model) class454.first;
	    ((Class365_Sub1_Sub3_Sub2) this).aClass_na9924 = (Shadow) class454.second;
	    if (class432.aBoolean5441) {
		((Class365_Sub1_Sub3_Sub2) this).aClass387_9925 = ((Class365_Sub1_Sub3_Sub2) this).aClass387_9925.method4755((byte) 0, i_11_, false);
		if (class432.aBoolean5441) {
		    Class287 class287 = pb.aClass283_8716.method2632(-2114342399);
	...
	Shadow class_na;
	if (((Class365_Sub1_Sub3_Sub2) this).aClass_na9924 == null && ((Class365_Sub1_Sub3_Sub2) this).aBoolean9931) {
	    Tuple class454 = method4511(class_ra, 262144, true, 833087212);
	    class_na = (Shadow) (null != class454 ? class454.second : null);
	} else {
	    class_na = ((Class365_Sub1_Sub3_Sub2) this).aClass_na9924;
	    ((Class365_Sub1_Sub3_Sub2) this).aClass_na9924 = null;
	...
	Shadow class_na;
	if (((Class365_Sub1_Sub3_Sub2) this).aClass_na9924 == null && ((Class365_Sub1_Sub3_Sub2) this).aBoolean9931) {
	    Tuple class454 = method4511(class_ra, 262144, true, 258900059);
	    class_na = (Shadow) (null != class454 ? class454.second : null);
	} else {
	    class_na = ((Class365_Sub1_Sub3_Sub2) this).aClass_na9924;
	    ((Class365_Sub1_Sub3_Sub2) this).aClass_na9924 = null;
    ...
    boolean method4372(Toolkit class_ra, int i, int i_12_) {
	Model class387 = method4510(class_ra, 131072, 1910114060);
	if (class387 != null) {
	    Class222 class222 = method4347();
    ...
    boolean method4385(Toolkit class_ra, int i, int i_13_) {
	Model class387 = method4510(class_ra, 131072, 2092256266);
	if (class387 != null) {
	    Class222 class222 = method4347();
    ...
    boolean method4352(Toolkit class_ra, int i, int i_14_) {
	Model class387 = method4510(class_ra, 131072, 2046392588);
	if (class387 != null) {
	    Class222 class222 = method4347();
    ...
    Tuple method4511(Toolkit class_ra, int i, boolean bool, int i_15_) {
	try {
