...
public final class Class329 {
	...
	try {
	    if (Class294.HSL_TABLE == null) {
		Class294.HSL_TABLE = new int[65536];
		...
		for (int i_43_ = 0; i_43_ < 65536; i_43_++) {
		    ...
		    Class294.HSL_TABLE[i_43_] = i_58_ & 0xffffff;
	...
	try {
	    int i_60_ = (((Class403) class403).anIntArray5257[((Class403) class403).anInt5259 * 1883543357]);
	    String string = (((Class403) class403).aClass162_5252.method1755(-937307905 * pb.gametype.gameType << 16 | i_60_, -1713280768));
	    String string_61_;
	    if (null == string)
		string_61_ = "";
	    else
		string_61_ = string;
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = string_61_;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    int i_62_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]);
	...
	try {
	    ...
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2073, pb.aClass25_8711.aClass449_330, (byte) 13);
