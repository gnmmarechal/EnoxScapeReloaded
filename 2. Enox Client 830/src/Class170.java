...
public final class Class170 {
	...
	try {
	    ...
	    ((Class403) class403).aClass177_5243.anIntArray1789[i_0_] = i_1_;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return (interface19 != null && interface19.method239(class298_sub50, pb.anInterface16Array8688, pb.anInt8687 * -1625219821, Class372.aClass323_4052, -622376364));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class82_Sub5.method882(i_10_, false, (byte) 63);
	}
	catch (RuntimeException runtimeexception) {
