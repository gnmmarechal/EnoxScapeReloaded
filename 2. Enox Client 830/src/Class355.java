...
public class Class355 implements Interface19 {
	...
	for (int i_0_ = 0; i_0_ < is.length; i_0_++) {
	    int i_1_ = is[i_0_];
	    if (!class323.pressingKey(i_1_, -12857846))
		return false;
	}
	return true;
    }
	...
	try {
		...
		int i_4_ = is[i_3_];
		if (!class323.pressingKey(i_4_, 537035513))
		    return false;
	    }
	    return true;
	}
	...
	for (int i_5_ = 0; i_5_ < is.length; i_5_++) {
	    int i_6_ = is[i_5_];
	    if (!class323.pressingKey(i_6_, -1630939752))
		return false;
	}
	return true;
    }
    ...
    static boolean notValidType(int i) {
	try {
	...
	try {
	    ...
	    int i_10_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
	    int i_11_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 1]);
	    Class497 class497 = Class92.aClass504_905.method6251(i_11_, -1869114423);
	    if (class497.method6206(1883696427))
		((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = pb.aClass283_8716.method2641(-1837734772).getObjectDefinitions(i_10_).method5770(i_11_, class497.aString6101, 1595133323);
	    else
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = (pb.aClass283_8716.method2641(767453715).getObjectDefinitions(i_10_).method5776(i_11_, class497.anInt6100 * -388931549, (byte) 2));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class298_Sub37_Sub12) class298_sub37_sub12).type = i_12_ * 1274450087;
	    ((Class298_Sub37_Sub12) class298_sub37_sub12).value = 293101103 * i_13_;
