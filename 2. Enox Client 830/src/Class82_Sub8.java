...
public class Class82_Sub8 extends Class82 {
    long aLong6853;
    int anInt6854;
    public static Sprite aClass57_6855;
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7570.method5612(i_2_, 1352882135);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class298_Sub37_Sub12) class298_sub37_sub12).type = i_3_ * 1274450087;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (-1233866115 * pb.anInt8752 != 14 || Class315.method3837((byte) 9))
		...
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2071, pb.aClass25_8693.aClass449_330, (byte) 42);
		class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(-1351839083 * Class117.anInt1399, -933492277);
		pb.aClass25_8693.method390(class298_sub36, (byte) -36);
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
	    }
	}
	catch (RuntimeException runtimeexception) {
