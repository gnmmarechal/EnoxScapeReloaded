...
public class Class82_Sub10 extends Class82 {
	...
	try {
	    ...
	    if (pb.qa_op && (pb.method2801(class105).anInt7416 * -1266165749 != 0 || class105.type * -1215239439 == 0)) {
		...
		pb.aClass453_8893.add(class298_sub46);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 - 2] = (Class316.aClass362_3318.method4307((((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 2]), 245040087).anIntArrayArray4017[(((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1])][0]);
