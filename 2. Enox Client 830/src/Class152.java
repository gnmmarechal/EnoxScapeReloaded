...
public class Class152 {
	...
	try {
		...
		((Class152) this).aClass453_1587.add(class298_sub17);
	    }
	}
	...
	try {
	    if ((-6615773310558494831L * ((Class152) this).aLong1592 != class298_sub25.hash * 7051297995265073167L) || (-3106107963843196613L * ((Class152) this).aLong1588 != (((ClanChannel) class298_sub25).aLong7361 * -3244420319926665157L)))
		throw new RuntimeException("");
    ...
    public static void method1652(Toolkit class_ra, long l) {
	try {
		...
		ParticleSystem class351 = (ParticleSystem) iterator.next();
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = -2067054685 * Class52_Sub2.anInt6815;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7583.method5726(-2143087996);
	}
	catch (RuntimeException runtimeexception) {
