...
public final class Class348 {
	...
	public int method4183(byte i) {
		try {
			int i_0_ = 0;
			for (Class298_Sub37_Sub9 class298_sub37_sub9 = (Class298_Sub37_Sub9) ((Class348) this).aClass461_3703.first(1659179977); class298_sub37_sub9 != null; class298_sub37_sub9 = (Class298_Sub37_Sub9) ((Class348) this).aClass461_3703.next(1776119940)) {
	...
	public Object get(long l) {
		try {
			...
			if (class298_sub37_sub9.method3438(-1388215910)) {
				...
				((Class348) this).aClass437_3702.method5817(class298_sub37_sub9_sub1, class298_sub37_sub9.hash * 7051297995265073167L);
				((Class348) this).aClass461_3703.add(class298_sub37_sub9_sub1, (byte) -4);
				class298_sub37_sub9_sub1.aLong7406 = 0L;
				class298_sub37_sub9.method2839(-1460969981);
				class298_sub37_sub9.method3402(1072331765);
			}
			else {
				((Class348) this).aClass461_3703.add(class298_sub37_sub9, (byte) -40);
	...
	public void method4185(Object object, long l, int i, byte i_1_) {
		try {
			...
			((Class348) this).aClass461_3703.add(class298_sub37_sub9_sub1, (byte) -108);
			class298_sub37_sub9_sub1.aLong7406 = 0L;
		}
		catch (RuntimeException runtimeexception) {
	...
	public void method4186(int i, int i_2_) {
		try {
			for (Class298_Sub37_Sub9 class298_sub37_sub9 = (Class298_Sub37_Sub9) ((Class348) this).aClass461_3703.first(-1737359401); class298_sub37_sub9 != null; class298_sub37_sub9 = (Class298_Sub37_Sub9) ((Class348) this).aClass461_3703.next(1372068776)) {
				if (class298_sub37_sub9.method3438(504566053)) {
					...
					((Class348) this).aClass437_3702.method5817(class298_sub37_sub9_sub2, 7051297995265073167L * class298_sub37_sub9.hash);
	...
	public void method4187() {
		try {
			...
			((Class348) this).aClass437_3702.method5811((byte) -88);
	...
	public void method4189() {
		try {
			for (Class298_Sub37_Sub9 class298_sub37_sub9 = (Class298_Sub37_Sub9) ((Class348) this).aClass461_3703.first(-1664121892); null != class298_sub37_sub9; class298_sub37_sub9 = (Class298_Sub37_Sub9) ((Class348) this).aClass461_3703.next(-1665993458)) {
	...
	static final void method4195(Class403 class403, int i) {
		try {
			...
			pb.aClass283_8716.method2667(458039847);
	...
	static final void method4198(Class403 class403, int i) {
		try {
			int i_12_ = (((Class403) class403).anIntArray5257[((Class403) class403).anInt5259 * 1883543357]);
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((NPC) ((Class403) class403).aClass365_Sub1_Sub1_Sub2_5242).aClass73_10187.method817(i_12_, -966489489);
		}
		catch (RuntimeException runtimeexception) {
