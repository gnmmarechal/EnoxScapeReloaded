...
public class Textures implements Interface_ma {
	JS5 spriteJS5;
	JS5 textureJS5;
	static TextureMetrics[] textures;
	int numTextures;
	...
	public int[] method173(int i, float f, int i_0_, int i_1_, boolean bool) {
		int[] is = (method2390(i, 354542821).method3421(spriteJS5, this, (double) f, i_0_, i_1_, textures[i].isBrickTile, 795191351));
		return is;
	}

	public int method177(int i) {
		try {
			return numTextures * -1882566529;
		}
	...
	public TextureMetrics getTexture(int id, int i_2_) {
		try {
			return textures[id];
	...
	public Textures(JS5 idx26, JS5 idx9, JS5 idx8) {
		textureJS5 = idx9;
		spriteJS5 = idx8;
		numTextures = (idx26.getFileCountForArchive(0, 0) + 1) * 12939135;
		textures = new TextureMetrics[numTextures * -1882566529];
		for (int i = 0; i < textures.length; i++) {
			textures[i] = new TextureMetrics();
			RsByteBuffer buffer = new RsByteBuffer(idx26.getFile(0, i));
			TextureMetrics info = new TextureMetrics();
			if (null == buffer.buffer) {
				info.textureId = -1;
			} else {
				int bitLoadCode = buffer.readByte() & 0xFF;
				info.isHalfSize = bitLoadCode == 0;
				if (0 == bitLoadCode)
					info.bitLoad = 64;
				else if (bitLoadCode == 1)
					info.bitLoad = 128;
				else if (bitLoadCode == 2)
					info.bitLoad = 256;
				else if (bitLoadCode == 3)
					info.bitLoad = 512;
				else if (bitLoadCode == 4)
					info.bitLoad = 1024;
				int i_2_ = buffer.readInt(0);
				if (0 != (i_2_ & 0x1)) {
					info.textureId = buffer.readShort(0) & 0xFFFF;
					buffer.readByte();
				}
				if (0 != (i_2_ & 0x1000)) {
					info.anIntArray1268 = new int[6];
					info.aByteArray1289 = new byte[6];
					for (int i_3_ = 0; i_3_ < 6; i_3_++) {
						info.anIntArray1268[i_3_] = buffer.readShort(0) & 0xFFFF;
						info.aByteArray1289[i_3_] = (byte) buffer.readByte();
					}
				}
				if ((i_2_ & 0x2) != 0) {
					buffer.readShort(0);
				...
				//decide texture ST coords REPEAT or GL_CLAMP_TO_EDGE (1 = true)
				int wrappingModeFlag = buffer.readByte() & 0xFF;
				info.repeatS = (byte) (wrappingModeFlag & 0xf);
				info.repeatT = (byte) (wrappingModeFlag >> 4 & 0xf);
				info.isBrickTile = true;
				int i_5_ = buffer.readInt(0);
				if ((i_5_ & 0x10) != 0) {
					Float.intBitsToFloat(buffer.readInt(0));
					Float.intBitsToFloat(buffer.readInt(0));
				}
				if (0 != (i_5_ & 0x20))
					buffer.readInt(0);
				...
				if (0 != (i_5_ & 0x200))
					buffer.readInt(0);
				info.hdr = buffer.readByte() == 1;
				buffer.readByte();
				buffer.readByte();
				info.blendType = buffer.readByte() * 980235301;
				if(info.blendType * -2138060883 == 1)
					info.blendMode = (byte) buffer.readByte();
				int i_6_ = buffer.readByte();
				if (0 != (i_6_ & 0x1))
					info.textureSpeedU = (byte) buffer.readByte();
				if (0 != (i_6_ & 0x2))
					info.textureSpeedV = (byte) buffer.readByte();
				if (0 != (i_6_ & 0x4))
					buffer.readByte();
				if ((i_6_ & 0x8) != 0)
					buffer.readByte();
				if (buffer.readByte() == 1) {
					info.effectId = (byte) buffer.readByte();
					info.effectParam1 = (byte) buffer.readByte();
					info.effectParam2 = buffer.readInt(0) * -946109519;
					info.combineMode = (byte) buffer.readByte() * -39200327;
					buffer.readByte();
					info.useMipmaps = (byte) buffer.readByte();//if not 0
					info.skipTriangles = buffer.readByte() == 1;
					info.isGroundMesh = buffer.readByte() == 1;
					info.brightness = (byte) buffer.readByte();
					info.shadowFactor = (byte) buffer.readByte();
					info.color = (short) buffer.readShort(0);
				}
			}
			textures[i] = info;
		}
	...
	public int[] method171(int i, float f, int i_5_, int i_6_, boolean bool, int i_7_) {
		try {
			int[] is = (method2390(i, 1119072054).method3423(spriteJS5, this, (double) f, i_5_, i_6_, bool, textures[i].isBrickTile, -1817838295));
			return is;
		}
		catch (RuntimeException runtimeexception) {
	...
	public int[] method172(int i, float f, int i_8_, int i_9_, boolean bool, int i_6_) {
		try {
			int[] is = (method2390(i, 1019997631).method3421(spriteJS5, this, (double) f, i_8_, i_9_, textures[i].isBrickTile, -524170328));
			return is;
		}
		catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("kk.w(").append(')').toString());
	...
	TextureDecoder method2390(int id, int i_11_) {
		try {
			Class298_Sub37 class298_sub37 = aClass354_6464.method4253((long) id);
			if (class298_sub37 != null)
				return (TextureDecoder) class298_sub37;
			TextureDecoder class298_sub37_sub6 = new TextureDecoder(id, textureJS5/*new RsByteBuffer(is))*/);
			aClass354_6464.method4255(class298_sub37_sub6, (long) id);
	...
	public int[] method183(int i, float f, int i_12_, int i_13_, boolean bool) {
		int[] is = (method2390(i, 526499029).method3421(spriteJS5, this, (double) f, i_12_, i_13_, textures[i].isBrickTile, -1650198196));
		return is;
	}
	...
	public boolean method170(int i, int i_14_) {
		try {
			TextureDecoder class298_sub37_sub6 = method2390(i, 709398631);
			return (class298_sub37_sub6 != null && class298_sub37_sub6.method3420((spriteJS5), this, (byte) -26));
		}
		catch (RuntimeException runtimeexception) {
	...
	public boolean method180(int i) {
		TextureDecoder class298_sub37_sub6 = method2390(i, 942144985);
		return (class298_sub37_sub6 != null && class298_sub37_sub6.method3420((spriteJS5), this, (byte) 78));
	}

	public int[] method178(int i, float f, int i_15_, int i_16_, boolean bool) {
		int[] is = (method2390(i, -345886802).method3421(spriteJS5, this, (double) f, i_15_, i_16_, textures[i].isBrickTile, -1164110413));
		return is;
	}

	public int[] method182(int i, float f, int i_17_, int i_18_, boolean bool) {
		int[] is = (method2390(i, -1131324471).method3421(spriteJS5, this, (double) f, i_17_, i_18_, textures[i].isBrickTile, -876617633));
		return is;
	}

	public float[] method181(int i, float f, int i_19_, int i_20_, boolean bool, byte i_21_) {
		try {
			float[] fs = (method2390(i, -1967108124).method3422(spriteJS5, this, i_19_, i_20_, textures[i].isBrickTile, -1481337578));
			return fs;
		}
		catch (RuntimeException runtimeexception) {
	...
	public float[] method179(int i, float f, int i_22_, int i_23_, boolean bool) {
		float[] fs = (method2390(i, 2055609416).method3422(spriteJS5, this, i_22_, i_23_, textures[i].isBrickTile, -415868966));
		return fs;
	}

	public float[] method184(int i, float f, int i_24_, int i_25_, boolean bool) {
		float[] fs = (method2390(i, -1813054507).method3422(spriteJS5, this, i_24_, i_25_, textures[i].isBrickTile, -1304965359));
		return fs;
	}

	public TextureMetrics method187(int id) {
		return textures[id];
	}

	public TextureMetrics method188(int id) {
		return textures[id];
	}
	...
	public int[] method190(int i, float f, int i_26_, int i_27_, boolean bool) {
		int[] is = (method2390(i, -212514005).method3423(spriteJS5, this, (double) f, i_26_, i_27_, bool, textures[i].isBrickTile, -1817838295));
		return is;
	}
		...
		try {
			switch (-2008816077 * class394.anInt5187) {
				...
				case 667:
					...
					break;
				case 49:
					BillBoardDefinitions.method1825(class403, 187155990);
					break;
				case 338:
				...
				case 147:
					...
					break;
				case 596:
					LookupTable.method1242(class403, 1373771263);
					break;
				case 803:
				...
				case 867:
					...
					break;
				case 859:
					EquipmentDefaults.method923(class403, (short) -156);
					break;
				case 708:
					Class264.method2493(class403, 1946850329);
					break;
				case 326:
					pb.method2811(class403, -295386469);
					break;
				case 19:
				...
				case 908:
					...
					break;
				case 707:
					AnimationDefinition.method4883(class403, 285928237);
					break;
				case 331:
				...
				case 948:
					...
					break;
				case 872:
					EmitterConfig.method956(class403, (byte) -111);
					break;
				case 676:
				...
				case 149:
					...
					break;
				case 576:
					TextureMetrics.method600(class403, (byte) -100);
					break;
				case 957:
				...
				case 674:
					...
					break;
				case 141:
					AnimationDefinition.method4885(class403, (byte) 94);
					break;
				case 632:
				...
				case 21:
					...
					break;
				case 284:
					Toolkit.method5193(class403, (byte) 13);
					break;
				case 466:
				...
				case 893:
					...
					break;
				case 659:
					SunDefinition.method1392(class403, -1953346525);
					break;
				case 245:
				...
				case 745:
					...
					break;
				case 560:
					MapIconDefinitions.method6201(class403, 372399345);
					break;
				case 720:
				...
				case 302:
					...
					break;
				case 131:
					BillBoardConfig.method950(class403, -1792546982);
					break;
				case 367:
					Class339.method4126(class403, 1402373589);
					break;
				case 138:
					MapIconDefinitions.method6200(class403, -1316439840);
					break;
				case 824:
				...
				case 134:
					...
					break;
				case 341:
					SunDefinition.method1394(class403, 1103915043);
					break;
				case 554:
				...
				case 299:
					...
					break;
				case 192:
					GraphicDefinition.method4925(class403, 1249914677);
					break;
				case 108:
				...
				case 556:
					...
					break;
				case 256:
					BillBoardConfig.method947(class403, 1777073458);
					break;
				case 176:
				...
				case 752:
					...
					break;
				case 863:
					LookupTable.method1241(class403, -1661899204);
					break;
				case 964:
				...
				case 740:
					...
					break;
				case 715:
					MapIconDefinitions.method6203(class403, 1254374330);
					break;
				case 928:
				...
				case 289:
					...
					break;
				case 832:
					ConfigEntry.method1313(class403, -847776836);
					break;
				case 123:
				...
				case 473:
					...
					break;
				case 508:
					Shadow.method3477(class403, 691482692);
					break;
				case 825:
				...
				case 67:
					...
					break;
				case 11:
					SunDefinition.method1393(class403, 1842241343);
					break;
				case 654:
				...
				case 946:
					...
					break;
				case 204:
					BillBoardConfig.method951(class403, -136975475);
					break;
				case 969:
				...
				case 821:
					...
					break;
				case 94:
					TextureMetrics.method601(class403, 1329583265);
					break;
				case 80:
				...
				case 530:
					...
					break;
				case 291:
					Shadow.method3480(class403, -269779966);
					break;
				case 383:
				...
				case 88:
					...
					break;
				case 438:
					PlayerLookDefinitions.method1478(class403, 16711935);
					break;
				case 827:
				...
				case 45:
					...
					break;
				case 842:
					PlayerLookDefinitions.method1479(class403, (byte) -73);
					break;
				case 849:
				...
				case 3:
					...
					break;
				case 768:
					BillBoardConfig.method948(class403, -1092945905);
					break;
				case 288:
				...
				case 102:
					...
					break;
				case 890:
					BillBoardConfig.method949(class403, -1113867771);
					break;
				case 269:
