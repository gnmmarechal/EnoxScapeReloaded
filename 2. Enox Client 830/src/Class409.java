...
public class Class409 {
    int anInt5281;
    int anInt5282;
    WorldTile aClass341_5283;
    static int anInt5284;

    public Class409(WorldTile class341, int i, int i_0_, int i_1_) {
	...
	try {
	    return (pb.anIntArray8739[((Class409) this).anInt5281 * -1511232243]);
	}
	...
	try {
	    int i_2_ = 1008331379 * ((Class409) this).aClass341_5283.plane;
	    WorldTile class341 = pb.aClass283_8716.method2628(681479919);
	    int i_3_ = (((Class409) this).aClass341_5283.x * -1760580017 - class341.x * -1760580017);
	    int i_4_ = (((Class409) this).aClass341_5283.y * 283514611 - class341.y * 283514611);
	    if (i_3_ < 0 || i_4_ < 0 || i_3_ >= pb.aClass283_8716.method2629(-1998327105) || i_4_ >= pb.aClass283_8716.method2630(539294898))
		return null;
	    switch (method4970(-2091768912)) {
		case 0:
		    return ((Interface3) pb.aClass283_8716.method2675(-1611682495).method4031(i_2_, i_3_, i_4_, 1566382166));
		case 1:
		    return ((Interface3) pb.aClass283_8716.method2675(-1611682495).method4033(i_2_, i_3_, i_4_, 1080081135));
		default:
		    return null;
		case 2:
		    return (Interface3) (pb.aClass283_8716.method2675(-1611682495).method4035(i_2_, i_3_, i_4_, pb.anInterface17_8960, -1306218271));
		case 3:
		    return ((Interface3) pb.aClass283_8716.method2675(-1611682495).method4058(i_2_, i_3_, i_4_, (byte) 72));
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class301_Sub1.aBoolean7635 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub7_7581.method5650(-192114923);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub11_7558, (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]), 417121289);
	...
	try {
	    boolean bool = ((((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]) != 0);
	    int i_11_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]);
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = Class300.method3685((long) i_11_, 0, bool, Class321.aClass429_3357, (short) 25477);
	}
	catch (RuntimeException runtimeexception) {
