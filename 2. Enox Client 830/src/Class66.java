...
public abstract class Class66 {
	...
	try {
	    ...
	    class264.method2480(string, 3 + i_1_, i_5_, i_6_, 0, pb.aRandom8702, 1401020893 * Class368.anInt4005, Class436.aClass57Array5501, Class422_Sub3.anIntArray8372, 65280);
	}
	...
	try {
	    IComponentDefinition.method1135((((Class403) class403).aClass365_Sub1_Sub1_Sub2_5242), class403, -908974507);
	}
	catch (RuntimeException runtimeexception) {
