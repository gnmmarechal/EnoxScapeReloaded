...
public class Class365_Sub1_Sub4_Sub1 extends Class365_Sub1_Sub4 {
	...
	try {
		...
		Ground class_xa = aClass331_7722.aClass_xaArray3517[aByte7724];
		int i_3_ = (455610861 * ((Class365_Sub1_Sub4_Sub1) this).anInt10149 << 1);
		int i_4_ = i_3_;
		int i_5_ = -i_3_ / 2;
		int i_6_ = -i_4_ / 2;
		int i_7_ = class_xa.averageHeight(i_5_ + (int) class217.aFloat2451, (int) class217.aFloat2454 + i_6_, -1982900642);
		int i_8_ = i_3_ / 2;
		int i_9_ = -i_4_ / 2;
		int i_10_ = class_xa.averageHeight((int) class217.aFloat2451 + i_8_, i_9_ + (int) class217.aFloat2454, -1725399320);
		int i_11_ = -i_3_ / 2;
		int i_12_ = i_4_ / 2;
		int i_13_ = class_xa.averageHeight((int) class217.aFloat2451 + i_11_, (int) class217.aFloat2454 + i_12_, -1471266970);
		int i_14_ = i_3_ / 2;
		int i_15_ = i_4_ / 2;
		int i_16_ = class_xa.averageHeight(i_14_ + (int) class217.aFloat2451, i_15_ + (int) class217.aFloat2454, -1424760570);
	...
	if (anInt10142 * -1184748693 == 0) {
	    ...
	    int i_29_ = -i_27_ / 2;
	    int i_30_ = -i_28_ / 2;
	    int i_31_ = class_xa.averageHeight(i_29_ + (int) class217.aFloat2451, (int) class217.aFloat2454 + i_30_, -1545427351);
	    int i_32_ = i_27_ / 2;
	    int i_33_ = -i_28_ / 2;
	    int i_34_ = class_xa.averageHeight((int) class217.aFloat2451 + i_32_, i_33_ + (int) class217.aFloat2454, -1284070566);
	    int i_35_ = -i_27_ / 2;
	    int i_36_ = i_28_ / 2;
	    int i_37_ = class_xa.averageHeight((int) class217.aFloat2451 + i_35_, (int) class217.aFloat2454 + i_36_, -1982262190);
	    int i_38_ = i_27_ / 2;
	    int i_39_ = i_28_ / 2;
	    int i_40_ = class_xa.averageHeight(i_38_ + (int) class217.aFloat2451, i_39_ + (int) class217.aFloat2454, -1609235363);
    ...
    boolean method4350(Toolkit class_ra, int i, int i_49_, byte i_50_) {
	try {
	    Class222 class222 = class_ra.method5178();
	    class222.method2054(method4337());
	    class222.method2064(0.0F, -10.0F, 0.0F);
	    Model class387 = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(-441234013 * anInt10152).method6029(class_ra, 131072, anInt10143 * 825822935, null, null, 0, 0, 0, 0, 1524116625));
    ...
    boolean method4385(Toolkit class_ra, int i, int i_51_) {
	Class222 class222 = class_ra.method5178();
	class222.method2054(method4337());
	class222.method2064(0.0F, -10.0F, 0.0F);
	Model class387 = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(-441234013 * anInt10152).method6029(class_ra, 131072, anInt10143 * 825822935, null, null, 0, 0, 0, 0, 1941958028));
    ...
    boolean method4372(Toolkit class_ra, int i, int i_52_) {
	Class222 class222 = class_ra.method5178();
	class222.method2054(method4337());
	class222.method2064(0.0F, -10.0F, 0.0F);
	Model class387 = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(-441234013 * anInt10152).method6029(class_ra, 131072, anInt10143 * 825822935, null, null, 0, 0, 0, 0, 1821520052));
    ...
    boolean method4352(Toolkit class_ra, int i, int i_58_) {
	Class222 class222 = class_ra.method5178();
	class222.method2054(method4337());
	class222.method2064(0.0F, -10.0F, 0.0F);
	Model class387 = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(-441234013 * anInt10152).method6029(class_ra, 131072, anInt10143 * 825822935, null, null, 0, 0, 0, 0, 1529040042));
