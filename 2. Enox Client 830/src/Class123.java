...
public abstract class Class123 {
    ...
    Class123(AbstractToolkit class_ra_sub3, Class109 class109) {
    ...
    abstract Class110 method1326(AbstractToolkit class_ra_sub3, Class108 class108);
    ...
    abstract Class110 method1361(AbstractToolkit class_ra_sub3, Class108 class108);

    abstract Class110 method1362(AbstractToolkit class_ra_sub3, Class108 class108);
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_42_).anInt5704) * 789409129 == 1 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
