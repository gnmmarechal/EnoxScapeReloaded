...
public class Class317 {
	...
	((Class317) this).aClass243_3319.getFileCountForArchive((-1006924897 * (ConfigEntry.aClass120_1434.anInt1460)), -1713499559);
    }
	...
	try {
		...
		for (int i_4_ = 0; i_4_ < class276s.length; i_4_++) {
		    SunDefinition class125 = class131.method1467((((Class325) class325).anIntArray3451[i_4_]), -1248511043);
	...
	try {
		...
		is = (((Class317) this).aClass243_3319.getFile(ConfigEntry.aClass120_1434.anInt1460 * -1006924897, i));
	    }
	...
	try {
	    ...
	    class105.anInt1151 = (-1825442367 * (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]));
	    class105.anInt1140 = ((((Class403) class403).anIntArray5244[1 + ((Class403) class403).anInt5239 * 681479919]) * 908204397);
	    if (1 == (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 2]))
		class105.anInt1184 = -886348599;
	    else
		class105.anInt1184 = 643790344;
	    if ((((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 3]) == 1)
	...
	try {
	    if (pb.aString8656 != null)
		((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = pb.aString8656;
	    else
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (class105_8_ == null ? -1 : -440872681 * class105_8_.ihash);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (19 == -1233866115 * pb.anInt8752 && (!Class315.method3837((byte) 16) && !Class489.method6167(-391880689)))
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_9_ >> 28;
	}
	catch (RuntimeException runtimeexception) {
