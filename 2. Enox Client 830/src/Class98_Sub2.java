...
public class Class98_Sub2 extends Class98 {
	...
	try {
	    byte[] is = class243.getTextureData(i, (byte) 120);
	    if (is == null)
		return null;
	...
	try {
	    ...
	    if (null != LookupTable.aString1369 && LookupTable.aString1369.equalsIgnoreCase(string))
	...
	try {
	    Class403 class403 = Class211.method1950(1868919888);
	    ((Class403) class403).aClass365_Sub1_Sub4_Sub1_5253 = class365_sub1_sub4_sub1;
	    SubIncommingPacket.method1925(class502, i, i_27_, class403, 536465062);
	    ((Class403) class403).aClass365_Sub1_Sub4_Sub1_5253 = null;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    for (Class298_Sub37_Sub5 class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass461_5482.first(-431286975)); null != class298_sub37_sub5; class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass461_5482.next(-2120194897))) {
		if ((-628325139 * ((Class298_Sub37_Sub5) class298_sub37_sub5).anInt9583) > 1) {
		    ((Class298_Sub37_Sub5) class298_sub37_sub5).anInt9583 = 0;
		    Class436.aClass348_5464.put(class298_sub37_sub5, (6619564980435866523L * ((Class298_Sub37_Sub15) (Class298_Sub37_Sub15) (((Class298_Sub37_Sub5) class298_sub37_sub5).aClass461_9584.aClass298_Sub37_5679.aClass298_Sub37_7405)).aLong9666));
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = 2119035647 * Class216.anInt6659;
	}
	catch (RuntimeException runtimeexception) {
