...
public class ClanSettings {
	...
	try {
	    if (((ClanSettings) this).useUserHashes) {
		if (((ClanSettings) this).membersHashes != null)
		    Class425.method5738(((ClanSettings) this).membersHashes, 0, (((ClanSettings) this).membersHashes = new long[i]), 0, membersCount * 2125429757);
		else
		    ((ClanSettings) this).membersHashes = new long[i];
	    }
	    if (((ClanSettings) this).useDisplayNames) {
	    ...
	    if (((ClanSettings) this).anIntArray1665 != null)
		Class425.method5741(((ClanSettings) this).anIntArray1665, 0, (((ClanSettings) this).anIntArray1665 = new int[i]), 0, 2125429757 * membersCount);
	    else
		((ClanSettings) this).anIntArray1665 = new int[i];
	...
	try {
	    if (((ClanSettings) this).useUserHashes) {
		if (((ClanSettings) this).bannedMembersHashes != null)
		    Class425.method5738(((ClanSettings) this).bannedMembersHashes, 0, (((ClanSettings) this).bannedMembersHashes = new long[size]), 0, -1102843797 * bannedMembersCount);
		else
		    ((ClanSettings) this).bannedMembersHashes = new long[size];
	    }
	    if (((ClanSettings) this).useDisplayNames) {
	...
	try {
	    ...
	    return (((ClanSettings) this).anIntArray1665[i] & i_6_) >>> i_3_;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (null == ((ClanSettings) this).configurations)
		return null;
	    Class298 class298 = ((ClanSettings) this).configurations.get((long) i);
	...
	try {
	    if (((ClanSettings) this).configurations == null)
		return null;
	    Class298 class298 = ((ClanSettings) this).configurations.get((long) i);
	    if (null == class298 || !(class298 instanceof Class298_Sub35))
		return null;
	...
	try {
	    if (null == ((ClanSettings) this).anIntArray1652) {
		String[] strings = new String[2125429757 * membersCount];
		((ClanSettings) this).anIntArray1652 = new int[membersCount * 2125429757];
		for (int i_13_ = 0; i_13_ < 2125429757 * membersCount; i_13_++) {
		    strings[i_13_] = membersDisplayNames[i_13_];
		    ((ClanSettings) this).anIntArray1652[i_13_] = i_13_;
		}
		Class298_Sub32_Sub32.method3345(strings, (((ClanSettings) this).anIntArray1652), -43867253);
	    }
	    return ((ClanSettings) this).anIntArray1652;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		name = null;
	    if (((ClanSettings) this).useUserHashes != hash > 0L)
		throw new RuntimeException("");
	    if ((name != null) != ((ClanSettings) this).useDisplayNames)
		throw new RuntimeException("");
	    if (hash > 0L && (((ClanSettings) this).membersHashes == null || (membersCount * 2125429757 >= ((ClanSettings) this).membersHashes.length)) || (name != null && (membersDisplayNames == null || 2125429757 * membersCount >= membersDisplayNames.length)))
		setMembersBufferSize(5 + 2125429757 * membersCount, (byte) 1);
	    if (null != ((ClanSettings) this).membersHashes)
		((ClanSettings) this).membersHashes[2125429757 * membersCount] = hash;
	    ...
	    ((ClanSettings) this).anIntArray1665[membersCount * 2125429757] = 0;
	    anIntArray1666[2125429757 * membersCount] = i;
	    membersCount += -397756075;
	    ((ClanSettings) this).anIntArray1652 = null;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		string = null;
	    if (((ClanSettings) this).useUserHashes != l > 0L)
		throw new RuntimeException("");
	    if ((string != null) != ((ClanSettings) this).useDisplayNames)
		throw new RuntimeException("");
	    if (l > 0L && (((ClanSettings) this).bannedMembersHashes == null || (-1102843797 * bannedMembersCount >= ((ClanSettings) this).bannedMembersHashes.length)) || string != null && (bannedMembersDisplayNames == null || (-1102843797 * bannedMembersCount >= bannedMembersDisplayNames.length)))
		setChattersBufferSize(5 + bannedMembersCount * -1102843797);
	    if (null != ((ClanSettings) this).bannedMembersHashes)
		((ClanSettings) this).bannedMembersHashes[bannedMembersCount * -1102843797] = l;
	    if (null != bannedMembersDisplayNames)
	...
	try {
		...
		if (class298 != null) {
			...
			if (class298_sub29.anObject7366 instanceof String) {
			    ...
			    class298_sub29.method2839(-1460969981);
			    ((ClanSettings) this).configurations.method5817(new Class298_Sub29(string), (7051297995265073167L * class298_sub29.hash));
			    return true;
			}
		    }
		...
		((ClanSettings) this).configurations = new HashTable(4);
	    ((ClanSettings) this).configurations.method5817(new Class298_Sub29(string), (long) i);
	    return true;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		((ClanSettings) this).configurations = new HashTable(4);
	    ((ClanSettings) this).configurations.method5817(new Class298_Sub35(i_19_), (long) i);
	    return true;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		((ClanSettings) this).configurations = new HashTable(4);
	    ((ClanSettings) this).configurations.method5817(new Class298_Sub35(i_21_), (long) i);
	    return true;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		((ClanSettings) this).configurations = new HashTable(4);
	    ((ClanSettings) this).configurations.method5817(new Class298_Sub33(l), (long) i);
	    return true;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (0 != (masks & 0x1))
		((ClanSettings) this).useUserHashes = true; // read name as
							    // longs
	    if (0 != (masks & 0x2))
		((ClanSettings) this).useDisplayNames = true; // read name as
							      // strings
	    if (!((ClanSettings) this).useUserHashes) {
		((ClanSettings) this).membersHashes = null;
		((ClanSettings) this).bannedMembersHashes = null;
	    }
	    if (!((ClanSettings) this).useDisplayNames) {
		membersDisplayNames = null;
		bannedMembersDisplayNames = null;
	    }
	    ((ClanSettings) this).nextUpdateNumber = stream.readInt((byte) -76) * 1441392111;
	    ((ClanSettings) this).anInt1655 = stream.readInt((byte) -65) * 34754587;
	    if (version <= 3 && ((ClanSettings) this).anInt1655 * -1699149293 != 0)
		((ClanSettings) this).anInt1655 += 1039784928;
	    ...
	    aByte1672 = stream.readByte();
	    aByte1658 = stream.readByte(); // some rank for something
						    // in clan channel
	    aByte1659 = stream.readByte();
	    aByte1660 = stream.readByte();
	    if (2125429757 * membersCount > 0) {
		if (((ClanSettings) this).useUserHashes && (null == ((ClanSettings) this).membersHashes || (((ClanSettings) this).membersHashes.length < 2125429757 * membersCount)))
		    ((ClanSettings) this).membersHashes = new long[membersCount * 2125429757];
		if (((ClanSettings) this).useDisplayNames && (null == membersDisplayNames || membersDisplayNames.length < membersCount * 2125429757))
		...
		if (null == ((ClanSettings) this).anIntArray1665 || (((ClanSettings) this).anIntArray1665.length < membersCount * 2125429757))
		    ((ClanSettings) this).anIntArray1665 = new int[membersCount * 2125429757];
		...
		for (int index = 0; index < 2125429757 * membersCount; index++) {
		    if (((ClanSettings) this).useUserHashes)
			((ClanSettings) this).membersHashes[index] = stream.readLong((short) 10823);
		    if (((ClanSettings) this).useDisplayNames)
			membersDisplayNames[index] = stream.readJNullString(-517364695);
		    membersRanks[index] = stream.readByte();
		    if (version >= 2)
			((ClanSettings) this).anIntArray1665[index] = stream.readInt((byte) -36);
		    if (version >= 5)
		...
		if (((ClanSettings) this).useUserHashes && (null == ((ClanSettings) this).bannedMembersHashes || (((ClanSettings) this).bannedMembersHashes.length < bannedMembersCount * -1102843797)))
		    ((ClanSettings) this).bannedMembersHashes = new long[-1102843797 * bannedMembersCount];
		if (((ClanSettings) this).useDisplayNames && (bannedMembersDisplayNames == null || bannedMembersDisplayNames.length < -1102843797 * bannedMembersCount))
		...
		for (int index = 0; index < -1102843797 * bannedMembersCount; index++) {
		    if (((ClanSettings) this).useUserHashes)
			((ClanSettings) this).bannedMembersHashes[index] = stream.readLong((short) 4192);
		    if (((ClanSettings) this).useDisplayNames)
		...
		if (configsCount > 0) {
		    ((ClanSettings) this).configurations = new HashTable(configsCount < 16 ? Class416.nextPowerOfTwo(configsCount, (byte) 16) : 16);
			...
			if (0 == type) {
			    ...
			    ((ClanSettings) this).configurations.method5817(new Class298_Sub35(data), (long) configID);
			} else if (type == 1) {
			    long data = stream.readLong((short) 2486);
			    ((ClanSettings) this).configurations.method5817(new Class298_Sub33(data), (long) configID);
			} else if (type == 2) {
			    String data = stream.readString(478616247);
			    ((ClanSettings) this).configurations.method5817(new Class298_Sub29(data), (long) configID);
			}
		    }
		}
	    }
	...
	try {
		...
		if (null != ((ClanSettings) this).bannedMembersHashes)
		    Class425.method5738(((ClanSettings) this).bannedMembersHashes, chatterID + 1, ((ClanSettings) this).bannedMembersHashes, chatterID, -1102843797 * bannedMembersCount - chatterID);
		if (null != bannedMembersDisplayNames)
	...
	try {
	    ...
	    i_41_ <<= i_42_;
	    i_41_ &= i_47_;
	    int i_48_ = ((ClanSettings) this).anIntArray1665[i];
	    if (i_41_ == (i_48_ & i_47_))
		return -1;
	    i_48_ &= i_47_ ^ 0xffffffff;
	    ((ClanSettings) this).anIntArray1665[i] = i_48_ | i_41_;
	    return i;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		membersDisplayNames = null;
		membersRanks = null;
		((ClanSettings) this).anIntArray1665 = null;
		anIntArray1666 = null;
		clanLeaderID = -2050262011;
		deputyOwnerWithLeaderPriorityID = 1697252921;
	    } else {
		Class425.method5736(membersRanks, memberID + 1, membersRanks, memberID, membersCount * 2125429757 - memberID);
		Class425.method5741(((ClanSettings) this).anIntArray1665, memberID + 1, ((ClanSettings) this).anIntArray1665, memberID, membersCount * 2125429757 - memberID);
		Class425.method5741(anIntArray1666, 1 + memberID, anIntArray1666, memberID, 2125429757 * membersCount - memberID);
		if (null != ((ClanSettings) this).membersHashes)
		    Class425.method5738(((ClanSettings) this).membersHashes, 1 + memberID, ((ClanSettings) this).membersHashes, memberID, 2125429757 * membersCount - memberID);
		if (null != membersDisplayNames)
	...
	try {
		...
		Player class365_sub1_sub1_sub2_sub2 = pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[is[i_53_]];
	...
	try {
	    int i_54_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]);
	    Shadow.method3479((Class350.aClass298_Sub25_3757 == (((Class403) class403).myClanChannel)), i_54_, (byte) 1);
	}
	catch (RuntimeException runtimeexception) {
