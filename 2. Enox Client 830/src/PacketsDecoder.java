	...
	static final boolean method4548(Class25 class25, int i) throws IOException {
		try {
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2162) {
				pb.aByte8959 = stream.readByteC(281504196);
				if (pb.aByte8959 == 0 || pb.aByte8959 == 1)
					pb.aBoolean8640 = true;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2261) {
				pb.anInt8885 = 887090299 * pb.anInt8933;
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2309) {
				pb.anInt8845 = stream.readShort(2135181158) * 2043410797;
				pb.anInt8888 = pb.anInt8933 * 1991119277;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.GRAPHICS_PACKET) {
				...
				if (targetHash >> 30 != 0) {
					...
					int i_102_ = ((targetHash >> 14 & 0x3fff) - -1760580017 * class341.x);
					int i_103_ = (targetHash & 0x3fff) - 283514611 * class341.y;
					if (i_102_ >= 0 && i_103_ >= 0 && (i_102_ < pb.aClass283_8716.method2629(-1990296889)) && (i_103_ < pb.aClass283_8716.method2630(-1604198619))) {
						if (graphicsId == -1) {
							Class298_Sub37_Sub3 class298_sub37_sub3 = ((Class298_Sub37_Sub3) (pb.aClass437_8825.get((long) (i_102_ << 16 | i_103_))));
							...
							int i_106_ = i_101_;
							if (i_106_ < 3 && (pb.aClass283_8716.method2654(651162634).method2320(i_102_, i_103_, -2025869337)))
								i_106_++;
							Class365_Sub1_Sub1_Sub3 class365_sub1_sub1_sub3 = (new Class365_Sub1_Sub1_Sub3(pb.aClass283_8716.method2675(-1611682495), graphicsId, speed, i_101_, i_106_, i_104_, Class356.method4271(i_104_, i_105_, i_101_, -1215922012) - graphicsHeight, i_105_, i_102_, i_102_, i_103_, i_103_, i_99_, bool));
							pb.aClass437_8825.method5817((new Class298_Sub37_Sub3(class365_sub1_sub1_sub3)), (long) (i_102_ << 16 | i_103_));
						}
					}
				}
				else if (targetHash >> 29 != 0) {
					int i_107_ = targetHash & 0xffff;
					Class298_Sub29 class298_sub29 = ((Class298_Sub29) pb.aClass437_8696.get((long) i_107_));
					if (null != class298_sub29) {
						...
						if (-1 != graphicsId && i_109_ != -1) {
							if (graphicsId == i_109_) {
								GraphicDefinition class398 = Class158_Sub1.aClass389_8568.getGraphicDefinition(graphicsId, -2138799623);
								if (class398.aBoolean5215 && -1 != class398.animation * 1505778629) {
									AnimationDefinition class391 = (Class501.aClass395_6122.getAnimationDefinition(class398.animation * 1505778629, (byte) -71));
									int i_110_ = class391.replayMode * -1117238071;
								...
								GraphicDefinition class398 = Class158_Sub1.aClass389_8568.getGraphicDefinition(graphicsId, -1997923010);
								GraphicDefinition class398_111_ = Class158_Sub1.aClass389_8568.getGraphicDefinition(i_109_, -1881939747);
								if (class398.animation * 1505778629 != -1 && (class398_111_.animation * 1505778629 != -1)) {
									AnimationDefinition class391 = (Class501.aClass395_6122.getAnimationDefinition(class398.animation * 1505778629, (byte) 83));
									AnimationDefinition class391_112_ = (Class501.aClass395_6122.getAnimationDefinition((1505778629 * class398_111_.animation), (byte) -25));
						...
						if (bool_108_) {
							...
							if (-1 != graphicsId) {
								GraphicDefinition class398 = Class158_Sub1.aClass389_8568.getGraphicDefinition(graphicsId, -1696520605);
					...
					if (i_114_ == -442628795 * pb.playerIndex)
						class365_sub1_sub1_sub2_sub2 = Class287.myPlayer;
					else
						class365_sub1_sub1_sub2_sub2 = (pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_114_]);
					if (class365_sub1_sub1_sub2_sub2 != null) {
						...
						if (graphicsId != -1 && -1 != i_116_) {
							if (graphicsId == i_116_) {
								GraphicDefinition class398 = Class158_Sub1.aClass389_8568.getGraphicDefinition(graphicsId, -1990411818);
								if (class398.aBoolean5215 && class398.animation * 1505778629 != -1) {
									AnimationDefinition class391 = (Class501.aClass395_6122.getAnimationDefinition(class398.animation * 1505778629, (byte) -15));
									int i_117_ = -1117238071 * class391.replayMode;
								...
								GraphicDefinition class398 = Class158_Sub1.aClass389_8568.getGraphicDefinition(graphicsId, -1975194771);
								GraphicDefinition class398_118_ = Class158_Sub1.aClass389_8568.getGraphicDefinition(i_116_, -1893234855);
								if (-1 != class398.animation * 1505778629 && -1 != (1505778629 * class398_118_.animation)) {
									AnimationDefinition class391 = (Class501.aClass395_6122.getAnimationDefinition(1505778629 * class398.animation, (byte) -1));
									AnimationDefinition class391_119_ = (Class501.aClass395_6122.getAnimationDefinition((class398_118_.animation * 1505778629), (byte) -13));
						...
						if (bool_115_) {
							...
							if (graphicsId != -1) {
								GraphicDefinition class398 = Class158_Sub1.aClass389_8568.getGraphicDefinition(graphicsId, -2053481236);
			...
			if (IncommingPacket.OPEN_INTERFACE_OBJECT == ((Class25) class25).INCOMMING_PACKET) {
				...
				int type = objectHash >> 2;
									...
									WorldTile coordinateHash = new WorldTile(stream.readInt((byte) -80));
			...
			if (IncommingPacket.aClass202_2199 == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (bool_139_) {
					...
					((Class7) class7).aString94 = BillBoardDefinitions.method1824(class7.aString93, -514633017);
					...
					for (i_143_ = -1801543887 * Class489.anInt6071 - 1; i_143_ >= 0; i_143_--) {
						...
						if (0 == i_144_) {
							...
							if (string_136_.equals(Class287.myPlayer.aString10195))
								BillBoardDefinitions.aByte1759 = i_138_;
							pb.anInt8912 = pb.anInt8933 * 1348241137;
							((Class25) class25).INCOMMING_PACKET = null;
							return true;
						}
						if (i_144_ < 0) {
			...
			if (IncommingPacket.SYSTEM_UPDATE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				if (Class299.method3682(pb.anInt8752 * -1233866115, 1765230881))
					pb.anInt8669 = (int) ((float) stream.readUnsignedShort() * 2.5F) * -2090750423;
				else
					pb.anInt8669 = (stream.readUnsignedShort() * 1701996750);
				pb.anInt8888 = pb.anInt8933 * 1991119277;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.CLAN_CHANNEL_PACKET) {
				pb.anInt8886 = -1469951735 * pb.anInt8933;
				boolean bool = stream.readUnsignedByte() == 1;
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2236) {
				...
				if (null != pb.aClass299Array8671[i_156_]) {
					pb.aClass299Array8671[i_156_].method3677(pb.aClass283_8716.method2675(-1611682495), -1127737066);
					pb.aClass299Array8671[i_156_] = null;
				}
				if (i_157_ != -1) {
					pb.aClass299Array8671[i_156_] = new Class299(Class373.activeToolkit, stream, i_157_);
					pb.aClass299Array8671[i_156_].method3676(pb.aClass283_8716.method2675(-1611682495), 2021897283);
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2177) {
				...
				if (stream.method3615((byte) 83))
					Textures.method2391(stream, (385051775 * stream.index) - 28, (byte) 2);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.SET_MOUSE_PACKET) {
				...
				pb.anInt8822 = ((((Class25) class25).anInt336 * -866602563 > 0 ? stream.readUnsignedShort() : -1) * 812630591);
				if (pb.anInt8822 * -1471730241 == 65535)
					pb.anInt8822 = -812630591;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.aClass202_2160 == ((Class25) class25).INCOMMING_PACKET) {
				...
				WorldTile class341 = new WorldTile(stream.readInt((byte) 122));
			...
			if (IncommingPacket.aClass202_2153 == ((Class25) class25).INCOMMING_PACKET) {
				...
				while_86_: do {
					if (null == class298_sub25)
						...
						for (int i_170_ = 0; i_170_ < 100; i_170_++) {
							if (pb.aLongArray8915[i_170_] == l_168_) {
								bool_169_ = true;
								break while_86_;
							}
						}
						if (i_167_ <= 1) {
							if (pb.aBoolean8811 && !pb.aBoolean8812 || pb.aBoolean8802)
								bool_169_ = true;
				...
				while (false);
				if (!bool_169_) {
					pb.aLongArray8915[1594173071 * pb.anInt8916] = l_168_;
					pb.anInt8916 = ((1 + 1594173071 * pb.anInt8916) % 100 * 1356544111);
			...
			if (IncommingPacket.ICOMPONENT_SETTINGS_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				for (int slot = fromSlot; slot <= toSlot; slot++) {
					...
					IComponentSettings class298_sub38 = (IComponentSettings) pb.aClass437_8896.get(l);
					IComponentSettings class298_sub38_178_;
					if (class298_sub38 == null) {
						if (-1 == slot)
							class298_sub38_178_ = new IComponentSettings(settingsHash, ((Class50.getIComponentDefinitions(icomponentHash, (byte) -34).aClass298_Sub38_1219.anInt7410) * -1133219011));
						else
							class298_sub38_178_ = new IComponentSettings(settingsHash, -1);
					}
					else {
						class298_sub38_178_ = new IComponentSettings(settingsHash, (-1133219011 * class298_sub38.anInt7410));
						class298_sub38.method2839(-1460969981);
					}
					pb.aClass437_8896.method5817(class298_sub38_178_, l);
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.aClass202_2223 == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (i_181_ == -1) {
					...
					i_182_ -= -1760580017 * class341.x;
					if (i_182_ < 0)
						i_182_ = 0;
					else if (i_182_ >= pb.aClass283_8716.method2629(-2076483330))
						i_182_ = pb.aClass283_8716.method2629(-1922242399);
					i_183_ -= 283514611 * class341.y;
					if (i_183_ < 0)
						i_183_ = 0;
					else if (i_183_ >= pb.aClass283_8716.method2630(-1784447321))
						i_183_ = pb.aClass283_8716.method2630(232319200);
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2274) {//possible
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.OBJECT_ANIMATION_PACKET) {
				...
				int i_193_ = pb.anIntArray8739[i_191_];
				...
				int i_195_ = locationHash >> 28 & 0x3;
					...
					WorldTile class341 = pb.aClass283_8716.method2628(681479919);
					i_196_ -= -1760580017 * class341.x;
					i_197_ -= 283514611 * class341.y;
			...
			if (IncommingPacket.PUBLIC_MESSAGE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				Player class365_sub1_sub1_sub2_sub2;
				if (-442628795 * pb.playerIndex == i_198_)
					class365_sub1_sub1_sub2_sub2 = Class287.myPlayer;
				else
					class365_sub1_sub1_sub2_sub2 = (pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_198_]);
				...
				if (null != class365_sub1_sub1_sub2_sub2.aString10195 && null != class365_sub1_sub1_sub2_sub2.aClass366_10209) {
					...
					if (rights != 2) {
						if (!bool && (pb.aBoolean8811 && !pb.aBoolean8812 || pb.aBoolean8802))
							bool_201_ = true;
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2298) {
				...
				if (!pb.aBoolean8638 || !Class65.method762(string, 1, string_204_, -2024310199))
					Class273.method2559(string, true, Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571.method5677(-446024577) == 5, string_204_, pb.aBoolean8867, pb.aBoolean8651, -1865929375);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.LOAD_MAP_SCENE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (Loader.useMapsTest || Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub21_7580.method5703((byte) -123) == 1)
					...
					pb.aClass283_8716.sendMapScene(new Class267(Class266.LOAD_MAP_SCENE_NORMAL, class298_sub53_sub2_217_), -1991819579);
				((Class25) class25).INCOMMING_PACKET = null;
				return false;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2234) {
				pb.anInt8886 = pb.anInt8933 * -1469951735;
				boolean bool = stream.readUnsignedByte() == 1;
			...
			if (IncommingPacket.RUN_ENERGY_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				pb.anInt8844 = stream.readUnsignedByte() * -1985989501;
				pb.anInt8888 = pb.anInt8933 * 1991119277;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.PLAYER_OPTION_PACKET) {
				...
				if (slot >= 1 && slot <= 8) {
					if (optionName.equalsIgnoreCase("null"))
						optionName = null;
					pb.aStringArray8820[slot - 1] = optionName;
					pb.anIntArray8904[slot - 1] = cursor;
					pb.aBooleanArray8821[slot - 1] = 0 == onTop;
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.ITEMS_PACKET) {
				...
				pb.anIntArray8823[(pb.anInt8873 += 1524000797) * 1610062389 - 1 & 0x1f] = i_222_;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.SET_CAMERA_LOOK_PACKET) {
				...
				BillBoardDefinitions.method1822(viewLocalX, viewLocalY, viewZ, speed1, speed2, (byte) 92);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.RECEIVE_PRIVATE_QUICK_CHAT_MESSAGE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				while_87_: do {
					for (int i_239_ = 0; i_239_ < 100; i_239_++) {
						if (pb.aLongArray8915[i_239_] == l_237_) {
							bool_238_ = true;
							break while_87_;
						}
					}
				...
				while (false);
				if (!bool_238_) {
					pb.aLongArray8915[pb.anInt8916 * 1594173071] = l_237_;
					pb.anInt8916 = 1356544111 * ((1594173071 * pb.anInt8916 + 1) % 100);
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2293) {
				...
				pb.anIntArray8880[((pb.anInt8881 += -1965237945) * -1653538697) - 1 & 0x1f] = i_242_;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.aClass202_2249 == ((Class25) class25).INCOMMING_PACKET) {
				...
				for (int i_248_ = fromSlot; i_248_ <= i_247_; i_248_++) {
					...
					if (class298_sub38 == null) {
						if (i_248_ == -1)
							class298_sub38_249_ = new IComponentSettings(((Class50.getIComponentDefinitions(i_246_, (byte) -9).aClass298_Sub38_1219.anInt7416) * -1266165749), i_245_);
						else
							class298_sub38_249_ = new IComponentSettings(0, i_245_);
					}
					else {
						class298_sub38_249_ = new IComponentSettings((-1266165749 * class298_sub38.anInt7416), i_245_);
						class298_sub38.method2839(-1460969981);
					}
					pb.aClass437_8896.method5817(class298_sub38_249_, l);
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.SHAKE_CAMERA_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				pb.aBooleanArray8684[slotId] = true;
				pb.anIntArray8860[slotId] = a;
				pb.anIntArray8925[slotId] = b;
				pb.anIntArray8926[slotId] = c;
				pb.anIntArray8790[slotId] = d;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.RECEIVE_FRIEND_CHAT_QUICK_MESSAGE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				while_88_: do {
					for (int i_267_ = 0; i_267_ < 100; i_267_++) {
						if (l_265_ == pb.aLongArray8915[i_267_]) {
							bool_266_ = true;
							break while_88_;
						}
					}
				...
				while (false);
				if (!bool_266_) {
					pb.aLongArray8915[1594173071 * pb.anInt8916] = l_265_;
					pb.anInt8916 = ((pb.anInt8916 * 1594173071 + 1) % 100 * 1356544111);
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.FRIENDS_PACKET) {
				while (stream.index * 385051775 < ((Class25) class25).anInt336 * -866602563) {
					...
					for (int i_275_ = 0; i_275_ < pb.anInt8941 * -1054937867; i_275_++) {
						if (!bool) {
							if (string.equals(pb.aStringArray8704[i_275_])) {
								if (pb.anIntArray8946[i_275_] != worldId) {
									boolean bool_276_ = true;
									for (Class302_Sub2 class302_sub2 = ((Class302_Sub2) pb.aClass442_8951.method5868(-16777216)); null != class302_sub2; class302_sub2 = ((Class302_Sub2) pb.aClass442_8951.method5872(269965941))) {
										if (((Class302_Sub2) class302_sub2).aString7648.equals(string)) {
											if (worldId != 0 && (((Class302_Sub2) class302_sub2).aShort7646 == 0)) {
												class302_sub2.method3714(185516853);
												bool_276_ = false;
											}
											else if (worldId == 0 && (0 != (((Class302_Sub2) class302_sub2).aShort7646))) {
									...
									if (bool_276_)
										pb.aClass442_8951.method5870(new Class302_Sub2(string, worldId), 1940667363);
									pb.anIntArray8946[i_275_] = worldId;
								}
								pb.aStringArray8945[i_275_] = string_269_;
								pb.aStringArray8947[i_275_] = string_273_;
								pb.anIntArray8705[i_275_] = i_271_;
								pb.aBooleanArray8722[i_275_] = bool_274_;
								pb.aBooleanArray8950[i_275_] = bool_272_;
								string = null;
								break;
							}
						}
						else if (string_269_.equals(pb.aStringArray8704[i_275_])) {
							pb.aStringArray8704[i_275_] = string;
							pb.aStringArray8945[i_275_] = string_269_;
							string = null;
							break;
						}
					}
					if (string != null && pb.anInt8941 * -1054937867 < 200) {
						pb.aStringArray8704[-1054937867 * pb.anInt8941] = string;
						pb.aStringArray8945[-1054937867 * pb.anInt8941] = string_269_;
						pb.anIntArray8946[-1054937867 * pb.anInt8941] = worldId;
						pb.aStringArray8947[pb.anInt8941 * -1054937867] = string_273_;
						pb.anIntArray8705[-1054937867 * pb.anInt8941] = i_271_;
						pb.aBooleanArray8722[(-1054937867 * pb.anInt8941)] = bool_274_;
						pb.aBooleanArray8950[(pb.anInt8941 * -1054937867)] = bool_272_;
						pb.anInt8941 += 560029533;
					}
				}
				pb.anInt8942 = 1353701786;
				pb.anInt8883 = 754377557 * pb.anInt8933;
				boolean bool = false;
				int i_277_ = -1054937867 * pb.anInt8941;
				while_89_: do {
					do {
						if (i_277_ <= 0)
							break while_89_;
						...
						for (int i_278_ = 0; i_278_ < i_277_; i_278_++) {
							...
							if ((Class474.aClass471_5979.worldId * 1606920449 != pb.anIntArray8946[i_278_]) && ((1606920449 * Class474.aClass471_5979.worldId) == pb.anIntArray8946[i_278_ + 1]))
								bool_279_ = true;
							if (!bool_279_ && pb.anIntArray8946[i_278_] == 0 && pb.anIntArray8946[i_278_ + 1] != 0)
								bool_279_ = true;
							if (!bool_279_ && !pb.aBooleanArray8950[i_278_] && pb.aBooleanArray8950[1 + i_278_])
								bool_279_ = true;
							if (bool_279_) {
								int i_280_ = pb.anIntArray8946[i_278_];
								pb.anIntArray8946[i_278_] = pb.anIntArray8946[i_278_ + 1];
								pb.anIntArray8946[1 + i_278_] = i_280_;
								String string = pb.aStringArray8947[i_278_];
								pb.aStringArray8947[i_278_] = pb.aStringArray8947[i_278_ + 1];
								pb.aStringArray8947[1 + i_278_] = string;
								String string_281_ = pb.aStringArray8704[i_278_];
								pb.aStringArray8704[i_278_] = pb.aStringArray8704[i_278_ + 1];
								pb.aStringArray8704[1 + i_278_] = string_281_;
								String string_282_ = pb.aStringArray8945[i_278_];
								pb.aStringArray8945[i_278_] = pb.aStringArray8945[1 + i_278_];
								pb.aStringArray8945[1 + i_278_] = string_282_;
								int i_283_ = pb.anIntArray8705[i_278_];
								pb.anIntArray8705[i_278_] = pb.anIntArray8705[i_278_ + 1];
								pb.anIntArray8705[1 + i_278_] = i_283_;
								boolean bool_284_ = pb.aBooleanArray8722[i_278_];
								pb.aBooleanArray8722[i_278_] = pb.aBooleanArray8722[i_278_ + 1];
								pb.aBooleanArray8722[1 + i_278_] = bool_284_;
								boolean bool_285_ = pb.aBooleanArray8950[i_278_];
								pb.aBooleanArray8950[i_278_] = pb.aBooleanArray8950[1 + i_278_];
								pb.aBooleanArray8950[1 + i_278_] = bool_285_;
								bool = false;
							}
						}
					}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.CLAN_SETTINGS_PACKET) {
				pb.anInt8885 = 887090299 * pb.anInt8933;
				boolean bool = stream.readUnsignedByte() == 1;
			...
			if (IncommingPacket.aClass202_2228 == ((Class25) class25).INCOMMING_PACKET) {
				if (-1 != pb.WINDOW_PANE_ID * -257444687)
					Class82_Sub10.method903(pb.WINDOW_PANE_ID * -257444687, 0, 390245730);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.aClass202_2198 == ((Class25) class25).INCOMMING_PACKET) {
				...
				pb.anIntArray8880[((pb.anInt8881 += -1965237945) * -1653538697) - 1 & 0x1f] = i_291_;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.OTHER_GAME_BAR_STAGES_PACKET) {
				pb.anInt8913 = stream.readUnsigned128Byte((byte) 101) * -1777248765;
				pb.anInt8837 = stream.readUnsignedByte() * 1583527743;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			// not
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.SEND_PRIVATE_QUICK_CHAT_MESSAGE_PACKET) {
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2185) {
				for (int i_313_ = 0; (i_313_ < pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805.length); i_313_++) {
					if (pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_313_] != null) {
						pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_313_].anIntArray10093 = null;
						pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_313_].aClass438_10078.method5821(-1, -1564622591);
					}
				}
				for (int i_314_ = 0; i_314_ < pb.anInt8772 * 1962237353; i_314_++) {
					((Entity) pb.aClass298_Sub29Array8816[i_314_].anObject7366).anIntArray10093 = null;
					((Entity) pb.aClass298_Sub29Array8816[i_314_].anObject7366).aClass438_10078.method5821(-1, -2064932982);
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2251) {
				...
				Interface class298_sub51 = ((Interface) pb.aClass437_8841.get((long) i_315_));
				Interface class298_sub51_317_ = ((Interface) pb.aClass437_8841.get((long) i_316_));
				if (null != class298_sub51_317_)
					BillBoardDefinitions.method1821(class298_sub51_317_, (class298_sub51 == null || ((class298_sub51_317_.interfaceId * -1617025021) != (-1617025021 * class298_sub51.interfaceId))), false, -113822480);
				if (class298_sub51 != null) {
					class298_sub51.method2839(-1460969981);
					pb.aClass437_8841.method5817(class298_sub51, (long) i_316_);
				}
				...
				if (pb.WINDOW_PANE_ID * -257444687 != -1)
					Class82_Sub10.method903(pb.WINDOW_PANE_ID * -257444687, 1, -167409895);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.GAME_PANE_PACKET) {
				...
				pb.WINDOW_PANE_ID = 1785861201 * windowId;
				Class8.method321(windowId, keySet, 1073572568);
				Class257.method2453(false, (byte) 8);
				Class14.method341(pb.WINDOW_PANE_ID * -257444687, keySet, 278724032);
				for (int i_327_ = 0; i_327_ < 113; i_327_++)
					pb.aBooleanArray8900[i_327_] = true;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.INDEX14_SOUND_PACKET) {
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.ITEMS_UPDATE_PACKET) {
				...
				pb.anIntArray8823[(pb.anInt8873 += 1524000797) * 1610062389 - 1 & 0x1f] = key;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.aClass202_2250 == ((Class25) class25).INCOMMING_PACKET) {
				...
				SubIncommingPacket.sendSomethingOnIComponent(i_342_, pb.playerIndex * -442628795, 5, 0, 262144);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.PLAYER_UNDER_NPC_PRIORITY_PACKET) {
				...
				pb.anInt8903 = i_343_ * -1149402483;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.aClass202_2290 == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (bool_362_)
					...
					i_358_ *= 4;
				WorldTile class341 = pb.aClass283_8716.method2628(681479919);
				int i_364_ = i_354_ - class341.x * 773807262;
				int i_365_ = i_357_ - 567029222 * class341.y;
				i_351_ += i_364_;
				i_361_ += i_365_;
				if (i_364_ >= 0 && i_365_ >= 0 && (i_364_ < pb.aClass283_8716.method2629(-1911669738) * 2) && (i_365_ < pb.aClass283_8716.method2629(-1992464171) * 2) && i_351_ >= 0 && i_361_ >= 0 && (i_351_ < pb.aClass283_8716.method2630(-2022476058) * 2) && (i_361_ < pb.aClass283_8716.method2630(1563119067) * 2) && 65535 != i_348_) {
					i_364_ *= 256;
					i_365_ *= 256;
					i_351_ = 256 * i_351_;
					i_361_ = 256 * i_361_;
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2168) {
				...
				pb.anInt8942 = -1470632755;
				pb.anInt8883 = pb.anInt8933 * 754377557;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.aClass202_2297 == ((Class25) class25).INCOMMING_PACKET) {
				pb.aBoolean8815 = stream.readUnsignedByteC((short) -6905) == 1;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.CUTSCENE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				pb.anInt8726 = 733205975;
				pb.anInt8870 = 221729505 * i_380_;
				pb.anInt8724 = 986798515;
				Class399.idx35.fileLoaded(577335585 * pb.anInt8870, -457216440);
			...
			if (IncommingPacket.aClass202_2203 == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (stream.readUnsignedByte() == 0)
					pb.GRAND_EXCHANGE_SLOTS[slot] = new Class251();
				else {
					stream.index -= 116413311;
					pb.GRAND_EXCHANGE_SLOTS[slot] = new Class251(stream);
				}
				pb.anInt8796 = pb.anInt8933 * 1729482221;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.aClass202_2191 == ((Class25) class25).INCOMMING_PACKET) {
				...
				LookupTable.method1244(i_389_, i_390_, (byte) -47);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.ICOMPONENT_SPRITE_PACKET) {
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.RECEIVE_QUICK_PRIVATE_MESSAGE) {
				...
				while_90_: do {
					if (class298_sub25 == null)
						...
						for (int i_399_ = 0; i_399_ < 100; i_399_++) {
							if (l_397_ == pb.aLongArray8915[i_399_]) {
								bool_398_ = true;
								break while_90_;
							}
						}
				...
				while (false);
				if (!bool_398_) {
					pb.aLongArray8915[1594173071 * pb.anInt8916] = l_397_;
					pb.anInt8916 = ((1594173071 * pb.anInt8916 + 1) % 100 * 1356544111);
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.INDEX15_SOUND_PACKET) {
				int soundId = stream.readUnsignedShort();
				if (soundId == 65535)
					soundId = -1;
				int repeatAmt = stream.readUnsignedByte();
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2232) {
				...
				class298_sub36.aClass298_Sub53_Sub2_7396.write128Byte(914379507 * pb.anInt6467, (byte) 1);
			...
			if (IncommingPacket.HELPER_PACKET == ((Class25) class25).INCOMMING_PACKET) {
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2154) {// emote
				...
				Class298_Sub29 class298_sub29 = ((Class298_Sub29) pb.aClass437_8696.get((long) i_425_));
			...
			if (IncommingPacket.aClass202_2220 == ((Class25) class25).INCOMMING_PACKET) {
				...
				WorldTile class341 = pb.aClass283_8716.method2628(681479919);
				for (Class298_Sub2 class298_sub2 = ((Class298_Sub2) pb.aClass437_8685.method5816(1564654282)); class298_sub2 != null; class298_sub2 = ((Class298_Sub2) pb.aClass437_8685.method5815((byte) 10))) {
					...
					int i_428_ = i_427_ - -1760580017 * class341.x;
					int i_429_ = (int) ((7051297995265073167L * class298_sub2.hash) >> 14 & 0x3fffL);
					int i_430_ = i_429_ - 283514611 * class341.y;
					if (i_426_ == Class375.basePlane * -191892109 && i_428_ >= 134435705 * ClanSettings.baseTileX && i_428_ < 8 + 134435705 * ClanSettings.baseTileX && i_430_ >= -105526719 * Class216.baseTileY && i_430_ < 8 + Class216.baseTileY * -105526719) {
						...
						if (i_428_ >= 0 && i_430_ >= 0 && i_428_ < pb.aClass283_8716.method2629(-2088487368) && i_430_ < pb.aClass283_8716.method2630(1377874440))
							BillBoardDefinitions.method1820((Class375.basePlane * -191892109), i_428_, i_430_, 1641680263);
					}
				}
				for (Class298_Sub1 class298_sub1 = (Class298_Sub1) Class298_Sub1.aClass453_7152.method5939(1766612795); class298_sub1 != null; class298_sub1 = ((Class298_Sub1) Class298_Sub1.aClass453_7152.method5944(49146))) {
					if ((class298_sub1.anInt7150 * 634196087 >= 134435705 * ClanSettings.baseTileX) && (634196087 * class298_sub1.anInt7150 < 8 + 134435705 * ClanSettings.baseTileX) && (-2146829167 * class298_sub1.anInt7155 >= -105526719 * Class216.baseTileY) && (-2146829167 * class298_sub1.anInt7155 < Class216.baseTileY * -105526719 + 8) && (((Class298_Sub1) class298_sub1).anInt7151 * 2108312995) == -191892109 * Class375.basePlane)
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2188) {
				...
				pb.anIntArray8880[((pb.anInt8881 += -1965237945) * -1653538697) - 1 & 0x1f] = i_437_;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.SKILL_LEVEL_PACKET) {
				...
				pb.anIntArray8829[skillId] = xp;
				pb.anIntArray8924[skillId] = level;
				pb.anIntArray8828[skillId] = 1;
				int i_443_ = Class368.anIntArray4002[skillId] - 1;
				for (int i_444_ = 0; i_444_ < i_443_; i_444_++) {
					if (xp >= Class368.anIntArray4003[i_444_])
						pb.anIntArray8828[skillId] = 2 + i_444_;
				}
				pb.anIntArray8833[(pb.anInt8875 += 1972492301) * -1048955195 - 1 & 0x1f] = skillId;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.FRIENDS_CHAT_CHANNEL_PACKET) {
				pb.anInt8912 = 1348241137 * pb.anInt8933;
				...
				pb.aString8919 = stream.readString(2105595106);
				boolean bool = stream.readUnsignedByte() == 1;
				if (bool)
					stream.readString(-124470201);
				long l = stream.readLong((short) 6221);
				pb.aString8804 = Class377.method4664(l);
				...
				for (int i_446_ = 0; i_446_ < Class489.anInt6071 * -1801543887; i_446_++) {
					...
					((Class7) class7s[i_446_]).aString94 = BillBoardDefinitions.method1824(class7s[i_446_].aString93, 445649895);
					...
					if (class7s[i_446_].aString93.equals(Class287.myPlayer.aString10195))
						BillBoardDefinitions.aByte1759 = class7s[i_446_].aByte97;
				}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.HINT_ICON_PACKET) {
				...
				int i_451_ = i_450_ >> 5;
					...
					if (0 == i_452_) {
						pb.aClass19Array8869[i_451_] = null;
						((Class25) class25).INCOMMING_PACKET = null;
						return true;
					}
					...
					if (((Class19) class19).anInt258 * -92466201 >= 0 && (((Class19) class19).anInt258 * -92466201 < Class128_Sub2.aClass57Array8560.length)) {
						if (class19.anInt266 * 958933333 == 1 || 10 == class19.anInt266 * 958933333) {
							...
							WorldTile class341 = pb.aClass283_8716.method2628(681479919);
							class19.anInt260 += ((stream.readUnsignedShort() - -1760580017 * class341.x) << 9) * 962213171;
							class19.anInt261 += ((stream.readUnsignedShort() - class341.y * 283514611) << 9) * 313675491;
						...
						pb.aClass19Array8869[i_451_] = class19;
					}
					((Class25) class25).INCOMMING_PACKET = null;
					return true;
			}
			if (IncommingPacket.PLAYER_ON_ICOMPONENT_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				SubIncommingPacket.sendSomethingOnIComponent(i_453_, pb.playerIndex * -442628795, 3, 0, 262144);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.aClass202_2247 == ((Class25) class25).INCOMMING_PACKET) {
				...
				pb.anIntArray8880[((pb.anInt8881 += -1965237945) * -1653538697) - 1 & 0x1f] = i_454_;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.LOAD_MAP_SCENE_DYNAMIC_PACKET) {
				...
				if (Loader.useMapsTest || Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub21_7580.method5703((byte) -70) == 1)
					...
					pb.aClass283_8716.sendMapScene(new Class267(Class266.LOAD_MAP_SCENE_DYNAMIC, class298_sub53_sub2_455_), -1991819579);
				((Class25) class25).INCOMMING_PACKET = null;
				return false;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2306) {
				...
				pb.anIntArray8823[(pb.anInt8873 += 1524000797) * 1610062389 - 1 & 0x1f] = i_456_;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.OPEN_URL_PACKET) {
				...
				if (bool) {
					...
					if (string_466_.length() == 0)
						string_466_ = string;
					if (!pb.aBoolean8638 || Class82_Sub8.aString6856.startsWith("mac") || !Class65.method762(string, 1, Class212.aClass212_2424.method1951(-1209858466), -1999887910))
						Class346.method4172(string_466_, true, Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571.method5677(-2008340671) == 5, pb.aBoolean8867, pb.aBoolean8651, (byte) 13);
				}
				else
					Class346.method4172(string, true, Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571.method5677(-389602471) == 5, pb.aBoolean8867, pb.aBoolean8651, (byte) 54);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.RECEIVE_FRIEND_CHAT_MESSAGE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				while_92_: do {
					for (int i_479_ = 0; i_479_ < 100; i_479_++) {
						if (l_477_ == pb.aLongArray8915[i_479_]) {
							bool_478_ = true;
							break while_92_;
						}
					}
				...
				while (false);
				if (!bool_478_) {
					pb.aLongArray8915[1594173071 * pb.anInt8916] = l_477_;
					pb.anInt8916 = 1356544111 * ((1 + 1594173071 * pb.anInt8916) % 100);
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.CLOSE_INTERFACE_PACKET) {
				...
				Interface class298_sub51 = ((Interface) pb.aClass437_8841.get((long) interfaceHash));
				if (class298_sub51 != null)
					BillBoardDefinitions.method1821(class298_sub51, true, false, -113822480);
				if (pb.aClass105_8652 != null) {
					Tradution.method6054(pb.aClass105_8652, -760560936);
			...
			if (IncommingPacket.IGNORES_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				pb.anInt8952 = stream.readUnsignedByte() * -765637727;
				for (int i_483_ = 0; i_483_ < pb.anInt8952 * -548972447; i_483_++) {
					pb.aStringArray8859[i_483_] = stream.readString(-1615855350);
					pb.aStringArray8954[i_483_] = stream.readString(700707036);
					if (pb.aStringArray8954[i_483_].equals(""))
						pb.aStringArray8954[i_483_] = pb.aStringArray8859[i_483_];
					pb.aStringArray8955[i_483_] = stream.readString(-104782632);
					pb.aStringArray8773[i_483_] = stream.readString(1098088401);
					if (pb.aStringArray8773[i_483_].equals(""))
						pb.aStringArray8773[i_483_] = pb.aStringArray8955[i_483_];
					pb.aBooleanArray8957[i_483_] = false;
				}
				pb.anInt8883 = 754377557 * pb.anInt8933;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			...
			if (IncommingPacket.aClass202_2157 == ((Class25) class25).INCOMMING_PACKET) {
				...
				pb.aBoolean8811 = stream.readUnsignedByte() == 1;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2218) {//possible
			...
			if (IncommingPacket.RECEIVE_PRIVATE_MESSAGE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				while_93_: do {
					for (int i_493_ = 0; i_493_ < 100; i_493_++) {
						if (l_491_ == pb.aLongArray8915[i_493_]) {
							bool_492_ = true;
							break while_93_;
						}
					}
				...
				while (false);
				if (!bool_492_) {
					pb.aLongArray8915[pb.anInt8916 * 1594173071] = l_491_;
					pb.anInt8916 = 1356544111 * ((1 + pb.anInt8916 * 1594173071) % 100);
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.IGNORE_PACKET) {
				...
				if (!bool) {
					pb.aStringArray8859[pb.anInt8952 * -548972447] = string;
					pb.aStringArray8954[pb.anInt8952 * -548972447] = string_496_;
					pb.aStringArray8955[pb.anInt8952 * -548972447] = string_497_;
					pb.aStringArray8773[-548972447 * pb.anInt8952] = string_498_;
					pb.aBooleanArray8957[-548972447 * pb.anInt8952] = 2 == (i_495_ & 0x2);
					pb.anInt8952 += -765637727;
				}
				else {
					for (int i_499_ = 0; i_499_ < pb.anInt8952 * -548972447; i_499_++) {
						if (pb.aStringArray8954[i_499_].equals(string_498_)) {
							pb.aStringArray8859[i_499_] = string;
							pb.aStringArray8954[i_499_] = string_496_;
							pb.aStringArray8955[i_499_] = string_497_;
							pb.aStringArray8773[i_499_] = string_498_;
							break;
						}
					}
				}
