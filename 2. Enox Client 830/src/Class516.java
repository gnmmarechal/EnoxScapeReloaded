...
public class Class516 {
    ...
    static final void method6300(int i, int i_1_, int i_2_, int i_3_, ObjectOverride class435, byte i_4_) {
	try {
	    if (i_2_ >= 1 && i_3_ >= 1 && i_2_ <= pb.aClass283_8716.method2629(-1894377459) - 2 && i_3_ <= pb.aClass283_8716.method2630(793681614) - 2) {
		if (pb.aClass283_8716.method2675(-1611682495) != null) {
		    Interface3 interface3 = pb.aClass283_8716.method2644(112641684).method2241(i, i_1_, i_2_, i_3_, 2002986961);
		    if (interface3 != null) {
	...
	try {
	    ...
	    pb.aClass283_8716.method2667(1924605464);
