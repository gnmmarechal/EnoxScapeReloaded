...
public class HouseConstants {
	...
	//HEAD_TROPHY
	, CRAWLING_HAND(8260, 13481, 38, 211, new Item(TEAK_PLANK, 2), new Item(7982)), COCKATRICE_HEAD(8261, 13482, 38, 224, new Item(TEAK_PLANK, 2), new Item(7983)), BASALISK_HEAD(8262, 13483, 38, 243, new Item(TEAK_PLANK, 2), new Item(7984)), KURASK(8263, 13484, 58, 357, new Item(MAHOGANY_PLANK, 2), new Item(7985)), ABBYSAL_DEMON(8264, 13485, 58, 389, new Item(MAHOGANY_PLANK, 2), new Item(7986)), KING_BLACK_DRAGON(8265, 13486, 78, 1103, new Item(MAHOGANY_PLANK, 2), new Item(7987, 1), new Item(GOLD_LEAF, 2)), KALPHITE_QUEEN(8266, 13487, 78, 1103, new Item(MAHOGANY_PLANK, 2), new Item(7988, 1), new Item(GOLD_LEAF, 2))
	//FISH_MANTEL
	, MOUNTED_BASS(8267, 13488, 36, 151, new Item(OAK_PLANK, 2), new Item(7990)), MOUNTED_SWORDFISH(8268, 13489, 56, 230, new Item(TEAK_PLANK, 2), new Item(7992)), MOUNTED_SHARK(8269, 13490, 76, 350, new Item(MAHOGANY_PLANK, 2), new Item(7994))
	//RUNE CASES
	...
	//Portal Room
	//CENTER PIECE
	, TELEPORT_FOCUS(8331, 13640, 50, 40, new Item(LIMESTONE_BRICKS, 2)), GREATER_FOCUS(8332, 13641, 65, 500, new Item(MARBLE_BLOCK, 1)), SCRYING_POOL(8333, 13639, 80, 2000, new Item(MARBLE_BLOCK, 4))
	//PORTALS
	, VARROCKP(8330, 13629, 80, 1500, new Item(MARBLE_BLOCK, 3), new Item(563, 100), new Item(554, 100), new Item(556, 300)), LUMBRIDGEP(8330, 13630, 80, 1500, new Item(MARBLE_BLOCK, 3), new Item(563, 100), new Item(557, 100), new Item(556, 300)), FALADORP(8330, 13631, 80, 1500, new Item(MARBLE_BLOCK, 3), new Item(563, 100), new Item(555, 100), new Item(556, 300)), CAMELOTP(8330, 13632, 80, 1500, new Item(MARBLE_BLOCK, 3), new Item(563, 100), new Item(556, 500)), ARDOUGNEP(8330, 13633, 80, 1500, new Item(MARBLE_BLOCK, 3), new Item(563, 200), new Item(555, 200)), YANILLEP(8330, 13634, 80, 1500, new Item(MARBLE_BLOCK, 3), new Item(563, 200), new Item(557, 200)), KHARYRLLP(8330, 13635, 80, 1500, new Item(MARBLE_BLOCK, 3), new Item(563, 200), new Item(565, 200))
	// KITCHEN
	//LARDER
	...
	// WORKSPACE
	//REPAIR BENCH
	, REPAIR_BENCH(8389, 13713, 15, 120, new Item(OAK_PLANK, 2)), WHETSTONE(8390, 13714, 35, 260, new Item(OAK_PLANK, 4),new Item(LIMESTONE_BRICKS, 1)), ARMOUR_STAND(8391, 13715, 55, 500, new Item(OAK_PLANK, 8),new Item(LIMESTONE_BRICKS, 1))
	//HERALDRY
	, PLUMING_STAND(8392, 13716, 16, 120, new Item(OAK_PLANK, 2)), SHIELD_EASEL(8393, 13717, 41, 240, new Item(OAK_PLANK, 4)), BANNER_EASEL(8394, 13718, 66, 510, new Item(OAK_PLANK, 8),new Item(BOLT_OF_CLOTH, 2))
	//TOOL MOUNT
	, TOOL_STORE_1(8384, 13699, 15, 120, new Item(OAK_PLANK, 2)), TOOL_STORE_2(8385, 13700, 25, 120, new Item(OAK_PLANK, 4)), TOOL_STORE_3(8386, 13701, 35, 120, new Item(OAK_PLANK, 6)), TOOL_STORE_4(8387, 13702, 44, 120, new Item(OAK_PLANK, 8)), TOOL_STORE_5(8388, 13703, 55, 121, new Item(OAK_PLANK, 10))
	//CRAFTING TABLE
