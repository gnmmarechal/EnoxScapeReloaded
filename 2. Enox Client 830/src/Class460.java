...
public class Class460 implements Iterator {
	...
	try {
	    if ((((HashTable) ((Class460) this).aClass437_5675).aClass298Array5512[1772241843 * ((Class460) this).anInt5677 - 1]) != ((Class460) this).aClass298_5676)
		return true;
	    while (((Class460) this).anInt5677 * 1772241843 < 577108745 * (((HashTable) ((Class460) this).aClass437_5675).anInt5515)) {
		if ((((HashTable) ((Class460) this).aClass437_5675).aClass298Array5512[((((Class460) this).anInt5677 += -317185157) * 1772241843 - 1)].aClass298_3187) != (((HashTable) ((Class460) this).aClass437_5675).aClass298Array5512[((Class460) this).anInt5677 * 1772241843 - 1])) {
		    ((Class460) this).aClass298_5676 = (((HashTable) ((Class460) this).aClass437_5675).aClass298Array5512[((Class460) this).anInt5677 * 1772241843 - 1].aClass298_3187);
		    return true;
		}
		((Class460) this).aClass298_5676 = (((HashTable) ((Class460) this).aClass437_5675).aClass298Array5512[1772241843 * ((Class460) this).anInt5677 - 1]);
	    }
	    return false;
	}
	...
	try {
	    ((Class460) this).aClass298_5676 = (((HashTable) ((Class460) this).aClass437_5675).aClass298Array5512[0].aClass298_3187);
    ...
    public Object next() {
	try {
	    if ((((HashTable) ((Class460) this).aClass437_5675).aClass298Array5512[((Class460) this).anInt5677 * 1772241843 - 1]) != ((Class460) this).aClass298_5676) {
		...
		Class298 class298;
		do {
		    if (((Class460) this).anInt5677 * 1772241843 >= (577108745 * (((HashTable) ((Class460) this).aClass437_5675).anInt5515)))
			break while_106_;
		    class298 = (((HashTable) ((Class460) this).aClass437_5675).aClass298Array5512[((((Class460) this).anInt5677 += -317185157) * 1772241843) - 1].aClass298_3187);
		}
		while (class298 == (((HashTable) ((Class460) this).aClass437_5675).aClass298Array5512[((Class460) this).anInt5677 * 1772241843 - 1]));
		((Class460) this).aClass298_5676 = class298.aClass298_3187;
		((Class460) this).aClass298_5678 = class298;
		return class298;
	    }
	...
	try {
		...
		do {
			...
			if (12 == Class360.anInt3896 * -707576455) {
			    if (264 == -122629167 * Class360.anInt3868) // World login
				Class360.aClass25_3905.method389((Class264_Sub4.method2515(Class474.aClass471_5979.craeteSocket(false), 15000, -649048480)), Class474.aClass471_5979.address, (byte) 0);
			    else
				Class360.aClass25_3905.method389((Class264_Sub4.method2515(Class241.aClass471_2705.craeteSocket(true), 15000, -649048480)), Class241.aClass471_2705.address, (byte) 0);
				...
				if (-122629167 * Class360.anInt3868 == 264)
				    class298_sub36.aClass298_Sub53_Sub2_7396.writeByte((5 == pb.anInt8752 * -1233866115 ? 1 : 0));
				...
				class298_sub53.writeInt((pb.anInt8665 * -1154804873), -1393012818);
				for (int i_2_ = 0; i_2_ < 6; i_2_++)
				    class298_sub53.writeInt((int) (Math.random() * 9.9999999E7), 499420945);
				class298_sub53.writeLong(pb.aLong8675 * -8380697455384249973L);
				class298_sub53.writeByte((-937307905 * (pb.gametype.gameType)));
			...
			if (Class360.anInt3896 * -707576455 == 58) {
			    ...
			    if (!pb.aBoolean8638 || !Class65.method762(string, 1, string_4_, -2049749087))
				Class273.method2559(string, true, Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571.method5677(-671601354) == 5, string_4_, pb.aBoolean8867, pb.aBoolean8651, -1487322449);
			...
			if (-707576455 * Class360.anInt3896 == 82) {
				...
				if (!Class360.aBoolean3886) {
				    ...
				    stream.writeByte((pb.anInt8752 * -1233866115 == 5 ? 1 : 0));
				...
				// 24
				// bytes
				stream.writeString((pb.aString8927), 2114152304);
				stream.writeInt(-1154804873 * pb.anInt8665, -1572632938);
				...
				stream.writeInt(((pb.anInt8713) * -2059460167), -1287558190);
				stream.writeLong(pb.aLong8645 * -5648129435911399733L);
				stream.writeByte(null == pb.aString8648 ? 0 : 1);
				if (pb.aString8648 != null)
				    stream.writeString(pb.aString8648, 2119355084);
				stream.writeByte((BillBoardConfig.aClass305_770.method3747("jagtheora", 1302159774) ? 1 : 0));
				stream.writeByte(((pb.aBoolean8638) ? 1 : 0));
				stream.writeByte(((pb.aBoolean8958) ? 1 : 0));
				stream.writeByte(((Class350.anInt3758) * -180909151));
				stream.writeInt(1886068421 * pb.anInt8654, 576248494);
				stream.writeString((pb.aString8655), 2141094155);
				...
				class298_sub53.method3593(123, 132406974553842422L);
				...
				stream.writeByte((-937307905 * pb.gametype.gameType));
				stream.writeByte(Class321.aClass429_3357.getType(694163818));
				Class10.method322(stream, (byte) 1);
				stream.writeString((pb.aString8927), 2107324025);
				...
				stream.writeInt(-1154804873 * pb.anInt8665, 142980326);
				stream.writeInt(((pb.anInt8654) * 1886068421), -840792899);
				stream.writeString((pb.aString8655), 2126130218);
			...
			if (Class360.anInt3896 * -707576455 == 117) {
				...
				if (264 == Class360.anInt3868 * -122629167) { // world
				    ...
				    stream.index = 0;
				    pb.playerRights = (stream.readUnsignedByte() * 1835619115);
				    pb.anInt8932 = (stream.readUnsignedByte() * -418443653);
				    pb.aBoolean8811 = stream.readUnsignedByte() == 1;
				    pb.aBoolean8812 = stream.readUnsignedByte() == 1;
				    pb.aBoolean8813 = stream.readUnsignedByte() == 1;
				    pb.aBoolean8802 = stream.readUnsignedByte() == 1;
				    pb.playerIndex = (stream.readUnsignedShort() * 1448461709);
				    pb.aBoolean8807 = stream.readUnsignedByte() == 1;
				    Class298_Sub41.anInt7456 = (stream.read24BitInteger((byte) -39) * 777394511);
				    pb.isMemberWorld = stream.readUnsignedByte() == 1;
				    LookupTable.aString1369 = stream.readString(-796084606);
				    pb.aClass283_8716.method2641(-1352577967).method5790(pb.isMemberWorld, 915103443);
				    Class62.aClass248_612.method2384((short) 206).method2641(-884206015).method5790(pb.isMemberWorld, 915103443);
				    Class298_Sub32_Sub14.aClass477_9400.method6092(pb.isMemberWorld, 798055588);
				    Class15.aClass507_224.method6270(pb.isMemberWorld, (byte) -2);
				} else { // lobby login
				    ...
				    pb.aBoolean8640 = stream.readUnsignedByte() == 1;
				    ...
				    if ((Class242.aClass401_2708 != Class401.aClass401_6552) && ((Class242.aClass401_2708 != Class401.aClass401_6554) || (1806357379 * pb.playerRights < 2)) && (Class474.aClass471_5979.method6057(Class474.aClass471_5976, 2123928060))) {
					Class380.method4678(-1667448332);
				    }
				}
				if (pb.aBoolean8811 && !pb.aBoolean8813 || pb.aBoolean8807) {
				    try {
				...
				if (Class360.aClass25_3905.method387(537308016).isAvailable((-866602563 * (((Class25) Class360.aClass25_3905).anInt336)), (byte) -22)) {
					...
					pb.aClass283_8716.sendMapScene(new Class267((Class266.LOAD_MAP_SCENE_DYNAMIC), stream), -1991819579);
				    else
					pb.aClass283_8716.sendMapScene(new Class267((Class266.LOAD_MAP_SCENE_NORMAL), stream), -1991819579);
