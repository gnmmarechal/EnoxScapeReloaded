...
public class Class223 implements Interface24 {
	...
	try {
		...
		try {
		    ...
		    class57 = Class373.activeToolkit.method5031(is_4_, 0, i_2_, i_2_, i_3_, 708696378);
		    break;
		}
	...
	try {
		...
		pb.aClass283_8716.method2641(1825433072).method5793(1390466939);
		...
		ConfigEntry.aClass487_1463.method6161((byte) 115);
		...
		Shadow.aClass491_9686.method6171((byte) 37);
		...
		ConfigEntry.method1309((byte) -57);
		...
		pb.aClass283_8716.method2640((byte) 31).method4317((byte) 24);
		...
		pb.aClass348_8780.method4187();
		pb.aClass348_8898.method4187();
		pb.aClass348_8697.method4187();
	...
	try {
	    for (Class302_Sub4 class302_sub4 = ((Class302_Sub4) pb.aClass442_8650.method5868(-16777216)); null != class302_sub4; class302_sub4 = (Class302_Sub4) pb.aClass442_8650.method5872(1278684124)) {
		if (pb.ticketCycle * 443738891 >= 591467947 * ((Class302_Sub4) class302_sub4).anInt7655)
		    ...
		    Class101.aClass264_1084.method2490(((Class302_Sub4) class302_sub4).aString7657, (int) ((float) i + pb.aFloatArray8891[0]), (int) (pb.aFloatArray8891[1] + (float) i_6_), ~0xffffff | 1160845051 * ((Class302_Sub4) class302_sub4).anInt7651, 0, 8619684);
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    BillBoardConfig.method946(strings, is, 0, strings.length - 1, 2094440127);
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("jl.a(").append(')').toString());
	}
