...
public class Class158 implements Interface5 {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1170 * 1045422783;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Class320.method3913((((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]), (((Class403) class403).anIntArray5244[1 + ((Class403) class403).anInt5239 * 681479919]), (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 2]), (((Class403) class403).anIntArray5244[3 + 681479919 * ((Class403) class403).anInt5239]), true, 256, 1228357249);
	}
	catch (RuntimeException runtimeexception) {
