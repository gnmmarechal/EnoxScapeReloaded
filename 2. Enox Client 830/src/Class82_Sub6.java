...
public class Class82_Sub6 extends Class82 {
	...
	try {
	    AnimationDefinition class391 = Class501.aClass395_6122.getAnimationDefinition((2090514815 * (((Class82_Sub6) this).anInt6839)), (byte) 111);
	    return class391.ready(1778758091);
	}
	catch (RuntimeException runtimeexception) {
    ...
    boolean method884() {
	AnimationDefinition class391 = Class501.aClass395_6122.getAnimationDefinition(2090514815 * ((Class82_Sub6) this).anInt6839, (byte) 25);
	return class391.ready(524582595);
    }
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_2_ | 1 << i_3_;
	}
	catch (RuntimeException runtimeexception) {
