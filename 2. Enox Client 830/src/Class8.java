...
public class Class8 {
	...
	try {
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = ((Class403) class403).myClanChannel.aString7358;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class62 class62 = ((Class403) class403).aClass365_Sub1_Sub1_Sub2_5242.method4437(658355638);
	    if (null == class62)
		((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = "";
	    else
		((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = class62.method721((byte) 1);
	}
	catch (RuntimeException runtimeexception) {
