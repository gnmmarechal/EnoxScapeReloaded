...
public class Class298 {
	...
	static final void method2841(Class403 class403, int i) {
		try {
			...
			Class298_Sub37_Sub10 class298_sub37_sub10 = (Class300.aClass518_3217.method6311(
					(((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]), 894186762));
			int i_0_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 1]);
			int i_1_ = -1;
	...
	static final void method2843(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919
					- 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub25_7569.method5716((byte) 23);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("mk.ajm(").append(')').toString());
		}
	}

	public static BillBoardDefinitions loadBillBoard(int i, int i_3_) {
		try {
			BillBoardDefinitions class173 = (BillBoardDefinitions) BillBoardDefinitions.aClass348_1749.get((long) i);
			if (class173 != null)
				return class173;
			byte[] is = BillBoardDefinitions.aClass243_1756.getFile(0, i);
			class173 = new BillBoardDefinitions();
			if (null != is)
				class173.method1817(new RsByteBuffer(is), i, (byte) -27);
			BillBoardDefinitions.aClass348_1749.put(class173, (long) i);
			return class173;
		} catch (RuntimeException runtimeexception) {
