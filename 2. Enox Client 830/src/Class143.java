...
public class Class143 {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Class403) class403).aClass162_5252.membersCount * 2125429757;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class321.aClass429_3357.getType(694163818);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    byte[][][] is = pb.aClass283_8716.method2642(1330177323);
	    byte i_5_ = (bool ? (byte) 1 : (byte) (-1953789277 * pb.anInt8777 & 0xff));
	    if (i_5_ == is[1855729883 * Class99.anInt952][i_2_][i_3_])
		return false;
	    Class244 class244 = pb.aClass283_8716.method2654(-334353018);
	    if (((class244.aByteArrayArrayArray2731[Class99.anInt952 * 1855729883][i_2_][i_3_]) & 0x4) == 0)
		return false;
	    int i_6_ = 0;
	    int i_7_ = 0;
	    pb.anIntArray8735[i_6_] = i_2_;
	    pb.anIntArray8847[i_6_++] = i_3_;
	    is[1855729883 * Class99.anInt952][i_2_][i_3_] = i_5_;
	    while (i_7_ != i_6_) {
		int i_8_ = pb.anIntArray8735[i_7_] & 0xffff;
		int i_9_ = pb.anIntArray8735[i_7_] >> 16 & 0xff;
		int i_10_ = pb.anIntArray8735[i_7_] >> 24 & 0xff;
		int i_11_ = pb.anIntArray8847[i_7_] & 0xffff;
		int i_12_ = pb.anIntArray8847[i_7_] >> 16 & 0xff;
		i_7_ = i_7_ + 1 & 0xfff;
		...
		if (null != class326s) {
			...
			if (null == class326s[i_15_]) {
				...
				if (null != (class326s[i_15_][i_8_][i_11_].aClass365_Sub1_Sub5_3457)) {
				    int i_16_ = SunDefinition.method1402(i_9_, -1319957905);
				    ...
				    if (i_10_ != 0) {
					int i_17_ = SunDefinition.method1402(i_10_, -1159033021);
				    ...
				    if (i_12_ != 0) {
					int i_18_ = SunDefinition.method1402(i_12_, -1010197518);
		...
		if (bool_14_) {
		    int i_24_ = pb.aClass283_8716.method2675(-1611682495).aClass_xaArray3517[1855729883 * Class99.anInt952 + 1].method6341(i_8_, i_11_, (byte) -36);
		    if (pb.anIntArray8793[i] < i_24_)
			pb.anIntArray8793[i] = i_24_;
		    int i_25_ = i_8_ << 9;
		    int i_26_ = i_11_ << 9;
		    if (pb.anIntArray8670[i] > i_25_)
			pb.anIntArray8670[i] = i_25_;
		    else if (pb.anIntArray8795[i] < i_25_)
			pb.anIntArray8795[i] = i_25_;
		    if (pb.anIntArray8797[i] > i_26_)
			pb.anIntArray8797[i] = i_26_;
		    else if (pb.anIntArray8641[i] < i_26_)
			pb.anIntArray8641[i] = i_26_;
		}
		if (bool_13_) {
		    if (i_4_ != -777988087) {
			/* empty */
			...
			pb.anIntArray8735[i_6_] = i_8_ - 1 | 0x120000 | ~0x2cffffff;
			pb.anIntArray8847[i_6_] = i_11_ | 0x130000;
			i_6_ = i_6_ + 1 & 0xfff;
			is[Class99.anInt952 * 1855729883][i_8_ - 1][i_11_] = i_5_;
		    }
		    if (++i_11_ < pb.aClass283_8716.method2630(-1603394405)) {
			if (i_8_ - 1 >= 0 && i_5_ != (is[Class99.anInt952 * 1855729883][i_8_ - 1][i_11_]) && 0 == ((class244.aByteArrayArrayArray2731[1855729883 * Class99.anInt952][i_8_][i_11_]) & 0x4) && 0 == ((class244.aByteArrayArrayArray2731[Class99.anInt952 * 1855729883][i_8_ - 1][i_11_ - 1]) & 0x4)) {
			    pb.anIntArray8735[i_6_] = i_8_ - 1 | 0x120000 | 0x52000000;
			    pb.anIntArray8847[i_6_] = i_11_ | 0x130000;
			    i_6_ = 1 + i_6_ & 0xfff;
			    is[Class99.anInt952 * 1855729883][i_8_ - 1][i_11_] = i_5_;
			}
			if (is[1855729883 * Class99.anInt952][i_8_][i_11_] != i_5_) {
			    pb.anIntArray8735[i_6_] = i_8_ | 0x520000 | 0x13000000;
			    pb.anIntArray8847[i_6_] = i_11_ | 0x530000;
			    i_6_ = i_6_ + 1 & 0xfff;
			    is[1855729883 * Class99.anInt952][i_8_][i_11_] = i_5_;
			}
			if ((1 + i_8_ < pb.aClass283_8716.method2629(-1968040539)) && i_5_ != (is[Class99.anInt952 * 1855729883][1 + i_8_][i_11_]) && ((class244.aByteArrayArrayArray2731[1855729883 * Class99.anInt952][i_8_][i_11_]) & 0x4) == 0 && ((class244.aByteArrayArrayArray2731[1855729883 * Class99.anInt952][1 + i_8_][i_11_ - 1]) & 0x4) == 0) {
			    pb.anIntArray8735[i_6_] = i_8_ + 1 | 0x520000 | ~0x6dffffff;
			    pb.anIntArray8847[i_6_] = i_11_ | 0x530000;
			    i_6_ = 1 + i_6_ & 0xfff;
		    ...
		    i_11_--;
		    if ((1 + i_8_ < pb.aClass283_8716.method2629(-1881854697)) && i_5_ != (is[1855729883 * Class99.anInt952][i_8_ + 1][i_11_])) {
			pb.anIntArray8735[i_6_] = 1 + i_8_ | 0x920000 | 0x53000000;
			pb.anIntArray8847[i_6_] = i_11_ | 0x930000;
			i_6_ = i_6_ + 1 & 0xfff;
			is[Class99.anInt952 * 1855729883][i_8_ + 1][i_11_] = i_5_;
		    }
		    if (--i_11_ >= 0) {
			if (i_8_ - 1 >= 0 && i_5_ != (is[1855729883 * Class99.anInt952][i_8_ - 1][i_11_]) && ((class244.aByteArrayArrayArray2731[1855729883 * Class99.anInt952][i_8_][i_11_]) & 0x4) == 0 && ((class244.aByteArrayArrayArray2731[1855729883 * Class99.anInt952][i_8_ - 1][1 + i_11_]) & 0x4) == 0) {
			    pb.anIntArray8735[i_6_] = i_8_ - 1 | 0xd20000 | 0x12000000;
			    pb.anIntArray8847[i_6_] = i_11_ | 0xd30000;
			    i_6_ = i_6_ + 1 & 0xfff;
			    is[1855729883 * Class99.anInt952][i_8_ - 1][i_11_] = i_5_;
			}
			if (i_5_ != (is[1855729883 * Class99.anInt952][i_8_][i_11_])) {
			    pb.anIntArray8735[i_6_] = i_8_ | 0xd20000 | ~0x6cffffff;
			    pb.anIntArray8847[i_6_] = i_11_ | 0xd30000;
			    i_6_ = i_6_ + 1 & 0xfff;
			    is[Class99.anInt952 * 1855729883][i_8_][i_11_] = i_5_;
			}
			if ((1 + i_8_ < pb.aClass283_8716.method2629(-1909288528)) && (is[1855729883 * Class99.anInt952][i_8_ + 1][i_11_]) != i_5_ && ((class244.aByteArrayArrayArray2731[Class99.anInt952 * 1855729883][i_8_][i_11_]) & 0x4) == 0 && ((class244.aByteArrayArrayArray2731[Class99.anInt952 * 1855729883][i_8_ + 1][i_11_ + 1]) & 0x4) == 0) {
			    pb.anIntArray8735[i_6_] = 1 + i_8_ | 0x920000 | ~0x2dffffff;
			    pb.anIntArray8847[i_6_] = i_11_ | 0x930000;
			    i_6_ = i_6_ + 1 & 0xfff;
	    ...
	    if (-1000000 != pb.anIntArray8793[i]) {
		pb.anIntArray8793[i] += 40;
		pb.anIntArray8670[i] -= 512;
		pb.anIntArray8795[i] += 512;
		pb.anIntArray8641[i] += 512;
		pb.anIntArray8797[i] -= 512;
	    }
	    return true;
	}
	catch (RuntimeException runtimeexception) {
