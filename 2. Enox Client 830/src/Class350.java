...
public class Class350 {
	...
	try {
	    ...
	    String string_27_ = ((String) (((Class403) class403).anObjectArray5240[1 + ((Class403) class403).anInt5241 * -203050393]));
	...
	try {
	    int i_32_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub2_7547.method5612(i_32_, 1352882135);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (0 != 1170859143 * pb.mouseWheelScroll) {
		Class8.anInt103 -= pb.mouseWheelScroll * 1787831191;
		...
		if (-1731316011 * Class8.anInt103 < 0)
		    Class8.anInt103 = 0;
		pb.mouseWheelScroll = 0;
	    }
	    for (int i_35_ = 0; i_35_ < 1351936279 * pb.anInt8894; i_35_++) {
		Interface16 interface16 = pb.anInterface16Array8710[i_35_];
		...
		if (i_36_ == 80)
		    ...
		    Class8.aString101 = new StringBuilder().append(Class8.aString101.substring(0, -1182747927 * Class8.anInt99)).append(pb.anInterface16Array8710[i_35_].method217((byte) 9)).append(Class8.aString101.substring(Class8.anInt99 * -1182747927)).toString();
		    Class8.anInt99 += 1914783065;
		}
	    }
	    pb.anInt8894 = 0;
