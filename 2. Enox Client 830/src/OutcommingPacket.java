...
public class OutcommingPacket {
	...
	static {
		...
		ITEM_ON_ITEM = new OutcommingPacket(3, 20);
		ADD_IGNORE_PACKET = new OutcommingPacket(4, -1);
		aClass198_2054 = new OutcommingPacket(5, 10);
		aClass198_1999 = new OutcommingPacket(6, 10);
		...
		ACTION_BUTTON1_PACKET = new OutcommingPacket(14, 10);
		...
		aClass198_2020 = new OutcommingPacket(27, 10);
		...
		aClass198_2025 = new OutcommingPacket(32, 10);
		...
		INTERFACE_ON_OBJECT = new OutcommingPacket(37, 19);
		...
		aClass198_2050 = new OutcommingPacket(43, 9);
		aClass198_2037 = new OutcommingPacket(44, -2);
		aClass198_2038 = new OutcommingPacket(45, 9);
		...
		INTERFACE_ON_PLAYER = new OutcommingPacket(50, 13);
		...
		aClass198_2048 = new OutcommingPacket(55, 10);
		aClass198_2049 = new OutcommingPacket(56, 3);
		ITEM_TAKE_PACKET = new OutcommingPacket(57, 9);
		...
		aClass198_2002 = new OutcommingPacket(61, 9);
		aClass198_2055 = new OutcommingPacket(62, 9);
		...
		INTERFACE_ON_NPC = new OutcommingPacket(66, 13);
		ACTION_BUTTON2_PACKET = new OutcommingPacket(67, 10);
		aClass198_1993 = new OutcommingPacket(68, 10);
		...
		aClass198_2083 = new OutcommingPacket(90, 10);
		...
		aClass198_2089 = new OutcommingPacket(96, 10);
		...
		ITEM_ON_FLOOR_EXAMINE = new OutcommingPacket(102, 9);
	...
	static final void method1889(Class403 class403, int i) {
		try {
			int i_1_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689)
					* 681479919)]);
	...
	static final void method1891(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919
					- 1)] = ((Class403) class403).myClanChannel.aByte7360;
		} catch (RuntimeException runtimeexception) {
							...
							.method847(
									Class411.method5574(
											(((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689)
													* 681479919]),
											2103151536),
									Class321.aClass429_3357.getType(694163818), -1841335173));
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1893(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
		try {
			class105.anInt1239 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689)
					* 681479919]) * 476443207;
		} catch (RuntimeException runtimeexception) {
