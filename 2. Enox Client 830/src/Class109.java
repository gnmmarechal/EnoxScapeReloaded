...
public class Class109 {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub19_7567.method5695(-1741518508);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    int i_5_ = (((int) class217.aFloat2451 >> 9) + -1760580017 * class341.x);
	    int i_6_ = (((int) class217.aFloat2454 >> 9) + 283514611 * class341.y);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (i_5_ << 14) + (i_4_ << 28) + i_6_;
	}
	catch (RuntimeException runtimeexception) {
