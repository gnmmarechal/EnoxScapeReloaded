...
public class Class173 {
	...
	public int particleTextureId = -2036085851;
	...
	void method1816(RsByteBuffer class298_sub53, int i, int i_0_, int i_1_) {
		try {
			if (1 == i) {
				particleTextureId = class298_sub53.readUnsignedShort() * 2036085851;
				if (39181267 * particleTextureId == 65535)
					particleTextureId = -2036085851;
				System.out.println("Particle Texture: "+(particleTextureId * 39181267));
			}
			else if (i == 2) {
