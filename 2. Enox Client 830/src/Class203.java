...
public class Class203 {
	...
	try {
		...
		Class403 class403 = Class211.method1950(974537460);
		...
		int i_3_ = 0;
		((Class403) class403).aLongArray5235 = new long[1679522843 * class298_sub37_sub17.anInt9681];
		int i_4_ = 0;
		for (int i_5_ = 1; i_5_ < parameters.length; i_5_++) {
			...
			((Class403) class403).anIntArray5248[i_2_++] = i_6_;
			...
			((Class403) class403).anObjectArray5234[i_3_++] = string;
		    } else if (parameters[i_5_] instanceof Long) {
			long l = ((Long) parameters[i_5_]).longValue();
			((Class403) class403).aLongArray5235[i_4_++] = l;
		    }
		}
		((Class403) class403).anInt5254 = ((Class298_Sub46) class298_sub46).anInt7524 * -323690565;
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (null == class105_7_ ? -1 : class105_7_.ihash * -440872681);
	}
	catch (RuntimeException runtimeexception) {
