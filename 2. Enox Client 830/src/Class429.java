...
public class Class429 implements Interface21 {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub2_7547.method5628((byte) 103) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (pb.method2801(class105).method3492((byte) -12) && null == pb.aClass105_8652) {
		Class117.method1280(class105.ihash * -440872681, class105.anInt1154 * -1309843523, 1723723267);
		pb.aClass105_8652 = Class140.method1558(-440872681 * class105.ihash, class105.anInt1154 * -1309843523, -156511736);
		Tradution.method6054(pb.aClass105_8652, 1608408687);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    int i_5_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
	    int i_6_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 1]);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_5_ - i_6_;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (Class299.method3682(-1233866115 * pb.anInt8752, 1765230881))
		return pb.aClass25_8693;
	    return pb.aClass25_8711;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method5761(Toolkit class_ra, Interface_ma interface_ma, byte i) {
	try {
	    if (null != Class301_Sub1.aClass298_Sub37_Sub13_3218) {
		Class122.method1319((byte) 1);
		Class122.method1319((byte) 1);
		if (Class301_Sub1.anInt7624 * -1289394455 < 10) {
		    if (!Class301_Sub1.idx23.method2312(Class301_Sub1.aClass298_Sub37_Sub13_3218.namehash, -2140139718)) {
			Class301_Sub1.anInt7624 = (Class_v.idx23.method2305((Class301_Sub1.aClass298_Sub37_Sub13_3218.namehash), -1210672889)) / 10 * 1078186329;
			return;
		    }
		...
		if (10 == Class301_Sub1.anInt7624 * -1289394455) {
		    ...
		    if (Class301_Sub1.aClass298_Sub37_Sub13_3218.method3453(Class287.myPlayer.plane, (((int) class217.aFloat2451 >> 9) + -1760580017 * class341.x), (283514611 * class341.y + ((int) class217.aFloat2454 >> 9)), is, 46106083)) {
			...
			Class301_Sub1.aClass298_Sub37_Sub13_3218.method3452((Class301_Sub1.aClass298_Sub37_Sub13_3218.tileHash) * -1973484731 >> 14 & 0x3fff, -1973484731 * (Class301_Sub1.aClass298_Sub37_Sub13_3218.tileHash) & 0x3fff, is, -1810513482);
			Class82_Sub14.anInt6875 = (is[1] - Class301_Sub1.anInt3245) * -2076584633;
			Class376.anInt4090 = (is[2] - Class301_Sub1.anInt3238) * -435591305;
		    }
		    if ((1110271707 * Class301_Sub1.aClass298_Sub37_Sub13_3218.defaultZoom) == 37) {
			Class301_Sub1.aFloat3233 = 3.0F;
			Class301_Sub1.aFloat3234 = 3.0F;
		    } else if ((Class301_Sub1.aClass298_Sub37_Sub13_3218.defaultZoom) * 1110271707 == 50) {
			Class301_Sub1.aFloat3233 = 4.0F;
			Class301_Sub1.aFloat3234 = 4.0F;
		    } else if ((Class301_Sub1.aClass298_Sub37_Sub13_3218.defaultZoom) * 1110271707 == 75) {
			Class301_Sub1.aFloat3233 = 6.0F;
			Class301_Sub1.aFloat3234 = 6.0F;
		    } else if (1110271707 * (Class301_Sub1.aClass298_Sub37_Sub13_3218.defaultZoom) == 100) {
			Class301_Sub1.aFloat3233 = 8.0F;
			Class301_Sub1.aFloat3234 = 8.0F;
		    } else if (1110271707 * (Class301_Sub1.aClass298_Sub37_Sub13_3218.defaultZoom) == 200) {
		    ...
		    if (Class301_Sub1.idx23.method2295(new StringBuilder().append(Class301_Sub1.aClass298_Sub37_Sub13_3218.namehash).append("_staticelements").toString(), -400372089)) {
			if (!Class301_Sub1.idx23.method2312(new StringBuilder().append(Class301_Sub1.aClass298_Sub37_Sub13_3218.namehash).append("_staticelements").toString(), -2145213052))
			    return;
			Class301_Sub1.aClass296_3235 = (WorldMap.getMapKeys(Class301_Sub1.idx23, new StringBuilder().append(Class301_Sub1.aClass298_Sub37_Sub13_3218.namehash).append("_staticelements").toString(), pb.isMemberWorld, 565671699));
		    } else
			Class301_Sub1.aClass296_3235 = new MapKeys(0);
