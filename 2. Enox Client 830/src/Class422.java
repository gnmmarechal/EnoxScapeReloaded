...
public abstract class Class422 {
    ...
    static Sprite[] aClass57Array5351;
	...
	try {
	    ...
	    pb.aClass283_8716.method2667(382492199);
	...
	try {
	    ((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 2] = (Class316.aClass362_3318.method4307((((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 2]), 245040087).method4567(Class128.aClass148_6331, (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 - 1]), -1119994003)) ? 1 : 0;
	...
	try {
	    EquipmentDefaults.method922((byte) -40);
	}
	catch (RuntimeException runtimeexception) {
