...
public final class Class439 {
	...
	try {
	    if (null != string) {
		if ((-1054937867 * pb.anInt8941 >= 200 && !pb.aBoolean8807) || -1054937867 * pb.anInt8941 >= 200)
		    Class264.method2492(4, (Tradution.aClass470_5831.method6049(Class321.aClass429_3357, -875414210)), (byte) -99);
		else {
		    String string_0_ = BillBoardDefinitions.method1824(string, 554575211);
		    if (null != string_0_) {
			for (int i_1_ = 0; i_1_ < pb.anInt8941 * -1054937867; i_1_++) {
			    String string_2_ = BillBoardDefinitions.method1824((pb.aStringArray8704[i_1_]), 460678269);
			    ...
			    if (pb.aStringArray8945[i_1_] != null) {
				String string_3_ = BillBoardDefinitions.method1824((pb.aStringArray8945[i_1_]), -1697709934);
			...
			for (int i_4_ = 0; i_4_ < -548972447 * pb.anInt8952; i_4_++) {
			    String string_5_ = BillBoardDefinitions.method1824((pb.aStringArray8859[i_4_]), 629913933);
			    ...
			    if (null != pb.aStringArray8955[i_4_]) {
				String string_6_ = BillBoardDefinitions.method1824((pb.aStringArray8955[i_4_]), -1007795446);
			...
			if (BillBoardDefinitions.method1824((Class287.myPlayer.aString10195), -712250197).equals(string_0_))
	...
	try {
		...
		if (19 == i)
		    Class501.method6227((8 == -1233866115 * pb.anInt8752 || -1233866115 * pb.anInt8752 == 2 || (747461259 * (HashTable.aClass371_5520.anInt4042) != (pb.WINDOW_PANE_ID * -257444687))), -1608675861);
		if (i == 14)
		    IcmpService_Sub1.method6382((pb.WINDOW_PANE_ID * -257444687 != (HashTable.aClass371_5520.anInt4031) * 1349088077), -687019075);
		if (i == 4 || 6 == i)
		    Class147.method1601((byte) -8);
		else if (3 == i || i == 18 && -1233866115 * pb.anInt8752 != 16)
		    Class473.method6070(1162411214);
		else if (i == 2)
		    Class70.method805((byte) 0);
		if (Class358.method4287(i, -1178041789)) {
		    pb.aClass283_8716.method2673((byte) 75);
		...
		boolean bool_8_ = (7 == -1233866115 * pb.anInt8752 || Class413.method5584(pb.anInt8752 * -1233866115, 2005988447) || Class299.method3682(-1233866115 * pb.anInt8752, 1765230881));
		if (bool != bool_8_) {
		    if (bool) {
			...
			if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7587.method5726(-2145576299) != 0) {
			    Class431.method5767(2, Class374_Sub1.idx6, 782166935 * Class300.anInt3210, 0, Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7587.method5726(-2142499578), false, 1118626209);
		...
		if (Class358.method4287(i, 299941911) || i == 5 || 13 == i)
		    Class373.activeToolkit.method5176();
		pb.anInt8752 = -705702187 * i;
	    }
	}
	catch (RuntimeException runtimeexception) {
