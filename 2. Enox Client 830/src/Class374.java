...
public abstract class Class374 {
	...
	try {
	    ((Class374) this).aClass453_4074.add(class298_sub50);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (class298_sub36 != null) {
		    ...
		    pb.aClass25_8711.method390(class298_sub36, (byte) -85);
		}
	    }
	    method4618((byte) 1);
	}
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (int) (Math.random() * (double) i_10_);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Class403) class403).myClanChannel.aByte7355;
	}
	catch (RuntimeException runtimeexception) {
