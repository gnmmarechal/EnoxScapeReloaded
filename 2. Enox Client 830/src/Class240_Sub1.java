...
public class Class240_Sub1 extends Class240 {
    ...
    void method2234(Toolkit class_ra, int i, int i_0_, int i_1_, int i_2_, Class289 class289, int i_3_) {
	try {
		...
		if (i_0_ == 0) {
		    ...
		    if (-1508517619 * class432.occludes == 1) {
			if (0 == i_5_)
		    ...
		    aClass331_2619.method4028(i, i_1_, i_2_, pb.anInterface17_8960, (short) -414);
    ...
    public final void method2235(Toolkit class_ra, RsByteBuffer class298_sub53, int i, int i_6_, byte i_7_) {
	try {
	    if (!aBoolean2629) {
		boolean bool = false;
    ...
    public final void method2236(Toolkit class_ra, RsByteBuffer class298_sub53, int i, int i_39_, int i_40_, int i_41_, int i_42_, int i_43_, int i_44_, int i_45_) {
	try {
	    if (!aBoolean2629) {
		boolean bool = false;
		Class385 class385 = null;
    ...
    public final void method2237(Toolkit class_ra, byte[] is, int i, int i_72_, Class289[] class289s, int i_73_) {
	try {
    ...
    public final void method2238(Toolkit class_ra, byte[] is, int i, int i_87_, int i_88_, int i_89_, int i_90_, int i_91_, int i_92_, Class289[] class289s, int i_93_) {
	try {
	    RsByteBuffer class298_sub53 = new RsByteBuffer(is);
	    int i_94_ = -1;
	    for (;;) {
    ...
    boolean method2239(Toolkit class_ra, int i, int i_107_, boolean bool, ObjectDefinitions class432, int i_108_, int i_109_, int i_110_, int i_111_, int i_112_, int i_113_, int i_114_, int i_115_, boolean bool_116_, Ground class_xa, Class289 class289, int i_117_, int i_118_, byte i_119_) {
	try {
	    if (-1976050083 * GameObjectType.T0.type == i) {
		int i_120_ = class432.occludes * -1508517619;
		if (aBoolean7073 && -1 == -1508517619 * class432.occludes)
		    i_120_ = 1;
		...
		if (0 == i_107_) {
		    if (aBoolean2632 && class432.castsShadow) {
		...
		if (class432.castsShadow && aBoolean2632) {
		    if (i_107_ == 0)
			class_xa.LA(i_114_, i_115_ + 1, 50);
		    else if (1 == i_107_)
		...
		if ((class432.occludes * -1508517619 == 1 || aBoolean7073 && -1 == -1508517619 * class432.occludes) && !aBoolean2629) {
		    if (0 == i_107_) {
		...
		if (1 == class432.occludes * -1508517619 && !aBoolean2629) {
		    int i_124_;
		    if ((i_107_ & 0x1) == 0)
			i_124_ = 8;
		    else
    ...
    boolean method2240(Toolkit class_ra, int i, int i_125_, boolean bool, ObjectDefinitions class432, int i_126_, int i_127_, int i_128_, int i_129_, int i_130_, int i_131_, int i_132_, int i_133_, int i_134_) {
	try {
	...
	try {
	    ...
	    if (i_143_ == 2)
		interface3 = ((Interface3) aClass331_2619.method4035(i, i_144_, i_145_, pb.anInterface17_8960, -1336288750));
	    if (i_143_ == 3)
    ...
    public final void method2242(Toolkit class_ra, boolean bool, int i) {
	try {
    ...
    final void method2243(Toolkit class_ra, int i, int i_161_, int i_162_, int i_163_, int i_164_, int i_165_, int i_166_, Class289 class289, int i_167_, int i_168_) {
	try {
		...
		Ground class_xa = aClass331_2619.aClass_xaArray3517[i];
		...
		if (class432.method5784(-1167401239))
		    AnimationDefinition.method4884(i_161_, i_162_, i_163_, i_165_, class432, null, null, (byte) 37);
		boolean bool_178_ = (-1 == i_167_ && !class432.method5779(934270378) && class432.morphisms == null && !class432.aBoolean5381 && !class432.bloom);
		if (!aBoolean7084 || ((!Class82_Sub9.isWall(i_166_, (byte) 13) || class432.occludes * -1508517619 == 1) && (!Class111.method1236(i_166_, 1378507148) || 0 != -1508517619 * class432.occludes))) {
			...
			if (bool_178_) {
			    ...
			    class365_sub1_sub1 = (new Class365_Sub1_Sub1_Sub5(aClass331_2619, class_ra, ((Class240_Sub1) this).aClass433_7072, class432, i_161_, i, i_176_, i_175_, i_177_, aBoolean2629, i_162_, i_162_ + i_169_ - 1, i_163_, i_163_ + i_170_ - 1, i_166_, i_165_, i_167_));
			aClass331_2619.method4022(class365_sub1_sub1, false, (byte) 0);
			if (aBoolean2632 && !aBoolean2629 && Class111.method1236(i_166_, 1932287279) && (-1976050083 * GameObjectType.T13.type != i_166_) && i_161_ > 0 && class432.occludes * -1508517619 != 0)
	...
	try {
	    ((Class403) class403).anInt5239 -= -1959403445;
	    int i_185_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
	    int i_186_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 1]);
	    int i_187_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 2]);
	    int i_188_ = (((Class403) class403).anIntArray5244[3 + 681479919 * ((Class403) class403).anInt5239]);
	    int i_189_ = (((Class403) class403).anIntArray5244[4 + 681479919 * ((Class403) class403).anInt5239]);
	    if (-1 == i_187_)
		...
		throw new RuntimeException();
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = is[i_189_];
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (1548853569 * class105.anInt1184 == 1 ? class105.anInt1151 * 572201537 : -1);
	}
	catch (RuntimeException runtimeexception) {
