...
public class Class370 {
	...
	try {
		...
		is = (((Class370) this).aClass243_4030.getFile(ConfigEntry.aClass120_1414.anInt1460 * -1006924897, i));
	    }
	    class376 = new Class376();
	    if (is != null)
		class376.method4655(new RsByteBuffer(is), 1705012994);
	    synchronized (((Class370) this).aClass348_4029) {
		((Class370) this).aClass348_4029.put(class376, (long) i);
	    }
	    return class376;
	}
	catch (RuntimeException runtimeexception) {
	...
	if (null != ((Class370) this).aClass243_4030)
	    ((Class370) this).aClass243_4030.getFileCountForArchive(-1006924897 * ConfigEntry.aClass120_1414.anInt1460, -279300149);
    }
    ...
    static void method4579(int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, ObjectOverride class435, byte i_8_) {
	try {
