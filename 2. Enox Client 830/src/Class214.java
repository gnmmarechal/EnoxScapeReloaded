...
public class Class214 implements Runnable {
	...
	try {
	    class105.anInt1272 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]) * -1122372539;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = (((Class403) class403).myClanChannel.members[i_0_].aString1681);
	}
	catch (RuntimeException runtimeexception) {
