...
public class Class359 implements Interface19 {
	...
	try {
	    ...
	    if((i > class119.aClass105Array1405.length))
		i = class119.aClass105Array1405.length-1;
	...
	try {
	    Class79.method850((((Class403) class403).aClass365_Sub1_Sub4_Sub1_5253), (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]), (byte) 14);
	...
	try {
	    ...
	    pb.aClass283_8716.method2641(2004012946).method5791(i_12_, -1760580017);
	    ...
	    pb.aClass283_8716.method2667(1301460504);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    String string = (String) (((Class403) class403).anObjectArray5240[(((Class403) class403).anInt5241 -= 969361751) * -203050393]);
	    if (14 != -1233866115 * pb.anInt8752 || Class315.method3837((byte) 23))
		pb.aByte8959 = (byte) -5;
	    else if (string.length() > 20)
		pb.aByte8959 = (byte) -4;
	    else {
		pb.aByte8959 = (byte) -1;
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2028, pb.aClass25_8693.aClass449_330, (byte) 66);
		...
		pb.aClass25_8693.method390(class298_sub36, (byte) -40);
	    }
	}
	catch (RuntimeException runtimeexception) {
