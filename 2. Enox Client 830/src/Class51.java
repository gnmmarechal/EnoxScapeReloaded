...
public class Class51 {
	...
	static void method50123(int x) {
		try {
			...
			Method method = var_class_124_.getDeclaredMethod("setAccessible",
	...
	static final void decodeLswp(RsBitsBuffer class298_sub53_sub2, int i) {
		try {
			...
			int myPlayerIndex = pb.playerIndex * -442628795;
			Player player = (Class287.myPlayer = pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[myPlayerIndex] = (new Player(
					pb.aClass283_8716.method2675(-1611682495))));
			...
			player.scenePositionXQueue[0] = i_4_ - -1760580017 * class341.x;
			player.scenePositionYQueue[0] = i_5_ - class341.y * 283514611;
			player.method4341(
					(float) ((player.scenePositionXQueue[0] << 9)
							+ (player.getSize() << 8)),
					(player.method4343().aClass217_2599.aFloat2455),
					(float) ((player.scenePositionYQueue[0] << 9)
							+ (player.getSize() << 8)));
			Class99.anInt952 = (player.plane = player.aByte7724 = i_3_)
					* -85701805;
			if (pb.aClass283_8716.method2654(1740552362).method2320(
					player.scenePositionXQueue[0],
					player.scenePositionYQueue[0], -14939637))
				player.aByte7724++;
			if (Class10.aClass298_Sub53Array133[myPlayerIndex] != null)
				player.sendAppearence(
						Class10.aClass298_Sub53Array133[myPlayerIndex],
						(byte) 3);
			Class10.anInt129 = 0;
			Class10.anIntArray135[(Class10.anInt129 += -656365301) * 1168366243
					- 1] = myPlayerIndex;
			...
			for (int i_6_ = 1; i_6_ < 2048; i_6_++) {
				if (myPlayerIndex == i_6_) {
					...
					((Class410) class410).anInt5288 = ((i_9_ << 14)
							+ (i_8_ << 28) + i_10_) * 1896571807;
			...
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("ca.a(").append(')').toString());
		}
	}
	...
	static final void method542(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689)
					* 681479919
					- 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub13_7550
							.method5675(-254007730);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ca.ajh(").append(')').toString());
		}
	}

	public static boolean method543(CharSequence charsequence, int i) {
		try {
			return ClientScriptsExecutor.method4692(charsequence, 10, true,
					-1628070489);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("ca.b(").append(')').toString());
		}
	}
}
