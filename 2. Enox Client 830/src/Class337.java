...
public class Class337 {
	...
	try {
	    ...
	    Integer integer = (((Class403) class403).aClass162_5252.method1754((pb.gametype.gameType * -937307905 << 16 | class376.anInt4086 * -1808461691), class376.anInt4087 * -2047408817, class376.anInt4088 * -530058953, -1943222730));
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_1_;
	}
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class468.aBoolean5771 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
