...
public class Class297 {
	...
	try {
		...
		if (i_20_ > 0) {
			...
			player.method4420(mark, damage, i_22_, i_24_, 443738891 * pb.ticketCycle, hitDelay, hpBarPercentage, (byte) 121);
		    }
		}
	    }
	    ...
	    if ((mask & 0x40000) != 0)
		player.isClanMember = stream.readUnsignedByteC((short) -25952) == 1;
	    if ((mask & 0x20000) != 0) {
		String string = stream.readString(711431277);
		int i_40_ = stream.readUnsignedByte();
		if ((i_40_ & 0x1) != 0)
		    ChecksumTableEntry.method2282(2, i_40_, player.method4470(true, -2017419584), player.method4475(false, (byte) -87), player.aString10200, string, 252423564);
		...
		player.anInt10086 = (1208636921 * pb.ticketCycle + -1132907677 * player.anInt10087 + 1195117671 * player.anInt10088);
	    }
		...
		player.anInt10095 = (stream.readUnsignedShort() + pb.ticketCycle * 443738891) * 996079737;
		player.anInt10103 = (stream.readUnsignedShort() + pb.ticketCycle * 443738891) * 1000906529;
	    ...
	    if (0 != (mask & 0x100000)) { //this mask seems to update player position
		...
		if (player == Class287.myPlayer)
		    ChecksumTableEntry.method2282(2, 0, player.method4470(true, -1880046656), player.method4475(false, (byte) -103), player.aString10200, string, -588173673);
		player.method4474(string, 0, 0, -1278251821);
	    }
	    if ((mask & 0x200000) != 0) { //change body color
		...
		player.anInt10105 = ((443738891 * pb.ticketCycle + stream.readUnsignedShort()) * 1828453179);
		player.anInt10106 = ((pb.ticketCycle * 443738891 + stream.readUnsignedShort()) * -473408095);
	    }
	    if ((mask & 0x80000) != 0) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class406.aBoolean5274 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
