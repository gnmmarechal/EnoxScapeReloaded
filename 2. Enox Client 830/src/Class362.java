...
public class Class362 {
	...
	public Class362(Class411 class411, Class429 class429, JS5 class243, boolean bool) {
		...
		if (((Class362) this).aClass243_3917 != null)
			((Class362) this).anInt3916 = (((Class362) this).aClass243_3917.getFileCountForArchive(-1006924897 * ConfigEntry.aClass120_1440.anInt1460, -941078932)) * 70760625;
		else
		...
		if (bool) {
			...
			for (int i = 0; i < ((Class362) this).anInt3916 * 1223397457; i++) {
				...
				synchronized (((Class362) this).aClass243_3917) {
					is = (((Class362) this).aClass243_3917.getFile(ConfigEntry.aClass120_1440.anInt1460 * -1006924897, i));
				}
	...
	static final void method4309(Class403 class403, byte i) {
		try {
			...
			int i_4_ = pb.GRAND_EXCHANGE_SLOTS[i_3_].method2400(-574288948);
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_4_ == 0 ? 1 : 0;
		}
		catch (RuntimeException runtimeexception) {
	...
	static final void method4312(Class403 class403, byte i) {
		try {
			...
			if (2 == 1131012101 * pb.anInt8942 && i_5_ < pb.anInt8941 * -1054937867)
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = pb.anIntArray8946[i_5_];
			else
