...
public abstract class Toolkit {
	...
	public abstract void N(int i, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_, byte[] is, int i_15_,
			int i_16_);
	...
	public final void method5003(Canvas canvas, byte i) {
		try {
			...
			if (929186669 * ((Toolkit) this).anInt5310 > 0 || aClass52_5292 != aClass52_Sub2_5312)
				throw new RuntimeException();
			if (aClass52_5292 != null)
				aClass52_5292.method546();
			if (((Toolkit) this).anInt5310 * 929186669 < 0)
	...
	public abstract int mergeFunctionMasks(int i, int i_27_);

	public final void method5005(Class52_Sub1 class52_sub1, byte i) {
		try {
			if (929186669 * ((Toolkit) this).anInt5310 < 0
					|| (((Toolkit) this).aClass52_Sub1Array5304[((Toolkit) this).anInt5310
							* 929186669]) != class52_sub1)
				throw new RuntimeException();
			((Toolkit) this).aClass52_Sub1Array5304[(((Toolkit) this).anInt5310 -= 1780694629) * 929186669 + 1] = null;
			class52_sub1.method546();
			if (((Toolkit) this).anInt5310 * 929186669 >= 0) {
				aClass52_5292 = (((Toolkit) this).aClass52_Sub1Array5304[((Toolkit) this).anInt5310 * 929186669]);
				((Toolkit) this).aClass52_Sub1Array5304[((Toolkit) this).anInt5310 * 929186669].method136();
			} else {
	...
	public abstract void method5007(int i, int i_29_, int i_30_, int i_31_, int i_32_, int i_33_, Class_ta class_ta,
	...
	public abstract void method5020(int i, int i_79_, float f, int i_80_, int i_81_, float f_82_, int i_83_, int i_84_,
			float f_85_, int i_86_, int i_87_, int i_88_, int i_89_);
	...
	public abstract void method5022(int i, int i_100_, int i_101_, int i_102_, int i_103_, int i_104_,
			Class_ta class_ta, int i_105_, int i_106_);
	...
	public abstract Model createModel(ModelDecoder class64, int i, int i_136_, int i_137_, int i_138_);

	public abstract void method5038(int i, int i_139_, int i_140_, int i_141_, int i_142_, int i_143_, int i_144_,
			int i_145_, int i_146_);

	public abstract void method5039(int i, int i_147_, int i_148_, int i_149_, int i_150_, int i_151_, int i_152_,
			int i_153_, int i_154_);

	public abstract Ground method5040(int i, int i_155_, int[][] is, int[][] is_156_, int i_157_, int i_158_,
			int i_159_);
	...
	public abstract Ground method5087(int i, int i_196_, int[][] is, int[][] is_197_, int i_198_, int i_199_,
			int i_200_);
	...
	public abstract void method5088(int i, int i_202_, int i_203_, int i_204_, int i_205_, int i_206_,
			Class_ta class_ta, int i_207_, int i_208_);
	...
	public abstract void fo(int i, int i_239_, int i_240_, int i_241_, int i_242_, int i_243_, byte[] is, int i_244_,
			int i_245_);
	...
	public abstract void method5096(int i, int i_277_, int i_278_, int i_279_, int i_280_, int i_281_,
			Class_ta class_ta, int i_282_, int i_283_);

	public abstract void method5097(int i, int i_284_, int i_285_, int i_286_, int i_287_, int i_288_,
			Class_ta class_ta, int i_289_, int i_290_);

	public abstract void method5098(int i, int i_291_, int i_292_, int i_293_, int i_294_, int i_295_,
			Class_ta class_ta, int i_296_, int i_297_, int i_298_, int i_299_, int i_300_);
	...
	public abstract Model method5116(ModelDecoder class64, int i, int i_328_, int i_329_, int i_330_);
	...
	public abstract Ground method5121(int i, int i_334_, int[][] is, int[][] is_335_, int i_336_, int i_337_,
			int i_338_);

	public abstract Ground method5122(int i, int i_339_, int[][] is, int[][] is_340_, int i_341_, int i_342_,
			int i_343_);

	public abstract Ground method5123(int i, int i_344_, int[][] is, int[][] is_345_, int i_346_, int i_347_,
			int i_348_);

	public abstract Class233 method5124();

	public abstract Sprite method5125(IndexedImage class89, boolean bool);
	...
	public void method5136(int i) {
		try {
			aBooleanArray5297[580915349 * id] = false;
	...
	public abstract void method5139(int i, int i_373_, float f, int i_374_, int i_375_, float f_376_, int i_377_,
			int i_378_, float f_379_, int i_380_, int i_381_, int i_382_, int i_383_);
	...
	public final void method5143(Class52_Sub1 class52_sub1, byte i) {
		try {
			if (929186669 * ((Toolkit) this).anInt5310 >= 3)
				throw new RuntimeException();
			if (((Toolkit) this).anInt5310 * 929186669 >= 0)
				((Toolkit) this).aClass52_Sub1Array5304[929186669 * ((Toolkit) this).anInt5310].method546();
			else
				aClass52_Sub2_5312.method546();
			aClass52_5292 = ((Toolkit) this).aClass52_Sub1Array5304[(((Toolkit) this).anInt5310 += 1780694629)
					* 929186669] = class52_sub1;
	...
	public abstract void method5157(int i, int i_399_, float f, int i_400_, int i_401_, float f_402_, int i_403_,
			int i_404_, float f_405_, int i_406_, int i_407_, int i_408_, int i_409_);

	public abstract void method5158(int i, int i_410_, float f, int i_411_, int i_412_, float f_413_, int i_414_,
			int i_415_, float f_416_, int i_417_, int i_418_, int i_419_, int i_420_);
	...
	Toolkit(Interface_ma interface_ma) {
		// System.out.println("Created toolkit:" + getClass().getName());
		((Toolkit) this).aClass52_Sub1Array5304 = new Class52_Sub1[4];
	...
	protected void finalize() {
		try {
			...
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("ra.finalize(").append(')').toString());
		}
	}
	...
	public abstract void fi(int i, int i_474_, int i_475_, int i_476_, int i_477_, int i_478_, byte[] is, int i_479_,
			int i_480_);
	...
	static void method5191(int i) {
		try {
			if (null != Class82_Sub6.aClass227_6843) {
				...
				Class288_Sub1.aClass219_7147.method2043(-4360787748556788915L * Class230.aLong2560,
						((Class227) Class82_Sub6.aClass227_6843).aClass470_2549.method6049(Class321.aClass429_3357,
								-875414210),
						(360399239 * ((Class227) Class82_Sub6.aClass227_6843).anInt2551), Class82_Sub6.aClass227_6843,
						180676280);
	...
	static void method5192(int i, int i_484_, int i_485_, int i_486_, int i_487_, int i_488_, int i_489_,
			Class298_Sub37_Sub15 class298_sub37_sub15, Class264 class264, Class505 class505, int i_490_, int i_491_,
			int i_492_) {
		try {
			if (i > i_485_ && i < i_485_ + i_487_ && i_484_ > i_489_ - class505.anInt6202 * 1110385787 - 1
			...
			class264.method2480(string, 3 + i_485_, i_489_, i_490_, 0, pb.aRandom8702, Class368.anInt4005 * 1401020893,
					Class436.aClass57Array5501, Class422_Sub3.anIntArray8372, 65280);
			if (((Class298_Sub37_Sub15) class298_sub37_sub15).aBoolean9665)
				Graphics.aClass57_573.method645(i_485_ + 5 + class505.method6264(string, 1318090489),
						i_489_ - 1110385787 * class505.anInt6202);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method5193(Class403 class403, byte i) {
		try {
			int i_493_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689)
					* 681479919)]);
	...
	static void method5195(Toolkit class_ra, IComponentDefinition class105, int i, int i_496_, byte i_497_) {
		try {
			...
			if (null != class117) {
				...
				if ((-2093041337 * class105.anInt1156 != class117.anInt1393 * 1633695381)
					...
					throw new IllegalStateException("");
				if (2 != -64305285 * Class3.anInt56 && 5 != Class3.anInt56 * -64305285
					...
					if (2 == Class298_Sub1.anInt7164 * -863531439) {
						i_498_ = pb.anInt8753 * -2080858977;
						i_499_ = 1818837461 * pb.anInt8755;
						i_500_ = (int) -pb.aFloat8949 & 0x3fff;
						i_501_ = 4096;
					} else {
						...
						i_500_ = (pb.anInt8801 * 1227356013 + (int) -pb.aFloat8949) & 0x3fff;
						i_501_ = 4096 - 1412674352 * pb.anInt8749;
					}
					int i_502_ = i_498_ / 128 + 48;
					int i_503_ = (48 + pb.aClass283_8716.method2630(789210081) * 4 - i_499_ / 128);
					Class384.aClass57_4127.method659(((float) i + (float) (class105.anInt1156 * -2093041337) / 2.0F),
							((float) i_496_ + (float) (457937409 * class105.anInt1162) / 2.0F), (float) i_502_,
							(float) i_503_, i_501_, i_500_ << 2, class_ta, i, i_496_);
					MapKeys class296 = pb.aClass283_8716.method2631(-337725639);
					for (Class298_Sub35 class298_sub35 = ((Class298_Sub35) Class3.aClass453_61.method5939(
							1766612795)); class298_sub35 != null; class298_sub35 = ((Class298_Sub35) Class3.aClass453_61
									.method5944(49146))) {
						int i_504_ = class298_sub35.anInt7394 * -774922497;
						int i_505_ = ((class296.keyTiles[i_504_] >> 14 & 0x3fff) - -1760580017 * class341.x);
						int i_506_ = ((class296.keyTiles[i_504_] & 0x3fff) - 283514611 * class341.y);
						int i_507_ = 2 + 4 * i_505_ - i_498_ / 128;
						int i_508_ = 2 + 4 * i_506_ - i_499_ / 128;
						Class248.method2389(class_ra, class_ta, class105, i, i_496_, i_507_, i_508_,
								class296.keyIds[i_504_], (byte) 0);
					}
					for (int i_509_ = 0; i_509_ < 1659101557 * Class3.anInt67; i_509_++) {
						...
						ObjectDefinitions class432 = (pb.aClass283_8716.method2641(2011176396)
								.getObjectDefinitions(Class3.anIntArray60[i_509_]));
						...
						Class248.method2389(class_ra, class_ta, class105, i, i_496_, i_510_, i_511_,
								class432.anInt5399 * -1422593103, (byte) 0);
					}
					for (Class298_Sub2 class298_sub2 = ((Class298_Sub2) pb.aClass437_8685.method5816(
							1742338274)); class298_sub2 != null; class298_sub2 = ((Class298_Sub2) pb.aClass437_8685
									.method5815((byte) 24))) {
						int i_512_ = (int) ((class298_sub2.hash * 7051297995265073167L) >> 28 & 0x3L);
						if (i_512_ == Class3.anInt57 * -1694437021) {
							int i_513_ = ((int) ((class298_sub2.hash * 7051297995265073167L) & 0x3fffL)
									- -1760580017 * class341.x);
							int i_514_ = ((int) ((class298_sub2.hash * 7051297995265073167L) >> 14 & 0x3fffL)
									- class341.y * 283514611);
							int i_515_ = 2 + i_513_ * 4 - i_498_ / 128;
							int i_516_ = 2 + i_514_ * 4 - i_499_ / 128;
							Class443.method5883(class105, class_ta, i, i_496_, i_515_, i_516_,
									SubIncommingPacket.radar_mark_icons[0], (byte) 16);
						}
					}
					...
					if (2 != Class298_Sub1.anInt7164 * -863531439) {
						if (Class3.anInt62 * 2076926079 != 0) {
							int i_517_ = (-282230276 * Class3.anInt62 + 2 - i_498_ / 128
									+ (Class287.myPlayer.getSize() - 1) * 2);
							int i_518_ = (2 + Class3.anInt54 * -1505214580 - i_499_ / 128
									+ (Class287.myPlayer.getSize() - 1) * 2);
							Class443.method5883(class105, class_ta, i, i_496_, i_517_, i_518_,
									(Class234.aClass57Array2598[Class3.aBoolean63 ? 1 : 0]), (byte) 23);
						}
						if (!Class287.myPlayer.hidden)
							class_ra.method5015(i + (-2093041337 * class105.anInt1156 / 2) - 1,
									(457937409 * class105.anInt1162 / 2) + i_496_ - 1, 3, 3, -1, (byte) 7);
					}
				} else
