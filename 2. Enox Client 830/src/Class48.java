...
public class Class48 {
    ...
    GLToolkit aClass_ra_Sub2_495;
    static int[] anIntArray496 = new int[2];

    Class48(GLToolkit class_ra_sub2, int i, int i_0_) {
	...
	aClass_ra_Sub2_495.deleteShad((long)anInt492);
	super.finalize();
    }

    static Class48 method526(GLToolkit class_ra_sub2, int i, String string) {
