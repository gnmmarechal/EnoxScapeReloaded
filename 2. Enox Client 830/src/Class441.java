...
public class Class441 {
    ...
    final boolean method5863(Class395 class395, AnimationDefinition class391, int i, int i_0_, int[] is, byte i_1_) {
	try {
	    if (!((Class441) this).aBoolean5585) {
		if (i >= is.length)
		    return false;
		((Class441) this).anInt5584 = -1850168697 * is[i];
		((Class441) this).aClass298_Sub37_Sub4_5583 = class395.getCollection((((Class441) this).anInt5584 * 806878007) >> 16, -2028006412);
		...
		if (((Class441) this).aClass298_Sub37_Sub4_5583 != null) {
		    if (class391.tweened && i_0_ != -1 && i_0_ < is.length) {
			((Class441) this).anInt5586 = is[i_0_] * -1477634565;
			((Class441) this).aClass298_Sub37_Sub4_5587 = class395.getCollection((((Class441) this).anInt5586 * -643912397) >> 16, -1623469578);
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = 715019623 * class352.anInt3785;
	}
	catch (RuntimeException runtimeexception) {
