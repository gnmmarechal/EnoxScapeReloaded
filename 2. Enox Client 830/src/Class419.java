...
public class Class419 {
	...
	static final void method5604(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class165.aClass319_6366.method3878(1767596149) ? 1 : 0;
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class165.aClass319_6366.method3887(1474356836) ? 1 : 0;
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class165.aClass319_6366.method3880((byte) -46) ? 1 : 0;
		}
		catch (RuntimeException runtimeexception) {
		...
		try {
			do {
				try {
					if (string.equalsIgnoreCase("commands") || string.equalsIgnoreCase("help")) {
					...
					else if (string.startsWith("directlogin ")) {
						final String[] strings = (Class365_Sub1_Sub3_Sub1.method4508(string.substring(12), ' ', 0));
						if (2 == strings.length)
					...
					else if (string.equalsIgnoreCase("rendergc")) {
						Class373.activeToolkit.method4993((int) Class122.method1319((byte) 1));
						Class255.method2435("Cleaned!", 1394924823);
					}
					else if (string.equalsIgnoreCase("rendergczero")) {
						Class373.activeToolkit.method4993(0);
						Class255.method2435("Cleaned!", 1394924823);
					}
						...
						class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(128);
						class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(0);
						Class23.method379(class298_sub36.aClass298_Sub53_Sub2_7396, "YOLOSWAG", 1526854691);
						...
						pb.qa_op = !pb.qa_op;
						Class255.method2435("Current value:" + pb.qa_op, 1394924823);
					}
					else if (string.startsWith("blcs2 ")) {
						Loader.BLOCK_IDS = string.substring(6);
					}
						...
						pb.aBoolean8667 = !pb.aBoolean8667;
						if (pb.aBoolean8667)
						...
						Class58 class58 = Class373.activeToolkit.method4987();
						...
						Class255.method2435(new StringBuilder().append("Pos: ").append(Class287.myPlayer.plane).append(",").append(((-1740717447 * Class367.anInt4000 >> 9) + class341.x * -1760580017) >> 6).append(",").append(((Class146.anInt1575 * -299812095 >> 9) + 283514611 * class341.y) >> 6).append(",").append((-1760580017 * class341.x + (-1740717447 * Class367.anInt4000 >> 9)) & 0x3f).append(",").append((class341.y * 283514611 + (-299812095 * Class146.anInt1575 >> 9)) & 0x3f).append(" Height: ").append((Class356.method4271(Class367.anInt4000 * -1740717447, Class146.anInt1575 * -299812095, (Class287.myPlayer.plane), -1453034846)) - Class110.anInt6403 * 1449634147).toString(), 306448697);
						Class255.method2435(new StringBuilder().append("Look: ").append(Class287.myPlayer.plane).append(",").append((-1125224763 * Ground.cameraLookViewLocalX + class341.x * -1760580017) >> 6).append(",").append((283514611 * class341.y + IPAddress.cameraLookViewLocalY * -1758389953) >> 6).append(",").append((class341.x * -1760580017 + -1125224763 * Ground.cameraLookViewLocalX) & 0x3f).append(",").append((283514611 * class341.y + -1758389953 * IPAddress.cameraLookViewLocalY) & 0x3f).append(" Height: ").append((Class356.method4271(Ground.cameraLookViewLocalX * -1125224763, -1758389953 * IPAddress.cameraLookViewLocalY, (Class287.myPlayer.plane), -860898067)) - 771695069 * Class18.cameraLookViewZ).toString(), 1171744016);
					}
				}
			...
			while (false);
			if (Class242.aClass401_2708 != Class401.aClass401_6557 || 1806357379 * pb.playerRights >= 2) {
				try {
					...
					if (string.equalsIgnoreCase("clientdrop")) {
						if (0 == pb.anInt8752 * -1233866115)
							SubIncommingPacket.method1923(554378996);
						else if (17 == -1233866115 * pb.anInt8752)
							pb.aClass25_8711.aBoolean347 = true;
						return;
					}
					if (string.equalsIgnoreCase("breakcon")) {
						Class25[] class25s = pb.aClass25Array8679;
					...
					if (pb.anInt8752 * -1233866115 == 0) {
						Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.COMMANDS_PACKET, (pb.aClass25_8711.aClass449_330), (byte) 6);
						...
						pb.aClass25_8711.method390(class298_sub36, (byte) -55);
					}
				}
				catch (Exception exception) {
