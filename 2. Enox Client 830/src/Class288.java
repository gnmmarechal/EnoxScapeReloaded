...
public abstract class Class288 implements Runnable {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = -1372893999 * Class360.anInt3871;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (!string.equals(class105.aString1212) && (string = CS2Replacer.blockRuntime(class105, -440872681 * class105.ihash, string)) != null) {
