...
public class ConfigDefinitions {
    ...
    public static void method3977(Class331 class331, Toolkit class_ra, int i) {
	try {
	    Iterator iterator = Class344.aList3683.iterator();
	    while (iterator.hasNext()) {
		ParticleSystem class351 = (ParticleSystem) iterator.next();
		if (((ParticleSystem) class351).aBoolean3771)
	...
	try {
	    Class436.aClass298_Sub37_Sub15_5466 = (new Class298_Sub37_Sub15(Tradution.aClass470_5934.method6049(Class321.aClass429_3357, -875414210), "", -1808468501 * pb.anInt8937, 1006, -1, 0L, 0, 0, true, false, 0L, true));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    int i_8_ = ((pb.anIntArrayArrayArray8767[(((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)])]).length >> 1);
