...
public class Class365_Sub1_Sub5_Sub1 extends Class365_Sub1_Sub5 implements Interface3 {
    ...
    Model aClass387_9893;
    Shadow aClass_na9894;
    ...
    Model method4523(Toolkit class_ra, int i, int i_0_) {
	try {
	    ...
	    Tuple class454 = method4524(class_ra, i, false, (byte) -90);
	    if (null != class454)
    ...
    Tuple method4524(Toolkit class_ra, int i, boolean bool, byte i_1_) {
	try {
	...
	if (null == ((Class365_Sub1_Sub5_Sub1) this).aClass_na9894 && ((Class365_Sub1_Sub5_Sub1) this).aBoolean9902) {
	    Tuple class454 = method4524(class_ra, 262144, true, (byte) -75);
    ...
    boolean method4350(Toolkit class_ra, int i, int i_7_, byte i_8_) {
	try {
	    Model class387 = method4523(class_ra, 131072, -546231639);
	    if (class387 != null) {
		Class222 class222 = method4347();
	...
	Shadow class_na;
	if (null == ((Class365_Sub1_Sub5_Sub1) this).aClass_na9894 && ((Class365_Sub1_Sub5_Sub1) this).aBoolean9902) {
	    Tuple class454 = method4524(class_ra, 262144, true, (byte) -35);
	...
	Shadow class_na;
	if (null == ((Class365_Sub1_Sub5_Sub1) this).aClass_na9894 && ((Class365_Sub1_Sub5_Sub1) this).aBoolean9902) {
	    Tuple class454 = method4524(class_ra, 262144, true, (byte) -118);
	    class_na = (Shadow) (class454 != null ? class454.second : null);
	} else {
	    class_na = ((Class365_Sub1_Sub5_Sub1) this).aClass_na9894;
	    ((Class365_Sub1_Sub5_Sub1) this).aClass_na9894 = null;
    ...
    public Class365_Sub1_Sub5_Sub1(Class331 class331, Toolkit class_ra, Class433 class433, ObjectDefinitions class432, int i, int i_9_, int i_10_, int i_11_, int i_12_, boolean bool, int i_13_, int i_14_, boolean bool_15_) {
	super(class331, i_10_, i_11_, i_12_, i, i_9_, BillBoardConfig.method952(i_13_, i_14_, 800544861));
	((Class365_Sub1_Sub5_Sub1) this).aClass433_9898 = class433;
	((Class365_Sub1_Sub5_Sub1) this).anInt9896 = class432.objectId * 584655573;
	...
	if (class432.aBoolean5441)
	    i_16_ |= 0x80000;
	Tuple class454 = method4524(class_ra, i_16_, ((Class365_Sub1_Sub5_Sub1) this).aBoolean9902, (byte) -72);
	if (class454 != null) {
	    ((Class365_Sub1_Sub5_Sub1) this).aClass387_9893 = (Model) class454.first;
	    ((Class365_Sub1_Sub5_Sub1) this).aClass_na9894 = (Shadow) class454.second;
		...
		if (class432.aBoolean5441) {
		    Class287 class287 = pb.aClass283_8716.method2632(-2131923625);
	...
	try {
	    ...
	    Shadow class_na;
	    if (null == ((Class365_Sub1_Sub5_Sub1) this).aClass_na9894 && ((Class365_Sub1_Sub5_Sub1) this).aBoolean9902) {
		Tuple class454 = method4524(class_ra, 262144, true, (byte) -99);
		class_na = (Shadow) (class454 != null ? class454.second : null);
	    } else {
		class_na = ((Class365_Sub1_Sub5_Sub1) this).aClass_na9894;
		((Class365_Sub1_Sub5_Sub1) this).aClass_na9894 = null;
    ...
    void method4388(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_17_, int i_18_, boolean bool) {
	if (class365_sub1 instanceof Class365_Sub1_Sub5_Sub1) {
    ...
    boolean method4372(Toolkit class_ra, int i, int i_20_) {
	Model class387 = method4523(class_ra, 131072, -1405605049);
	if (class387 != null) {
	    Class222 class222 = method4347();
    ...
    boolean method4385(Toolkit class_ra, int i, int i_21_) {
	Model class387 = method4523(class_ra, 131072, -189727936);
	if (class387 != null) {
	    Class222 class222 = method4347();
    ...
    boolean method4352(Toolkit class_ra, int i, int i_22_) {
	Model class387 = method4523(class_ra, 131072, -673650245);
	if (class387 != null) {
	    Class222 class222 = method4347();
    ...
    void method4375(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_23_, int i_24_, boolean bool) {
	if (class365_sub1 instanceof Class365_Sub1_Sub5_Sub1) {
	...
	try {
	    ...
	    Shadow class_na;
	    if (null == ((Class365_Sub1_Sub5_Sub1) this).aClass_na9894 && ((Class365_Sub1_Sub5_Sub1) this).aBoolean9902) {
		Tuple class454 = method4524(class_ra, 262144, true, (byte) 2);
		class_na = (Shadow) (null != class454 ? class454.second : null);
	    } else {
		class_na = ((Class365_Sub1_Sub5_Sub1) this).aClass_na9894;
		((Class365_Sub1_Sub5_Sub1) this).aClass_na9894 = null;
	...
	try {
	    boolean bool_26_ = Class373.activeToolkit.method5054();
	    if (bool != bool_26_) {
		if (bool) {
		    if (!Class373.activeToolkit.method5052())
			bool = false;
		} else
		    Class373.activeToolkit.method5053();
		if (bool != bool_26_) {
