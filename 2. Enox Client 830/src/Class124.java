...
public class Class124 implements Runnable {
	...
	try {
	    ...
	    Class360.aClass25_3905 = pb.aClass25_8693;
	...
	try {
	    ...
	    int i_4_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 2]);
	...
	try {
	    int i_5_ = (class365_sub1_sub1_sub2.anInt10095 * -412225079 - pb.ticketCycle * 443738891);
