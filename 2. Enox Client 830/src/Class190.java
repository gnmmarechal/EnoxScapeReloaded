...
public class Class190 {
	...
	void method1855(int i) {
		try {
			anInt1943 = (-738467127 * (Class220.COSINE[((Class190) this).anInt1922 * -1184073033 << 3]));
			long l = (long) (anInt1933 * 1776313545);
			long l_2_ = (long) (-739294135 * anInt1934);
			long l_3_ = (long) (anInt1935 * -1849369705);
			distance = (int) Math.sqrt((double) (l * l + l_2_ * l_2_ + l_3_ * l_3_)) * -1363693449;
			...
			if (anInt1936 * -1660029223 == 0)
				...
				aLong1931 = ((long) (-1570158024 * distance / (anInt1920 * -1595714959)) * 8888916578422759065L);
				aLong1931 *= aLong1931 * 6688605316592129449L;
			}
			else if (-1660029223 * anInt1936 == 2)
				aLong1931 = ((long) (-1570158024 * distance / (-1595714959 * anInt1920)) * 8888916578422759065L);
	...
	static final void method1856(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = -2093041337 * class105.anInt1156;
		}
		catch (RuntimeException runtimeexception) {
	...
	static final void method1857(Class403 class403, int i) {
		try {
			...
			if (pb.anInt8942 * 1131012101 != 0 && i_5_ < -548972447 * pb.anInt8952) {
				((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = pb.aStringArray8859[i_5_];
				if (null != pb.aStringArray8955[i_5_])
					((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = pb.aStringArray8955[i_5_];
				else
	...
	static final void method1858(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub4_7563.method5612(i_6_, 1352882135);
		}
		catch (RuntimeException runtimeexception) {
	...
	static final void method1860(Class403 class403, int i) {
		try {
			((Class403) class403).anInt5259 += ((((Class403) class403).anIntArray5257[((Class403) class403).anInt5259 * 1883543357]) * 286750741);
		}
		catch (RuntimeException runtimeexception) {
