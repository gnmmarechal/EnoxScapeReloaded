...
public class Class300 {
	...
	try {
	    ...
	    ((Class302_Sub4) class302_sub4).anInt7655 = (i_11_ + pb.ticketCycle * 443738891) * -1019659005;
	    ...
	    pb.aClass442_8650.method5870(class302_sub4, 1639821588);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    int i_14_ = (((Class403) class403).anIntArray5257[((Class403) class403).anInt5259 * 1883543357]);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class128.aClass148_6331.anIntArray6654[i_14_];
	}
	catch (RuntimeException runtimeexception) {
