...
public class MapDetails extends Class298_Sub37 {
	...
	boolean method3450(int i, int i_0_, byte i_1_) {
		try {
			for (MapRectangle class298_sub42 = (MapRectangle) ((MapDetails) this).aClass453_9642.method5939(
					1766612795); null != class298_sub42; class298_sub42 = (MapRectangle) ((MapDetails) this).aClass453_9642
							.method5944(49146)) {
	...
	public boolean method3451(int i, int i_2_, int[] is, int i_3_) {
		try {
			for (MapRectangle class298_sub42 = (MapRectangle) ((MapDetails) this).aClass453_9642.method5939(
					1766612795); class298_sub42 != null; class298_sub42 = (MapRectangle) ((MapDetails) this).aClass453_9642
							.method5944(49146)) {
	...
	void method3454(int i) {
		try {
			...
			for (MapRectangle class298_sub42 = (MapRectangle) ((MapDetails) this).aClass453_9642.method5939(
					1766612795); class298_sub42 != null; class298_sub42 = (MapRectangle) ((MapDetails) this).aClass453_9642
							.method5944(49146)) {
				if (((MapRectangle) class298_sub42).anInt7457 * 1528024175 < 1364716801 * anInt9650)
					anInt9650 = (((MapRectangle) class298_sub42).anInt7457 * -878769809);
				if (((MapRectangle) class298_sub42).anInt7461 * 37578241 > anInt9647 * -2052483955)
					anInt9647 = (((MapRectangle) class298_sub42).anInt7461 * -1211577275);
				if (50981941 * ((MapRectangle) class298_sub42).anInt7463 < anInt9649 * 1345239131)
					anInt9649 = -608005457 * (((MapRectangle) class298_sub42).anInt7463);
				if (1374138429 * ((MapRectangle) class298_sub42).anInt7465 > 929385381 * anInt9646)
					anInt9646 = (-1870852423 * ((MapRectangle) class298_sub42).anInt7465);
			}
		} catch (RuntimeException runtimeexception) {
	...
	MapDetails(int id, String namehash, String name, int tileHash, int i_11_, boolean load, int defaultZoom,
			int mapSize) {
		anInt9647 = 0;
		anInt9649 = 1374107136;
		anInt9646 = 0;
		((MapDetails) this).load = true;
		this.fileId = -1929943701 * id;
		this.namehash = namehash;
		this.name = name;
		this.tileHash = tileHash * 350230413;
		((MapDetails) this).anInt9639 = -1105193455 * i_11_;
		((MapDetails) this).load = load;
		this.defaultZoom = defaultZoom * -715250349;
		if (1110271707 * this.defaultZoom == 255)
			this.defaultZoom = 0;
		Class94.method1020(mapSize, 1337257918);
		((MapDetails) this).aClass453_9642 = new Class453();
	}

	public static final void method3455(int i, int i_14_) {
		try {
			if (Class350.aClass298_Sub25_3757 != null
					&& (i >= 0 && i < 649879491 * (Class350.aClass298_Sub25_3757.anInt7356))) {
				...
				if (-1 == class163.aByte1683) {
					...
					Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2045,
							class25.aClass449_330, (byte) 120);
					class298_sub36.aClass298_Sub53_Sub2_7396
							.writeByte(2 + Class58.method693(class163.aString1681, 1064865624));
