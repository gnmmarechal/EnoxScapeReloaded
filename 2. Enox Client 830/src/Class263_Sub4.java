...
public class Class263_Sub4 extends Class263 implements Interface9_Impl2_Impl1 {
    ...
    Class263_Sub4(HybridOglToolkit class_ra_sub3_sub1, Class55 class55, int i, int i_0_, byte[] is, int i_1_, int i_2_) {
	...
	OpenGL.glTexImage2Dub(((Class263_Sub4) this).anInt6415, 0, (HybridOglToolkit.method5533(((Class263_Sub4) this).aClass55_6419, ((Class263_Sub4) this).aClass77_6420)), i, i_0_, 0, HybridOglToolkit.method5532(((Class263_Sub4) this).aClass55_6419), 5121, is, i_1_);
	OpenGL.glPixelStorei(3314, 0);
	OpenGL.glPixelStorei(3317, 4);
    }

    Class263_Sub4(HybridOglToolkit class_ra_sub3_sub1, Class55 class55, int i, int i_3_, float[] fs, int i_4_, int i_5_) {
	...
	OpenGL.glTexImage2Df(((Class263_Sub4) this).anInt6415, 0, (HybridOglToolkit.method5533(((Class263_Sub4) this).aClass55_6419, ((Class263_Sub4) this).aClass77_6420)), i, i_3_, 0, HybridOglToolkit.method5532(((Class263_Sub4) this).aClass55_6419), 5126, fs, i_4_ * 4);
	OpenGL.glPixelStorei(3314, 0);
    }
	...
	OpenGL.glTexSubImage2Di(((Class263_Sub4) this).anInt6415, 0, i, i_8_, i_9_, i_10_, 32993, ((HybridOglToolkit) (((Class263_Sub4) this).aClass_ra_Sub3_Sub1_6422)).anInt9841, is, i_11_);
	if (i_9_ != i_12_)
	    OpenGL.glPixelStorei(3314, 0);
    }
	...
	OpenGL.glTexSubImage2Dub(((Class263_Sub4) this).anInt6415, 0, i, i_19_, i_20_, i_21_, HybridOglToolkit.method5532(class55), 5121, is, i_22_);
	if (i_23_ != i_20_)
	    OpenGL.glPixelStorei(3314, 0);
	OpenGL.glPixelStorei(3317, 4);
    }
    ...
    Class263_Sub4(HybridOglToolkit class_ra_sub3_sub1, Class55 class55, Class77 class77, int i, int i_24_) {
	super(class_ra_sub3_sub1, 34037, class55, class77, i * i_24_, false);
	((Class263_Sub4) this).anInt9954 = i;
	((Class263_Sub4) this).anInt9953 = i_24_;
	((Class263_Sub4) this).aClass_ra_Sub3_Sub1_6422.method5358(this);
	OpenGL.glTexImage2Dub(((Class263_Sub4) this).anInt6415, 0, HybridOglToolkit.method5533((((Class263_Sub4) this).aClass55_6419), (((Class263_Sub4) this).aClass77_6420)), i, i_24_, 0, HybridOglToolkit.method5532(((Class263_Sub4) this).aClass55_6419), HybridOglToolkit.method5537(((Class263_Sub4) this).aClass77_6420), null, 0);
    }
	...
	OpenGL.glTexSubImage2Dub(((Class263_Sub4) this).anInt6415, 0, i, i_28_, i_29_, i_30_, HybridOglToolkit.method5532(class55), 5121, is, i_31_);
	if (i_32_ != i_29_)
	    OpenGL.glPixelStorei(3314, 0);
	OpenGL.glPixelStorei(3317, 4);
    }

    Class263_Sub4(HybridOglToolkit class_ra_sub3_sub1, int i, int i_33_, int[] is, int i_34_, int i_35_) {
	...
	OpenGL.glTexImage2Di(((Class263_Sub4) this).anInt6415, 0, 6408, ((Class263_Sub4) this).anInt9954, ((Class263_Sub4) this).anInt9953, 0, 32993, (((HybridOglToolkit) ((Class263_Sub4) this).aClass_ra_Sub3_Sub1_6422).anInt9841), is, i_34_ * 4);
	OpenGL.glPixelStorei(3314, 0);
    }
	...
	OpenGL.glTexSubImage2Di(((Class263_Sub4) this).anInt6415, 0, i, i_36_, i_37_, i_38_, 32993, ((HybridOglToolkit) (((Class263_Sub4) this).aClass_ra_Sub3_Sub1_6422)).anInt9841, is, i_39_);
	if (i_37_ != i_40_)
	    OpenGL.glPixelStorei(3314, 0);
    }
	...
	OpenGL.glTexSubImage2Di(((Class263_Sub4) this).anInt6415, 0, i, i_41_, i_42_, i_43_, 32993, ((HybridOglToolkit) (((Class263_Sub4) this).aClass_ra_Sub3_Sub1_6422)).anInt9841, is, i_44_);
	if (i_42_ != i_45_)
	    OpenGL.glPixelStorei(3314, 0);
    }
	...
	OpenGL.glTexSubImage2Dub(((Class263_Sub4) this).anInt6415, 0, i, i_46_, i_47_, i_48_, HybridOglToolkit.method5532(class55), 5121, is, i_49_);
	if (i_50_ != i_47_)
	    OpenGL.glPixelStorei(3314, 0);
	OpenGL.glPixelStorei(3317, 4);
    }
	...
	OpenGL.glTexSubImage2Dub(((Class263_Sub4) this).anInt6415, 0, i, i_51_, i_52_, i_53_, HybridOglToolkit.method5532(class55), 5121, is, i_54_);
	if (i_55_ != i_52_)
	    OpenGL.glPixelStorei(3314, 0);
	OpenGL.glPixelStorei(3317, 4);
    }
