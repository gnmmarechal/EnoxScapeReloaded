...
public class Class139 {
	...
	try {
		...
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = class298_sub37_sub13.fileId * -947282109;
	}
	catch (RuntimeException runtimeexception) {
    ...
    public static void method1548(String string, boolean bool, Toolkit class_ra, Class264 class264, Class505 class505, byte i) {
	try {
		...
		if (Class372_Sub3.aBoolean7730 && bool_5_) {
		    ...
		    int i_10_ = (Class14.aClass139_171.method1545(i_6_, (pb.anInt8794 * 775068819), -1808907629) + -994816289 * Class14.anInt170);
		    int i_11_ = (Class14.aClass133_177.method1482(i_7_, (pb.anInt8803 * -791746413), -750031668) + -277668631 * Class14.anInt173);
	...
	try {
	    SunDefinition.method1400(i, i_17_, i_18_, 0, i_19_, false, 2074024195);
	}
	catch (RuntimeException runtimeexception) {
