...
public class Class47_Sub9 extends Class47 {
	...
	if (((Class47_Sub9) this).aBoolean6809 && class30_sub1 != null) {
	    ...
	    OpenGL.glUniform3f(OpenGL.glGetUniformLocation(i, "sunDir"), -(((GLToolkit) ((Class47_Sub9) this).aClass_ra_Sub2_491).aFloatArray8124[0]), -(((GLToolkit) ((Class47_Sub9) this).aClass_ra_Sub2_491).aFloatArray8124[1]), -(((GLToolkit) ((Class47_Sub9) this).aClass_ra_Sub2_491).aFloatArray8124[2]));
	    OpenGL.glUniform4f(OpenGL.glGetUniformLocation(i, "sunColour"), (((GLToolkit) ((Class47_Sub9) this).aClass_ra_Sub2_491).aFloat8125), (((GLToolkit) ((Class47_Sub9) this).aClass_ra_Sub2_491).aFloat8128), (((GLToolkit) ((Class47_Sub9) this).aClass_ra_Sub2_491).aFloat8191), 1.0F);
	    OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i, "sunExponent"), 96.0F + Math.abs(((GLToolkit) (((Class47_Sub9) this).aClass_ra_Sub2_491)).aFloatArray8124[1]) * 928.0F);
	...
	if (((Class47_Sub9) this).aBoolean6811) {
	    ...
	    OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_4_, "time"), (float) (i_1_ * ((GLToolkit) (((Class47_Sub9) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
	...
	if (((Class47_Sub9) this).aBoolean6811) {
	    ...
	    OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_9_, "time"), (float) (i_6_ * ((GLToolkit) (((Class47_Sub9) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
	...
	if (((Class47_Sub9) this).aBoolean6811) {
	    ...
	    OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_14_, "time"), (float) (i_11_ * ((GLToolkit) (((Class47_Sub9) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
	...
	if (((Class47_Sub9) this).aBoolean6811) {
	    ...
	    OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_19_, "time"), (float) (i_16_ * ((GLToolkit) (((Class47_Sub9) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
    ...
    Class47_Sub9(GLToolkit class_ra_sub2, Class45 class45) {
	super(class_ra_sub2);
	((Class47_Sub9) this).aBoolean6809 = false;
	((Class47_Sub9) this).aClass45_6813 = class45;
	if ((((Class45) ((Class47_Sub9) this).aClass45_6813).aClass30_Sub4_485 != null) && (((GLToolkit) ((Class47_Sub9) this).aClass_ra_Sub2_491).vertex_shader) && (((GLToolkit) ((Class47_Sub9) this).aClass_ra_Sub2_491).fragment_shader)) {
	...
	if (((Class47_Sub9) this).aBoolean6811) {
	    ...
	    OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_25_, "time"), (float) (i_22_ * ((GLToolkit) (((Class47_Sub9) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
	...
	if (((Class47_Sub9) this).aBoolean6811) {
	    ...
	    OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_30_, "time"), (float) (i_27_ * ((GLToolkit) (((Class47_Sub9) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
