...
public class Gui extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					UIManager.setLookAndFeel(Settings.UI_STYLE);
					Gui frame = new Gui();
	 ...
	 */
	public Gui() {
		setTitle(Settings.SERVER_NAME + "'s Server Panel");
		...
		JButton forceTeleButton = new JButton("Force teleport player");
		forceTeleButton.setBounds(10, 215, 151, 23);
		contentPane.add(forceTeleButton);
		forceTeleButton.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				ForceTelePlayer(evt);
			}
		});
		JButton btnNewButton_6 = new JButton("Message player");
		btnNewButton_6.setBounds(10, 249, 151, 23);
		...
		btnNewButton_7.setBounds(10, 283, 151, 23);
		...
		btnNewButton_8.setBounds(173, 11, 151, 23);
		...
		btnNewButton_9.setBounds(173, 45, 151, 23);
		...
		btnNewButton_10.setBounds(173, 79, 151, 23);
		...
		btnNewButton_11.setBounds(173, 113, 151, 23);
		...
		btnNewButton_67.setBounds(173, 113+34, 151, 23);
 ...
 private void PlayerMessage(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_banButtonActionPerformed
	{
		...
		Player target = World.getPlayerByDisplayName(name);
	if (target != null) {
		target.getPackets().receivePrivateMessage(name, "Server", 2, msg);
	} else {
		JOptionPane.showMessageDialog(null,  name +" was not found");
	}
}
 ...
 private void TelePlayer(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_banButtonActionPerformed
	{
		...
		target.getPackets().sendGameMessage("<col=ff0000>[Sever Message]: You have been forcefully teleported.");
		} else {
			JOptionPane.showMessageDialog(null,  name +" was not found");
		}
	}
 ...
 private void ForceTelePlayer(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_banButtonActionPerformed
	{
		// THIS DOES NOT WORK
		String name = JOptionPane.showInputDialog(null, "Who would you like to Teleport");
		Player target = World.getPlayerByDisplayName(name);
		String x = JOptionPane.showInputDialog(null, "Enter x");
		String y = JOptionPane.showInputDialog(null, "Enter y");
		String z = JOptionPane.showInputDialog(null, "Enter z");
		...
		if (target != null) {
			...
			player.setNextWorldTile(new WorldTile( x2, y2, z2));
			JOptionPane.showMessageDialog(null, "You have Teleported " + name);
			target.getPackets().sendGameMessage("<col=ff0000>[Server Message]: You have been forcefully teleported.");
		} else {
			JOptionPane.showMessageDialog(null,  name +" was not found");
		}
	}
 ...
 private void ServerMessage(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_banButtonActionPerformed
	{
		...
		World.sendWorldMessage("<col=ff0000>[Server Message]: " + message + "", true);
		JOptionPane.showMessageDialog(null, "Message sent");
		}
	} 
 
 private void PlayerServerMessage(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_banButtonActionPerformed
	{
		String playerName = JOptionPane.showInputDialog(null, "Enter target player username");
