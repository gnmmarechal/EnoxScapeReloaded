...
public class Class331 {
    ...
    public Ground[] aClass_xaArray3517;
    public Class326[][][] aClass326ArrayArrayArray3518;
    public Ground[] aClass_xaArray3519;
    public Class326[][][] aClass326ArrayArrayArray3520;
    public Ground[] aClass_xaArray3521;
    ...
    public Class331(Toolkit class_ra, int i, int i_69_, int i_70_, int i_71_, int i_72_, boolean bool, boolean bool_73_) {
	...
	aClass_xaArray3519 = new Ground[i_69_];
	if (bool) {
	    ...
	    aClass_xaArray3521 = new Ground[1];
	}
	if (bool_73_) {
	...
	if (aClass_xaArray3517 == aClass_xaArray3521) {
	    ...
	    class78.colour = method4015(i, i_195_, (byte) 76) * 614121861;
	    class78.scale = method4014(i, i_195_, (byte) -5) * -885436027;
	    ...
	    ((Class331) this).aClass_ra3508.method5058(aClass_xaArray3519[0].averageHeight((int) class217.aFloat2451, (int) class217.aFloat2454, -1986155301), class78);
	}
    ...
    public void method4047(Shadow class_na, int i, int i_196_, int i_197_, boolean[] bools, int i_198_) {
	try {
	    if (aClass_xaArray3521 != aClass_xaArray3517) {
		int i_199_ = aClass_xaArray3519[i].averageHeight(i_196_, i_197_, -1918392290);
		for (int i_200_ = 0; i_200_ <= i; i_200_++) {
		    if (bools == null || bools[i_200_]) {
			Ground class_xa = aClass_xaArray3519[i_200_];
			if (null == class_xa) {
			    if (i_198_ <= 16711935)
				break;
			} else
			    class_xa.NA(class_na, i_196_, (i_199_ - class_xa.averageHeight(i_196_, i_197_, -1764966761)), i_197_, 0, false);
		    }
		}
	    }
	}
	...
	try {
	    Shadow class_na = null;
	    for (int i_203_ = i; i_203_ < i_201_; i_203_++) {
		Ground class_xa = aClass_xaArray3519[i_203_];
		if (null != class_xa) {
			...
			for (int i_205_ = 0; i_205_ < anInt3514 * 1988988347; i_205_++) {
				...
				for (int i_208_ = i_203_ - 1; i_208_ >= 0; i_208_--) {
				    Ground class_xa_209_ = aClass_xaArray3519[i_208_];
    ...
    public boolean method4055(Shadow class_na, int i, int i_265_, int i_266_, boolean[] bools, int i_267_) {
	try {
	    boolean bool = false;
	    if (aClass_xaArray3521 != aClass_xaArray3517) {
		int i_268_ = aClass_xaArray3519[i].averageHeight(i_265_, i_266_, -1298291430);
		int i_269_ = 0;
		for (/**/; i_269_ <= i; i_269_++) {
		    Ground class_xa = aClass_xaArray3519[i_269_];
		    if (null == class_xa) {
			if (i_267_ == 2008908432)
			    throw new IllegalStateException();
		    } else {
			int i_270_ = i_268_ - class_xa.averageHeight(i_265_, i_266_, -1859389272);
			if (bools != null) {
    ...
    public void method4056(int i, Ground class_xa, byte i_271_) {
	try {
	...
	try {
	    ((Class403) class403).anInt5239 -= 1551802473;
	    int i_284_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]);
	    int i_285_ = ((((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 1]) << 1);
	    int i_286_ = (((Class403) class403).anIntArray5244[2 + ((Class403) class403).anInt5239 * 681479919]);
	    int i_287_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 3]);
	    int i_288_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 4]);
	    int i_289_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 5]);
	    int i_290_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 6]);
	    if (i_284_ >= 0 && i_284_ < 2 && null != pb.anIntArrayArrayArray8767[i_284_] && i_285_ >= 0 && i_285_ < pb.anIntArrayArrayArray8767[i_284_].length) {
		pb.anIntArrayArrayArray8767[i_284_][i_285_] = new int[] { (i_286_ >> 14 & 0x3fff) << 9, i_287_ << 2, (i_286_ & 0x3fff) << 9, i_290_ };
		pb.anIntArrayArrayArray8767[i_284_][1 + i_285_] = new int[] { (i_288_ >> 14 & 0x3fff) << 9, i_289_ << 2, (i_288_ & 0x3fff) << 9 };
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = 1045422783 * class105.anInt1170;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    IComponentDefinition class105_291_ = pb.method2808(class105);
