...
public class Class11 {
	...
	try {
	    ...
	    int i_2_ = (((Class403) class403).anIntArray5244[1 + ((Class403) class403).anInt5239 * 681479919]);
	    Class497 class497 = Class92.aClass504_905.method6251(i_2_, 831421944);
	    if (class497.method6206(1883696427))
		((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = Class363.aClass339_3931.method4116(i_1_, -1801093114).method4239(i_2_, class497.aString6101, (byte) -38);
	    else
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = (Class363.aClass339_3931.method4116(i_1_, -183647434).method4241(i_2_, -388931549 * class497.anInt6100, 1379930702));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (null != Class301.aClass298_Sub37_Sub13_3218 ? -947282109 * Class301.aClass298_Sub37_Sub13_3218.fileId : -1);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (int) (Class247.aLong2748 * -536549149186981023L / 60000L);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (int) ((Class247.aLong2748 * -536549149186981023L - Class122.method1319((byte) 1) - Class298_Sub35.aLong7395 * -7323824110069770829L) / 60000L);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class510.aBoolean6222 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
