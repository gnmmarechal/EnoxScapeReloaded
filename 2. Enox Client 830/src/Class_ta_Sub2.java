...
public class Class_ta_Sub2 extends Class_ta {
	...
	try {
	    ((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1] = (Class316.aClass362_3318.method4307((((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 - 1]), 245040087).anInt4012) * 126451825;
	}
    ...
    public static void method6001(Sprite[] class57s, int i) {
	try {
	    Class277.anInt2964 = -1283115375 * class57s.length;
	    Class436.aClass57Array5501 = new Sprite[Class277.anInt2964 * -232961423 + 10];
	...
	try {
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = (Class316.aClass362_3318.method4307((((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]), 245040087).aString4008);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (null != pb.aString8804 && i_4_ < Class489.anInt6071 * -1801543887)
		((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = Class82_Sub6.aClass7Array6846[i_4_].aString93;
	    else
