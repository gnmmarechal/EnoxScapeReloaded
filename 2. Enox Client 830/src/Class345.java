...
public class Class345 implements Interface19 {
	...
	if (null == class298_sub50) {
		...
		int i_1_ = is[i_0_];
		if (!class323.pressingKey(i_1_, 311958108))
		    return false;
	    }
	}
	return true;
	...
	try {
		...
		for (int i_3_ = 0; i_3_ < is.length; i_3_++) {
		    int i_4_ = is[i_3_];
		    if (!class323.pressingKey(i_4_, 741080989))
			return false;
		}
	    }
	    return true;
	...
	if (null == class298_sub50) {
		...
		int i_6_ = is[i_5_];
		if (!class323.pressingKey(i_6_, 226662543))
		    return false;
	    }
	}
	return true;
	...
	try {
	    ...
	    if (i_10_ >= 0 && i_10_ < 2)
		pb.anIntArrayArrayArray8767[i_10_] = new int[i_11_ << 1][4];
	}
	catch (RuntimeException runtimeexception) {
