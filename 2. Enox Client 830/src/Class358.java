...
public class Class358 {
    ...
    public Sprite method4280(Toolkit class_ra, short i) {
	try {
	    if (459224223 * ((Class358) this).anInt3855 < 0)
		return null;
	    Sprite class57 = ((Sprite) (((Class347) ((Class358) this).aClass347_3856).aClass348_3700.get((long) (459224223 * ((Class358) this).anInt3855))));
	    if (class57 == null) {
		method4283(class_ra, 370410201);
		class57 = (Sprite) (((Class347) ((Class358) this).aClass347_3856).aClass348_3700.get((long) (459224223 * ((Class358) this).anInt3855)));
	    }
	    return class57;
	}
	catch (RuntimeException runtimeexception) {
    ...
    public Sprite method4281(Toolkit class_ra, byte i) {
	try {
	    if (((Class358) this).anInt3857 * 1894403017 < 0)
		return null;
	    Sprite class57 = ((Sprite) (((Class347) ((Class358) this).aClass347_3856).aClass348_3700.get((long) (((Class358) this).anInt3857 * 1894403017))));
	    if (class57 == null) {
		method4283(class_ra, 445358153);
		class57 = (Sprite) (((Class347) ((Class358) this).aClass347_3856).aClass348_3700.get((long) (1894403017 * ((Class358) this).anInt3857)));
	    }
	    return class57;
	}
	catch (RuntimeException runtimeexception) {
    ...
    public Sprite method4282(Toolkit class_ra, byte i) {
	try {
	    if (1896268847 * ((Class358) this).anInt3858 < 0)
		return null;
	    Sprite class57 = ((Sprite) (((Class347) ((Class358) this).aClass347_3856).aClass348_3700.get((long) (((Class358) this).anInt3858 * 1896268847))));
	    if (class57 == null) {
		method4283(class_ra, -388591321);
		class57 = (Sprite) (((Class347) ((Class358) this).aClass347_3856).aClass348_3700.get((long) (1896268847 * ((Class358) this).anInt3858)));
	    }
	    return class57;
	}
	catch (RuntimeException runtimeexception) {
    ...
    void method4283(Toolkit class_ra, int i) {
	try {
	    JS5 class243 = ((Class347) ((Class358) this).aClass347_3856).aClass243_3699;
	    if (459224223 * ((Class358) this).anInt3855 >= 0 && (((Class347) ((Class358) this).aClass347_3856).aClass348_3700.get((long) (459224223 * ((Class358) this).anInt3855))) == null && class243.fileLoaded(((Class358) this).anInt3855 * 459224223, -457216440)) {
		IndexedImage class89 = IndexedImage.method979(class243, (((Class358) this).anInt3855 * 459224223));
		((Class347) ((Class358) this).aClass347_3856).aClass348_3700.put(class_ra.method5125(class89, true), (long) (((Class358) this).anInt3855 * 459224223));
	    }
	    if (((Class358) this).anInt3860 * -1362963983 >= 0 && ((((Class347) ((Class358) this).aClass347_3856).aClass348_3700.get((long) (((Class358) this).anInt3860 * -1362963983))) == null) && class243.fileLoaded((-1362963983 * ((Class358) this).anInt3860), -457216440)) {
		IndexedImage class89 = IndexedImage.method979(class243, (-1362963983 * ((Class358) this).anInt3860));
		((Class347) ((Class358) this).aClass347_3856).aClass348_3700.put(class_ra.method5125(class89, true), (long) (((Class358) this).anInt3860 * -1362963983));
	    }
	    if (((Class358) this).anInt3857 * 1894403017 >= 0 && ((((Class347) ((Class358) this).aClass347_3856).aClass348_3700.get((long) (((Class358) this).anInt3857 * 1894403017))) == null) && class243.fileLoaded((((Class358) this).anInt3857 * 1894403017), -457216440)) {
		IndexedImage class89 = IndexedImage.method979(class243, (((Class358) this).anInt3857 * 1894403017));
		((Class347) ((Class358) this).aClass347_3856).aClass348_3700.put(class_ra.method5125(class89, true), (long) (((Class358) this).anInt3857 * 1894403017));
	    }
	    if (((Class358) this).anInt3858 * 1896268847 >= 0 && ((((Class347) ((Class358) this).aClass347_3856).aClass348_3700.get((long) (((Class358) this).anInt3858 * 1896268847))) == null) && class243.fileLoaded((((Class358) this).anInt3858 * 1896268847), -457216440)) {
		IndexedImage class89 = IndexedImage.method979(class243, (1896268847 * ((Class358) this).anInt3858));
		((Class347) ((Class358) this).aClass347_3856).aClass348_3700.put(class_ra.method5125(class89, true), (long) (1896268847 * ((Class358) this).anInt3858));
	    }
	}
	catch (RuntimeException runtimeexception) {
    ...
    public Sprite method4284(Toolkit class_ra, int i) {
	try {
	    if (((Class358) this).anInt3860 * -1362963983 < 0)
		return null;
	    Sprite class57 = ((Sprite) (((Class347) ((Class358) this).aClass347_3856).aClass348_3700.get((long) (-1362963983 * ((Class358) this).anInt3860))));
	    if (class57 == null) {
		method4283(class_ra, -843145755);
		class57 = (Sprite) (((Class347) ((Class358) this).aClass347_3856).aClass348_3700.get((long) (-1362963983 * ((Class358) this).anInt3860)));
	    }
	    return class57;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Class86.method967((((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]), (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 * 681479919 + 1)]), (((Class403) class403).anIntArray5244[2 + (((Class403) class403).anInt5239 * 681479919)]), -507940004);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = (Class316.aClass362_3318.method4307((((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 2]), 245040087).aStringArray4022[(((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1])]);
	...
	try {
	    ((Class403) class403).anInt5239 -= -783761378;
	    int i_7_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
	    int i_8_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 1]);
	    if (i_7_ == 0)
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
	    else if (i_8_ == 0)
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 2147483647;
	    else
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = (int) Math.pow((double) i_7_, 1.0 / (double) i_8_);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		i_15_ = (int) pb.aFloat8949 & 0x3fff;
	    else
		i_15_ = (pb.anInt8801 * 1227356013 + (int) pb.aFloat8949 & 0x3fff);
		...
		if (Class298_Sub1.anInt7164 * -863531439 != 2) {
		    ...
		    i_19_ = 256 * i_19_ / (256 + 356727603 * pb.anInt8749);
		}
