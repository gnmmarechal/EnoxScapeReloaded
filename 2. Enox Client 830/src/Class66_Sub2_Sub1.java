...
public class Class66_Sub2_Sub1 extends Class66_Sub2 {
	...
	int anInt9104;
	int anInt9105;
	AbstractToolkit aClass_ra_Sub3_9106;
	int anInt9107;
	int anInt9108;
	...
	Interface9_Impl1 method774() {
		if (((Class66_Sub2_Sub1) this).anInterface9_Impl1_9102 == null) {
			...
			for (int i_2_ = 0; i_2_ < 6; i_2_++)
				textures[i_2_] = interface_ma.getTexture(anIntArray9109[i_2_], 1025120075).textureId;
			boolean bool = false;
			int i = 0;
			for (int i_0_ = 0; i_0_ < 6; i_0_++) {
				if (!interface_ma.method170(textures[i_0_], (short) 4664))
					return null;
				TextureMetrics class53 = interface_ma.getTexture(anIntArray9109[i_0_], 1025120075);
			...
			for (int i_2_ = 0; i_2_ < 6; i_2_++)
				anIntArrayArray9101[i_2_] = interface_ma.method171(textures[i_2_], 1.0F, i, i, false, 1504533027);
			((Class66_Sub2_Sub1) this).anInterface9_Impl1_9102 = ((Class66_Sub2_Sub1) this).aClass_ra_Sub3_9106
					.method5415(i, bool, anIntArrayArray9101);
		}
		return ((Class66_Sub2_Sub1) this).anInterface9_Impl1_9102;
	}

	Class66_Sub2_Sub1(AbstractToolkit class_ra_sub3, int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_) {
	...
	Interface9_Impl1 method773() {
		if (((Class66_Sub2_Sub1) this).anInterface9_Impl1_9102 == null) {
			...
			for (int i_8_ = 0; i_8_ < 6; i_8_++) {
				if (!interface_ma.method170(textures[i_8_], (short) 30897))
					return null;
				TextureMetrics class53 = interface_ma.getTexture(anIntArray9109[i_8_], 548251560);
			...
			for (int i_10_ = 0; i_10_ < 6; i_10_++)
				anIntArrayArray9101[i_10_] = interface_ma.method171(textures[i_10_], 1.0F, i, i, false, -1308282836);
			((Class66_Sub2_Sub1) this).anInterface9_Impl1_9102 = ((Class66_Sub2_Sub1) this).aClass_ra_Sub3_9106
					.method5415(i, bool, anIntArrayArray9101);
		}
		return ((Class66_Sub2_Sub1) this).anInterface9_Impl1_9102;
