...
public class Class163 {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = 443738891 * pb.ticketCycle;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		TextureMetrics.method599(class119, class105, (byte) -3);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class390.method4871((byte) 30);
	}
	catch (RuntimeException runtimeexception) {
