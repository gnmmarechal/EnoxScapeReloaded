...
public class Class301_Sub1 extends Class301 {
	...
	try {
		...
		if (pb.method2801(class105).method3498(i - 1, (byte) -25)) {
		    Class25 class25 = Class429.method5760((short) 512);
		    if (-1233866115 * pb.anInt8752 == 14 || 0 == pb.anInt8752 * -1233866115) {
			/*if (i >= 1 && i <= 10) {
			    System.err.println("Client nonblocked click: " + (i_0_ >> 16) + "," + (i_0_ & 0xFFFF) + "," + i_1_ + "," + (class105.anInt1280 * -1232467723));
			}*/
			
			if (i == 1) {
			    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.ACTION_BUTTON1_PACKET, class25.aClass449_330, (byte) 40);
			    SunDefinition.method1396(class298_sub36, i_0_, i_1_, (-1232467723 * class105.id), -1695827903);
			...
			if (i == 2) {
			    ...
			    SunDefinition.method1396(class298_sub36, i_0_, i_1_, (class105.id * -1232467723), 1169430348);
			...
			if (i == 3) {
			    ...
			    SunDefinition.method1396(class298_sub36, i_0_, i_1_, (class105.id * -1232467723), -1266676543);
			...
			if (4 == i) {
			    ...
			    SunDefinition.method1396(class298_sub36, i_0_, i_1_, (-1232467723 * class105.id), -603023247);
			...
			if (5 == i) {
			    ...
			    SunDefinition.method1396(class298_sub36, i_0_, i_1_, (class105.id * -1232467723), -120093158);
			...
			if (i == 6) {
			    ...
			    SunDefinition.method1396(class298_sub36, i_0_, i_1_, (-1232467723 * class105.id), -206334631);
			...
			if (i == 7) {
			    ...
			    SunDefinition.method1396(class298_sub36, i_0_, i_1_, (class105.id * -1232467723), 1351893071);
			...
			if (i == 8) {
			    ...
			    SunDefinition.method1396(class298_sub36, i_0_, i_1_, (class105.id * -1232467723), 1834394135);
			...
			if (9 == i) {
			    ...
			    SunDefinition.method1396(class298_sub36, i_0_, i_1_, (-1232467723 * class105.id), -1435192522);
			...
			if (i == 10) {
			    ...
			    SunDefinition.method1396(class298_sub36, i_0_, i_1_, (-1232467723 * class105.id), -87863525);
		    ...
		    if (-1233866115 * pb.anInt8752 == 14 || 0 == pb.anInt8752 * -1233866115) {
			/*if (i >= 1 && i <= 10) {
			    System.err.println("Client blocked click: " + (i_0_ >> 16) + "," + (i_0_ & 0xFFFF) + "," + i_1_ + "," + (class105.anInt1280 * -1232467723));
			}*/
		    }
		}
	    }
