...
public abstract class Class365_Sub1_Sub5 extends Class365_Sub1 {
	...
	try {
		...
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = (-1973484731 * class298_sub37_sub13.tileHash >> 14 & 0x3fff);
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = class298_sub37_sub13.tileHash * -1973484731 & 0x3fff;
	    }
	}
	catch (RuntimeException runtimeexception) {
