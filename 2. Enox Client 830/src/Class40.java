...
public abstract class Class40 {
	...
	public void finalize() throws Throwable {
	    if (!aBoolean439) {
		aClass_ra_Sub2_437.deleteBuf(anInt436, anInt432);
		aBoolean439 = true;
	    }
	    super.finalize();
	}

    Class40(GLToolkit class_ra_sub2, int i, Buffer buffer, int i_0_, boolean bool) {
	...
	((GLToolkit) ((Class40) this).aClass_ra_Sub2_437).anInt8112 += ((Class40) this).anInt432;
    }
	...
	if (i > ((Class40) this).anInt432) {
	    ...
	    ((GLToolkit) ((Class40) this).aClass_ra_Sub2_437).anInt8112 += i - ((Class40) this).anInt432;
	    ((Class40) this).anInt432 = i;
	} else
	    OpenGL.glBufferSubDataARBub(((Class40) this).anInt433, 0, i, is, 0);
    }

    Class40(GLToolkit class_ra_sub2, int i, byte[] is, int i_1_, boolean bool) {
	((Class40) this).aClass_ra_Sub2_437 = class_ra_sub2;
	((Class40) this).anInt433 = i;
