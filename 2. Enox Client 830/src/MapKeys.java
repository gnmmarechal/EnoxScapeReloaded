...
public class MapKeys {
	...
	static final void method2829(Class403 class403, byte i) {
		try {
			...
			if (class298_sub37_sub14.anIntArray9653 == null)
				...
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919)
						- 1] = class298_sub37_sub14.anIntArray9653.length;
	...
	static final void method2831(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919
					- 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub18_7561.method5693(-919235605) == 1 ? 1
							: 0;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method2832(Class403 class403, byte i) {
		try {
			int i_7_ = (((Class403) class403).anIntArray5257[((Class403) class403).anInt5259 * 1883543357]);
			((Class403) class403).anInt5241 -= i_7_ * 969361751;
			String string = Class_ta.method5996(((Class403) class403).anObjectArray5240,
					(-203050393 * ((Class403) class403).anInt5241), i_7_, (byte) 0);
			string = CS2Replacer.filterRuntime(string);
	...
	static final void method2833(Class403 class403, byte i) {
		try {
			...
			Class18.method362(
					(String) (((Class403) class403).anObjectArray5240[((Class403) class403).anInt5241 * -203050393]),
					(String) (((Class403) class403).anObjectArray5240[-203050393 * ((Class403) class403).anInt5241
							+ 1]),
					(((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]),
					1 == (((Class403) class403).anIntArray5244[1 + 681479919 * ((Class403) class403).anInt5239]),
					-1761866879);
		} catch (RuntimeException runtimeexception) {
	...
	static void method2834(int i, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_) {
		try {
			...
			if (i_8_ >= Class372_Sub1_Sub1.anInt4049 * 1155384281
					&& i_8_ <= Class372_Sub1_Sub1.anInt4050 * -1062447355) {
				int i_28_ = Class463.method6012(i_9_ + i, (Class372_Sub1_Sub1.anInt4051 * -1424479739),
						(Class372_Sub1_Sub1.anInt4048 * 1135094847), -1212608691);
				int i_29_ = Class463.method6012(i - i_9_, (Class372_Sub1_Sub1.anInt4051 * -1424479739),
						(Class372_Sub1_Sub1.anInt4048 * 1135094847), -1212608691);
			...
			while (i_14_ > 0) {
				...
				if (i_31_ >= Class372_Sub1_Sub1.anInt4049 * 1155384281
						&& i_30_ <= Class372_Sub1_Sub1.anInt4050 * -1062447355) {
					int i_32_ = Class463.method6012(i + i_13_, (-1424479739 * Class372_Sub1_Sub1.anInt4051),
							(1135094847 * Class372_Sub1_Sub1.anInt4048), -1212608691);
					int i_33_ = Class463.method6012(i - i_13_, (-1424479739 * Class372_Sub1_Sub1.anInt4051),
							(Class372_Sub1_Sub1.anInt4048 * 1135094847), -1212608691);
