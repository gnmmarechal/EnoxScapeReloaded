...
public class a implements Interface25 {
    ...
    native void ha(long l, Toolkit class_ra, int i, int i_14_);

    Model method276(h var_h, byte i, int i_15_, boolean bool) {
    ...
    void method278(Toolkit class_ra, int[] is, int[] is_19_, int[] is_20_, short[] is_21_, int i) {
	b(((a) this).nativeid, class_ra, is, is_19_, is_20_, is_21_, i);
    }

    native void b(long l, Toolkit class_ra, int[] is, int[] is_22_, int[] is_23_, short[] is_24_, int i);

    native void P(long l, long l_25_, long l_26_, int i, int i_27_, int i_28_, boolean bool);

    void method279(Model class387, Class222 class222, int[] is, int i) {
    ...
    void method280(Model class387, int[] is, Class222 class222) {
	((a) this).aClass233_6673.method2145(class222);
    ...
    void method281(Ground class_xa, int i, int i_31_) {
	v(((a) this).nativeid, ((i) (i) class_xa).nativeid, i, i_31_);
    }

    native void v(long l, long l_32_, int i, int i_33_);

    void method282(Ground class_xa, int i, int i_34_, int i_35_, int i_36_, int i_37_, int i_38_, int i_39_, boolean[][] bools) {
	i(((a) this).nativeid, ((i) (i) class_xa).nativeid, i, i_34_, i_35_, i_36_, i_37_, i_38_, i_39_, bools);
    }

    native void K(long l, Toolkit class_ra, int i, int i_40_, int i_41_, int i_42_, int i_43_, int i_44_, int i_45_);

    native void c(long l, Toolkit class_ra, int i, int i_46_);

    native void m(long l, Toolkit class_ra, int i, int i_47_);

    native void w(long l, Toolkit class_ra, int i, int i_48_);
    ...
    native void ao(long l, Toolkit class_ra, int[] is, int[] is_50_, int[] is_51_, short[] is_52_, int i);

    native void ad(long l, Toolkit class_ra, int[] is, int[] is_53_, int[] is_54_, short[] is_55_, int i);

    native void av(long l, Toolkit class_ra, int[] is, int[] is_56_, int[] is_57_, short[] is_58_, int i);

    native void at(long l, Toolkit class_ra, int[] is, int[] is_59_, int[] is_60_, short[] is_61_, int i);

    native void ah(long l, Toolkit class_ra, int[] is, int[] is_62_, int[] is_63_, short[] is_64_, int i);

    native void bp(long l, long l_65_, int i, int i_66_, int i_67_, int i_68_, int i_69_, int i_70_, int i_71_, boolean[][] bools);

    native void ap(long l, Toolkit class_ra, int i, int i_72_, int i_73_, int i_74_, int i_75_, int i_76_, int i_77_);
    ...
    boolean method284(Model class387, int i, int i_88_, Class222 class222, boolean bool) {
	((a) this).aClass233_6673.method2145(class222);
    ...
    void method285(Model class387, Model class387_93_, int i, int i_94_, int i_95_, boolean bool) {
	P(((a) this).nativeid, ((h) (h) class387).nativeid, ((h) (h) class387_93_).nativeid, i, i_94_, i_95_, bool);
    }

    native void as(long l, Toolkit class_ra, int i, int i_96_, int i_97_, int i_98_, int i_99_, int i_100_, int i_101_);
    ...
    void method286(Toolkit class_ra, int i, int i_108_, int i_109_, int i_110_, int i_111_, int i_112_, int i_113_) {
