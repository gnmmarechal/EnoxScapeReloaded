...
public class Class405 {
	...
	byte[] is = class243.getTextureData((-363169051 * Class380.aClass380_4105.anInt4108), (byte) 105);
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = pb.aBoolean8802 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class152.method1652(Class373.activeToolkit, (long) (443738891 * pb.ticketCycle));
	    if (-257444687 * pb.WINDOW_PANE_ID != -1)
		Class443.method5884(-257444687 * pb.WINDOW_PANE_ID, 186134073);
	    for (int i_5_ = 0; i_5_ < -112139815 * pb.anInt8686; i_5_++) {
		pb.aBooleanArray8901[i_5_] = pb.aBooleanArray8900[i_5_];
		pb.aBooleanArray8900[i_5_] = false;
	    }
	    pb.anInt8832 = -1390800553 * pb.ticketCycle;
	    if (-1 != pb.WINDOW_PANE_ID * -257444687) {
		pb.anInt8686 = 0;
		Class104.method1104(-710389872);
	    }
	    Class373.activeToolkit.L();
	    Class463.method6013(Class373.activeToolkit, (byte) 74);
	    int i_6_ = Class298_Sub17_Sub4.method2926(-185727929);
	    if (-1 == i_6_)
		i_6_ = pb.anInt8937 * -1808468501;
	    if (-1 == i_6_)
		i_6_ = pb.anInt8831 * 1203044105;
	...
	try {
	    ((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1] = (Class316.aClass362_3318.method4307((((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1]), 245040087).anInt4006) * 1327747841;
	}
	catch (RuntimeException runtimeexception) {
