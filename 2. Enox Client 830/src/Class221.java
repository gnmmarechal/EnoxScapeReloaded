...
public class Class221 implements Interface24 {
	...
	try {
		...
		return 100;
	    int i_0_ = BillBoardConfig.aClass305_770.method3744(((Class221) this).aString6661, 637615919);
	    if (i_0_ >= 0 && i_0_ <= 100)
		return i_0_;
	...
	if (((Class221) this).aBoolean6662)
	    return 100;
	int i = BillBoardConfig.aClass305_770.method3744(((Class221) this).aString6661, 963304472);
	if (i >= 0 && i <= 100)
	    return i;
	((Class221) this).aBoolean6662 = true;
	return 100;
	...
	try {
	    ...
	    if (pb.playerRights * 1806357379 != 0 || ((!pb.aBoolean8811 || pb.aBoolean8812) && !pb.aBoolean8802)) {
