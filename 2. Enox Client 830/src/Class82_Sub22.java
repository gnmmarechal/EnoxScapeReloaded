...
public class Class82_Sub22 extends Class82 {
    ...
    boolean method939() {
	GraphicDefinition class398 = (Class158_Sub1.aClass389_8568.getGraphicDefinition(1632084697 * ((Class82_Sub22) this).anInt6908, -1743709088));
	boolean bool = class398.loaded((byte) 119);
	AnimationDefinition class391 = Class501.aClass395_6122.getAnimationDefinition(class398.animation * 1505778629, (byte) -66);
	bool &= class391.ready(1883883362);
	return bool;
    }
	...
	try {
	    GraphicDefinition class398 = Class158_Sub1.aClass389_8568.getGraphicDefinition((1632084697 * ((Class82_Sub22) this).anInt6908), -1845152840);
	    boolean bool = class398.loaded((byte) 118);
	    AnimationDefinition class391 = Class501.aClass395_6122.getAnimationDefinition(class398.animation * 1505778629, (byte) -64);
	    bool &= class391.ready(1376129821);
	    return bool;
	}
	...
	Class365_Sub1_Sub1_Sub1 class365_sub1_sub1_sub1 = (new Class365_Sub1_Sub1_Sub1(pb.aClass283_8716.method2675(-1611682495), ((Class82_Sub22) this).anInt6908 * 1632084697, i_4_, i_4_, i, i_3_, ((Class82_Sub22) this).anInt6916 * 266943569 << 2, pb.ticketCycle * 443738891, (929559909 * ((Class82_Sub22) this).anInt6904 + pb.ticketCycle * 443738891), -1300008271 * ((Class82_Sub22) this).anInt6915, i_7_, ((Class82_Sub22) this).anInt6905 * -153670819 + 1, 1 + -1629854861 * ((Class82_Sub22) this).anInt6909, ((Class82_Sub22) this).anInt6912 * 172590773 << 2, false, 0));
	class365_sub1_sub1_sub1.method4405(i_5_, i_6_, 172590773 * ((Class82_Sub22) this).anInt6912 << 2, (pb.ticketCycle * 443738891 + 929559909 * ((Class82_Sub22) this).anInt6904), -414343918);
	...
	class365_sub1_sub1_sub1.method4405(i_10_, i_11_, 172590773 * ((Class82_Sub22) this).anInt6912 << 2, (pb.ticketCycle * 443738891 + 929559909 * ((Class82_Sub22) this).anInt6904), 1238518641);
	pb.aClass453_8824.add(new Class298_Sub37_Sub2(class365_sub1_sub1_sub1));
    }
	...
	try {
	    ...
	    class365_sub1_sub1_sub1.method4405(i_16_, i_17_, 172590773 * ((Class82_Sub22) this).anInt6912 << 2, (pb.ticketCycle * 443738891 + 929559909 * ((Class82_Sub22) this).anInt6904), 1057769456);
	    pb.aClass453_8824.add(new Class298_Sub37_Sub2(class365_sub1_sub1_sub1));
	}
	catch (RuntimeException runtimeexception) {
