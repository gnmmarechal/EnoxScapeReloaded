...
public class Class339 {
	...
	try {
		...
		return class352;
	    byte[] is;
	    synchronized (((Class339) this).idx2) {
		is = (((Class339) this).idx2.getFile(-1006924897 * ConfigEntry.aClass120_1441.anInt1460, i));
	    }
	    ...
	    synchronized (((Class339) this).aClass348_3633) {
		((Class339) this).aClass348_3633.put(class352, (long) i);
	    }
	    return class352;
	}
	...
	((Class339) this).idx2 = class243;
	((Class339) this).aClass243_3638 = class243_4_;
	((Class339) this).idx2.getFileCountForArchive((-1006924897 * (ConfigEntry.aClass120_1441.anInt1460)), -1187243048);
    }
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class165.aClass319_6366.method3883((byte) -67);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class82_Sub14.anInt6875 * 1196508279 + Class301.anInt3245;
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = 1882038855 * Class376.anInt4090 + Class301.anInt3238;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).aClass177_5243 = new Class177();
	    ((Class403) class403).aClass177_5243.anInt1787 = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]) * -1496580327;
	    ((Class403) class403).aClass177_5243.aClass298_Sub37_Sub14_1788 = Class447.aClass469_5618.method6045((-2034569943 * (((Class403) class403).aClass177_5243.anInt1787)), (short) -31803);
	    ((Class403) class403).aClass177_5243.anIntArray1789 = new int[((Class403) class403).aClass177_5243.aClass298_Sub37_Sub14_1788.method3461((short) -407)];
	}
	catch (RuntimeException runtimeexception) {
