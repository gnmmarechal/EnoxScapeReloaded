...
public class Class464 {
	...
	anIntArray5694[1] = ((ItemDefinitions) class468).maleEquipModelId2 * 34210967;
	anIntArray5694[2] = ((ItemDefinitions) class468).maleEquipModelId3 * 1313278521;
	anIntArray5695[0] = 1585491093 * class468.femaleEquipModelId1;
	anIntArray5695[1] = ((ItemDefinitions) class468).femaleEquipModelId2 * -1284247975;
	anIntArray5695[2] = ((ItemDefinitions) class468).femaleEquipModelId3 * -1767718263;
	...
	if (((ItemDefinitions) class468).modifiedModelColors != null) {
	    aShortArray5698 = new short[((ItemDefinitions) class468).modifiedModelColors.length];
	    System.arraycopy(((ItemDefinitions) class468).modifiedModelColors, 0, aShortArray5698, 0, aShortArray5698.length);
	}
	if (null != ((ItemDefinitions) class468).modifiedTextureColors) {
	    aShortArray5699 = new short[((ItemDefinitions) class468).modifiedTextureColors.length];
	    System.arraycopy(((ItemDefinitions) class468).modifiedTextureColors, 0, aShortArray5699, 0, aShortArray5699.length);
	}
    }
	...
	try {
	    int i_0_ = (((Class403) class403).anIntArray5257[((Class403) class403).anInt5259 * 1883543357]);
	    ClientScriptsExecutor.aStringArray4126[i_0_] = (String) (((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 -= 969361751) * -203050393)]);
