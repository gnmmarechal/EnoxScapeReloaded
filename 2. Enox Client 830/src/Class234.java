...
public class Class234 {
    ...
    static Sprite[] aClass57Array2598;
	...
	try {
		...
		i = i != -1 ? i : pb.anInt8937 * -1808468501;
	...
	try {
	    ...
	    MagnetConfig.method782(class105, class119, class403, -1168214437);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = pb.GRAND_EXCHANGE_SLOTS[i_11_].anInt2768 * 535421071;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    int i_12_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
	    int i_13_ = (((Class403) class403).anIntArray5244[1 + 681479919 * ((Class403) class403).anInt5239]);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_12_ % i_13_;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class74.method830((((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]), -1, -1, false, 752651181);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7553.method5726(-2145285486);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		PathStrategy.method4093((pb.aClass283_8716.method2675(-1611682495).aClass326ArrayArrayArray3518), 234916861);
		if ((pb.aClass283_8716.method2675(-1611682495).aClass326ArrayArrayArray3520) != null)
		    PathStrategy.method4093((pb.aClass283_8716.method2675(-1611682495).aClass326ArrayArrayArray3520), -1747837187);
