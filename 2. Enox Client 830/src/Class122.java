...
public class Class122 {
	...
	try {
	    ...
	    if (i_18_ != -1) {
		Object object = null;
		Sprite class57 = (Sprite) pb.aClass348_8697.get((long) i_18_);
		if (null == class57) {
		    IndexedImage[] class89s = IndexedImage.method993(Class158.idx8, i_18_, 0);
		    if (null == class89s)
			return;
		    class57 = Class373.activeToolkit.method5125(class89s[0], true);
		    pb.aClass348_8697.put(class57, (long) i_18_);
		}
		Class217 class217 = class365_sub1_sub1_sub2.method4337().aClass217_2599;
		SunDefinition.method1400(class365_sub1_sub1_sub2.plane, (int) class217.aFloat2451, (int) class217.aFloat2454, class365_sub1_sub1_sub2.getSize() * 256, 0, false, 2131920659);
		int i_19_ = (int) ((float) i_11_ + pb.aFloatArray8891[0] - 18.0F);
		int i_20_ = (int) ((float) i_12_ + pb.aFloatArray8891[1] - 16.0F - 54.0F);
		i_19_ += i / 4 * 18;
		i_20_ += 18 * (i % 4);
		class57.method645(i_19_, i_20_);
		if (class365_sub1_sub1_sub2 == class365_sub1_sub1_sub2_10_)
		    Class373.activeToolkit.method5014(i_19_ - 1, i_20_ - 1, 18, 18, -256, -769094548);
		...
		pb.aClass442_8781.method5870(class302_sub5, -69122600);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub10_7548.method5661((byte) 92);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    int i_21_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]);
	    int i_22_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 1]);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_21_ < i_22_ ? i_21_ : i_22_;
	}
	catch (RuntimeException runtimeexception) {
