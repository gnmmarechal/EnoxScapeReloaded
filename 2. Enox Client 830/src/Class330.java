...
public class Class330 implements Runnable {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class287.myPlayer.anInt10206 * 696798311);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).aLongArray5235[(((Class403) class403).anIntArray5257[((Class403) class403).anInt5259 * 1883543357])] = (((Class403) class403).aLongArray5251[((((Class403) class403).anInt5245 -= -682569305) * 1685767703)]);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ParticleDefinitions.aClass348_1815.method4187();
	}
	catch (RuntimeException runtimeexception) {
