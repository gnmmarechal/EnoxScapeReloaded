...
public class Class131 {
	...
	public SunDefinition method1467(int i, int i_0_) {
		try {
			SunDefinition class125;
			synchronized (((Class131) this).aClass348_1496) {
				class125 = (SunDefinition) ((Class131) this).aClass348_1496.get((long) i);
			}
			if (class125 != null)
				return class125;
			byte[] is;
			synchronized (((Class131) this).aClass243_1497) {
				is = (((Class131) this).aClass243_1497.getFile(ConfigEntry.aClass120_1417.anInt1460 * -1006924897, i));
			}
			class125 = new SunDefinition();
			if (is != null)
	...
	public Class131(Class411 class411, Class429 class429, JS5 class243) {
		...
		((Class131) this).aClass243_1497.getFileCountForArchive((ConfigEntry.aClass120_1417.anInt1460) * -1006924897,
				-1961959383);
	}
		...
		try {
			if (class105 != null) {
				if (class105.anInt1154 * -1309843523 != -1) {
					IComponentDefinition class105_2_ = class119.method1297(1573706803 * class105.anInt1160,
							(short) 26063);
					if (class105_2_ != null) {
						if (class105_2_.aClass105Array1293 == class105_2_.aClass105Array1292) {
							...
							Class425.arrayCopy(class105_2_.aClass105Array1292, 0, class105_2_.aClass105Array1293, 0,
									(-1309843523 * class105.anInt1154));
							Class425.arrayCopy(class105_2_.aClass105Array1292, 1 + class105.anInt1154 * -1309843523,
									class105_2_.aClass105Array1293, -1309843523 * class105.anInt1154,
									(class105_2_.aClass105Array1292.length - class105.anInt1154 * -1309843523 - 1));
						} else {
							int i_3_ = 0;
	...
	static final void method1471(Class403 class403, int i) {
		try {
			...
			int i_5_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]);
			int i_6_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 1]);
			int i_7_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 2]);
			int i_8_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 3]);
			WorldTile class341 = pb.aClass283_8716.method2628(681479919);
			BillBoardDefinitions.method1822(((i_5_ >> 14 & 0x3fff) - class341.x * -1760580017),
					((i_5_ & 0x3fff) - 283514611 * class341.y), i_6_ << 2, i_7_, i_8_, (byte) 72);
		} catch (RuntimeException runtimeexception) {
