...
public class Class107 {
	...
	try {
	    ...
	    Interface class298_sub51 = ((Interface) pb.aClass437_8841.get((long) i_0_));
	...
	try {
	    ...
	    String string_2_ = ((String) (((Class403) class403).anObjectArray5240[1 + -203050393 * ((Class403) class403).anInt5241]));
	    ((Class403) class403).anInt5239 -= -783761378;
	    int i_3_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
	    int i_4_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 1]);
	    if (null == string_2_)
		string_2_ = "";
	...
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub25_7569, (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]), -2044130238);
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Class403) class403).aClass162_5252.membersRanks[i_6_];
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (1596783995 * pb.anInt8724 != 2 && 1596783995 * pb.anInt8724 != 3) {
		if (!bool) {
		...
		pb.anInt8724 = 1973597030;
		Class298_Sub37.anIntArrayArray7407 = null;
		Class128_Sub1.aClass298_Sub53_8555 = null;
		pb.aBoolean8725 = false;
		Class228.method2117(1960223809);
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2011, pb.aClass25_8711.aClass449_330, (byte) 30);
		class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(bool ? 1 : 0);
		pb.aClass25_8711.method390(class298_sub36, (byte) -61);
	    }
	}
	catch (RuntimeException runtimeexception) {
