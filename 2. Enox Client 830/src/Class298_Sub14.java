...
public class Class298_Sub14 extends Class298 {
	...
	try {
	    int i_4_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 - 3]);
	    int i_5_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 2]);
	    int i_6_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1]);
	    ((Class403) class403).anInt5239 -= -1175642067;
	    if (i_4_ > ((Class403) class403).anIntArray5236[i_5_])
		throw new RuntimeException();
	    if (i_4_ > ((Class403) class403).anIntArray5236[i_6_])
		throw new RuntimeException();
	    if (i_5_ == i_6_)
		throw new RuntimeException();
	    Class82_Sub17.method920((((Class403) class403).anIntArrayArray5238[i_5_]), (((Class403) class403).anIntArrayArray5238[i_6_]), 0, i_4_ - 1, -8746626);
	}
	catch (RuntimeException runtimeexception) {
