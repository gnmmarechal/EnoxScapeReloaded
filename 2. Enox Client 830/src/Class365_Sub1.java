...
public abstract class Class365_Sub1 extends Class365 {
    ...
    abstract boolean method4350(Toolkit class_ra, int i, int i_0_, byte i_1_);

    abstract boolean method4351();

    abstract boolean method4352(Toolkit class_ra, int i, int i_2_);

    abstract boolean method4353();

    abstract int method4354(Class298_Sub10[] class298_sub10s, int i);

    abstract void method4355(Toolkit class_ra, Class365_Sub1 class365_sub1_3_, int i, int i_4_, int i_5_, boolean bool, int i_6_);
    ...
    abstract void method4357(Toolkit class_ra, int i);

    public abstract Class334 method4358(Toolkit class_ra, byte i);

    abstract boolean method4359(Toolkit class_ra);
    ...
    abstract boolean method4364(Toolkit class_ra, byte i);

    abstract boolean method4365();

    abstract boolean method4366(int i);

    public abstract Class334 method4367(Toolkit class_ra);

    public abstract Class334 method4368(Toolkit class_ra);

    abstract boolean method4369();

    abstract Class335 method4370(Toolkit class_ra);

    abstract void method4371(Toolkit class_ra);

    abstract boolean method4372(Toolkit class_ra, int i, int i_9_);

    abstract void method4373(Toolkit class_ra);

    abstract boolean method4374();

    abstract void method4375(Toolkit class_ra, Class365_Sub1 class365_sub1_10_, int i, int i_11_, int i_12_, boolean bool);
    ...
    abstract boolean method4385(Toolkit class_ra, int i, int i_13_);

    abstract boolean method4386();

    abstract boolean method4387();

    abstract void method4388(Toolkit class_ra, Class365_Sub1 class365_sub1_14_, int i, int i_15_, int i_16_, boolean bool);

    abstract boolean method4389(Toolkit class_ra);

    abstract int method4390(Class298_Sub10[] class298_sub10s);

    abstract boolean method4391(Toolkit class_ra);
    ...
    abstract boolean method4393(Toolkit class_ra);

    abstract Class335 method4394(Toolkit class_ra, int i);
	...
	try {
	    int i_23_ = ((((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]) - 1);
	    if (i_23_ < 0 || i_23_ > 9)
		((Class403) class403).anInt5241 -= 969361751;
	    else
		class105.method1115(i_23_, (String) (((Class403) class403).anObjectArray5240[(((Class403) class403).anInt5241 -= 969361751) * -203050393]), 1110385787);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		pb.aClass283_8716.method2667(1601177628);
