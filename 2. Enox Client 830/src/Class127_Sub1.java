...
public class Class127_Sub1 extends Class127 {
    Sprite aClass57_8569;
    Sprite aClass57_8570;
    Sprite aClass57_8571;
    Sprite aClass57_8572;
    Sprite aClass57_8573;
    Sprite aClass57_8574;
	...
	if (!((Class127_Sub1) this).aClass243_6372.fileLoaded(class128_sub3.anInt8563 * -876812375, -457216440))
	    return false;
	if (!((Class127_Sub1) this).aClass243_6372.fileLoaded(1551490597 * class128_sub3.anInt8562, -457216440))
	    return false;
	if (!((Class127_Sub1) this).aClass243_6372.fileLoaded(578265259 * class128_sub3.anInt8566, -457216440))
	    return false;
	if (!((Class127_Sub1) this).aClass243_6372.fileLoaded(class128_sub3.anInt8564 * 861652881, -457216440))
	    return false;
	if (!((Class127_Sub1) this).aClass243_6372.fileLoaded(((class128_sub3.anInt8565) * -1259370861), -457216440))
	    return false;
	if (!((Class127_Sub1) this).aClass243_6372.fileLoaded(class128_sub3.anInt8561 * 356687159, -457216440))
	    return false;
	return true;
    }
	...
	if (bool) {
	    int[] is = new int[4];
	    Class373.activeToolkit.qa(is);
	    Class373.activeToolkit.r(i, i_0_, (((Class127_Sub1) this).aClass128_6375.anInt6326) * -944287579 + i, (((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793 + i_0_);
	    ...
	    Class373.activeToolkit.r(i, i_0_, (-944287579 * (((Class127_Sub1) this).aClass128_6375.anInt6326) + i), i_0_ + ((Class127_Sub1) this).aClass57_8573.method626());
	    ...
	    Class373.activeToolkit.r(i, (((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793 + i_0_ - i_5_, i + -944287579 * (((Class127_Sub1) this).aClass128_6375.anInt6326), i_0_ + ((((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793));
	    ...
	    Class373.activeToolkit.r(is[0], is[1], is[2], is[3]);
	}
    }
	...
	try {
		...
		int[] is = new int[4];
		Class373.activeToolkit.qa(is);
		Class373.activeToolkit.r(i, i_6_, (((Class127_Sub1) this).aClass128_6375.anInt6326) * -944287579 + i, (((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793 + i_6_);
		...
		Class373.activeToolkit.r(i, i_6_, -944287579 * (((Class127_Sub1) this).aClass128_6375.anInt6326) + i, i_6_ + ((Class127_Sub1) this).aClass57_8573.method626());
		...
		Class373.activeToolkit.r(i, (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793) + i_6_ - i_12_, i + (-944287579 * ((Class127_Sub1) this).aClass128_6375.anInt6326), i_6_ + (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793));
	...
	int[] is = new int[4];
	Class373.activeToolkit.qa(is);
	Class373.activeToolkit.r(i_14_, i_16_, i_14_ + i_20_, i_17_);
	method1424(i_14_, i_16_, i_18_, i_19_, 1789961003);
	Class373.activeToolkit.r(i_20_ + i_14_, i_16_, i_15_, i_17_);
	...
	if (bool) {
	    int[] is = new int[4];
	    Class373.activeToolkit.qa(is);
	    Class373.activeToolkit.r(i, i_25_, (((Class127_Sub1) this).aClass128_6375.anInt6326) * -944287579 + i, (((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793 + i_25_);
	    ...
	    Class373.activeToolkit.r(i, i_25_, (-944287579 * (((Class127_Sub1) this).aClass128_6375.anInt6326) + i), i_25_ + ((Class127_Sub1) this).aClass57_8573.method626());
	    ...
	    Class373.activeToolkit.r(i, (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793 + i_25_ - i_30_), i + (-944287579 * ((Class127_Sub1) this).aClass128_6375.anInt6326), i_25_ + (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793));
	...
	try {
	    ...
	    int[] is = new int[4];
	    Class373.activeToolkit.qa(is);
	    Class373.activeToolkit.r(i_33_, i_35_, i_33_ + i_39_, i_36_);
	    method1424(i_33_, i_35_, i_37_, i_38_, -1231781770);
	    Class373.activeToolkit.r(i_39_ + i_33_, i_35_, i_34_, i_36_);
	...
	int[] is = new int[4];
	Class373.activeToolkit.qa(is);
	Class373.activeToolkit.r(i_41_, i_43_, i_41_ + i_47_, i_44_);
	method1424(i_41_, i_43_, i_45_, i_46_, -672953345);
	Class373.activeToolkit.r(i_47_ + i_41_, i_43_, i_42_, i_44_);
	...
	int[] is = new int[4];
	Class373.activeToolkit.qa(is);
	Class373.activeToolkit.r(i_49_, i_51_, i_49_ + i_55_, i_52_);
	method1424(i_49_, i_51_, i_53_, i_54_, 2053935529);
	Class373.activeToolkit.r(i_55_ + i_49_, i_51_, i_50_, i_52_);
	...
	int[] is = new int[4];
	Class373.activeToolkit.qa(is);
	Class373.activeToolkit.r(i_57_, i_59_, i_57_ + i_63_, i_60_);
	method1424(i_57_, i_59_, i_61_, i_62_, 1166821857);
	Class373.activeToolkit.r(i_63_ + i_57_, i_59_, i_58_, i_60_);
	...
	if (bool) {
	    int[] is = new int[4];
	    Class373.activeToolkit.qa(is);
	    Class373.activeToolkit.r(i, i_64_, (((Class127_Sub1) this).aClass128_6375.anInt6326) * -944287579 + i, (((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793 + i_64_);
	    ...
	    Class373.activeToolkit.r(i, i_64_, (-944287579 * (((Class127_Sub1) this).aClass128_6375.anInt6326) + i), i_64_ + ((Class127_Sub1) this).aClass57_8573.method626());
	    ...
	    Class373.activeToolkit.r(i, (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793 + i_64_ - i_69_), i + (-944287579 * ((Class127_Sub1) this).aClass128_6375.anInt6326), i_64_ + (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793));
    ...
    static final void method1428(Class403 class403, byte i) {
	try {
	    ((Class403) class403).anInt5239 -= -783761378;
	    int i_72_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]);
	    int i_73_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 1]);
