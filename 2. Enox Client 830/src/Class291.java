...
public abstract class Class291
	...
	final void method2752(String string, String string_5_, int i, int i_6_,
		...
		try {
			...
			try {
				Class83.aString765 = ClientSettings.HOME_SPOOF;
			...
			try {
				if (Class82_Sub8.aString6856.startsWith("win")) {
					if (null == Class83.aString765)
						Class83.aString765 = ClientSettings.USERPROFILE_SPOOF;
	...
	File method2783(String string, String string_27_, int i, short i_28_) {
		try {
			...
			if (string_30_ == null) { // This must be what creates EnoxScapecache
				//System.out.println(Class83.aString765); --> This is set to %USERPROFILE%
