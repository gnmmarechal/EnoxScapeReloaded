...
public class Class219 implements Runnable {
	...
	try {
		...
		synchronized (this) {
			...
			if (((Class219) this).anInterface12_2466 instanceof Class224)
			    ...
			    if (Class373.activeToolkit != null && null != ((Class219) this).anInterface12_2467 && ((Class219) this).anInterface12_2467.method151(73548607) != 0 && ((6015775630087136145L * ((Class219) this).aLong2468) >= l_1_ - (long) (((Class219) this).anInterface12_2467.method151(-462627527)))) {
				...
				Sprite class57 = (Class373.activeToolkit.method5046(-2110394505 * Class462.anInt5683, (-1111710645 * Class298_Sub40_Sub9.anInt9716), true, -34894995));
				Class52_Sub1 class52_sub1 = Class373.activeToolkit.method5094();
				class52_sub1.method563(0, class57.method627());
				Class373.activeToolkit.method5143(class52_sub1, (byte) 28);
				((Class219) this).anInterface12_2467.method160(true, 2128455067);
				Class373.activeToolkit.method5005(class52_sub1, (byte) 8);
				class57.method631(0, 0, 0, i_2_, 1);
				Class373.activeToolkit.method5143(class52_sub1, (byte) -59);
				Class373.activeToolkit.ba(1, 0);
				((Class219) this).anInterface12_2466.method160(true, 2141475636);
				Class373.activeToolkit.method5005(class52_sub1, (byte) -56);
				...
				((Class219) this).anInterface12_2466.method160((((Class219) this).aBoolean2473 || (Class373.activeToolkit != null && Class373.activeToolkit.method5074())), 2145176958);
			    }
			    try {
				if (null != Class373.activeToolkit && !(((Class219) this).anInterface12_2466 instanceof Class224))
				    Class373.activeToolkit.method4988((byte) 101);
			    }
			...
			if (null != Class373.activeToolkit && !(((Class219) this).anInterface12_2466 instanceof Class224) && ((((Class219) this).aClass227_2465.anInt2548 * -861845079) < (-861845079 * Class227.aClass227_2545.anInt2548)))
    ...
    public static Model method2044(Toolkit class_ra, int i, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_) {
	try {
	    long l = (long) i_8_;
	    Model class387 = (Model) Class19.aClass348_264.get(l);
	    int i_10_ = 2055;
	    if (null == class387) {
		ModelDecoder class64 = ModelDecoder.getModel(WorldTile.idx7, i_8_, 0);
		if (class64 == null)
		    return null;
		if (class64.version < 13)
		    class64.method755(2);
		class387 = class_ra.createModel(class64, i_10_, -203714349 * Class481.anInt6035, 64, 768);
	...
	try {
	    ...
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = class105.aString1212;
	}
	catch (RuntimeException runtimeexception) {
