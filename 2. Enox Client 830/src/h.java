...
public class h extends Model implements Interface25 {
	long nativeid;
	ja aJa6674;
	ba aBa6675;
	MagnetConfig[] aClass68Array6676;
	EmitterConfig[] aClass85Array6677;
	...
	public void method4786(Class222 class222) {
		...
		if (((h) this).aClass85Array6677 != null) {
			for (int i_0_ = 0; i_0_ < ((h) this).aClass85Array6677.length; i_0_++) {
				EmitterConfig class85 = ((h) this).aClass85Array6677[i_0_];
		...
		if (((h) this).aClass68Array6676 != null) {
			for (int i_1_ = 0; i_1_ < ((h) this).aClass68Array6676.length; i_1_++) {
				MagnetConfig class68 = ((h) this).aClass68Array6676[i_1_];
				MagnetConfig class68_2_ = class68;
	...
	public Model method4755(byte i, int i_3_, boolean bool) {
	...
	public void method4745(Model class387, int i, int i_7_, int i_8_, boolean bool) {
	...
	public native void ia(int x, int i_9_, int i_10_);

	public native void wa();

	public native void by(int i);

	public native void pa(int i, int i_11_, Ground class_xa, Ground class_xa_12_, int i_13_, int i_14_, int i_15_);
	...
	public native void bs(int i, int i_25_, Ground class_xa, Ground class_xa_26_, int i_27_, int i_28_, int i_29_);
	...
	public void method4779(Model class387, int i, int i_38_, int i_39_, boolean bool) {
	...
	public native Shadow ct(Shadow class_na);
	...
	public native void X(short srcColour, short i_43_);
	...
	native void U(ja var_ja, ba var_ba, int i, int i_52_, int[] is, int[] is_53_, int[] is_54_, int[] is_55_,
			...
			byte[] is_63_, short[] textureCoords, short[] is_65_, short[] is_66_, int[] is_67_, byte i_68_,
			short[] is_69_, int i_70_, byte[] is_71_, short[] is_72_, short[] is_73_, short[] is_74_, int[] is_75_,
			int[] is_76_, int[] is_77_, byte[] is_78_, byte[] is_79_, int[] is_80_, int[] is_81_, int[] is_82_,
			int[] is_83_, int i_84_, int i_85_, int i_86_, int i_87_, int i_88_, int i_89_, int[] is_90_);

	public Model method4748(byte i, int i_91_, boolean bool) {
		return ((h) this).aJa6674.method5571().method276(this, i, i_91_, bool);
	}

	public Model method4770(byte i, int i_92_, boolean bool) {
		return ((h) this).aJa6674.method5571().method276(this, i, i_92_, bool);
	}

	public Model method4749(byte i, int i_93_, boolean bool) {
	...
	public native void W(short srcTexture, short i_99_);
	...
	public native void bg(int i, int i_107_, Ground class_xa, Ground class_xa_108_, int i_109_, int i_110_, int i_111_);

	public native int RA();

	public native void bp(int i, int i_112_, Ground class_xa, Ground class_xa_113_, int i_114_, int i_115_, int i_116_);
	...
	public void method4747(Model class387, int i, int i_117_, int i_118_, boolean bool) {
	...
	h(ja var_ja, ba var_ba, ModelDecoder class64, int i, int i_135_, int i_136_, int i_137_) {
		((h) this).aJa6674 = var_ja;
		((h) this).aBa6675 = var_ba;
		((h) this).aClass85Array6677 = class64.emitterConfigs;
		((h) this).aClass68Array6676 = class64.magnetConfigs;
		int i_138_ = (class64.emitterConfigs == null ? 0 : class64.emitterConfigs.length);
		int i_139_ = (class64.magnetConfigs == null ? 0 : class64.magnetConfigs.length);
		int i_140_ = 0;
		int[] is = new int[i_138_ * 3 + i_139_];
		for (int i_141_ = 0; i_141_ < i_138_; i_141_++) {
			is[i_140_++] = ((h) this).aClass85Array6677[i_141_].faceX * -710317103;
			is[i_140_++] = ((h) this).aClass85Array6677[i_141_].faceY * 1705862021;
			is[i_140_++] = ((h) this).aClass85Array6677[i_141_].faceZ * 1636170731;
		}
		for (int i_142_ = 0; i_142_ < i_139_; i_142_++)
			is[i_140_++] = ((h) this).aClass68Array6676[i_142_].point * -180596249;
		...
		for (int i_146_ = 0; i_146_ < i_143_; i_146_++) {
			BillBoardConfig class84 = class64.billBoardConfigs[i_146_];
			BillBoardDefinitions class173 = Class298.loadBillBoard(class84.type * 1834782277, -67897652);
			is_144_[i_145_++] = class84.face * 1512514121;
			is_144_[i_145_++] = class173.position * 1951943953;
			is_144_[i_145_++] = class173.sv_position * 893949695;
			is_144_[i_145_++] = class173.textureId * 39181267;
		...
		for (int i_147_ = 0; i_147_ < i_143_; i_147_++) {
			BillBoardConfig class84 = class64.billBoardConfigs[i_147_];
			is_144_[i_145_++] = class84.priority * -1606786303;
		}
		
		U(((h) this).aJa6674,
				((h) this).aBa6675,
				class64.vertexCount,
				class64.maxVertexUsed,
				class64.vertexX,
				class64.vertexY, class64.vertexZ, class64.vertexBones, class64.aShortArray620, class64.faceCount,
				class64.faceA, class64.faceB, class64.faceC, class64.faceRenderTypes, class64.facePriorities,
				class64.faceAlpha, class64.faceTextureIndexes, class64.faceColors, class64.faceTextures,
				class64.faceBones, class64.priority, class64.aShortArray615, class64.texturedFaceCount,
				class64.textureRenderTypes, class64.textureTriangleX, class64.textureTriangleY,
				class64.textureTriangleZ, class64.textureScaleX, class64.textureScaleY, class64.textureScaleZ,
				class64.textureRotationY, class64.textureUVDirections, class64.particleLifespanZ,
				class64.texturePrimaryColor, class64.textureSecondaryColor, is, i_138_, i_139_, i, i_135_, i_136_,
				i_137_, is_144_);
	}
	...
	public native Shadow cc(Shadow class_na);
	...
	public native void oa(int x, int i_161_, int i_162_);
	...
	public native Shadow ga(Shadow class_na);
	...
	public void method4751(Class222 class222) {
		...
		if (((h) this).aClass85Array6677 != null) {
			for (int i_175_ = 0; i_175_ < ((h) this).aClass85Array6677.length; i_175_++) {
				EmitterConfig class85 = ((h) this).aClass85Array6677[i_175_];
				class85.anInt777 = ja.anIntArray6681[i++] * -1879868075;
				class85.anInt783 = ja.anIntArray6681[i++] * -2041556771;
				class85.anInt779 = ja.anIntArray6681[i++] * -1434499227;
				class85.anInt772 = ja.anIntArray6681[i++] * 1070341177;
		...
		if (((h) this).aClass68Array6676 != null) {
			for (int i_176_ = 0; i_176_ < ((h) this).aClass68Array6676.length; i_176_++) {
				MagnetConfig class68 = ((h) this).aClass68Array6676[i_176_];
				MagnetConfig class68_177_ = class68;
				if (class68.aClass68_672 != null)
	...
	public void method4782(Class222 class222) {
		...
		if (((h) this).aClass85Array6677 != null) {
			for (int i_178_ = 0; i_178_ < ((h) this).aClass85Array6677.length; i_178_++) {
				EmitterConfig class85 = ((h) this).aClass85Array6677[i_178_];
				class85.anInt777 = ja.anIntArray6681[i++] * -1879868075;
				class85.anInt783 = ja.anIntArray6681[i++] * -2041556771;
				class85.anInt779 = ja.anIntArray6681[i++] * -1434499227;
				class85.anInt772 = ja.anIntArray6681[i++] * 1070341177;
		...
		if (((h) this).aClass68Array6676 != null) {
			for (int i_179_ = 0; i_179_ < ((h) this).aClass68Array6676.length; i_179_++) {
				MagnetConfig class68 = ((h) this).aClass68Array6676[i_179_];
				MagnetConfig class68_180_ = class68;
				if (class68.aClass68_672 != null)
	...
	public void method4783(Class222 class222) {
		...
		if (((h) this).aClass85Array6677 != null) {
			for (int i_181_ = 0; i_181_ < ((h) this).aClass85Array6677.length; i_181_++) {
				EmitterConfig class85 = ((h) this).aClass85Array6677[i_181_];
				class85.anInt777 = ja.anIntArray6681[i++] * -1879868075;
				class85.anInt783 = ja.anIntArray6681[i++] * -2041556771;
				class85.anInt779 = ja.anIntArray6681[i++] * -1434499227;
				class85.anInt772 = ja.anIntArray6681[i++] * 1070341177;
		...
		if (((h) this).aClass68Array6676 != null) {
			for (int i_182_ = 0; i_182_ < ((h) this).aClass68Array6676.length; i_182_++) {
				MagnetConfig class68 = ((h) this).aClass68Array6676[i_182_];
				MagnetConfig class68_183_ = class68;
				if (class68.aClass68_672 != null)
	...
	public Model method4750(byte i, int i_233_, boolean bool) {
