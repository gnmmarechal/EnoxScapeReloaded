...
public abstract class Class52_Sub2 extends Class52 {
	...
	try {
	    ...
	    try {
		class476 = Class86.method962("2", pb.gametype.aString5317, true, -1804643872);
		RsByteBuffer class298_sub53 = new RsByteBuffer(pb.anInt8890 * 260699542 + 3);
		class298_sub53.writeByte(1);
		class298_sub53.writeShort(pb.anInt8890 * -672377959, 16711935);
	    ...
	    pb.aLong8892 = Class122.method1319((byte) 1) * 5732957771927789473L;
	    pb.aBoolean8736 = false;
	}
	catch (RuntimeException runtimeexception) {
