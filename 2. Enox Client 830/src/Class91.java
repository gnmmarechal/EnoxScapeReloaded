...
public class Class91 {
	...
	try {
	    ...
	    int i_1_ = (((Class403) class403).anIntArray5244[1 + 681479919 * ((Class403) class403).anInt5239]);
	...
	try {
	    ...
	    if (pb.aFloat8757 > f2)
		pb.aFloat8757 = f2;
	    for (/**/; pb.aFloat8949 >= 16384.0F; pb.aFloat8949 -= 16384.0F) {
		/* empty */
	    }
	    for (/**/; pb.aFloat8949 < 0.0F; pb.aFloat8949 += 16384.0F) {
		/* empty */
	    }
	    Class244 class244 = pb.aClass283_8716.method2654(1252790814);
	    ...
	    int i_6_ = 0;
	    if (i_3_ > 3 && i_4_ > 3 && i_3_ < pb.aClass283_8716.method2629(-1981660153) - 4 && i_4_ < pb.aClass283_8716.method2630(1904630701) - 4) {
		for (int i_7_ = i_3_ - 4; i_7_ <= 4 + i_3_; i_7_++) {
			...
			if (i_9_ < 3 && class244.method2320(i_7_, i_8_, -316177210))
			    i_9_++;
			int i_10_ = 0;
			byte[][] is = pb.aClass283_8716.method2637(i_9_, 300700071);
			if (null != is)
	    ...
	    if (i_12_ < 262144)
		i_12_ = 262144;
	    if (i_12_ > pb.anInt8764 * -523207831)
		pb.anInt8764 += ((i_12_ - -523207831 * pb.anInt8764) / 24 * 1746126041);
	    else if (i_12_ < -523207831 * pb.anInt8764)
		pb.anInt8764 += 1746126041 * ((i_12_ - pb.anInt8764 * -523207831) / 80);
	}
	catch (RuntimeException runtimeexception) {
