...
public class Class237 implements Interface24 {
	...
	try {
		...
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = class298_sub52.anInt7608 * -530122905;
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = pb.aBoolean8811 && !pb.aBoolean8812 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class298_Sub37_Sub12) class298_sub37_sub12).type = 1274450087 * i_11_;
	    ((Class298_Sub37_Sub12) class298_sub37_sub12).value = 293101103 * i_12_;
	}
	catch (RuntimeException runtimeexception) {
