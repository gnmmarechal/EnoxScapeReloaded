...
final class Class238 implements Interface10 {
	...
	try {
	    return Class373.activeToolkit.method5092(class505, IndexedImage.method982(is), bool);
	}
	...
	try {
	    ...
	    int i_13_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
	    int i_14_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 1]);
	    int i_15_ = (((Class403) class403).anIntArray5244[2 + 681479919 * ((Class403) class403).anInt5239]);
	    Class50.getIComponentDefinitions(i_13_, (byte) 83);
	    Class359.method4291(Class389.aClass119Array4165[i_13_ >>> 16], i_13_ & 0xffff, i_14_, i_15_, ((Class403) class403).aBoolean5261, class403, -782842809);
	}
	catch (RuntimeException runtimeexception) {
