...
public class MouseIcon {
	...
	void method6179(RsByteBuffer class298_sub53, int i, byte i_0_) {
		try {
			if (i == 1) {
				((MouseIcon) this).mouseIconModel = class298_sub53.readBigSmart(1235052657) * -1732871629;
			} else if (2 == i) {
	...
	public synchronized IndexedImage method6181(int i) {
		try {
			IndexedImage class89 = ((IndexedImage) (((Class491) ((MouseIcon) this).aClass491_6082).aClass348_6078
					.get((long) (((MouseIcon) this).mouseIconModel * 1338052859))));
			if (class89 != null)
				return class89;
			class89 = IndexedImage.method987((((Class491) ((MouseIcon) this).aClass491_6082).aClass243_6077),
					1338052859 * ((MouseIcon) this).mouseIconModel, 0);
			if (class89 != null)
				((Class491) ((MouseIcon) this).aClass491_6082).aClass348_6078.put(class89,
						(long) (1338052859 * ((MouseIcon) this).mouseIconModel));
			return class89;
		} catch (RuntimeException runtimeexception) {
			...
			for (int i_8_ = 0; i_8_ < class19s.length; i_8_++) {
				...
				if (class19 != null) {
					if (class19.anInt266 * 958933333 != 2) {
						...
						Class139.method1549((((Class19) class19).anInt259 * -458864019), -1338192389 * class19.anInt260,
								1018128075 * class19.anInt261, (((Class19) class19).anInt262 * 143254950), -549885479);
						if (pb.aFloatArray8891[0] > -1.0F && 443738891 * pb.ticketCycle % 20 < 10) {
							Sprite class57 = (Class128_Sub2.aClass57Array8560[-92466201
									* ((Class19) class19).anInt258]);
							int i_9_ = (int) ((float) i + pb.aFloatArray8891[0] - 12.0F);
							int i_10_ = (int) ((float) i_2_ + pb.aFloatArray8891[1] - 28.0F);
