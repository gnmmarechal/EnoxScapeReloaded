...
public class Class216 implements Interface24 {
	...
	try {
	    i = CS2Replacer.swapScript(i);
	    CS2Replacer.LAST_LOAD = i;
	    ...
	    byte[] is = Class377.idx12.getFile(i, 0);
	...
	try {
		...
		if (class369.anInt4028 * 347977109 == -1) {
		    ...
		    Sprite class57 = ((Sprite) (Class436.aClass348_5500.get((long) (347977109 * class369.anInt4028))));
		    if (class57 == null) {
			IndexedImage class89 = IndexedImage.method987(Class158.idx8, class369.anInt4028 * 347977109, 0);
			if (class89 != null) {
			    class57 = Class373.activeToolkit.method5125(class89, true);
			    Class436.aClass348_5500.put(class57, (long) (class369.anInt4028 * 347977109));
			}
		    }
		    if (null != class57) {
	...
	try {
	    ...
	    pb.aClass283_8716.method2666(-2101576654);
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class287.myPlayer.aClass386_10084.method4719((byte) 0) >> 3;
	}
	catch (RuntimeException runtimeexception) {
