...
public class Class248 implements Runnable {
	...
	try {
	    ...
	    pb.aClass283_8716.method2673((byte) 25);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    String string_1_ = (String) (((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 -= 969361751) * -203050393)]);
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2068, pb.aClass25_8693.aClass449_330, (byte) 47);
	    ...
	    pb.aClass25_8693.method390(class298_sub36, (byte) -123);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class239.method2208((((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]), -292908966);
	}
	catch (RuntimeException runtimeexception) {
    ...
    public static String escapeAnchors(String string, int i) {
	try {
	    ...
	    StringBuilder builder = new StringBuilder(i_2_ + i_3_);
	...
	String str = escapeAnchors(string, i);
	return str;
    }

    static void method2389(Toolkit class_ra, Class_ta class_ta, IComponentDefinition class105, int i, int i_6_, int i_7_, int i_8_, int i_9_, byte i_10_) {
	try {
		...
		if (class352.anIntArray3803 != null) {
			...
			if (-863531439 * Class298_Sub1.anInt7164 == 2)
			    i_12_ = (int) pb.aFloat8949 & 0x3fff;
			else
			    i_12_ = (pb.anInt8801 * 1227356013 + (int) pb.aFloat8949) & 0x3fff;
			int i_13_ = Class220.SINE[i_12_];
			int i_14_ = Class220.COSINE[i_12_];
			if (Class298_Sub1.anInt7164 * -863531439 != 2) {
			    i_13_ = 256 * i_13_ / (pb.anInt8749 * 356727603 + 256);
			    i_14_ = (i_14_ * 256 / (256 + 356727603 * pb.anInt8749));
			}
