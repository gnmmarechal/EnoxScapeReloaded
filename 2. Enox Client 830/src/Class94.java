...
public final class Class94 {
	...
	try {
		...
		if (1762367763 * anInt909 >= 0) {
		    ((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910 = (new NPC(pb.aClass283_8716.method2675(-1611682495), 25));
		    ((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.anInt10064 = ((Class94) this).anInt906 * 302956801;
		    ((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.anInt10075 = pb.ticketCycle * -128551287;
		    ...
		    ((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911 = (new Player(pb.aClass283_8716.method2675(-1611682495), 25));
		    ...
		    ((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911.anInt10075 = -128551287 * pb.ticketCycle;
	...
	try {
		...
		for (int i_8_ = 0; i_8_ < is.length; i_8_++) {
		    int i_9_ = is[i_8_];
		    bool &= Class501.aClass395_6122.getAnimationDefinition(i_9_, (byte) 66).ready(1245807797);
		}
		return bool;
	    }
	    return true;
	...
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub15_7560, (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]) == 1 ? 1 : 0, -1851948852);
	    Class359.method4294(-1900445314);
	    pb.aClass283_8716.method2640((byte) -42).method4324(134111872);
	...
	try {
	    IComponentDefinition.method1135(((Class365_Sub1) ((Class403) class403).anInterface3_5233), class403, -778688640);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (pb.playerRights * 1806357379 >= 2)
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 1806357379 * pb.playerRights;
	    else
	...
	try {
		...
		if (i_12_ == 0) {
		    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = pb.WINDOW_PANE_ID * -257444687;
		    return;
		}
		i_12_--;
	    }
	    Interface class298_sub51 = ((Interface) pb.aClass437_8841.method5816(1645730647));
	    while (i_12_-- > 0)
		class298_sub51 = (Interface) pb.aClass437_8841.method5815((byte) -33);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = -1617025021 * class298_sub51.interfaceId;
	}
	catch (RuntimeException runtimeexception) {
