...
public class Class473 {
	...
	try {
		...
		if (-1 != -967533709 * (class365_sub1_sub1_sub2.currentGraphics[i_2_].id)) {
			...
			GraphicDefinition class398 = (Class158_Sub1.aClass389_8568.getGraphicDefinition((class365_sub1_sub1_sub2.currentGraphics[i_2_].id) * -967533709, -2105534401));
			AnimationDefinition class391 = class438_3_.method5820(301840356);
			if (class398.aBoolean5215) {
			    if (3 == class391.animatingPrecedence * 62820525) {
				if ((1888275831 * class365_sub1_sub1_sub2.anInt10125) > 0 && ((class365_sub1_sub1_sub2.anInt10095 * -412225079) <= pb.ticketCycle * 443738891) && ((1450943713 * class365_sub1_sub1_sub2.anInt10103) < 443738891 * pb.ticketCycle)) {
				    class438_3_.method5821(-1, -1544973787);
				    class365_sub1_sub1_sub2.currentGraphics[i_2_].id = -1313669563;
				    continue;
				}
			    } else if (1 == class391.animatingPrecedence * 62820525 && (class365_sub1_sub1_sub2.anInt10125 * 1888275831) > 0 && ((-412225079 * (class365_sub1_sub1_sub2.anInt10095)) <= 443738891 * pb.ticketCycle) && ((1450943713 * (class365_sub1_sub1_sub2.anInt10103)) < 443738891 * pb.ticketCycle)) {
				if (i <= 0)
				    throw new IllegalStateException();
				continue;
			    }
		...
		if (class438_4_.method5819((byte) -111)) {
		    AnimationDefinition class391 = class438_4_.method5820(-239895480);
		    if (class391.animatingPrecedence * 62820525 == 3) {
			if (1888275831 * class365_sub1_sub1_sub2.anInt10125 > 0 && (class365_sub1_sub1_sub2.anInt10095 * -412225079 <= pb.ticketCycle * 443738891) && (class365_sub1_sub1_sub2.anInt10103 * 1450943713 < 443738891 * pb.ticketCycle)) {
			...
			if (1888275831 * class365_sub1_sub1_sub2.anInt10125 > 0 && (class365_sub1_sub1_sub2.anInt10095 * -412225079 <= 443738891 * pb.ticketCycle) && (class365_sub1_sub1_sub2.anInt10103 * 1450943713 < 443738891 * pb.ticketCycle)) {
