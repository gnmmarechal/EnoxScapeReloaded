...
public class Class299 {
    ...
    public Class299(Toolkit class_ra, RsByteBuffer class298_sub53, int i) {
	((Class299) this).anInt3195 = -1657032745 * i;
	((Class299) this).anInt3193 = class298_sub53.readSmart3(590991010) * -1823687737;
	...
	try {
	    ...
	    Class244 class244 = pb.aClass283_8716.method2654(1102233653);
	    WorldTile class341 = pb.aClass283_8716.method2628(681479919);
	    WorldTile class341_3_ = new WorldTile(1855729883 * Class99.anInt952, ((Class299) this).anIntArray3194[0], ((Class299) this).anIntArray3196[0]);
	    for (int i_4_ = 1; i_4_ < ((Class299) this).anInt3193 * -755722761; i_4_++) {
		WorldTile class341_5_ = new WorldTile(1855729883 * Class99.anInt952, ((Class299) this).anIntArray3194[i_4_], ((Class299) this).anIntArray3196[i_4_]);
		while ((class341_3_.x * -1760580017 != class341_5_.x * -1760580017) || (class341_5_.y * 283514611 != 283514611 * class341_3_.y)) {
		    if (-1760580017 * class341_3_.x < class341_5_.x * -1760580017)
			class341_3_.x += 2061281455;
		    else if (-1760580017 * class341_3_.x > class341_5_.x * -1760580017)
			class341_3_.x -= 2061281455;
		    if (class341_3_.y * 283514611 < class341_5_.y * 283514611)
			class341_3_.y += 1901982267;
		    else if (283514611 * class341_3_.y > class341_5_.y * 283514611)
			class341_3_.y -= 1901982267;
		    int i_6_ = 1855729883 * Class99.anInt952;
		    int i_7_ = (class341_3_.x * -1760580017 - -1760580017 * class341.x);
		    int i_8_ = (class341_3_.y * 283514611 - class341.y * 283514611);
    ...
    Model method3679(Toolkit class_ra, int i) {
	try {
	    ModelDecoder class64 = ModelDecoder.getModel(WorldTile.idx7, -1002982425 * ((Class299) this).anInt3195, 0);
	    if (class64 == null)
		return null;
	    if (class64.version < 13)
		class64.method755(2);
	    return class_ra.createModel(class64, 2048, anInt3197 * 598483091, 64, 768);
	}
	catch (RuntimeException runtimeexception) {
