...
public class Class495 {
	...
	try {
	    if (null != string) {
		String string_0_ = BillBoardDefinitions.method1824(string, 2076308091);
		if (string_0_ != null) {
		    for (int i_1_ = 0; i_1_ < pb.anInt8941 * -1054937867; i_1_++) {
			String string_2_ = pb.aStringArray8704[i_1_];
			String string_3_ = BillBoardDefinitions.method1824(string_2_, -1598414380);
			if (Class396.method4910(string, string_0_, string_2_, string_3_, -1043868937)) {
			    pb.anInt8941 -= 560029533;
			    for (int i_4_ = i_1_; i_4_ < -1054937867 * pb.anInt8941; i_4_++) {
				pb.aStringArray8704[i_4_] = pb.aStringArray8704[i_4_ + 1];
				pb.aStringArray8945[i_4_] = pb.aStringArray8945[1 + i_4_];
				pb.anIntArray8946[i_4_] = pb.anIntArray8946[i_4_ + 1];
				pb.aStringArray8947[i_4_] = pb.aStringArray8947[i_4_ + 1];
				pb.anIntArray8705[i_4_] = pb.anIntArray8705[1 + i_4_];
				pb.aBooleanArray8722[i_4_] = pb.aBooleanArray8722[1 + i_4_];
				pb.aBooleanArray8950[i_4_] = pb.aBooleanArray8950[1 + i_4_];
			    }
