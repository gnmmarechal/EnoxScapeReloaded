...
public class Class365_Sub1_Sub1_Sub3 extends Class365_Sub1_Sub1 {
    ...
    ParticleSystem aClass351_10137;
    ...
    void method4479(Toolkit class_ra, Model class387, Class222 class222, byte i) {
	try {
		...
		((Class365_Sub1_Sub1_Sub3) this).aClass351_10137 = ParticleSystem.method4232(pb.ticketCycle * 443738891, true);
	    if (null != ((Class365_Sub1_Sub1_Sub3) this).aClass351_10137) {
		((Class365_Sub1_Sub1_Sub3) this).aClass351_10137.method4231(class_ra, (long) (443738891 * pb.ticketCycle), class85s, class68s, false);
	...
	GraphicDefinition class398 = (Class158_Sub1.aClass389_8568.getGraphicDefinition(((Class365_Sub1_Sub1_Sub3) this).anInt10135 * -743331725, -2103306753));
    ...
    Model method4482(Toolkit class_ra, int i, int i_13_, int i_14_) {
	try {
	    GraphicDefinition class398 = Class158_Sub1.aClass389_8568.getGraphicDefinition(i_13_, -1949428738);
	    Ground class_xa = aClass331_7722.aClass_xaArray3519[plane];
	    Ground class_xa_15_ = (aByte7724 < 3 ? aClass331_7722.aClass_xaArray3519[1 + aByte7724] : null);
	...
	try {
	    Model class387 = method4482(class_ra, 0, (-743331725 * ((Class365_Sub1_Sub1_Sub3) this).anInt10135), -1760774279);
	    if (class387 != null)
    ...
    final void method4355(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_16_, int i_17_, boolean bool, int i_18_) {
	try {
	    throw new IllegalStateException();
	}
	catch (RuntimeException runtimeexception) {
    ...
    boolean method4350(Toolkit class_ra, int i, int i_19_, byte i_20_) {
	try {
	    return false;
	}
	catch (RuntimeException runtimeexception) {
	...
	Model class387 = method4482(class_ra, 0x800 | (0 != (((Class365_Sub1_Sub1_Sub3) this).anInt10139) * -657768375 ? 5 : 0), (-743331725 * ((Class365_Sub1_Sub1_Sub3) this).anInt10135), -1821357765);
	if (null == class387)
	    return null;
	...
	Model class387 = method4482(class_ra, 0, (-743331725 * ((Class365_Sub1_Sub1_Sub3) this).anInt10135), -1484520412);
	if (class387 != null)
	    method4479(class_ra, class387, method4347(), (byte) -82);
    }

    void method4373(Toolkit class_ra) {
	Model class387 = method4482(class_ra, 0, (-743331725 * ((Class365_Sub1_Sub1_Sub3) this).anInt10135), -1936222136);
	if (class387 != null)
	    method4479(class_ra, class387, method4347(), (byte) -12);
    }

    boolean method4372(Toolkit class_ra, int i, int i_22_) {
	return false;
    }

    boolean method4385(Toolkit class_ra, int i, int i_23_) {
	return false;
    }

    boolean method4352(Toolkit class_ra, int i, int i_24_) {
	return false;
    }

    final void method4375(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_25_, int i_26_, boolean bool) {
	throw new IllegalStateException();
    }

    Class335 method4394(Toolkit class_ra, int i) {
	try {
	    Model class387 = method4482(class_ra, 0x800 | (0 != (((Class365_Sub1_Sub1_Sub3) this).anInt10139) * -657768375 ? 5 : 0), (-743331725 * ((Class365_Sub1_Sub1_Sub3) this).anInt10135), -1982313638);
	    if (null == class387)
		return null;
	    if (-657768375 * ((Class365_Sub1_Sub1_Sub3) this).anInt10139 != 0)
		class387.f(1510098944 * ((Class365_Sub1_Sub1_Sub3) this).anInt10139);
    ...
    final void method4388(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_27_, int i_28_, boolean bool) {
	throw new IllegalStateException();
    }
