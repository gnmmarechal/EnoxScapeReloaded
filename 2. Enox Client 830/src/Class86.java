...
public class Class86 {
	...
	((Class86) this).aClass424_787 = ((GameObjectType) Class422_Sub20.method5701(ExactStrategy.method4108(114624527), class298_sub53.readUnsignedByte(), (byte) 2));
    }

    void method959(byte i) {
	try {
	    Class420.method5606(-637425735 * ((Class86) this).anInt788, ((Class86) this).anInt789 * -123379955, 1400706617 * ((Class86) this).anInt790, -6749525 * ((Class86) this).aClass424_787.slot, -1, ((Class86) this).aClass424_787.type * -1976050083, ((Class86) this).anInt791 * 1067426701, -694910012);
	}
	...
	try {
		...
		boolean bool = class432.method5771((((Class86) this).aClass424_787.type) * -1976050083, (byte) 42);
		int[] is = class432.method5782(-1156078162);
		if (is != null) {
		    int[] is_0_ = is;
		    for (int i_1_ = 0; i_1_ < is_0_.length; i_1_++) {
			int i_2_ = is_0_[i_1_];
			bool &= Class501.aClass395_6122.getAnimationDefinition(i_2_, (byte) -42).ready(714689881);
		    }
		}
		return bool;
	    }
	...
	try {
	    Class420.method5606(i, i_3_, i_4_, (-6749525 * ((Class86) this).aClass424_787.slot), 766413265 * ((Class86) this).anInt786, (((Class86) this).aClass424_787.type * -1976050083), i_5_, -392910268);
	...
	try {
		...
		string_9_ = "_wip";
	    File file_10_ = new File(Class83.aString765, new StringBuilder().append(Loader.SERVER_NAME + "_").append(string_7_).append("_preferences").append(string).append(string_9_).append(".dat").toString());
	    do {
	...
	try {
	    ...
	    byte[] is = (Class377.idx12.getTextureData(Class377.idx12.method2299(i_15_, 63686679), (byte) 22));
	    if (is != null) {
		if (is.length <= 1)
		    return null;
		try {
	    ...
	    if (null != class298_sub37_sub17)
		return class298_sub37_sub17;
	    is = (Class377.idx12.getTextureData(Class377.idx12.method2299(i_15_, 63686679), (byte) 82));
	    if (is != null) {
		if (is.length <= 1)
		    return null;
		try {
	    ...
	    if (null != class298_sub37_sub17)
		return class298_sub37_sub17;
	    is = (Class377.idx12.getTextureData(Class377.idx12.method2299(i_15_, 63686679), (byte) 52));
	    if (is != null) {
		if (is.length <= 1)
		    return null;
		try {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Class403) class403).aClass162_5252.aByte1672;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Class360.aClass25_3905 = pb.aClass25_8711;
	...
	try {
		...
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2004, pb.aClass25_8711.aClass449_330, (byte) 49);
		class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(-1, -735665420);
		pb.aClass25_8711.method390(class298_sub36, (byte) -21);
	    } else {
		...
		if (i == -1 && !Class300.aBoolean3208)
		    ...
		    Class170.method1811(i_29_, Class374_Sub1.idx6, i, 0, i_28_, false, new Class97_Sub1(), (byte) -36);
