...
public class Class282 implements Interface21 {
	...
	try {
		...
		if (!((Class298_Sub37_Sub15) class298_sub37_sub15).aBoolean9668 && !"".equals(((Class298_Sub37_Sub15) class298_sub37_sub15).aString9657)) {
		    ...
		    for (class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass437_5470.get(l)); class298_sub37_sub5 != null; class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass437_5470.method5813(-1492262664))) {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (class369.anIntArray4023 == null ? 0 : class369.anIntArray4023.length);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    String string = (ClientScriptsExecutor.aStringArray4126[(((Class403) class403).anIntArray5257[((Class403) class403).anInt5259 * 1883543357])]);
	    if (null == string)
		string = "";
	...
	try {
		...
		MouseIcon.method6183(i, i_4_, i_5_, i_6_, -1450466434);
	    }
	}
	catch (RuntimeException runtimeexception) {
