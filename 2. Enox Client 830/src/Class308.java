...
public abstract class Class308 {
    ...
    Class308(int i) {
	if (!EmitterConfig.method955(-1260275656).method265("jagtheora", -1126695495))
	    throw new RuntimeException("");
	...
	try {
		...
		while (Class474.anInt5971 * -64101949 < -499146007 * Class338.anInt3630) {
			...
			if (Class474.aClass396_5978 == null)
			    Class474.aClass396_5978 = (pb.aClass404_8715.method4946(class343_sub1.aString7718, (byte) 111));
