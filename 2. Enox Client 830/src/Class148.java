...
//	    throw Class346.method4175(runtimeexception, new StringBuilder().append("g.d(").append(')').toString());
	...
	try {
		...
		i_1_ = 0;
	    i_6_ <<= fromBitshift;
	    method1605(varpId, (((Class148) this).anIntArray6652[varpId] & (i_6_ ^ 0xffffffff) | i_1_ << fromBitshift & i_6_), (byte) 16);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    int i_29_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]);
	...
	try {
	    int i_30_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]);
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = pb.anInt8665 * -1154804873;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = pb.aBoolean8680 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Class344.aClass351Array3679 = new ParticleSystem[1 + (Class65.anIntArray658[Class344.anInt3675 * 1197525581])];
	...
	try {
	    ...
	    int i_32_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
	    int i_33_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 1]);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class298_Sub1.method2845(i_32_, i_33_, false, false, 1482071907);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		int i_34_ = 1898544019 * pb.anInt6473;
		int i_35_ = 540368727 * pb.anInt6474;
		int i_36_ = (Class78.anInt733 * -639974669 - Class462.anInt5683 * -2110394505 - i_34_);
		int i_37_ = (1282634425 * pb.anInt6472 - -1111710645 * Class298_Sub40_Sub9.anInt9716 - i_35_);
		if (i_34_ > 0 || i_36_ > 0 || i_35_ > 0 || i_37_ > 0) {
			...
			if (i_34_ > 0)
			    graphics.fillRect(i_38_, i_39_, i_34_, pb.anInt6472 * 1282634425);
			if (i_35_ > 0)
			    graphics.fillRect(i_38_, i_39_, -639974669 * Class78.anInt733, i_35_);
			if (i_36_ > 0)
			    graphics.fillRect((i_38_ + Class78.anInt733 * -639974669 - i_36_), i_39_, i_36_, pb.anInt6472 * 1282634425);
			if (i_37_ > 0)
			    graphics.fillRect(i_38_, (pb.anInt6472 * 1282634425 + i_39_ - i_37_), -639974669 * Class78.anInt733, i_37_);
		    }
	...
	try {
	    int i_40_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]);
	...
	try {
	    class105.anInt1284 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]) * -1066050969;
