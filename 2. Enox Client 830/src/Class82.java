...
public abstract class Class82 {
    ...
    static void method871(Toolkit class_ra, ObjectDefinitions class432, int i, int i_0_, int i_1_, byte i_2_) {
	try {
	    MapIconDefinitions mapIconDefinitions = ConfigEntry.aClass487_1463.method6159((class432.anInt5400 * -1204256389), -2141345299);
	    if (1690480405 * mapIconDefinitions.anInt6097 != -1) {
		if (class432.aBoolean5401) {
		    i += -1382013163 * class432.anInt5402;
		    i &= 0x3;
		} else
		    i = 0;
		Sprite class57 = mapIconDefinitions.method6198(class_ra, i, class432.aBoolean5440, (byte) -63);
		if (class57 != null) {
		    ...
		    if (0 != mapIconDefinitions.anInt6096 * -2012904123)
			class57.method634(i_0_, i_1_ - (i_4_ - 1) * 4, i_5_, i_6_, 0, (~0xffffff | mapIconDefinitions.anInt6096 * -2012904123), 1);
		    else
	...
	try {
	    long l = (((Class403) class403).aLongArray5251[((((Class403) class403).anInt5245 -= -682569305) * 1685767703)]);
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = l == -1L ? "" : Long.toString(l, 36).toUpperCase();
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub13_7550, (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]), -283253928);
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_10_;
	}
	catch (RuntimeException runtimeexception) {
