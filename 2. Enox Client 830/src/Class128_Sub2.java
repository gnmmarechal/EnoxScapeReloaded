...
public class Class128_Sub2 extends Class128 {
    ...
    static Sprite[] aClass57Array8560;
	...
	try {
		...
		if (string.charAt(i_8_ - 1) == 's')
		    objects[i_8_] = (((Class403) class403).anObjectArray5240[(((Class403) class403).anInt5241 -= 969361751) * -203050393]);
		else if (string.charAt(i_8_ - 1) == '\u00a7')
		    objects[i_8_] = new Long(((Class403) class403).aLongArray5251[(((Class403) class403).anInt5245 -= -682569305) * 1685767703]);
		else
		    objects[i_8_] = new Integer(((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]);
	    }
