...
public class BillBoardDefinitions {
	...
	public int textureId = -2036085851;
	public int anInt1752;
	public int sv_position;
	public int anInt1754;
	public int position = 1561394240;
	static JS5 aClass243_1756;
	public boolean aBoolean1757;
	public static JS5 idx29;
	public static byte aByte1759;

	void decodeBillBoards(RsByteBuffer class298_sub53, int i, int i_0_, int i_1_) {
		try {
			if (1 == i) {
				textureId = class298_sub53.readUnsignedShort() * 2036085851;
				if (39181267 * textureId == 65535)
					textureId = -2036085851;
			}
			else if (i == 2) {
				position = (class298_sub53.readUnsignedShort() + 1) * 1635009521;
				sv_position = (class298_sub53.readUnsignedShort() + 1) * 2057726207;
			}
			else if (3 == i)
	...
	void method1817(RsByteBuffer class298_sub53, int i, byte i_2_) {
		try {
			for (;;) {
				...
				decodeBillBoards(class298_sub53, i_3_, i, 1303074058);
			}
		}
		catch (RuntimeException runtimeexception) {
	...
	public static void method1820(int i, int i_5_, int i_6_, int i_7_) {
		try {
			...
			int i_8_ = i_5_ + -1760580017 * class341.x;
			int i_9_ = i_6_ + 283514611 * class341.y;
			if (pb.aClass283_8716.method2675(-1611682495) != null && (pb.aClass283_8716.method2674(-257896295) != Class266.aClass266_2846) && i_5_ >= 0 && i_6_ >= 0 && i_5_ < pb.aClass283_8716.method2629(-1890552944) && i_6_ < pb.aClass283_8716.method2630(-1685955624)) {
				long l = (long) (i << 28 | i_9_ << 14 | i_8_);
				Class298_Sub2 class298_sub2 = (Class298_Sub2) pb.aClass437_8685.get(l);
				if (class298_sub2 == null)
					pb.aClass283_8716.method2675(-1611682495).method4059(i, i_5_, i_6_, (byte) 86);
				else {
					Class298_Sub12 class298_sub12 = (Class298_Sub12) class298_sub2.aClass453_7166.method5939(1766612795);
					if (class298_sub12 == null)
						pb.aClass283_8716.method2675(-1611682495).method4059(i, i_5_, i_6_, (byte) 28);
					else {
						Class365_Sub1_Sub4_Sub1 class365_sub1_sub4_sub1 = ((Class365_Sub1_Sub4_Sub1) pb.aClass283_8716.method2675(-1611682495).method4059(i, i_5_, i_6_, (byte) 119));
						if (class365_sub1_sub4_sub1 == null)
							class365_sub1_sub4_sub1 = (new Class365_Sub1_Sub4_Sub1(pb.aClass283_8716.method2675(-1611682495), i_5_ << 265, pb.aClass283_8716.method2675(-1611682495).aClass_xaArray3517[i].method6341(i_5_, i_6_, (byte) -15), i_6_ << 265, i, i));
						else {
							...
							class365_sub1_sub4_sub1.aClass331_7722 = pb.aClass283_8716.method2675(-1611682495);
						}
						...
						if (pb.aClass283_8716.method2654(361928521).method2320(i_5_, i_6_, -1635198415))
							class365_sub1_sub4_sub1.aByte7724++;
						pb.aClass283_8716.method2675(-1611682495).method4053(i, i_5_, i_6_, i_13_, class365_sub1_sub4_sub1, 1648403764);
					}
				}
			}
		}
	...
	public static final void method1821(Interface class298_sub51, boolean bool, boolean bool_14_, int i) {
		try {
			...
			if (!bool_14_ && pb.WINDOW_PANE_ID * -257444687 != -1)
				Class82_Sub10.method903(-257444687 * pb.WINDOW_PANE_ID, 1, -80338519);
			Class460 class460 = new Class460(pb.aClass437_8841);
	...
	public static final void method1822(int viewLocalX, int viewLocalY, int viewZ, int speed1, int speed2, byte i_23_) {
		try {
			Ground.cameraLookViewLocalX = 446226445 * viewLocalX;
			...
			if (Class427.cameraLookSpeed2 * 1179258959 >= 100) {
				int i_24_ = -589460992 * Ground.cameraLookViewLocalX + 256;
				...
				pb.anInt8756 = ((int) (Math.atan2((double) i_28_, (double) i_30_) * 2607.5945876176133) & 0x3fff) * -648269561;
				Class135.anInt6384 = ((int) (Math.atan2((double) i_27_, (double) i_29_) * -2607.5945876176133) & 0x3fff) * -1587695039;
				Class229.anInt6458 = 0;
				if (-104436553 * pb.anInt8756 < 1024)
					pb.anInt8756 = 1891900416;
				if (pb.anInt8756 * -104436553 > 3072)
	...
	public static short method1823(int i) {
		return method1823(i, (byte) 0);
	}

	public static short method1823(int i, byte dummy) {
		try {
			int i_32_ = i >> 10 & 0x3f;
			int i_33_ = i >> 3 & 0x70;
			int i_34_ = i & 0x7f;
