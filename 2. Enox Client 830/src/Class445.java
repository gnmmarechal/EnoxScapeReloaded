...
public class Class445 {
	...
	try {
	    ...
	    if (null != class485)
		return class485;
	    byte[] is = ((Class445) this).aClass243_5609.getFile(((ConfigEntry.aClass120_1411.anInt1460) * -1006924897), i);
	...
	if (null != ((Class445) this).aClass243_5609)
	    ((Class445) this).aClass243_5609.getFileCountForArchive(ConfigEntry.aClass120_1411.anInt1460 * -1006924897, 1281975621);
    }

    static void method5895(Toolkit class_ra, byte i) {
	try {
		...
		int i_10_ = -1;
		if (443738891 * pb.ticketCycle % 30 > 15)
		    i_10_ = 16777215;
