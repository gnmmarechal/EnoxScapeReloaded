...
public class IcmpService_Sub1 extends IcmpService {
	...
	try {
		...
		for (Interface class298_sub51 = ((Interface) pb.aClass437_8841.method5816(2118062141)); class298_sub51 != null; class298_sub51 = ((Interface) pb.aClass437_8841.method5815((byte) 56))) {
		    if (!class298_sub51.method2840(-629325116)) {
			class298_sub51 = ((Interface) pb.aClass437_8841.method5816(1715939754));
		...
		pb.WINDOW_PANE_ID = -391544995 * HashTable.aClass371_5520.anInt4031;
		Class257.method2453(false, (byte) 8);
		Class360.method4301(-1204145082);
		Class14.method341(-257444687 * pb.WINDOW_PANE_ID, null, 188692666);
	    }
