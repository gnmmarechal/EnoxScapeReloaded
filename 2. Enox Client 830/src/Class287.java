...
public class Class287 {
	...
	public static boolean method2720(int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_,
			int i_10_) {
		try {
	...
	static final void method2721(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919
					- 1)] = 1914527151 * Class298_Sub41.anInt7456;
		} catch (RuntimeException runtimeexception) {
	...
	public static boolean method2722(String string, int i) {
		try {
			...
			for (int i_11_ = 0; i_11_ < -548972447 * pb.anInt8952; i_11_++) {
				if (string.equalsIgnoreCase(pb.aStringArray8954[i_11_]))
					return true;
				if (string.equalsIgnoreCase(pb.aStringArray8773[i_11_]))
					return true;
			}
			return false;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method2723(Class403 class403, int i) {
		try {
			int i_12_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689)
					* 681479919)]);
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919
					- 1)] = pb.GRAND_EXCHANGE_SLOTS[i_12_].anInt2770 * 1869840307;
		} catch (RuntimeException runtimeexception) {
