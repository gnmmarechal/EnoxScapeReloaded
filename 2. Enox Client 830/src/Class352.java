...
public class Class352 {
	...
	try {
		...
		if (((Class352) this).aClass437_3811 == null) {
		    int i_9_ = Class416.nextPowerOfTwo(i_8_, (byte) 16);
    ...
    public Sprite method4238(Toolkit class_ra, boolean bool, int i) {
	try {
	    int i_15_ = bool ? anInt3779 * -1413078901 : anInt3785 * 715019623;
	    int i_16_ = i_15_ | 580915349 * class_ra.id << 29;
	    Sprite class57 = (Sprite) ((Class339) ((Class352) this).aClass339_3776).aClass348_3635.get((long) i_16_);
	    if (class57 != null)
		return class57;
	    if (!((Class339) ((Class352) this).aClass339_3776).aClass243_3638.fileLoaded(i_15_, -457216440))
		return null;
	    IndexedImage class89 = IndexedImage.method987((((Class339) (((Class352) this).aClass339_3776)).aClass243_3638), i_15_, 0);
	    if (class89 != null) {
		class57 = class_ra.method5125(class89, true);
		((Class339) ((Class352) this).aClass339_3776).aClass348_3635.put(class57, (long) i_16_);
	    }
	    return class57;
	}
	catch (RuntimeException runtimeexception) {
    ...
    public Sprite method4240(Toolkit class_ra, int i) {
	try {
	    Sprite class57 = ((Sprite) (((Class339) ((Class352) this).aClass339_3776).aClass348_3635.get((long) (((Class352) this).anInt3794 * 1027948663 | 0x20000 | class_ra.id * 580915349 << 29))));
	    if (null != class57)
		return class57;
	    ((Class339) ((Class352) this).aClass339_3776).aClass243_3638.fileLoaded(1027948663 * ((Class352) this).anInt3794, -457216440);
	    IndexedImage class89 = IndexedImage.method987((((Class339) ((Class352) this).aClass339_3776).aClass243_3638), ((Class352) this).anInt3794 * 1027948663, 0);
	    if (class89 != null) {
		class57 = class_ra.method5125(class89, true);
		((Class339) ((Class352) this).aClass339_3776).aClass348_3635.put(class57, (long) (((Class352) this).anInt3794 * 1027948663 | 0x20000 | class_ra.id * 580915349 << 29));
	    }
	    return class57;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Class320.method3913((((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]), (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 1]), (((Class403) class403).anIntArray5244[2 + ((Class403) class403).anInt5239 * 681479919]), (((Class403) class403).anIntArray5244[3 + 681479919 * ((Class403) class403).anInt5239]), false, (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 4]), 2026903657);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class300.aClass518_3217.method6311(i_20_, 614874976).anInt9604) * 1317156085;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Class107.aShortArray1315[(((Class403) class403).anIntArray5244[(681479919 * ((Class403) class403).anInt5239)])] = (short) Class86.method964((((Class403) class403).anIntArray5244[(681479919 * ((Class403) class403).anInt5239 + 1)]), (byte) -118);
	...
	try {
	    ...
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_24_).name);
	}
	catch (RuntimeException runtimeexception) {
