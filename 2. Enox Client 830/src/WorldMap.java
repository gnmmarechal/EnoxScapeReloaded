public class WorldMap {
    ...
    public static MapKeys getMapKeys(JS5 idx, String archiveName, boolean member, int i) {
	try {
    ...
    static MapDetails getMapDetails(JS5 class243, int archiveId, int fileId, int i_21_) {
	try {
		...
		((MapDetails) mapDetails).aClass453_9642.add(new MapRectangle(stream.readUnsignedByte(), stream.readUnsignedShort(), stream.readUnsignedShort(), stream.readUnsignedShort(), stream.readUnsignedShort(), stream.readUnsignedShort(), stream.readUnsignedShort(), stream.readUnsignedShort(), stream.readUnsignedShort()));
