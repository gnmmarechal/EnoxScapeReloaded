...
public class i extends Ground implements Interface25 {
	...
	ya(i, i_5_, is, is_6_, is_7_, is_8_, is_9_, is_10_, is_11_, is_12_, class78.colour * -1212608691, class78.scale * 1996750669, class78.anInt727 * -1475891183, bool);
    }
	...
	if (bool_53_ || is_63_ != null)
	    ya(i, i_42_, is_58_, is_64_, is_59_, is_65_, is_60_, is_63_, is_61_, is_62_, class78.colour * -1212608691, class78.scale * 1996750669, class78.anInt727 * -1475891183, bool);
    }
    ...
    public native Shadow w(int i, int i_85_, Shadow class_na);

    public native void UA(Shadow class_na, int i, int i_86_, int i_87_, int i_88_, boolean bool);
    ...
    public boolean method6353(Shadow class_na, int i, int i_95_, int i_96_, int i_97_, boolean bool) {
	return true;
    }

    public void method6342(Class298_Sub10 class298_sub10, int[] is) {
	((i) this).aClass453_6679.add(class298_sub10);
	...
	ya(i, i_103_, is, is_104_, is_105_, is_106_, is_107_, is_108_, is_109_, is_110_, class78.colour * -1212608691, class78.scale * 1996750669, class78.anInt727 * -1475891183, bool);
    }

    public native void z(boolean bool);

    public native void ak(Shadow class_na, int i, int i_111_, int i_112_, int i_113_, boolean bool);
	...
	ya(i, i_114_, is, is_115_, is_116_, is_117_, is_118_, is_119_, is_120_, is_121_, class78.colour * -1212608691, class78.scale * 1996750669, class78.anInt727 * -1475891183, bool);
    }
	...
	ya(i, i_122_, is, is_123_, is_124_, is_125_, is_126_, is_127_, is_128_, is_129_, class78.colour * -1212608691, class78.scale * 1996750669, class78.anInt727 * -1475891183, bool);
    }
	...
	if (bool_157_ || is_167_ != null)
	    ya(i, i_146_, is_162_, is_168_, is_163_, is_169_, is_164_, is_167_, is_165_, is_166_, class78.colour * -1212608691, class78.scale * 1996750669, class78.anInt727 * -1475891183, bool);
    }

    public native void ad(Shadow class_na, int i, int i_175_, int i_176_, int i_177_, boolean bool);
    ...
    public native Shadow l(int i, int i_196_, Shadow class_na);

    public native Shadow ax(int i, int i_197_, Shadow class_na);

    public native Shadow aa(int i, int i_198_, Shadow class_na);
	...
	if (bool_210_ || is_220_ != null)
	    ya(i, i_199_, is_215_, is_221_, is_216_, is_222_, is_217_, is_220_, is_218_, is_219_, class78.colour * -1212608691, class78.scale * 1996750669, class78.anInt727 * -1475891183, bool);
    }

    public boolean method6354(Shadow class_na, int i, int i_228_, int i_229_, int i_230_, boolean bool) {
	return true;
    }

    public native void NA(Shadow class_na, int i, int i_231_, int i_232_, int i_233_, boolean bool);

    public boolean method6355(Shadow class_na, int i, int i_234_, int i_235_, int i_236_, boolean bool) {
	return true;
    }
	...
	if (bool_248_ || is_258_ != null)
	    ya(i, i_237_, is_253_, is_259_, is_254_, is_260_, is_255_, is_258_, is_256_, is_257_, class78.colour * -1212608691, class78.scale * 1996750669, class78.anInt727 * -1475891183, bool);
    }
    ...
    public native void av(Shadow class_na, int i, int i_310_, int i_311_, int i_312_, boolean bool);
}
