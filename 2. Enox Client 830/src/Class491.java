...
public class Class491 {
    ...
    public MouseIcon method6172(int i, int i_0_) {
	try {
	    MouseIcon mouseIcon;
	    synchronized (((Class491) this).aClass348_6079) {
		mouseIcon = (MouseIcon) ((Class491) this).aClass348_6079.get((long) i);
	    }
	    if (null != mouseIcon)
		return mouseIcon;
	    byte[] is;
	    synchronized (((Class491) this).idx2) {
		is = (((Class491) this).idx2.getFile(-1006924897 * ConfigEntry.aClass120_1438.anInt1460, i));
	    }
	    mouseIcon = new MouseIcon();
	    ((MouseIcon) mouseIcon).aClass491_6082 = this;
	    if (is != null)
		mouseIcon.method6180(new RsByteBuffer(is), 1638036980);
	    synchronized (((Class491) this).aClass348_6079) {
		((Class491) this).aClass348_6079.put(mouseIcon, (long) i);
	    }
	    return mouseIcon;
	}
	catch (RuntimeException runtimeexception) {
	...
	((Class491) this).idx2 = class243;
	((Class491) this).aClass243_6077 = class243_2_;
	((Class491) this).idx2.getFileCountForArchive((ConfigEntry.aClass120_1438.anInt1460) * -1006924897, -1015661848);
    }

    static final void method6175(long l) {
	try {
	    Class217 class217 = (Class287.myPlayer.method4337().aClass217_2599);
	    int i = 1734240325 * pb.anInt8817 + (int) class217.aFloat2451;
	    int i_3_ = pb.anInt8742 * 1874511679 + (int) class217.aFloat2454;
	    ...
	    pb.aFloat8949 += (float) l * pb.aFloat8759 / 6.0F;
	    pb.aFloat8757 += pb.aFloat8760 * (float) l / 6.0F;
	...
	try {
	    ...
	    int i_9_ = ((((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]) - 1);
	...
	try {
	    ...
	    ((Class298_Sub37_Sub12) class298_sub37_sub12).type = i_10_ * 1274450087;
	}
	catch (RuntimeException runtimeexception) {
