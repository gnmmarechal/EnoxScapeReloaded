...
public class Class271 {
	...
	try {
	    if (Class372.aClass323_4052.pressingKey(81, -841277867))
	...
	try {
	    ...
	    interface3 = (Interface3) class331.method4035(i, i_0_, i_1_, pb.anInterface17_8960, 664102063);
	    if (interface3 != null)
	...
	try {
	    Class436.anInt5499 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]) * 985311877;
	}
	catch (RuntimeException runtimeexception) {
