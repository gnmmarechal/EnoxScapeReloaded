...
public abstract class Shadow extends Class298_Sub37 {
	...
	public static final void method3478(int i) {
		try {
			for (int i_1_ = 0; i_1_ < 5; i_1_++)
				pb.aBooleanArray8684[i_1_] = false;
			...
			pb.anInt8921 = 727655629 * pb.ticketCycle;
			...
			Class21.anInt277 = 905514481 * pb.anInt8756;
		...
		try {
			...
			if (null != class298_sub25 && i >= 0 && i < 649879491 * class298_sub25.anInt7356) {
				...
				if (-1 == class163.aByte1683) {
					...
					Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2035,
							class25.aClass449_330, (byte) 56);
