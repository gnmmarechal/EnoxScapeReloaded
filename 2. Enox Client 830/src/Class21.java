...
public class Class21 {
	...
	try {
		...
		class105.id = -643064669;
	    } else {
		class105.id = i_4_ * 643064669;
	...
	try {
	    ...
	    int i_8_ = (((Class403) class403).anIntArray5244[1 + 681479919 * ((Class403) class403).anInt5239]);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Toolkit.aClass256_5315.method2441(i_7_, -1634888229).aCharArray9595[i_8_]);
	}
	catch (RuntimeException runtimeexception) {
