...
public class Class298_Sub39 extends Class298 {
	...
	try {
		...
		int i_2_ = 0;
		for (Class298_Sub37_Sub15 class298_sub37_sub15 = ((Class298_Sub37_Sub15) ((Class298_Sub37_Sub5) class298_sub37_sub5).aClass461_9584.first(2119881606)); class298_sub37_sub15 != null; class298_sub37_sub15 = ((Class298_Sub37_Sub15) ((Class298_Sub37_Sub5) class298_sub37_sub5).aClass461_9584.next(-758930912))) {
    ...
    static void method3505(Toolkit class_ra, Class298_Sub52 class298_sub52, Class352 class352, int i, int i_8_, int i_9_, int i_10_, Class4 class4, int i_11_) {
	try {
	...
	try {
	    ...
	    i_16_ = 256 + Ground.cameraLookViewLocalX * -589460992;
	    ...
	    if (i_23_ > 3072)
		i_23_ = 3072;
	    if (pb.anInt8756 * -104436553 < i_23_) {
		pb.anInt8756 += ((((i_23_ - pb.anInt8756 * -104436553 >> 3) * (1179258959 * Class427.cameraLookSpeed2) / 1000) + Class128_Sub1.cameraLookSpeed1 * 298687157) << 3) * -648269561;
		if (pb.anInt8756 * -104436553 > i_23_)
		    pb.anInt8756 = i_23_ * -648269561;
	    }
	    if (-104436553 * pb.anInt8756 > i_23_) {
		pb.anInt8756 -= (-648269561 * ((1179258959 * Class427.cameraLookSpeed2 * (pb.anInt8756 * -104436553 - i_23_ >> 3) / 1000) + 298687157 * Class128_Sub1.cameraLookSpeed1 << 3));
		if (-104436553 * pb.anInt8756 < i_23_)
		    pb.anInt8756 = i_23_ * -648269561;
	    }
