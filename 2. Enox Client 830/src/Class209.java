...
public class Class209 {
    ...
    public static void method1938(AnimationDefinition class391, int i, Class365_Sub1 class365_sub1, int i_1_) {
	try {
	...
	try {
	    ...
	    int i_12_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]);
	    int i_13_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 1]);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_12_ & -1 - (1 << i_13_);
	}
	catch (RuntimeException runtimeexception) {
