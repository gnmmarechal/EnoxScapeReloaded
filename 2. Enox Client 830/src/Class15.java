...
public class Class15 {
    ...
    int anInt185;
    boolean aBoolean186;
    SafeModeModel[] aClass387_Sub1Array187;
    ...
    int anInt215;
    boolean aBoolean216;
    SafeModeModel[] aClass387_Sub1Array217;
	...
	((Class15) this).anIntArray213 = new int[SafeModeModel.anInt7810];
	((Class15) this).aFloatArray197 = new float[SafeModeModel.anInt7810];
	((Class15) this).aFloatArray188 = new float[SafeModeModel.anInt7810];
	((Class15) this).aFloatArray199 = new float[SafeModeModel.anInt7810];
	((Class15) this).aFloatArray200 = new float[SafeModeModel.anInt7810];
	...
	((Class15) this).aClass387_Sub1Array187 = new SafeModeModel[7];
	((Class15) this).aClass387_Sub1Array217 = new SafeModeModel[7];
	...
	for (int i = 0; i < 7; i++) {
	    ((Class15) this).aClass387_Sub1Array187[i] = new SafeModeModel(((Class15) this).aClass_ra_Sub1_182);
	    ((Class15) this).aClass387_Sub1Array217[i] = new SafeModeModel(((Class15) this).aClass_ra_Sub1_182);
	}
	((Class15) this).anIntArray206 = new int[SafeModeModel.anInt7787];
	for (int i = 0; i < SafeModeModel.anInt7787; i++)
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class379.anIntArray4096[BillBoardDefinitions.method1823(i_1_, (byte) 0) & 0xffff]);
	}
	catch (RuntimeException runtimeexception) {
