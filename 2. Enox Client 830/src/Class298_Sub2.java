...
public class Class298_Sub2 extends Class298 {
	...
	try {
	    ...
	    Textures.method2393(class105, class119, class403, 131231409);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = Integer.toString(i_5_);
	}
	catch (RuntimeException runtimeexception) {
