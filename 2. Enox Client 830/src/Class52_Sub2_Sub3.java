...
public class Class52_Sub2_Sub3 extends Class52_Sub2 {
    ...
    Class52_Sub2_Sub3(GLToolkit class_ra_sub2, Canvas canvas) {
	this(class_ra_sub2, canvas, ((GLToolkit) class_ra_sub2).anOpenGL8116.prepareSurface(canvas));
    }
    ...
    Class52_Sub2_Sub3(GLToolkit class_ra_sub2, Canvas canvas, long l) {
	((Class52_Sub2_Sub3) this).aClass_ra_Sub2_9081 = class_ra_sub2;
	((Class52_Sub2_Sub3) this).aCanvas9082 = canvas;
	((Class52_Sub2_Sub3) this).anOpenGL9083 = ((GLToolkit) class_ra_sub2).anOpenGL8116;
