...
public class Class127_Sub2 extends Class127 {
	...
	Class373.activeToolkit.r(i, i_0_ + 2, i + i_1_, (((Class127_Sub2) this).aClass128_6375.anInt6330) * -1387457793 + i_0_);
	...
	try {
	    ...
	    int[] is = new int[4];
	    Class373.activeToolkit.qa(is);
	    Class373.activeToolkit.r(i, i_2_ + 2, i + i_4_, (((Class127_Sub2) this).aClass128_6375.anInt6330) * -1387457793 + i_2_);
	...
	try {
		...
		return false;
	    return (((Class127_Sub2) this).aClass243_6372.fileLoaded(-1056757525 * (((Class128_Sub1) ((Class127_Sub2) this).aClass128_6375).anInt8553), -457216440));
	}
	catch (RuntimeException runtimeexception) {
	...
	Class373.activeToolkit.method5019(i - 2, i_6_, ((Class127_Sub2) this).aClass128_6375.anInt6326 * -944287579 + 4, 2 + ((Class127_Sub2) this).aClass128_6375.anInt6330 * -1387457793, (((Class128_Sub1) ((Class127_Sub2) this).aClass128_6375).anInt8554 * 1514768717), 0);
	Class373.activeToolkit.method5019(i - 1, i_6_ + 1, ((Class127_Sub2) this).aClass128_6375.anInt6326 * -944287579 + 2, -1387457793 * ((Class127_Sub2) this).aClass128_6375.anInt6330, 0, 0);
    }
	...
	try {
	    Class373.activeToolkit.method5019(i - 2, i_7_, (((Class127_Sub2) this).aClass128_6375.anInt6326 * -944287579 + 4), 2 + (((Class127_Sub2) this).aClass128_6375.anInt6330 * -1387457793), (((Class128_Sub1) ((Class127_Sub2) this).aClass128_6375).anInt8554) * 1514768717, 0);
	    Class373.activeToolkit.method5019(i - 1, i_7_ + 1, (((Class127_Sub2) this).aClass128_6375.anInt6326 * -944287579 + 2), -1387457793 * ((Class127_Sub2) this).aClass128_6375.anInt6330, 0, 0);
	}
	catch (RuntimeException runtimeexception) {
	...
	int[] is = new int[4];
	Class373.activeToolkit.qa(is);
	Class373.activeToolkit.r(i, i_9_ + 2, i + i_10_, (((Class127_Sub2) this).aClass128_6375.anInt6330) * -1387457793 + i_9_);
	...
	int[] is = new int[4];
	Class373.activeToolkit.qa(is);
	Class373.activeToolkit.r(i, i_11_ + 2, i + i_12_, (((Class127_Sub2) this).aClass128_6375.anInt6330) * -1387457793 + i_11_);
	...
	int[] is = new int[4];
	Class373.activeToolkit.qa(is);
	Class373.activeToolkit.r(i, i_13_ + 2, i + i_14_, (((Class127_Sub2) this).aClass128_6375.anInt6330) * -1387457793 + i_13_);
	...
	Class373.activeToolkit.method5019(i - 2, i_15_, ((Class127_Sub2) this).aClass128_6375.anInt6326 * -944287579 + 4, 2 + ((Class127_Sub2) this).aClass128_6375.anInt6330 * -1387457793, (((Class128_Sub1) ((Class127_Sub2) this).aClass128_6375).anInt8554 * 1514768717), 0);
	Class373.activeToolkit.method5019(i - 1, i_15_ + 1, ((Class127_Sub2) this).aClass128_6375.anInt6326 * -944287579 + 2, -1387457793 * ((Class127_Sub2) this).aClass128_6375.anInt6330, 0, 0);
    }
	...
	Class373.activeToolkit.method5019(i - 2, i_16_, ((Class127_Sub2) this).aClass128_6375.anInt6326 * -944287579 + 4, 2 + ((Class127_Sub2) this).aClass128_6375.anInt6330 * -1387457793, (((Class128_Sub1) ((Class127_Sub2) this).aClass128_6375).anInt8554 * 1514768717), 0);
	Class373.activeToolkit.method5019(i - 1, i_16_ + 1, ((Class127_Sub2) this).aClass128_6375.anInt6326 * -944287579 + 2, -1387457793 * ((Class127_Sub2) this).aClass128_6375.anInt6330, 0, 0);
    }
}
