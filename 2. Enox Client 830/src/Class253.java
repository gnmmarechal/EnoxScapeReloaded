...
public final class Class253 {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class478.method6098(string, -1316013258);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (class343_sub1 == null ? 0 : class343_sub1.anInt3670 * -877023375);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    int i_10_ = (((Class403) class403).anIntArray5257[((Class403) class403).anInt5259 * 1883543357]);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Player) ((Class403) class403).aClass365_Sub1_Sub1_Sub2_5242).aClass70_10223.method799(i_10_, -1034906382);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class298_Sub37_Sub12) class298_sub37_sub12).type = i_11_ * 1274450087;
	    ((Class298_Sub37_Sub12) class298_sub37_sub12).value = i_12_ * 293101103;
