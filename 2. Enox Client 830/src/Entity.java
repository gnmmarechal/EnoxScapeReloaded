...
public abstract class Entity extends Class365_Sub1_Sub1 {
	...
	ParticleSystem aClass351_10067;
	...
	public Model[] aClass387Array10082;
	...
	public void method4413(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_) {
		try {
			if (method4439(-1427124632))
				pb.method2800(aClass119_10131, aClass119_10131.method1295((byte) 20), -1, i, i_0_, i_1_, i_2_, i_3_, i_4_, i_5_, i_6_);
		}
	...
	public boolean method4417(int i, int i_11_, byte i_12_) {
		try {
			if (anIntArray10085 == null) {
				if (-1 == i_11_)
					return true;
				anIntArray10085 = new int[(EquipmentDefaults.aClass405_6892.anIntArray5267).length];
			...
			if (-1 == i_11_) {
				...
				if (i_17_ >= -i_14_ && i_17_ <= i_14_) {
					anIntArray10085[i] = -1;
					for (int i_18_ = 0; i_18_ < (EquipmentDefaults.aClass405_6892.anIntArray5267).length; i_18_++) {
	...
	public final void sendGraphics(int primaryId, int height, int rotation, int i_23_, boolean bool, int graphicIndex, int i_25_) {
		try {
			Graphics graphics = currentGraphics[graphicIndex];
			int secondaryId = -967533709 * graphics.id;
			if (primaryId != -1 && secondaryId != -1) {
				if (secondaryId == primaryId) {
					GraphicDefinition graphicDef = Class158_Sub1.aClass389_8568.getGraphicDefinition(primaryId, -1791372939);
					if (graphicDef.aBoolean5215 && 1505778629 * graphicDef.animation != -1) {
						AnimationDefinition animDef = (Class501.aClass395_6122.getAnimationDefinition(graphicDef.animation * 1505778629, (byte) -43));
						int mode = animDef.replayMode * -1117238071;
						if (mode == 0)
							return;
						if (2 == mode) {
					...
					GraphicDefinition primary = Class158_Sub1.aClass389_8568.getGraphicDefinition(primaryId, -1699460112);
					GraphicDefinition secondary = Class158_Sub1.aClass389_8568.getGraphicDefinition(secondaryId, -1865033182);
					if (1505778629 * primary.animation != -1 && 1505778629 * secondary.animation != -1) {
						AnimationDefinition primaryAnimation = (Class501.aClass395_6122.getAnimationDefinition(1505778629 * primary.animation, (byte) 50));
						AnimationDefinition secondaryAnimation = (Class501.aClass395_6122.getAnimationDefinition(1505778629 * secondary.animation, (byte) -13));
						if (-1445588039 * primaryAnimation.priority < secondaryAnimation.priority * -1445588039)
							return;
					}
				}
			}
			int i_30_ = 0;
			if (primaryId != -1 && !(Class158_Sub1.aClass389_8568.getGraphicDefinition(primaryId, -2139980686).aBoolean5215))
				i_30_ = 2;
			if (-1 != primaryId && bool)
				i_30_ = 1;
			graphics.id = 1313669563 * primaryId;
			graphics.anInt568 = 1533439965 * i_23_;
			graphics.height = 1755371497 * (height >> 16);
			graphics.anInt571 = rotation * 1949040559;
			graphics.aClass438_569.method5824((-1 != primaryId ? ((Class158_Sub1.aClass389_8568.getGraphicDefinition(primaryId, -2144045629).animation) * 1505778629) : -1), height & 0xffff, i_30_, false, (byte) 0);
		}
		catch (RuntimeException runtimeexception) {
	...
	public int method4363(byte i) {
		try {
			...
			int i_48_ = (int) class235.aClass217_2599.aFloat2451 >> 9;
				...
				if (null != aClass331_7722 && i_48_ >= 1 && i_49_ >= 1 && i_48_ <= pb.aClass283_8716.method2629(-2008930035) - 1 && i_49_ <= pb.aClass283_8716.method2630(-33342416) - 1) {
	...
	void method4423(Model class387, int i) {
		try {
	...
	void method4424(Toolkit class_ra, Class350 class350, int i, int i_55_, int i_56_, int i_57_, int i_58_) {
		try {
			for (int i_59_ = 0; i_59_ < currentGraphics.length; i_59_++) {
				...
				if (-1 != class56.id * -967533709 && !class56.aClass438_569.method5826(-65534)) {
					GraphicDefinition class398 = (Class158_Sub1.aClass389_8568.getGraphicDefinition(class56.id * -967533709, -2040253952));
					...
					Model class387 = (aClass387Array10082[i_59_ + 1] = class398.method4917(class_ra, i_61_, class56.aClass438_569, i_60_, 2124203678));
					if (null != class387) {
						if (class56.anInt568 * -1418960779 >= 0 && null != class350.anIntArrayArray3710 && (class350.anIntArrayArray3710[-1418960779 * class56.anInt568]) != null) {
							...
							if (0 != i_64_ || i_62_ != 0) {
								...
								if (0 != i_66_)
									class387.f(i_66_);
								int i_67_ = Class220.SINE[i_66_];
								int i_68_ = Class220.COSINE[i_66_];
	...
	void method4425(int i, int i_70_, int i_71_, int i_72_, int i_73_, int i_74_) {
		try {
			...
			int i_75_ = aShort9796 + aShort9798 >> 1;
							...
							int i_77_ = Class220.SINE[i];
							int i_78_ = Class220.COSINE[i];
							int i_79_ = -i_70_ / 2;
							int i_80_ = -i_71_ / 2;
	...
	public int method4435() {
		...
		if (null != aClass331_7722 && i_111_ >= 1 && i_112_ >= 1 && i_111_ <= pb.aClass283_8716.method2629(-2022187323) - 1 && i_112_ <= pb.aClass283_8716.method2630(1908645218) - 1) {
	...
	public int method4436() {
		...
		if (null != aClass331_7722 && i_113_ >= 1 && i_114_ >= 1 && i_113_ <= pb.aClass283_8716.method2629(-2141154955) - 1 && i_114_ <= pb.aClass283_8716.method2630(145346949) - 1) {
	...
	public void method4441(int i, int i_115_, int i_116_, int i_117_, int i_118_, int i_119_, int i_120_, byte i_121_) {
		try {
			if (!method4439(-377564191)) {
				if (-1 != i)
					pb.aBooleanArray8900[i] = true;
				else {
					for (int i_122_ = 0; i_122_ < 113; i_122_++)
						pb.aBooleanArray8900[i_122_] = true;
				}
			} else
	...
	Entity(Class331 class331, int i) {
		...
		aClass387Array10082 = new Model[5];
		currentGraphics = new Graphics[4];
		for (int i_125_ = 0; i_125_ < 4; i_125_++)
			currentGraphics[i_125_] = new Graphics(this);
		aClass438_Sub2_Sub1Array10112 = (new Class438_Sub2_Sub1[EquipmentDefaults.aClass405_6892.anIntArray5267.length]);
	}

	void method4445(Toolkit class_ra, Model[] class387s, Class222 class222, boolean bool, int i) {
		try {
			if (!bool) {
				int i_126_ = 0;
				int i_127_ = 0;
				...
				int i_130_ = -1;
				int i_131_ = -1;
				EmitterConfig[][] class85s = new EmitterConfig[class387s.length][];
				MagnetConfig[][] class68s = new MagnetConfig[class387s.length][];
				...
				if ((((Entity) this).aClass351_10067 == null || (((Entity) this).aClass351_10067.aBoolean3772)) && (i_127_ > 0 || i_129_ > 0))
					((Entity) this).aClass351_10067 = ParticleSystem.method4232(pb.ticketCycle * 443738891, true);
				if (((Entity) this).aClass351_10067 != null) {
					Object object = null;
					EmitterConfig[] class85s_133_;
					if (i_127_ == 1)
						class85s_133_ = class85s[i_130_];
					else {
						class85s_133_ = new EmitterConfig[i_126_];
						int i_134_ = 0;
					...
					MagnetConfig[] class68s_137_;
					if (i_129_ == 1)
						class68s_137_ = class68s[i_131_];
					else {
						class68s_137_ = new MagnetConfig[i_128_];
						int i_138_ = 0;
					...
					((Entity) this).aClass351_10067.method4231(class_ra, (long) (443738891 * pb.ticketCycle), class85s_133_, class68s_137_, false);
					((Entity) this).aBoolean10128 = true;
				}
			} else if (((Entity) this).aClass351_10067 != null)
				((Entity) this).aClass351_10067.method4233((long) (pb.ticketCycle * 443738891));
	...
	public void method4451(int[] is, int[] is_142_, int i) {
		try {
			if (null == anIntArray10092 && is != null)
				anIntArray10092 = new int[(EquipmentDefaults.aClass405_6892.anIntArray5267).length];
			else if (null == is) {
