...
public class Class75 {
	...
	try {
	    ...
	    pb.anIntArrayArrayArray8767[i] = is;
	}
	...
	try {
	    class105.aString1228 = (String) (((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 -= 969361751) * -203050393)]);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		Class298 class298 = Class301_Sub1.aClass437_7637.get((long) i_6_);
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = class298 != null ? 1 : 0;
	    } else
	...
	try {
	    ...
	    for (Class298_Sub37_Sub5 class298_sub37_sub5_7_ = ((Class298_Sub37_Sub5) Class436.aClass461_5482.first(-1268764084)); class298_sub37_sub5_7_ != null; class298_sub37_sub5_7_ = ((Class298_Sub37_Sub5) Class436.aClass461_5482.next(-1549897657))) {
	    ...
	    if (!bool)
		Class436.aClass461_5482.add(class298_sub37_sub5, (byte) -51);
	}
	catch (RuntimeException runtimeexception) {
