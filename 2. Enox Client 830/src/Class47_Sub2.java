...
public class Class47_Sub2 extends Class47 {
	...
	if (((Class47_Sub2) this).aBoolean6753 && class30_sub1 != null) {
	    float f = (1.0F + (1.0F - Math.abs(((GLToolkit) (((Class47_Sub2) this).aClass_ra_Sub2_491)).aFloatArray8124[1])) * 2.0F);
	    ...
	    OpenGL.glUniform3f(OpenGL.glGetUniformLocation(i, "sunDir"), -(((GLToolkit) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloatArray8124[0]), -(((GLToolkit) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloatArray8124[1]), -(((GLToolkit) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloatArray8124[2]));
	    OpenGL.glUniform4f(OpenGL.glGetUniformLocation(i, "sunColour"), (((GLToolkit) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloat8125) * f, (((GLToolkit) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloat8128) * f, (((GLToolkit) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloat8191) * f, 1.0F);
	    OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i, "sunExponent"), 64.0F + Math.abs(((GLToolkit) (((Class47_Sub2) this).aClass_ra_Sub2_491)).aFloatArray8124[1]) * 928.0F);
	...
	if (((Class47_Sub2) this).aBoolean6755) {
	    ...
	    OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_7_, "time"), (float) (i_1_ * ((GLToolkit) (((Class47_Sub2) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
	...
	if (((Class47_Sub2) this).aBoolean6755) {
	    ...
	    OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_15_, "time"), (float) (i_9_ * ((GLToolkit) (((Class47_Sub2) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
	...
	if (((Class47_Sub2) this).aBoolean6755) {
	    ...
	    OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_23_, "time"), (float) (i_17_ * ((GLToolkit) (((Class47_Sub2) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
    ...
    Class47_Sub2(GLToolkit class_ra_sub2, Class45 class45) {
	super(class_ra_sub2);
	((Class47_Sub2) this).aBoolean6753 = false;
	((Class47_Sub2) this).aClass45_6757 = class45;
	if ((((Class45) ((Class47_Sub2) this).aClass45_6757).aClass30_Sub4_485 != null) && (((GLToolkit) ((Class47_Sub2) this).aClass_ra_Sub2_491).vertex_shader) && (((GLToolkit) ((Class47_Sub2) this).aClass_ra_Sub2_491).fragment_shader)) {
	...
	if (((Class47_Sub2) this).aBoolean6755) {
	    ...
	    OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_32_, "time"), (float) (i_26_ * ((GLToolkit) (((Class47_Sub2) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
	...
	if (((Class47_Sub2) this).aBoolean6755) {
	    ...
	    OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_40_, "time"), (float) (i_34_ * ((GLToolkit) (((Class47_Sub2) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
	...
	if (((Class47_Sub2) this).aBoolean6755) {
	    ...
	    OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_48_, "time"), (float) (i_42_ * ((GLToolkit) (((Class47_Sub2) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
