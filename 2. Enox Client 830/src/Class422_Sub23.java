...
public class Class422_Sub23 extends Class422 {
	...
	try {
		...
		byte[][][] is = pb.aClass283_8716.method2642(899241973);
		byte i_2_ = (byte) (-1953789277 * pb.anInt8777 - 4 & 0xff);
		int i_3_ = (-1953789277 * pb.anInt8777 % pb.aClass283_8716.method2629(-2129604944));
		for (int i_4_ = 0; i_4_ < 4; i_4_++) {
		    for (int i_5_ = 0; i_5_ < pb.aClass283_8716.method2630(-605085367); i_5_++)
			is[i_4_][i_3_][i_5_] = i_2_;
		}
		if (Class99.anInt952 * 1855729883 != 3) {
		    for (int i_6_ = 0; i_6_ < 2; i_6_++) {
			pb.anIntArray8793[i_6_] = -1000000;
			pb.anIntArray8670[i_6_] = 1000000;
			pb.anIntArray8795[i_6_] = 0;
			pb.anIntArray8797[i_6_] = 1000000;
			pb.anIntArray8641[i_6_] = 0;
		    }
		    ...
		    Class244 class244 = pb.aClass283_8716.method2654(688600578);
			...
			if (Class298_Sub1.anInt7164 * -863531439 == 4 || Class100.anInt1081 * 1329981847 != -1) {
			    ...
			    else if (pb.anInt8756 * -104436553 < 2560) {
				...
				if (i_12_ > i_10_)
				    ...
				    i_14_ = i_10_ - i_12_;
				if (0 == i_13_ && 0 == i_14_ || i_13_ <= -pb.aClass283_8716.method2629(-1952640446) || i_13_ >= pb.aClass283_8716.method2629(-2135239698) || i_14_ <= -pb.aClass283_8716.method2630(115807107) || i_14_ >= pb.aClass283_8716.method2630(-1212701794)) {
				    WorldTile class341 = pb.aClass283_8716.method2628(681479919);
				    IPAddress.method6062(new StringBuilder().append(i_9_).append(Class26.aString353).append(i_10_).append(" ").append(i_11_).append(Class26.aString353).append(i_12_).append(" ").append(class341.x * -1760580017).append(Class26.aString353).append(class341.y * 283514611).toString(), new RuntimeException(), (short) -16769);
				    break;
				}
				if (i_13_ > i_14_) {
