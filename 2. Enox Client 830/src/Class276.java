...
public class Class276 {
	...
	int anInt2920;
	int anInt2921;
	static Sprite aClass57_2922;
	int anInt2923;
	static int anInt2924 = 512;
	Sprite aClass57_2925;
	int anInt2926;
	int anInt2927;
	int anInt2928;
	...
	int anInt2935;
	static Model aClass387_2936;
	static Sprite aClass57_2937;
	...
	boolean method2575(Toolkit class_ra, Class276 class276_0_) {
		return (((Class276) this).aClass57_2925 != null || method2578(class_ra, class276_0_));
	}

	static void method2576(Toolkit class_ra) {
		if (aClass387_2936 == null) {
			ModelDecoder class64 = new ModelDecoder(580, 1104, 1);
			class64.method757((short) 0, (short) 32767, (short) 0, (short) 1024, (short) 1024, (short) 1024, (byte) 0,
					(byte) 0, (byte) 0);
			...
			class64.maxVertexUsed = class64.vertexCount;
			class64.faceBones = null;
			class64.vertexBones = null;
			class64.facePriorities = null;
			aClass387_2936 = class_ra.createModel(class64, 51200, 33, 64, 768);
		}
	}

	void method2577(Toolkit class_ra, int i, int i_14_, int i_15_, int i_16_, int i_17_, int i_18_, int i_19_,
		...
		if (((Class276) this).aClass57_2925 != null) {
			...
			if (!(fs[2] < 0.0F)) {
				...
				if (i_27_ < i_16_ && i_27_ + ((Class276) this).anInt2920 > 0 && i_26_ < i_15_
						&& i_26_ + ((Class276) this).anInt2920 > 0)
					((Class276) this).aClass57_2925.method634(i_26_, i_27_, ((Class276) this).anInt2920,
							((Class276) this).anInt2920, 0, i_22_ << 24 | 0xffffff, 1);
			}
		}
	}

	boolean method2578(Toolkit class_ra, Class276 class276_28_) {
		if (((Class276) this).aClass57_2925 == null) {
			if (((Class276) this).anInt2928 == 0) {
				TextureMetrics class53 = Class277.anInterface_ma2955.getTexture(anInt2918, 0);
				if (Class277.anInterface_ma2955.method170(class53.textureId, (short) 14716)) {
					int[] is = (Class277.anInterface_ma2955.method172(class53.textureId, 0.7F,
							class53.bitLoad, class53.bitLoad, false, (byte) 2));
					((Class276) this).aClass57_2925 = class_ra.method5031(is, 0, class53.bitLoad,
							class53.bitLoad, class53.bitLoad, -1518966523);
				}
	...
	boolean method2579(int i, int i_29_, int i_30_, int i_31_) {
		...
		if (i_35_ > 128) {
			...
			((Class276) this).anInt2920 = (((Class276) this).anInt2931 * i_31_
					/ (((Class276) this).aBoolean2913 ? 1024 : ((Class276) this).anInt2919));
		} else
		...
		int i_36_ = Class416.nextPowerOfTwo(((Class276) this).anInt2920, (byte) 16);
		if (i_36_ > i_31_)
		...
		((Class276) this).anInt2927 = (int) (Math.asin((double) ((float) i_33_ / 256.0F)) * 2607.5945876176133)
				& 0x3fff;
	...
	void method2580(Toolkit class_ra, Class276 class276_37_) {
		method2576(class_ra);
		method2581(class_ra);
		class_ra.qa(anIntArray2938);
		class_ra.r(0, 0, ((Class276) this).anInt2923, ((Class276) this).anInt2923);
		class_ra.ba(2, 0);
		class_ra.B(0, 0, ((Class276) this).anInt2923, ((Class276) this).anInt2923,
				~0xffffff | ((Class276) this).anInt2935, 0);
		int i = 0;
		int i_38_ = 0;
		int i_39_ = 256;
		...
		Model class387 = aClass387_2936.method4755((byte) 0, 51200, true);
		...
		class233_47_.method2153((float) (((Class276) this).anInt2923 / 2), (float) (((Class276) this).anInt2923 / 2),
				(float) i_46_, (float) i_46_, 50.0F, 50000.0F, (float) class_ra.method4992((short) 17114).method545(),
				(float) class_ra.method4992((short) -20188).method552(), 1024.0F);
		...
		((Class276) this).aClass57_2925 = class_ra.method5033(0, 0, ((Class276) this).anInt2923,
				((Class276) this).anInt2923, true);
		class_ra.ba(2, 0);
	...
	static void method2581(Toolkit class_ra) {
			...
			for (int i = 0; i < 64; i++) {
				...
				for (int i_55_ = 0; i_55_ < 64; i_55_++) {
					...
					if (i_58_ < 0)
						...
						i_58_ = 255;
					int i_59_ = i_58_ / 2;
					is_50_[i_53_ + i_55_] = is_50_[i_53_
							+ i_57_] = is_50_[i_54_ + i_55_] = is_50_[i_54_ + i_57_] = ~0xffffff | i_58_ << 16;
					is[i_53_ + i_55_] = is[i_53_
							+ i_57_] = is[i_54_ + i_55_] = is[i_54_ + i_57_] = 127 - i_59_ << 24 | 0xffffff;
				}
			}
	...
	void method2582(Toolkit class_ra, Class276 class276_60_) {
		ModelDecoder class64 = ModelDecoder.getModel(Class465.aClass243_6520, ((Class276) this).anInt2918, 0);
		if (class64 != null) {
			class_ra.qa(anIntArray2938);
			class_ra.r(0, 0, ((Class276) this).anInt2923, ((Class276) this).anInt2923);
			class_ra.ba(2, 0);
			...
			class64.method754(((Class276) this).anInt2926 & 0x3fff, ((Class276) this).anInt2917 & 0x3fff,
					((Class276) this).anInt2915 & 0x3fff);
			Model class387 = class_ra.createModel(class64, 2048, 0, 64, 768);
			...
			class233_75_.method2153((float) (((Class276) this).anInt2923 / 2),
					(float) (((Class276) this).anInt2923 / 2), (float) i_74_, (float) i_74_, 50.0F, 50000.0F,
					(float) class_ra.method4992((short) -8264).method545(),
					(float) class_ra.method4992((short) 11671).method552(), 1024.0F);
	...
	public Class276(int i, int i_77_, int i_78_, int i_79_, int i_80_, int i_81_, int i_82_, boolean bool, int i_83_,
			int i_84_, int i_85_) {
