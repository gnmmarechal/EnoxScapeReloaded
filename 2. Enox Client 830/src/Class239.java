...
public class Class239 {
	...
	try {
		...
		if (-1 == i_6_)
		    ...
		    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = Class316.aClass362_3318.method4307(i_6_, 245040087).method4570(i_7_, string, 1005518410);
	    } else {
		...
		if (i_6_ == -1)
		    ...
		    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = Class316.aClass362_3318.method4307(i_6_, 245040087).method4568(i_7_, i_8_, (byte) -64);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class505 class505 = class105.method1113(Class497.aClass197_6105, pb.anInterface10_8700, (byte) -46);
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = point.y;
	}
	catch (RuntimeException runtimeexception) {
