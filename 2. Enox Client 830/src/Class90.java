...
public class Class90 {
	...
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub22_7586, (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]) == 1 ? 1 : 0, 869927846);
	...
	try {
	    ...
	    if (pb.anInt8752 * -1233866115 != 14 || Class315.method3837((byte) -13))
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
	    else
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = Class372.method4589(i_1_, string, 955770805) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
