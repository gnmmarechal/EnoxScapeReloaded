...
public class Class366 {
    ...
    public Model method4543(Toolkit class_ra, int i, Class144 class144, Class507 class507, Class477 class477, Class395 class395, Interface23 interface23, Class438 class438, int i_15_) {
	try {
		...
		class387 = (Model) aClass348_3980.get(5093099708756449067L * (((Class366) this).aLong3975));
	    }
	    if (class387 == null || class_ra.method5017(class387.m(), i_16_) != 0) {
		if (null != class387)
		    i_16_ = class_ra.mergeFunctionMasks(i_16_, class387.m());
		int i_17_ = i_16_;
		boolean bool = false;
		...
		if (bool)
		    return null;
		ModelDecoder[] class64s = new ModelDecoder[((Class366) this).anIntArray3969.length];
		int i_20_ = 0;
		for (int i_21_ = 0; i_21_ < ((Class366) this).anIntArray3969.length; i_21_++) {
			...
			ModelDecoder class64 = (class477.getItemDefinitions(i_22_ & 0x3fffffff).method6040(aBoolean3977, class464, 327827223));
			if (class64 != null)
			    class64s[i_20_++] = class64;
		    } else if ((i_22_ & ~0x7fffffff) != 0) {
			ModelDecoder class64 = class144.method1579(i_22_ & 0x3fffffff, -276971058).method1476(1209505122);
			if (null != class64)
			    class64s[i_20_++] = class64;
		    }
		}
		ModelDecoder class64 = new ModelDecoder(class64s, i_20_);
		i_17_ |= 0x4000;
		class387 = class_ra.createModel(class64, i_17_, anInt3981 * 1931277641, 64, 768);
		...
		class387.KA(i_16_);
		synchronized (aClass348_3980) {
		    aClass348_3980.put(class387, (((Class366) this).aLong3975 * 5093099708756449067L));
		}
	    }
	    if (null == class438)
		return class387;
	    Model class387_25_ = class387.method4755((byte) 4, i_16_, true);
    ...
    public Model method4544(Toolkit class_ra, int i, Class144 class144, Class395 class395, Class438 class438, int i_26_, int i_27_, int i_28_, byte i_29_) {
	try {
	    int i_30_ = class438 != null ? i | class438.method5829(-1790708337) : i;
	    long l = (long) i_28_ << 32 | (long) (i_27_ << 16) | (long) i_26_;
	    Model class387;
	    synchronized (aClass348_3980) {
		class387 = (Model) aClass348_3980.get(l);
	    }
	    do {
		if (class387 == null || class_ra.method5017(class387.m(), i_30_) != 0) {
		    if (null != class387)
			i_30_ = class_ra.mergeFunctionMasks(i_30_, class387.m());
		    int i_31_ = i_30_;
		    ModelDecoder[] class64s = new ModelDecoder[3];
		    int i_32_ = 0;
			...
			ModelDecoder class64 = class144.method1579(i_26_, -156721354).method1476(1042420956);
			if (class64 != null)
			...
			if (null != class64)
			    class64s[i_32_++] = class64;
			class64 = new ModelDecoder(class64s, i_32_);
			i_31_ |= 0x4000;
			class387 = class_ra.createModel(class64, i_31_, 1931277641 * anInt3981, 64, 768);
    ...
    public Model method4545(Toolkit class_ra, int i, Class349 class349, Class144 class144, Class507 class507, Class477 class477, Class395 class395, Interface23 interface23, Class438 class438, Class438 class438_35_, Class438[] class438s, int[] is, int i_36_, boolean bool, Class405 class405, int i_37_) {
	try {
	    ...
	    if (null != class438) {
		AnimationDefinition class391 = class438.method5820(28542107);
		if (null != class391 && (609841829 * class391.offhand >= 0 || 1548903495 * class391.mainhand >= 0)) {
		    ...
		    if (class391.offhand * 609841829 >= 0 && -1 != -817429509 * class405.anInt5266) {
			bool_40_ = true;
			if (65535 == class391.offhand * 609841829) {
			    ...
			    is_39_[-817429509 * class405.anInt5266] = 609841829 * class391.offhand | 0x40000000;
		    ...
		    if (1548903495 * class391.mainhand >= 0 && -1 != class405.anInt5270 * -2126257265) {
			bool_41_ = true;
			if (class391.mainhand * 1548903495 == 65535) {
			    ...
			    is_39_[-2126257265 * class405.anInt5270] = 1548903495 * class391.mainhand | 0x40000000;
		...
		class387 = (Model) aClass348_3979.get(l);
	    }
		...
		if (null != class387)
		    i_38_ = class_ra.mergeFunctionMasks(i_38_, class387.m());
		int i_52_ = i_38_;
		...
		if (bool_53_) {
			...
			synchronized (aClass348_3979) {
			    class387 = (Model) (aClass348_3979.get(4366628042331861927L * ((Class366) this).aLong3966));
			}
		    }
		    if (null == class387 || class_ra.method5017(class387.m(), i_38_) != 0)
			return null;
		} else {
		    ModelDecoder[] class64s = new ModelDecoder[is_39_.length];
			...
			if (0 != (i_60_ & 0x40000000)) {
			    ...
			    ModelDecoder class64 = (class477.getItemDefinitions(i_60_ & 0x3fffffff).method6028(aBoolean3977, class464, -1675025463));
			    if (null != class64)
				class64s[i_59_] = class64;
			} else if (0 != (i_60_ & ~0x7fffffff)) {
			    ModelDecoder class64 = class144.method1579(i_60_ & 0x3fffffff, -959041423).method1474((byte) 93);
			    if (null != class64)
				class64s[i_59_] = class64;
			}
		    }
		    ...
		    ModelDecoder class64 = new ModelDecoder(class64s, class64s.length);
		    i_52_ |= 0x4000;
		    class387 = class_ra.createModel(class64, i_52_, 1931277641 * anInt3981, 64, 850);
	    ...
	    Model class387_71_ = class387.method4755((byte) 4, i_38_, true);
	...
	try {
	    pb.aClass25_8693.method384((byte) 4);
