...
public final class Class501 {
	...
	try {
		...
		if (-1 != pb.WINDOW_PANE_ID * -257444687)
		    Class82_Sub8.method893(-257444687 * pb.WINDOW_PANE_ID, -2042512871);
		for (Interface class298_sub51 = ((Interface) pb.aClass437_8841.method5816(1741120464)); null != class298_sub51; class298_sub51 = ((Interface) pb.aClass437_8841.method5815((byte) 42))) {
		    if (!class298_sub51.method2840(-629325116)) {
			class298_sub51 = ((Interface) pb.aClass437_8841.method5816(1941104676));
		...
		pb.WINDOW_PANE_ID = 62030331 * HashTable.aClass371_5520.anInt4042;
		Class257.method2453(false, (byte) 8);
		Class360.method4301(-960032596);
		Class14.method341(-257444687 * pb.WINDOW_PANE_ID, null, 2019085039);
	    }
	    Class209.method1939(-2068735860);
	    Class360.aBoolean3912 = false;
	    ConfigDefinitions.method3983(1449725764);
	    pb.anInt8937 = 280458557;
	    Class518.method6314(pb.anInt8831 * 1203044105, 614001892);
	    Class287.myPlayer = new Player(null);
	    Class287.myPlayer.method4341((float) (pb.aClass283_8716.method2629(-1895849411) * 512 / 2), 0.0F, (float) (pb.aClass283_8716.method2630(501771104) * 512 / 2));
	    Class287.myPlayer.scenePositionXQueue[0] = pb.aClass283_8716.method2629(-1873805931) / 2;
	    Class287.myPlayer.scenePositionYQueue[0] = pb.aClass283_8716.method2630(2001443939) / 2;
	    ...
	    pb.aClass283_8716.method2640((byte) -45).method4324(-1834713428);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (null != pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i])
		    throw new RuntimeException();
		Class410 class410 = Class10.aClass410Array138[i];
		Player class365_sub1_sub1_sub2_sub2 = (pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i] = (new Player(pb.aClass283_8716.method2675(-1611682495))));
		...
		int i_22_ = (i_20_ << 6) + i_16_ - class341.x * -1760580017;
		int i_23_ = (i_21_ << 6) + i_17_ - 283514611 * class341.y;
		class365_sub1_sub1_sub2_sub2.aBoolean10203 = ((Class410) class410).aBoolean5287;
		class365_sub1_sub1_sub2_sub2.isClanMember = ((Class410) class410).aBoolean5289;
		...
		if (pb.aClass283_8716.method2654(1040339757).method2320(i_22_, i_23_, -937818147))
