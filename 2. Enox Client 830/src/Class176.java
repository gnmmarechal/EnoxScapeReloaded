...
public class Class176 {
	...
	void method1827(AbstractToolkit class_ra_sub3) {
	...
	void method1829(AbstractToolkit class_ra_sub3, Class69 class69) {
		...
		for (Class302_Sub3 class302_sub3_5_ = class302_sub3.aClass302_Sub3_7650; class302_sub3_5_ != class302_sub3; class302_sub3_5_ = class302_sub3_5_.aClass302_Sub3_7650) {
			...
			int i_6_ = (int) (f * (float) (class302_sub3_sub1.x >> 12)
					+ f_0_ * (float) (class302_sub3_sub1.y >> 12)
					+ f_1_ * (float) (class302_sub3_sub1.z >> 12) + f_2_);
			if (i_6_ > i_4_)
				i_4_ = i_6_;
			if (i_6_ < i_3_)
				i_3_ = i_6_;
		...
		Class130 class130 = ((AbstractToolkit) class_ra_sub3).aClass130_8249;
			...
			for (/**/; class302_sub3_9_ != class302_sub3; class302_sub3_9_ = class302_sub3_9_.aClass302_Sub3_7650) {
				...
				if (i_14_ < 1600) {
					if (((Class176) this).anIntArray1781[i_14_] < 64)
						...
						((Class176) this).aClass302_Sub3_Sub1ArrayArray1784[((Class176) this).anIntArray1781[i_14_] - 64
								- 1][((Class176) this).anIntArray1782[(((Class176) this).anIntArray1781[i_14_] - 64
										- 1)]++] = class302_sub3_sub1;
					}
				}
			}
			class130.anInterface9_Impl2_1492 = null;
			if (i_10_ >= 0) {
				TextureMetrics class53 = class_ra_sub3.anInterface_ma5299.getTexture(i_10_, 0);
				if (class53.textureId != -1)
					class130.anInterface9_Impl2_1492 = class_ra_sub3.aClass157_8351.method1698(class53);
				class_ra_sub3.method9662(class53.blendMode);
			}
	...
	void method1830(AbstractToolkit class_ra_sub3, int i) {
		int i_15_ = 0;
		...
		for (int i_30_ = i - 1; i_30_ >= 0; i_30_--) {
			...
			if (i_31_ > 0) {
				for (int i_32_ = i_31_ - 1; i_32_ >= 0; i_32_--) {
					...
					int i_33_ = class302_sub3_sub1.colour;
					byte i_34_ = (byte) (i_33_ >> 16);
					byte i_35_ = (byte) (i_33_ >> 8);
					byte i_36_ = (byte) i_33_;
					byte i_37_ = (byte) (i_33_ >>> 24);
					float f_38_ = (float) (class302_sub3_sub1.x >> 12);
					float f_39_ = (float) (class302_sub3_sub1.y >> 12);
					float f_40_ = (float) (class302_sub3_sub1.z >> 12);
					int i_41_ = class302_sub3_sub1.size >> 12;
					...
					if (((AbstractToolkit) class_ra_sub3).anInt8346 == 0) {
				...
				if (((Class176) this).anIntArray1781[i_30_] > 64) {
					...
					for (int i_43_ = ((Class176) this).anIntArray1782[i_42_] - 1; i_43_ >= 0; i_43_--) {
						...
						int i_44_ = class302_sub3_sub1.colour;
						byte i_45_ = (byte) (i_44_ >> 16);
						byte i_46_ = (byte) (i_44_ >> 8);
						byte i_47_ = (byte) i_44_;
						byte i_48_ = (byte) (i_44_ >>> 24);
						float f_49_ = (float) (class302_sub3_sub1.x >> 12);
						float f_50_ = (float) (class302_sub3_sub1.y >> 12);
						float f_51_ = (float) (class302_sub3_sub1.z >> 12);
						int i_52_ = class302_sub3_sub1.size >> 12;
	...
	Class176(AbstractToolkit class_ra_sub3) {
		...
		((Class176) this).anInt1777 = 0;
		((Class176) this).aClass153_1774 = (class_ra_sub3.method5404(new Class181[] {
				new Class181(
						new Class155[] { Class155.aClass155_1610, Class155.aClass155_1597, Class155.aClass155_1599 }),
