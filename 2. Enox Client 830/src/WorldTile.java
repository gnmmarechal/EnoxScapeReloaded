...
public class WorldTile {
	...
	try {
	    return new StringBuilder().append(plane * 1008331379).append(",").append(-1760580017 * x >> 6).append(",").append(283514611 * y >> 6).append(",").append(-1760580017 * x & 0x3f).append(",").append(283514611 * y & 0x3f).toString();
	}
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = -749038817 * class105.anInt1155;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1223 * -1993792969;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (pb.anInt8942 * 1131012101 == 2 && i_4_ < pb.anInt8941 * -1054937867)
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = pb.aBooleanArray8950[i_4_] ? 1 : 0;
	    else
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_5_ >> 14 & 0x3fff;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (class365_sub1_sub1_sub2.aClass438_10078.method5819((byte) -91) && !class365_sub1_sub1_sub2.aClass438_10078.method5826(-65534)) {
		    AnimationDefinition class391 = class365_sub1_sub1_sub2.aClass438_10078.method5820(295193907);
		    if (class365_sub1_sub1_sub2.anInt10125 * 1888275831 > 0 && 62820525 * class391.animatingPrecedence == 0) {
			class365_sub1_sub1_sub2.anInt10124 += -248378059;
			Class331.anInt3565 = Class282.aClass282_6543.aByte6542 * -2059464589;
			Class431.anInt6504 = 0;
			return;
		    }
		    if (1888275831 * class365_sub1_sub1_sub2.anInt10125 <= 0 && 0 == class391.walkingPrecedence * -882531177) {
			class365_sub1_sub1_sub2.anInt10124 += -248378059;
		...
		for (int i_6_ = 0; i_6_ < class365_sub1_sub1_sub2.currentGraphics.length; i_6_++) {
			...
			GraphicDefinition class398 = (Class158_Sub1.aClass389_8568.getGraphicDefinition((class365_sub1_sub1_sub2.currentGraphics[i_6_].id) * -967533709, -1879864965));
			if (class398.aBoolean5215 && class398.animation * 1505778629 != -1) {
			    AnimationDefinition class391 = (Class501.aClass395_6122.getAnimationDefinition(1505778629 * class398.animation, (byte) -112));
			    if ((class365_sub1_sub1_sub2.anInt10125 * 1888275831) > 0 && class391.animatingPrecedence * 62820525 == 0) {
				class365_sub1_sub1_sub2.anInt10124 += -248378059;
				Class331.anInt3565 = (-2059464589 * Class282.aClass282_6543.aByte6542);
				Class431.anInt6504 = 0;
				return;
			    }
			    if ((class365_sub1_sub1_sub2.anInt10125 * 1888275831) <= 0 && 0 == class391.walkingPrecedence * -882531177) {
				class365_sub1_sub1_sub2.anInt10124 += -248378059;
				Class331.anInt3565 = (Class282.aClass282_6543.aByte6542 * -2059464589);
				Class431.anInt6504 = 0;
				return;
	...
	try {
	    ...
	    if (pb.aBoolean8667) {
		int i_25_ = -256;
		if (914379507 * pb.anInt6467 < 20)
		    i_25_ = -65536;
		Class343.aClass264_3673.method2474(new StringBuilder().append("Fps:").append(914379507 * pb.anInt6467).toString(), i_23_, i_24_, i_25_, -1, (byte) -7);
		i_24_ += 15;
		...
		i_24_ += 15;
		long l_28_ = ((Class25) pb.aClass25_8711).aClass124_340.method1384(1026179047);
		String string = "N/A";
		if (-1L != l_28_) {
		...
		Class343.aClass264_3673.method2474(new StringBuilder().append("Game: In:").append(-1705791507 * ((Class25) pb.aClass25_8711).anInt343).append("B/s ").append("Out:").append(((Class25) pb.aClass25_8711).anInt327 * 1114720205).append("B/s ").append("Ping:").append(string).toString(), i_23_, i_24_, -256, -1, (byte) -47);
		i_24_ += 15;
		long l_29_ = ((Class25) pb.aClass25_8693).aClass124_340.method1384(529918549);
		...
		Class343.aClass264_3673.method2474(new StringBuilder().append("Lobby: In:").append(((Class25) pb.aClass25_8693).anInt343 * -1705791507).append("B/s ").append("Out:").append(1114720205 * ((Class25) pb.aClass25_8693).anInt327).append("B/s ").append("Ping:").append(string_30_).toString(), i_23_, i_24_, -256, -1, (byte) -30);
		i_24_ += 15;
		int i_31_ = Class373.activeToolkit.za() / 1024;
	...
	try {
		...
		if (i_47_ != (974385733 * ((Class298_Sub41) class298_sub41).anInt7439)) {
		    int i_49_ = (SunDefinition.method1398((((Class298_Sub41) class298_sub41).aClass365_Sub1_Sub1_Sub2_Sub1_7433), 2092032929));
	...
	try {
	    int i_53_ = (((Class403) class403).anIntArray5257[1883543357 * ((Class403) class403).anInt5259]);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Player) ((Class403) class403).aClass365_Sub1_Sub1_Sub2_5242).aClass70_10223.method798(i_53_, 1440952834);
	}
	catch (RuntimeException runtimeexception) {
