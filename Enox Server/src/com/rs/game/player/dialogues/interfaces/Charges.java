    ...
    public void run(int interfaceId, int componentId) {
        ...
        case 0:
        	if(componentId == OPTION_1) {
        		if (player.getInventory().containsItem(12852, 500)) {
        			player.getInventory().deleteItem(12852, 500);
        		...
        		if (player.getInventory().containsItem(12852, 2250)) {
        			player.getInventory().deleteItem(12852, 2250);
            ...
            break;
        		...
        		if (player.getInventory().containsItem(12852, 4500)) {
        			player.getInventory().deleteItem(12852, 4500);
            ...
            break;
        		...
        		if (player.getInventory().containsItem(12852, 20000)) {
        			player.getInventory().deleteItem(12852, 20000);
            ...
            break;
        		...
        		if (player.getInventory().containsItem(12852, 35000)) {
        			player.getInventory().deleteItem(12852, 35000);
