...
public class SlayerMasterD extends Dialogue {
	...
	if (stage == -1) {
		...
		sendOptionsDialogue("Chose an option", "How many monsters do I have left?", "What do you have in your shop?", "Give me a tip.", "Nothing, Nevermind.");
		stage = 0;
	    } else {
	    ...
	    sendOptionsDialogue("Chose an option", "Can you become my master?", "What do you have in your shop?", "Nothing, Nevermind.");
	    stage = 3;
	} else if (stage == 3) {
	    if (componentId == OPTION_1) {
		stage = 6;
