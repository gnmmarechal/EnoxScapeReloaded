...
public class Class451 {
	...
	try {
		...
		return class443;
	    byte[] is;
	    synchronized (((Class451) this).idx2) {
		is = (((Class451) this).idx2.getFile(-1006924897 * ConfigEntry.aClass120_1428.anInt1460, i));
	    }
	    class443 = new Class443();
	    if (is != null)
		class443.method5882(new RsByteBuffer(is), (byte) -31);
	    synchronized (((Class451) this).aClass348_5640) {
		((Class451) this).aClass348_5640.put(class443, (long) i);
	    }
	    return class443;
	}
	catch (RuntimeException runtimeexception) {
	...
	((Class451) this).idx2 = class243;
	((Class451) this).idx2.getFileCountForArchive((-1006924897 * (ConfigEntry.aClass120_1428.anInt1460)), -978414795);
    }
	...
	try {
	    ...
	    int i_3_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 1]);
	    Class497 class497 = Class92.aClass504_905.method6251(i_3_, 1053350248);
	    if (class497.method6206(1883696427))
		((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = Class501.aClass395_6122.getAnimationDefinition(i_2_, (byte) -26).method4877(i_3_, class497.aString6101, -130818690);
	    else
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = (Class501.aClass395_6122.getAnimationDefinition(i_2_, (byte) 51).method4881(i_3_, -388931549 * class497.anInt6100, 240769181));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		AnimationDefinition.method4884(class365_sub1_sub1_sub2_sub2.plane, (class365_sub1_sub1_sub2_sub2.scenePositionXQueue[0]), (class365_sub1_sub1_sub2_sub2.scenePositionYQueue[0]), 0, null, null, class365_sub1_sub1_sub2_sub2, (byte) 58);
	    else
