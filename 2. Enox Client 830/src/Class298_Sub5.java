...
public class Class298_Sub5 extends Class298 {
	...
	if (((Class298_Sub5) this).anInt7199 != -1) {
	    TextureMetrics class53 = ((Class298_Sub5) this).aClass_ra_Sub2_7197.anInterface_ma5299.getTexture(((Class298_Sub5) this).anInt7199, 1908731420);
	    int i_4_ = class53.shadowFactor & 0xff;
	    if (i_4_ != 0 && class53.effectId != 4) {
		int i_5_;
		if (i_3_ < 0)
		    i_5_ = 0;
		else if (i_3_ > 127)
	    ...
	    int i_8_ = class53.brightness & 0xff;
	    if (i_8_ != 0) {
		i_8_ += 256;
	...
	((Class298_Sub5) this).aNativeHeapBuffer7195 = ((GLToolkit) ((Class298_Sub5) this).aClass_ra_Sub2_7197).aNativeHeap8181.f(i * 4, true);
	...
	((Class298_Sub5) this).aClass32_7193 = new OpenGlArrayBufferPointer(interface1, 5121, 4, 0);
	...
	int i_16_ = 0;
	RsFloatBuffer class298_sub53_sub1 = (((GLToolkit) ((Class298_Sub5) this).aClass_ra_Sub2_7197).aClass298_Sub53_Sub1_8197);
	class298_sub53_sub1.index = 0;
	if (((GLToolkit) ((Class298_Sub5) this).aClass_ra_Sub2_7197).aBoolean8143) {
	...
	if (i_16_ > 0) {
	    ...
	    if (((GLToolkit) ((Class298_Sub5) this).aClass_ra_Sub2_7197).aBoolean8146)
