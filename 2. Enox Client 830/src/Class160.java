...
public class Class160 {
    ...
    static Sprite[] aClass57Array1646;
    public static JS5 idx3;

    public void method1707(ClanSettings class162, byte i) {
	try {
	    if ((2334843941678543823L * ((ClanSettings) class162).aLong1663 != -6211723929392173281L * ((Class160) this).aLong1643) || (((Class160) this).anInt1631 * 2001926135 != -934549233 * ((ClanSettings) class162).nextUpdateNumber))
	    ...
	    ((ClanSettings) class162).nextUpdateNumber += 1441392111;
	}
	...
	try {
		...
		((Class160) this).aClass453_1632.add(class298_sub40);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = class468.aStringArray5732[i_2_ - 1];
	    else
	...
	try {
	    ...
	    int i_5_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 2]);
