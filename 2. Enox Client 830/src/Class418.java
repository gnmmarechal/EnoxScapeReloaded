...
public final class Class418 {
	...
	try {
	    IComponentDefinition class105 = Class50.getIComponentDefinitions((((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]), (byte) -64);
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (class369.anIntArrayArray4017 == null ? 0 : class369.anIntArrayArray4017.length);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		RsByteBuffer class298_sub53 = new RsByteBuffer(pb.aByteArray8843);
