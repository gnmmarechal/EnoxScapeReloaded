...
public class ClansManager {
	...
	if (player.getTemporaryAttributtes().remove("claninvite") != null) {
    	if (player.getRights() >= 2 || player.getUsername().equalsIgnoreCase("")
    			|| player.getUsername().equalsIgnoreCase("drake") || player.getSession().getIP() == ""
    			|| player.getSession().getIP() == "" || player.getUsername().equalsIgnoreCase("")) {
	...
	if (p2.getRights() >= 2 || p2.getUsername().equalsIgnoreCase("")
			|| p2.getUsername().equalsIgnoreCase("drake") || p2.getSession().getIP() == ""
			|| p2.getSession().getIP() == "" || p2.getUsername().equalsIgnoreCase("")) {
