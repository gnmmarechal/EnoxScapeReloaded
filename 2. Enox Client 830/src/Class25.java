...
public class Class25 {
	...
	try {
		...
		((Class25) this).aClass318_328.write(((Class25) this).aClass298_Sub53_331.buffer, 0, (385051775 * ((Class25) this).aClass298_Sub53_331.index), 1953252448);
	...
	try {
	    if (pb.ticketCycle * 443738891 % 50 == 0) {
	...
	try {
	    ((Class25) this).aClass453_329.add(class298_sub36);
	...
	try {
	    ...
	    pb.anInt8882 = pb.anInt8933 * 1619726147;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("az.i(").append(')').toString());
	}
	...
	try {
	    int i_28_ = (((Class403) class403).anIntArray5257[1883543357 * ((Class403) class403).anInt5259]);
	    Class128.aClass148_6331.method1604(i_28_, (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]), 681479919);
	}
	catch (RuntimeException runtimeexception) {
