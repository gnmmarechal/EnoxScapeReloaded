...
public abstract class Class319 {
    ...
    static void method3900(Toolkit class_ra, int i, int i_0_, int i_1_, int i_2_, int i_3_, Class264 class264, Class505 class505, String string, int i_4_) {
	try {
		...
		if (Class158.idx8.fileLoaded(Class362.anInt3918 * 142643703, -457216440) && Class158.idx8.fileLoaded(((Class422_Sub14.anInt8400) * 1757615047), -457216440)) {
	...
	try {
	    ...
	    int i_10_ = (((Class403) class403).anIntArray5244[2 + ((Class403) class403).anInt5239 * 681479919]);
	    int i_11_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 3]);
	    i_8_ += i_9_ << 14;
	    i_8_ += i_10_ << 28;
	    i_8_ += i_11_;
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_8_;
	}
	catch (RuntimeException runtimeexception) {
