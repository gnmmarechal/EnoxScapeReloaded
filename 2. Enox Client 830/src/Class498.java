...
public class Class498 {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7587.method5726(-2147059683);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    String string_2_ = ((String) (((Class403) class403).anObjectArray5240[-203050393 * ((Class403) class403).anInt5241 + 1]));
	    int i_3_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = string == null ? 0 : string.indexOf(string_2_, i_3_);
	}
	catch (RuntimeException runtimeexception) {
