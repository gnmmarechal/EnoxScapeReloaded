...
public class Class298_Sub19_Sub3 extends Class298_Sub19 {
	...
	try {
	    ...
	    ((Class298_Sub19_Sub3) this).aClass453_9259.add(class298_sub30);
	...
	try {
	    for (int i_11_ = 0; i_11_ < -1230451913 * pb.anInt8703; i_11_++) {
		int i_12_ = pb.anIntArray8699[i_11_];
		Class298_Sub29 class298_sub29 = ((Class298_Sub29) pb.aClass437_8696.get((long) i_12_));
	...
	try {
	    if ((((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]) == 0)
