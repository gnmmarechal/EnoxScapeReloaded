...
public class Class487 {
    ...
    public MapIconDefinitions method6159(int i, int i_0_) {
	try {
	    MapIconDefinitions mapIconDefinitions;
	    synchronized (((Class487) this).aClass348_6064) {
		mapIconDefinitions = (MapIconDefinitions) ((Class487) this).aClass348_6064.get((long) i);
	    }
	    if (mapIconDefinitions != null)
		return mapIconDefinitions;
	    byte[] is;
	    synchronized (((Class487) this).idx2) {
		is = (((Class487) this).idx2.getFile(ConfigEntry.aClass120_1419.anInt1460 * -1006924897, i));
	    }
	    mapIconDefinitions = new MapIconDefinitions();
	    ((MapIconDefinitions) mapIconDefinitions).aClass487_6095 = this;
	    if (is != null)
		mapIconDefinitions.method6196(new RsByteBuffer(is), -1377008682);
	    synchronized (((Class487) this).aClass348_6064) {
		((Class487) this).aClass348_6064.put(mapIconDefinitions, (long) i);
	    }
	    return mapIconDefinitions;
	}
	...
	((Class487) this).idx2 = class243;
	((Class487) this).aClass243_6068 = class243_3_;
	((Class487) this).idx2.getFileCountForArchive((ConfigEntry.aClass120_1419.anInt1460) * -1006924897, 1339445894);
	Math.random();
	Math.random();
	Math.random();
	Math.random();
	...
	try {
	    ...
	    if (string != null)
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = string.length();
	    else
