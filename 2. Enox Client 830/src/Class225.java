...
public class Class225 {
    ...
    RemoteRequest aClass298_Sub37_Sub16_Sub1_2507;
    BigInteger aBigInteger2508;
    Class247 aClass247_2509;
    RsByteBuffer aClass298_Sub53_2510;
    ChecksumTableEntry[] aClass242_Sub1Array2511;
	...
	try {
	    ...
	    if (((RemoteRequest) ((Class225) this).aClass298_Sub37_Sub16_Sub1_2507).aBoolean9670)
		return false;
	    ...
	    ((Class225) this).aClass242_Sub1Array2511 = new ChecksumTableEntry[i_0_];
	...
	try {
	    ...
	    ChecksumTableEntry class242_sub1 = new ChecksumTableEntry(i, class329, class329_7_, ((Class225) this).aClass247_2509, ((Class225) this).aClass255_2505, i_9_, is, i_10_, bool);
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class485.anInt6059 * 551398421;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (-1188221251 * ((Class298_Sub1) class298_sub1).anInt7148 < 0 || Class140.method1559(pb.aClass283_8716.method2641(681883413), (-1188221251 * (((Class298_Sub1) class298_sub1).anInt7148)), (-366156959 * (((Class298_Sub1) class298_sub1).anInt7154)), (byte) -3)) {
		    if (!bool)
			GraphicDefinition.method4923((((Class298_Sub1) class298_sub1).anInt7151 * 2108312995), (((Class298_Sub1) class298_sub1).anInt7157 * -431456739), class298_sub1.anInt7150 * 634196087, class298_sub1.anInt7155 * -2146829167, (((Class298_Sub1) class298_sub1).anInt7148 * -1188221251), (((Class298_Sub1) class298_sub1).anInt7161 * -1234291173), (-366156959 * ((Class298_Sub1) class298_sub1).anInt7154), -1, -1628738260);
		    else
	    ...
	    } else if (((Class298_Sub1) class298_sub1).aBoolean7159 && 634196087 * class298_sub1.anInt7150 >= 1 && class298_sub1.anInt7155 * -2146829167 >= 1 && (634196087 * class298_sub1.anInt7150 <= (pb.aClass283_8716.method2629(-2002349453) - 2)) && (class298_sub1.anInt7155 * -2146829167 <= pb.aClass283_8716.method2630(1538814162) - 2) && ((((Class298_Sub1) class298_sub1).anInt7156 * 856355825) < 0 || (Class140.method1559(pb.aClass283_8716.method2641(-2135125377), (((Class298_Sub1) class298_sub1).anInt7156 * 856355825), (205923815 * ((Class298_Sub1) class298_sub1).anInt7153), (byte) -66)))) {
		if (!bool)
		    GraphicDefinition.method4923((((Class298_Sub1) class298_sub1).anInt7151 * 2108312995), (-431456739 * ((Class298_Sub1) class298_sub1).anInt7157), class298_sub1.anInt7150 * 634196087, class298_sub1.anInt7155 * -2146829167, 856355825 * ((Class298_Sub1) class298_sub1).anInt7156, (((Class298_Sub1) class298_sub1).anInt7149 * -674934345), ((Class298_Sub1) class298_sub1).anInt7153 * 205923815, -1, 628810012);
		else
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1284 * -261021353;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    class105.aBoolean1216 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]) == 1;
	...
	try {
	    class105.aString1237 = (String) (((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 -= 969361751) * -203050393)]);
	}
	catch (RuntimeException runtimeexception) {
