...
public class Class266 {
    ...
    public static Class266 LOAD_MAP_SCENE_BACKGROUND = new Class266(false, false);
	...
	try {
		...
		if (class365_sub1_sub1_sub2.anInt10090 * 1433412323 < 32768) {
		    Class298_Sub29 class298_sub29 = ((Class298_Sub29) (pb.aClass437_8696.get((long) (1433412323 * class365_sub1_sub1_sub2.anInt10090))));
		    ...
		    class365_sub1_sub1_sub2_7_ = (pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[(1433412323 * class365_sub1_sub1_sub2.anInt10090 - 32768)]);
		...
		if (-1 != class365_sub1_sub1_sub2_sub1.anInt10179 * 579792529 && ((class365_sub1_sub1_sub2_sub1.anInt10120 * 2050671733 == 0) || (-1531994851 * class365_sub1_sub1_sub2_sub1.anInt10124) > 0)) {
		    ...
		    int i_10_ = ((int) class217.aFloat2451 - ((class365_sub1_sub1_sub2_sub1.anInt10179 * -1896967936) - 263081728 * class341.x - 263081728 * class341.x));
		    int i_11_ = ((int) class217.aFloat2454 - ((893346048 * class365_sub1_sub1_sub2_sub1.anInt10180) - class341.y * -434703616 - class341.y * -434703616));
		    if (0 != i_10_ || i_11_ != 0)
    ...
    static void method2526(Toolkit class_ra, Class453 class453, int i, int i_12_, int i_13_) {
	try {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class66.anInt666 * -1972322437;
	}
	catch (RuntimeException runtimeexception) {
