...
public final class Class70 {
    ...
    static void method802(Toolkit class_ra, int i, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_) {
	try {
	    ...
	    if (null != interface3) {
		ObjectDefinitions class432 = (pb.aClass283_8716.method2641(-1178105216).getObjectDefinitions(interface3.method32((byte) 20)));
	    ...
	    interface3 = (Interface3) class331.method4035(i, i_7_, i_8_, pb.anInterface17_8960, -1880419927);
	    if (null != interface3) {
		ObjectDefinitions class432 = (pb.aClass283_8716.method2641(-258471564).getObjectDefinitions(interface3.method32((byte) -26)));
	    ...
	    if (null != interface3) {
		ObjectDefinitions class432 = (pb.aClass283_8716.method2641(541526744).getObjectDefinitions(interface3.method32((byte) 49)));
	...
	try {
		...
		Class403 class403 = Class211.method1950(1034965053);
		((Class403) class403).anIntArray5248 = new int[class298_sub37_sub17.anInt9679 * -1516159487];
		((Class403) class403).anObjectArray5234 = new String[class298_sub37_sub17.anInt9680 * 1787035509];
		((Class403) class403).anObjectArray5234[0] = string;
		((Class403) class403).anIntArray5248[0] = i_21_;
	...
	try {
		...
		return 0;
	    if (i_29_ < 3) {
		Class244 class244 = pb.aClass283_8716.method2654(1767942332);
		int i_31_ = i >> 9;
		int i_32_ = i_26_ >> 9;
		if (i_27_ < 0 || i_28_ < 0 || (i_27_ > pb.aClass283_8716.method2629(-1972690353) - 1) || i_28_ > pb.aClass283_8716.method2630(-61619148) - 1)
		    return 0;
		if (i_31_ < 1 || i_32_ < 1 || (i_31_ > pb.aClass283_8716.method2629(-1988640932) - 1) || (i_32_ > pb.aClass283_8716.method2630(-694658273) - 1))
		    return 0;
	    ...
	    return pb.aClass283_8716.method2675(-1611682495).aClass_xaArray3517[i_29_].averageHeight(i, i_26_, -1371980258);
	}
	catch (RuntimeException runtimeexception) {
