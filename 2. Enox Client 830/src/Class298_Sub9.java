...
public class Class298_Sub9 extends Class298 {
    ...
    final Model method2891(Toolkit class_ra, int i, Class438 class438, int i_0_, boolean bool, Class366 class366, byte i_1_) {
	try {
	    Model class387 = null;
	    int i_2_ = i;
		...
		class387 = (Model) aClass348_7223.get(l);
	    if (null == class387 || class_ra.method5017(class387.m(), i_2_) != 0) {
		if (class387 != null)
		    i_2_ = class_ra.mergeFunctionMasks(i_2_, class387.m());
		int i_5_ = i_2_;
		...
		if (class350 != null && null != class350.anIntArrayArray3710) {
			...
			if (class350.anIntArrayArray3710[i_9_] != null) {
				...
				if (i_10_ != 0 || 0 != i_11_ || 0 != i_12_)
				    class64s[i_9_].translate(i_10_, i_11_, i_12_);
			    }
			}
		    }
		}
		...
		if (null != class366)
		    i_5_ |= 0x4000;
		class387 = class_ra.createModel(class64, i_5_, anInt7225 * 1310831989, 66, 850);
		if (class366 != null) {
	    ...
	    if (class438 == null)
		return class387;
	    Model class387_18_ = class387.method4755((byte) 1, i_2_, true);
