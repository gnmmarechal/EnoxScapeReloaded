...
public class Class288_Sub1 extends Class288 implements Runnable {
	...
	try {
		...
		try {
			...
			while (!((Class288_Sub1) this).aBoolean3103) {
			    ...
			    MouseIcon.method6185(null, -1086923830);
			}
		    }
	...
	try {
		...
		try {
			...
			pb.aClass25_8693.method389((Class264_Sub4.method2515(Class241.aClass471_2705.craeteSocket(true), 15000, -649048480)), Class241.aClass471_2705.address, (byte) 0);
			pb.aClass25_8693.method383((short) 8191);
			...
			class298_sub36.aClass298_Sub53_Sub2_7396.writeString(pb.aString8655, 2134259589);
			class298_sub36.aClass298_Sub53_Sub2_7396.writeShort(pb.anInt8665 * -1154804873, 16711935);
			class298_sub36.aClass298_Sub53_Sub2_7396.writeLong(pb.aLong8645 * -5648129435911399733L);
			class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(Class321.aClass429_3357.getType(694163818));
			class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(pb.gametype.gameType * -937307905);
			Class10.method322((class298_sub36.aClass298_Sub53_Sub2_7396), (byte) 1);
			String string = pb.aString8648;
			...
			pb.aClass25_8693.method390(class298_sub36, (byte) -37);
			pb.aClass25_8693.method386(-1810127022);
			Class525.aClass486_6298 = Class486.aClass486_6061;
		    }
		    if (Class486.aClass486_6061 == Class525.aClass486_6298) {
			if (pb.aClass25_8693.method387(537308016).isAvailable(1, (byte) -109)) {
			    pb.aClass25_8693.method387(537308016).readBytes((((Class25) pb.aClass25_8693).aClass298_Sub53_Sub2_333.buffer), 0, 1, (byte) -97);
			    Class525.aClass412_6299 = ((Class412) (Class422_Sub20.method5701(Class400.method4928((short) 4505), (((Class25) pb.aClass25_8693).aClass298_Sub53_Sub2_333.buffer[0]) & 0xff, (byte) 2)));
			    if (Class525.aClass412_6299 == Class412.aClass412_6569) {
				pb.aClass25_8693.aClass449_330 = new IsaacCipher(Class361.anIntArray3913);
				int[] is = new int[4];
				for (int i_3_ = 0; i_3_ < 4; i_3_++)
				    is[i_3_] = 50 + Class361.anIntArray3913[i_3_];
				((Class25) pb.aClass25_8693).aClass449_334 = new IsaacCipher(is);
				new IsaacCipher(is);
				((Class25) pb.aClass25_8693).aClass298_Sub53_Sub2_333.method3665((((Class25) pb.aClass25_8693).aClass449_334), (byte) 81);
				Class439.method5851(8, 1887293413);
				pb.aClass25_8693.method383((short) 8191);
				((Class25) pb.aClass25_8693).aClass298_Sub53_Sub2_333.index = 0;
				((Class25) pb.aClass25_8693).aClass202_344 = null;
				((Class25) pb.aClass25_8693).aClass202_345 = null;
				((Class25) pb.aClass25_8693).aClass202_348 = null;
				((Class25) pb.aClass25_8693).anInt338 = 0;
			    } else
				pb.aClass25_8693.method384((byte) 83);
			    ((Class25) pb.aClass25_8693).INCOMMING_PACKET = null;
