...
public class Class151 implements Interface5 {
    ...
    public static ParticleDefinitions getParticleDefinition(int i, int i_9_) {
	try {
	    ParticleDefinitions class182 = (ParticleDefinitions) ParticleDefinitions.aClass348_1815.get((long) i);
	    if (class182 != null)
		return class182;
	    byte[] is = ParticleDefinitions.aClass243_1821.getFile(0, i);
	    class182 = new ParticleDefinitions();
	    if (null != is)
		class182.method1843(new RsByteBuffer(is), (byte) 20);
	    class182.init(-721593745);
	    ParticleDefinitions.aClass348_1815.put(class182, (long) i);
	    return class182;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("gc.f(").append(')').toString());
	...
	try {
	    return MouseIcon.method6184(Class144.aClass381_1563.aClass355_4114, -1572506836);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).aLongArray5251[((((Class403) class403).anInt5245 += -682569305) * 1685767703 - 1)] = (((Class403) class403).aClass298_Sub37_Sub17_5260.aLongArray9677[1883543357 * ((Class403) class403).anInt5259]);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (!pb.aBoolean8761) {
		pb.aFloat8760 += (-12.0F - pb.aFloat8760) / 2.0F;
		pb.aBoolean8763 = true;
		pb.aBoolean8761 = true;
	    }
	}
	catch (RuntimeException runtimeexception) {
