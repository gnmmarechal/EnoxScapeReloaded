...
public class Class47_Sub4 extends Class47 {
	...
	if ((i & 0x1) == 1) {
	    if (((Class45) ((Class47_Sub4) this).aClass45_6773).texture3d) {
		...
		aFloatArray6774[3] = (float) ((((GLToolkit) ((Class47_Sub4) this).aClass_ra_Sub2_491).anInt8062) % 4000) / 4000.0F;
		OpenGL.glTexGenfv(8194, 9473, aFloatArray6774, 0);
	    } else {
		int i_1_ = (((GLToolkit) (((Class47_Sub4) this).aClass_ra_Sub2_491)).anInt8062 % 4000 * 16 / 4000);
		((Class47_Sub4) this).aClass_ra_Sub2_491.method5256(((Class45) ((Class47_Sub4) this).aClass45_6773).aClass30_Sub2Array487[i_1_]);
	    }
	} else if (((Class45) ((Class47_Sub4) this).aClass45_6773).texture3d) {
	    ((Class47_Sub4) this).aClass_ra_Sub2_491.method5256(((Class45) ((Class47_Sub4) this).aClass45_6773).aClass30_Sub4_482);
	    aFloatArray6774[0] = 0.0F;
	    aFloatArray6774[1] = 0.0F;
	    aFloatArray6774[2] = 0.0F;
    ...
    Class47_Sub4(GLToolkit class_ra_sub2, Class45 class45) {
	super(class_ra_sub2);
	...
	if ((i & 0x1) == 1) {
		...
		int i_3_ = (((GLToolkit) (((Class47_Sub4) this).aClass_ra_Sub2_491)).anInt8062 % 4000 * 16 / 4000);
	...
	if ((((GLToolkit) ((Class47_Sub4) this).aClass_ra_Sub2_491).anInt8007) > 0) {
	    float f = -0.5F / (float) (((GLToolkit) (((Class47_Sub4) this).aClass_ra_Sub2_491)).anInt8007);
	    ((Class47_Sub4) this).aClass_ra_Sub2_491.method5255(1);
	    aFloatArray6774[0] = 0.0F;
	    aFloatArray6774[1] = 0.0F;
	    aFloatArray6774[2] = f;
	    aFloatArray6774[3] = (((GLToolkit) ((Class47_Sub4) this).aClass_ra_Sub2_491).aFloat8142) * f + 0.25F;
	    OpenGL.glPushMatrix();
	    OpenGL.glLoadIdentity();
	    OpenGL.glTexGenfv(8192, 9474, aFloatArray6774, 0);
	    OpenGL.glPopMatrix();
	    ((Class47_Sub4) this).aClass_ra_Sub2_491.method5238(0.5F, (float) ((GLToolkit) ((Class47_Sub4) this).aClass_ra_Sub2_491).anInt8007);
	...
	if ((i & 0x1) == 1) {
		...
		int i_5_ = (((GLToolkit) (((Class47_Sub4) this).aClass_ra_Sub2_491)).anInt8062 % 4000 * 16 / 4000);
	...
	if ((i & 0x1) == 1) {
		...
		int i_7_ = (((GLToolkit) (((Class47_Sub4) this).aClass_ra_Sub2_491)).anInt8062 % 4000 * 16 / 4000);
	...
	if ((i & 0x1) == 1) {
		...
		int i_9_ = (((GLToolkit) (((Class47_Sub4) this).aClass_ra_Sub2_491)).anInt8062 % 4000 * 16 / 4000);
	...
	if ((i & 0x1) == 1) {
		...
		int i_11_ = (((GLToolkit) (((Class47_Sub4) this).aClass_ra_Sub2_491)).anInt8062 % 4000 * 16 / 4000);
