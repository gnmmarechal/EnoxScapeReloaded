...
public class Class518 {
	...
	((Class518) this).aClass243_6271.getFileCountForArchive((-1006924897 * (ConfigEntry.aClass120_1427.anInt1460)), 689615038);
    }
	...
	try {
		...
		is = (((Class518) this).aClass243_6271.getFile(-1006924897 * ConfigEntry.aClass120_1427.anInt1460, i));
	    }
	...
	try {
		...
		i = -1;
	    if (pb.anInt8834 * 1396956439 != i) {
		if (-1 != i) {
		    MouseIcon mouseIcon = Shadow.aClass491_9686.method6172(i, 16711935);
		    IndexedImage class89 = mouseIcon.method6181(1479362312);
		    if (class89 != null) {
			Class82_Sub23.aClass295_6921.method2828(Class52_Sub2_Sub1.aCanvas9079, class89.method990(), class89.method983(), class89.method994(), new Point(mouseIcon.anInt6084 * -1954213555, -326899251 * mouseIcon.anInt6081));
			pb.anInt8834 = -766301529 * i;
		    } else
			i = -1;
		}
		if (i == -1 && pb.anInt8834 * 1396956439 != -1) {
		    Class82_Sub23.aClass295_6921.method2828((Class52_Sub2_Sub1.aCanvas9079), null, -1, -1, new Point());
		    pb.anInt8834 = 766301529;
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    class105.anInt1251 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]) * -1448553585;
	...
	try {
		...
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 3;
	    else
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub6_7551.method5612(i_4_, 1352882135);
	}
	catch (RuntimeException runtimeexception) {
