...
public final class Class406 {
	...
	try {
	    ...
	    long l = (long) (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
	    long l_0_ = (long) (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 1]);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (int) (l + l * l_0_ / 100L);
	}
	...
	try {
		...
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = (Class389.aClass119Array4165[i_1_].aClass105Array1405[i_2_].anInt1141) * -914988669;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    pb.anInt8708 = 0;
	    pb.anInt8808 = 0;
	    pb.anInt8707 += 1968119283;
	    Class467.method6023(1694864911);
	    Class508.method6279(largeView, -775686729);
	    Class481.decodeNPCsMasks((short) -6102);
	    boolean bool_3_ = false;
	    for (int i_4_ = 0; i_4_ < pb.anInt8708 * -1508392173; i_4_++) {
		int i_5_ = pb.anIntArray8709[i_4_];
		Class298_Sub29 class298_sub29 = ((Class298_Sub29) pb.aClass437_8696.get((long) i_5_));
		NPC class365_sub1_sub1_sub2_sub1 = ((NPC) class298_sub29.anObject7366);
		if (-1402769421 * class365_sub1_sub1_sub2_sub1.anInt10075 != pb.anInt8707 * 440189755) {
	    ...
	    if (bool_3_) {
		int i_6_ = 1962237353 * pb.anInt8772;
		pb.anInt8772 = (pb.aClass437_8696.method5814(1946710966) * -118843751);
		int i_7_ = 0;
		Iterator iterator = pb.aClass437_8696.iterator();
		while (iterator.hasNext()) {
		    Class298_Sub29 class298_sub29 = (Class298_Sub29) iterator.next();
		    pb.aClass298_Sub29Array8816[i_7_++] = class298_sub29;
		}
		for (int i_8_ = pb.anInt8772 * 1962237353; i_8_ < i_6_; i_8_++)
		    pb.aClass298_Sub29Array8816[i_8_] = null;
	    }
	    if (385051775 * (((Class25) pb.aClass25_8711).aClass298_Sub53_Sub2_333.index) != ((Class25) pb.aClass25_8711).anInt336 * -866602563) {
		/*
	    ...
	    for (int i_9_ = 0; i_9_ < -1230451913 * pb.anInt8703; i_9_++) {
		if (pb.aClass437_8696.get((long) pb.anIntArray8699[i_9_]) == null) {
		    /*
	    ...
	    if (0 != (pb.anInt8772 * 1962237353 - -1230451913 * pb.anInt8703)) {
		/*
		 * throw new RuntimeException(new StringBuilder().append("")
	    ...
	    for (int i_10_ = 0; i_10_ < pb.anInt8772 * 1962237353; i_10_++) {
		if (-1402769421 * ((Entity) (pb.aClass298_Sub29Array8816[i_10_].anObject7366)).anInt10075 != 440189755 * pb.anInt8707) {
		    /*
