...
public class Class104 {
	...
	try {
	    ...
	    long l = (long) (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]);
	    long l_0_ = (long) (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 1]);
	    long l_1_ = (long) (((Class403) class403).anIntArray5244[2 + ((Class403) class403).anInt5239 * 681479919]);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (int) (l_1_ * l / l_0_);
	}
	...
	try {
	    ...
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = Class285.method2709(i_2_, -1648336964);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if ((pb.ticketCycle * 443738891 == class365_sub1_sub1_sub2.anInt10103 * 1450943713) || !class438.method5819((byte) -78) || class438.method5836(1, 2027501470)) {
		int i_3_ = (class365_sub1_sub1_sub2.anInt10103 * 1450943713 - class365_sub1_sub1_sub2.anInt10095 * -412225079);
		int i_4_ = (443738891 * pb.ticketCycle - -412225079 * class365_sub1_sub1_sub2.anInt10095);
	...
	try {
	    ...
	    Class448.method5912(pb.WINDOW_PANE_ID * -257444687, 0, 0, Class462.anInt5683 * -2110394505, Class298_Sub40_Sub9.anInt9716 * -1111710645, 0, 0, -1, 421170136);
	    if (null != Class83.aClass105Array764) {
		Class422_Sub24.method5714(Class83.aClass105Array764, -1412584499, 0, 0, Class462.anInt5683 * -2110394505, -1111710645 * Class298_Sub40_Sub9.anInt9716, Class216.anInt6660 * -391533651, HashTable.anInt5518 * -514549911, (Class82_Sub3.aClass105_6825 == pb.aClass105_8712 ? -1 : pb.aClass105_8712.anInt1303 * 91937559), true, (byte) 0);
		Class83.aClass105Array764 = null;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (((Class403) class403).anIntArray5248[(((Class403) class403).anIntArray5257[1883543357 * ((Class403) class403).anInt5259])]);
	}
	catch (RuntimeException runtimeexception) {
