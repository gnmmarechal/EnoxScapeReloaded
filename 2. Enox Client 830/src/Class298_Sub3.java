...
public class Class298_Sub3 extends Class298 {
    ...
    int anInt7171;
    int anInt7172;
    GLToolkit aClass_ra_Sub2_7173;
    Interface2 anInterface2_7174;
    int anInt7175;
    int anInt7176;
    int anInt7177;
    Interface1 anInterface1_7178;
    OpenGlArrayBufferPointer aClass32_7179;
    OpenGlArrayBufferPointer aClass32_7180;
	...
	if (((GLToolkit) ((Class298_Sub3) this).aClass_ra_Sub2_7173).aBoolean8143)
	...
	int i_13_ = ((Class298_Sub3) this).aClass_xa_Sub3_7169.averageHeight(i_11_, i_12_, -1731289320);
    ...
    Class298_Sub3(GLToolkit class_ra_sub2, Class_xa_Sub3 class_xa_sub3, Class298_Sub10 class298_sub10, int[] is) {
	...
	if (((Class298_Sub3) this).anInt7176 > 0) {
	    ...
	    ((Class298_Sub3) this).aClass440_7186 = new Class440(Class416.nextPowerOfTwo((((Class298_Sub3) this).anInt7176), (byte) 16));
	    int i_52_ = 0;
	    i_46_ = 0;
	    ...
	    ((Class298_Sub3) this).aClass32_7179 = new OpenGlArrayBufferPointer(((Class298_Sub3) this).anInterface1_7178, 5126, 3, 0);
	    ((Class298_Sub3) this).aClass32_7180 = new OpenGlArrayBufferPointer(((Class298_Sub3) this).anInterface1_7178, 5121, 4, 12);
	} else {
