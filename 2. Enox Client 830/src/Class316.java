	...
	public void run() {
		try {
			for (;;) {
				...
				synchronized (this) {
					for (;;) {
						...
						if (((Class316) this).anInt3317 * -352230015 == 0)
							i = (1913311441 * ((Class316) this).anInt3311 - -884053309 * ((Class316) this).anInt3315
									- 1);
							...
							i = (((Class316) this).anInt3317 * -352230015 - -884053309 * ((Class316) this).anInt3315
									- 1);
						if (i > 0)
							break;
						try {
				...
				int i_0_;
				try {
					i_0_ = (((Class316) this).anInputStream3312.read(((Class316) this).aByteArray3314,
							-884053309 * ((Class316) this).anInt3315, i));
					if (-1 == i_0_)
				...
				synchronized (this) {
					((Class316) this).anInt3315 = (-157936149 * ((-884053309 * ((Class316) this).anInt3315 + i_0_)
							% (1913311441 * ((Class316) this).anInt3311)));
				}
			}
		} catch (RuntimeException runtimeexception) {
		...
		try {
			...
			synchronized (this) {
				...
				if (((Class316) this).anInt3317 * -352230015 <= -884053309 * ((Class316) this).anInt3315)
					...
					i_2_ = (((Class316) this).anInt3311 * 1913311441 - -352230015 * ((Class316) this).anInt3317
							+ ((Class316) this).anInt3315 * -884053309);
				if (i_2_ < i) {
					if (null != ((Class316) this).anIOException3313)
		...
		try {
			synchronized (this) {
				...
				if (((Class316) this).anInt3317 * -352230015 <= -884053309 * ((Class316) this).anInt3315)
					...
					i_3_ = (((Class316) this).anInt3315 * -884053309
							+ (1913311441 * ((Class316) this).anInt3311 - ((Class316) this).anInt3317 * -352230015));
				this.notifyAll();
				int i_4_ = i_3_;
				return i_4_;
			}
		...
		try {
			...
			synchronized (this) {
				...
				if (-352230015 * ((Class316) this).anInt3317 <= ((Class316) this).anInt3315 * -884053309)
					...
					i_7_ = (((Class316) this).anInt3311 * 1913311441 - ((Class316) this).anInt3317 * -352230015
							+ -884053309 * ((Class316) this).anInt3315);
				if (i_5_ > i_7_)
					i_5_ = i_7_;
				...
				if (((Class316) this).anInt3317 * -352230015 + i_5_ <= ((Class316) this).anInt3311 * 1913311441)
					System.arraycopy(((Class316) this).aByteArray3314, -352230015 * ((Class316) this).anInt3317, is, i,
							i_5_);
				else {
				...
				((Class316) this).anInt3317 = (-1445143935 * ((-352230015 * ((Class316) this).anInt3317 + i_5_)
						% (((Class316) this).anInt3311 * 1913311441)));
				this.notifyAll();
				int i_9_ = i_5_;
				return i_9_;
			}
