...
public class NPCDefinitions {
	...
	public final Model method6236(Toolkit class_ra, int i, Class349 class349, Interface23 interface23,
		...
		try {
			...
			long l = (long) (anInt6126 * -407713023 | 580915349 * class_ra.id << 16);
			if (null != class498)
				l |= class498.aLong6110 * -8495627389615588201L << 24;
			Model class387;
			synchronized (((Class507) ((NPCDefinitions) this).aClass507_6125).aClass348_6204) {
				class387 = (Model) ((Class507) ((NPCDefinitions) this).aClass507_6125).aClass348_6204.get(l);
			}
			...
			if (class387 == null || (class387.m() & i_6_) != i_6_) {
				...
				if (((NPCDefinitions) this).aByte6141 != 0)
					i_10_ |= 0x80000;
				int[] is_11_ = (null != class498 && class498.anIntArray6108 != null ? class498.anIntArray6108
						: anIntArray6129);
				...
				synchronized (((Class507) ((NPCDefinitions) this).aClass507_6125).aClass243_6208) {
					for (int i_13_ = 0; i_13_ < is_11_.length; i_13_++) {
						...
						} else if (!((Class507) ((NPCDefinitions) this).aClass507_6125).aClass243_6208
								.containsFile(is_11_[i_13_], 0))
							bool_12_ = true;
					}
				}
				if (bool_12_)
					return null;
				ModelDecoder[] class64s = new ModelDecoder[is_11_.length];
				for (int i_14_ = 0; i_14_ < is_11_.length; i_14_++) {
					if (is_11_[i_14_] == -1) {
						...
						synchronized (((Class507) ((NPCDefinitions) this).aClass507_6125).aClass243_6208) {
							class64s[i_14_] = ModelDecoder.getModel(
									(((Class507) (((NPCDefinitions) this).aClass507_6125)).aClass243_6208),
									is_11_[i_14_], 0);
						}
						if (class64s[i_14_] != null) {
							if (class64s[i_14_].version < 13)
								class64s[i_14_].method755(2);
							if (((NPCDefinitions) this).anIntArrayArray6166 != null
									&& (((NPCDefinitions) this).anIntArrayArray6166[i_14_]) != null)
								class64s[i_14_].translate((((NPCDefinitions) this).anIntArrayArray6166[i_14_][0]),
										(((NPCDefinitions) this).anIntArrayArray6166[i_14_][1]),
										(((NPCDefinitions) this).anIntArrayArray6166[i_14_][2]));
						}
					}
				}
				...
				ModelDecoder class64;
				if (1 == class64s.length)
					class64 = class64s[0];
				else
					class64 = new ModelDecoder(class64s, class64s.length);
				class387 = (class_ra.createModel(class64, i_10_,
						299909243 * ((Class507) (((NPCDefinitions) this).aClass507_6125)).anInt6210,
						-335572127 * ((NPCDefinitions) this).anInt6137 + 64,
						850 + -1208973327 * ((NPCDefinitions) this).anInt6156));
				if (null != ((NPCDefinitions) this).aShortArray6133) {
					...
					for (int i_23_ = 0; i_23_ < ((NPCDefinitions) this).aShortArray6133.length; i_23_++) {
						if (null != ((NPCDefinitions) this).aByteArray6135
								&& i_23_ < ((NPCDefinitions) this).aByteArray6135.length)
							class387.X((((NPCDefinitions) this).aShortArray6133[i_23_]),
									aShortArray6182[(((NPCDefinitions) this).aByteArray6135[i_23_]) & 0xff]);
						else
				...
				if (0 != ((NPCDefinitions) this).aByte6141)
					class387.PA(((NPCDefinitions) this).aByte6138, ((NPCDefinitions) this).aByte6139,
							((NPCDefinitions) this).aByte6157, ((NPCDefinitions) this).aByte6141 & 0xff);
				class387.KA(i_6_);
				synchronized (((Class507) ((NPCDefinitions) this).aClass507_6125).aClass348_6204) {
					((Class507) ((NPCDefinitions) this).aClass507_6125).aClass348_6204.put(class387, l);
				}
			}
			Model class387_26_ = class387.method4755((byte) 4, i_6_, true);
			...
			if (-2086573057 * ((NPCDefinitions) this).anInt6150 != 128
					|| 128 != -1282053981 * ((NPCDefinitions) this).anInt6160)
				class387_26_.oa(((NPCDefinitions) this).anInt6150 * -2086573057,
						((NPCDefinitions) this).anInt6160 * -1282053981,
						((NPCDefinitions) this).anInt6150 * -2086573057);
			class387_26_.KA(i);
			return class387_26_;
		} catch (RuntimeException runtimeexception) {
	...
	public final Model method6237(Toolkit class_ra, int i, Interface23 interface23, Class438 class438,
		...
		try {
			...
			synchronized (((Class507) ((NPCDefinitions) this).aClass507_6125).aClass348_6211) {
				class387 = (Model) ((Class507) ((NPCDefinitions) this).aClass507_6125).aClass348_6211.get(l);
			}
			if (null == class387 || (class387.m() & i_34_) != i_34_) {
				...
				synchronized (((Class507) ((NPCDefinitions) this).aClass507_6125).aClass243_6208) {
					for (int i_36_ = 0; i_36_ < is.length; i_36_++) {
						if (!((Class507) ((NPCDefinitions) this).aClass507_6125).aClass243_6208.containsFile(is[i_36_],
								0))
							bool = true;
					}
				}
				if (bool)
					return null;
				ModelDecoder[] class64s = new ModelDecoder[is.length];
				synchronized (((Class507) ((NPCDefinitions) this).aClass507_6125).aClass243_6208) {
					for (int i_37_ = 0; i_37_ < is.length; i_37_++)
						class64s[i_37_] = ModelDecoder.getModel(
								(((Class507) (((NPCDefinitions) this).aClass507_6125)).aClass243_6208), is[i_37_], 0);
				}
				...
				if (class64s.length == 1)
					...
					class64 = new ModelDecoder(class64s, class64s.length);
				class387 = class_ra.createModel(class64, i_35_,
						(((Class507) (((NPCDefinitions) this).aClass507_6125)).anInt6210) * 299909243, 64, 768);
				if (((NPCDefinitions) this).aShortArray6133 != null) {
					short[] is_39_;
					...
					for (int i_40_ = 0; i_40_ < ((NPCDefinitions) this).aShortArray6133.length; i_40_++) {
						if (null != ((NPCDefinitions) this).aByteArray6135
								&& i_40_ < ((NPCDefinitions) this).aByteArray6135.length)
							class387.X((((NPCDefinitions) this).aShortArray6133[i_40_]),
									aShortArray6182[(((NPCDefinitions) this).aByteArray6135[i_40_]) & 0xff]);
						else
				...
				class387.KA(i_34_);
				synchronized (((Class507) ((NPCDefinitions) this).aClass507_6125).aClass348_6211) {
					((Class507) ((NPCDefinitions) this).aClass507_6125).aClass348_6211.put(class387, l);
				}
			}
			if (class438 != null) {
	...
	public final boolean method6238(int i) {
		try {
			...
			for (int i_43_ = 0; i_43_ < is.length; i_43_++) {
				int i_44_ = is[i_43_];
				if (!((Class507) ((NPCDefinitions) this).aClass507_6125).aClass243_6208.containsFile(i_44_, 0))
					bool = false;
			}
			return bool;
		} catch (RuntimeException runtimeexception) {
	...
	public int method6239(int i, int i_45_, byte i_46_) {
		try {
			if (((NPCDefinitions) this).aClass437_6159 == null)
				return i_45_;
			Class298_Sub35 class298_sub35 = ((Class298_Sub35) ((NPCDefinitions) this).aClass437_6159
					.get((long) i));
		...
		try {
			...
			for (int i_51_ = 0; i_51_ < anIntArray6188.length; i_51_++) {
				if (-1 != anIntArray6188[i_51_]) {
					NPCDefinitions class503_52_ = ((NPCDefinitions) this).aClass507_6125
	...
	void method6243(int i) {
		try {
			...
			if (aByte6158 == -1) {
				if ((((Class507) ((NPCDefinitions) this).aClass507_6125).aClass411_6205) == Class411.game_rs)
					aByte6158 = (byte) 1;
				else
					aByte6158 = (byte) 0;
			}
		...
		try {
			if (i == 1) {
				...
				for (int i_61_ = 0; i_61_ < i_60_; i_61_++)
					((NPCDefinitions) this).aByteArray6135[i_61_] = stream.readByte();
			} else if (i == 44) {
				...
				((NPCDefinitions) this).anInt6137 = stream.readByte() * 2012631201;
			else if (101 == i)
				((NPCDefinitions) this).anInt6156 = stream.readByte() * 1653976405;
			else if (i == 102)
				...
				((NPCDefinitions) this).aByte6138 = stream.readByte();
				((NPCDefinitions) this).aByte6139 = stream.readByte();
				((NPCDefinitions) this).aByte6157 = stream.readByte();
				((NPCDefinitions) this).aByte6141 = stream.readByte();
			} else if (158 == i)
				aByte6158 = (byte) 1;
			else if (i == 159)
				aByte6158 = (byte) 0;
				...
				if (((NPCDefinitions) this).aClass437_6159 == null) {
					int i_73_ = Class416.nextPowerOfTwo(i_72_, (byte) 16);
					((NPCDefinitions) this).aClass437_6159 = new HashTable(i_73_);
				}
	...
	public String method6245(int i, String string, int i_76_) {
		try {
			if (null == ((NPCDefinitions) this).aClass437_6159)
				return string;
			Class298_Sub29 class298_sub29 = ((Class298_Sub29) ((NPCDefinitions) this).aClass437_6159
					.get((long) i));
	...
	public final Model method6246(Toolkit class_ra, int i, Class349 class349, Interface23 interface23,
		...
		try {
			return method6236(class_ra, i, class349, interface23, class438, class438_77_, class438s, is, i_78_,
					class498, anInt6132 * 525312939, true, -679459424);
		} catch (RuntimeException runtimeexception) {
