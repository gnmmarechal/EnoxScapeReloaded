...
public class ItemDefinitions {
	...
	public void setOldDefs() {
		...
		if (oldFemaleEquipModelId1 != -1)
			femaleEquipModelId1 = oldFemaleEquipModelId1 * -1430077763;

		if (oldFemaleEquipModelId2 != -1)
			femaleEquipModelId2 = oldFemaleEquipModelId2 * -336299543;
		if (oldFemaleEquipModelId3 != -1)
			femaleEquipModelId3 = oldFemaleEquipModelId3 * 2098680761;
		if (oldMaleEquipModelId1 != -1)
			maleEquipModelId1 = oldMaleEquipModelId1 * -1612514031;
		if (oldMaleEquipModelId2 != -1)
			maleEquipModelId2 = oldMaleEquipModelId2 * 582597415;
		if (oldMaleEquipModelId3 != -1)
			maleEquipModelId3 = oldMaleEquipModelId3 * 756401161;
	...
	void method6027(ItemDefinitions class468_1_, ItemDefinitions class468_2_, int i) {
		try {
			((ItemDefinitions) this).invModelId = ((ItemDefinitions) class468_1_).invModelId * 1;
			...
			((ItemDefinitions) this).originalModelColors = ((ItemDefinitions) class468_1_).originalModelColors;
			((ItemDefinitions) this).modifiedModelColors = ((ItemDefinitions) class468_1_).modifiedModelColors;
			((ItemDefinitions) this).aByteArray5708 = ((ItemDefinitions) class468_1_).aByteArray5708;
			((ItemDefinitions) this).originalTextureColors = ((ItemDefinitions) class468_1_).originalTextureColors;
			((ItemDefinitions) this).modifiedTextureColors = ((ItemDefinitions) class468_1_).modifiedTextureColors;
	...
	public final ModelDecoder method6028(boolean bool, Class464 class464, int i) {
		try {
			int i_3_;
			int i_4_;
			int i_5_;
			if (bool) {
				if (class464 != null && class464.anIntArray5695 != null) {
					...
					i_4_ = Class477.OLD_ITEMS && oldFemaleEquipModelId2 != -1 ? oldFemaleEquipModelId2 : ((ItemDefinitions) this).femaleEquipModelId2 * -1284247975;
					i_5_ = Class477.OLD_ITEMS && oldFemaleEquipModelId3 != -1 ? oldFemaleEquipModelId3 : ((ItemDefinitions) this).femaleEquipModelId3 * -1767718263;
				}
				...
				i_4_ = Class477.OLD_ITEMS && oldMaleEquipModelId2 != -1 ? oldMaleEquipModelId2 : ((ItemDefinitions) this).maleEquipModelId2 * 34210967;
				i_5_ = Class477.OLD_ITEMS && oldMaleEquipModelId3 != -1 ? oldMaleEquipModelId3 : ((ItemDefinitions) this).maleEquipModelId3 * 1313278521;
			}
			if (i_3_ == -1)
				return null;
			ModelDecoder class64 = ModelDecoder.getModel((((Class477) (((ItemDefinitions) this).aClass477_5751)).aClass243_5992), i_3_, 0);
			if (class64 == null)
				return null;
			if (class64.version < 13)
				class64.method755(2);
			if (i_4_ != -1) {
				ModelDecoder class64_6_ = ModelDecoder.getModel((((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992), i_4_, 0);
				if (class64_6_.version < 13)
					class64_6_.method755(2);
				if (i_5_ != -1) {
					ModelDecoder class64_7_ = ModelDecoder.getModel((((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992), i_5_, 0);
					if (class64_7_.version < 13)
						class64_7_.method755(2);
					ModelDecoder[] class64s = { class64, class64_6_, class64_7_ };
					class64 = new ModelDecoder(class64s, 3);
				} else {
					ModelDecoder[] class64s = { class64, class64_6_ };
					class64 = new ModelDecoder(class64s, 2);
				}
			}
			...
			if (!bool && (0 != ((ItemDefinitions) this).anInt5742 * -1268579363 || 345393423 * ((ItemDefinitions) this).anInt5744 != 0 || 0 != ((ItemDefinitions) this).anInt5748 * 669576861))
				class64.translate(((ItemDefinitions) this).anInt5742 * -1268579363, 345393423 * ((ItemDefinitions) this).anInt5744, 669576861 * ((ItemDefinitions) this).anInt5748);
			if (bool && (0 != -1436808331 * ((ItemDefinitions) this).anInt5743 || -92251131 * ((ItemDefinitions) this).anInt5745 != 0 || ((ItemDefinitions) this).anInt5710 * 1813909637 != 0))
				class64.translate(((ItemDefinitions) this).anInt5743 * -1436808331, ((ItemDefinitions) this).anInt5745 * -92251131, 1813909637 * ((ItemDefinitions) this).anInt5710);
			if (null != ((ItemDefinitions) this).originalModelColors) {
				short[] is;
				if (class464 != null && class464.aShortArray5698 != null)
					is = class464.aShortArray5698;
				else
					is = ((ItemDefinitions) this).modifiedModelColors;
				for (int i_8_ = 0; i_8_ < ((ItemDefinitions) this).originalModelColors.length; i_8_++)
					class64.recolour(((ItemDefinitions) this).originalModelColors[i_8_], is[i_8_]);
			}
			if (null != ((ItemDefinitions) this).originalTextureColors) {
				short[] is;
				if (class464 != null && null != class464.aShortArray5699)
					is = class464.aShortArray5699;
				else
					is = ((ItemDefinitions) this).modifiedTextureColors;
				for (int i_9_ = 0; i_9_ < ((ItemDefinitions) this).originalTextureColors.length; i_9_++)
					class64.retexture(((ItemDefinitions) this).originalTextureColors[i_9_], is[i_9_]);
			}
			return class64;
		}
		catch (RuntimeException runtimeexception) {
	...
	public final Model method6029(Toolkit class_ra, int i, int i_10_, Class366 class366, Class438 class438, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_) {
		try {
			...
			synchronized (((Class477) ((ItemDefinitions) this).aClass477_5751).aClass348_5994) {
				class387 = ((Model) (((Class477) ((ItemDefinitions) this).aClass477_5751).aClass348_5994.get((long) (1027112447 * ((ItemDefinitions) this).anInt5740 | class_ra.id * 580915349 << 29))));
			}
			if (null == class387 || class_ra.method5017(class387.m(), i_18_) != 0) {
				if (null != class387)
					i_18_ = class_ra.mergeFunctionMasks(i_18_, class387.m());
				int i_19_ = i_18_;
				if (((ItemDefinitions) this).originalTextureColors != null)
					i_19_ |= 0x8000;
				if (null != ((ItemDefinitions) this).originalModelColors || class366 != null)
					i_19_ |= 0x4000;
				...
				if (((ItemDefinitions) this).anInt5758 * -1773084507 != 128)
					i_19_ |= 0x4;
				ModelDecoder class64 = ModelDecoder.getModel((((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992),

						Class477.OLD_ITEMS && oldInvModelId != -1 ? oldInvModelId : (((ItemDefinitions) this).invModelId * 381556007), 0);
				if (null == class64)
					return null;
				if (class64.version < 13)
					class64.method755(2);
				class387 = (class_ra.createModel(class64, i_19_, (((Class477) ((ItemDefinitions) this).aClass477_5751).anInt5991) * -424819635, 64 + 856370373 * ((ItemDefinitions) this).anInt5761, ((ItemDefinitions) this).anInt5762 * 1055603853 + 850));
				...
				if (((ItemDefinitions) this).originalModelColors != null) {
					for (int i_20_ = 0; i_20_ < ((ItemDefinitions) this).originalModelColors.length; i_20_++) {
						if (((ItemDefinitions) this).aByteArray5708 != null && i_20_ < ((ItemDefinitions) this).aByteArray5708.length)
							class387.X((((ItemDefinitions) this).originalModelColors[i_20_]), aShortArray5757[(((ItemDefinitions) this).aByteArray5708[i_20_]) & 0xff]);
						else
							class387.X((((ItemDefinitions) this).originalModelColors[i_20_]), (((ItemDefinitions) this).modifiedModelColors[i_20_]));
					}
				}
				if (null != ((ItemDefinitions) this).originalTextureColors) {
					for (int i_21_ = 0; i_21_ < ((ItemDefinitions) this).originalTextureColors.length; i_21_++)
						class387.W(((ItemDefinitions) this).originalTextureColors[i_21_], ((ItemDefinitions) this).modifiedTextureColors[i_21_]);
				}
				if (null != class366) {
				...
				class387.KA(i_18_);
				synchronized (((Class477) ((ItemDefinitions) this).aClass477_5751).aClass348_5994) {
					((Class477) ((ItemDefinitions) this).aClass477_5751).aClass348_5994.put(class387, (long) (((ItemDefinitions) this).anInt5740 * 1027112447 | class_ra.id * 580915349 << 29));
				}
			}
	...
	int[] method6031(Toolkit class_ra, Toolkit class_ra_27_, int i, int i_28_, int i_29_, boolean bool, int i_30_, Class264 class264, Class366 class366, int i_31_) {
		// class_ra beeing used to draw
		try {
			ModelDecoder class64 = ModelDecoder.getModel((((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992), Class477.OLD_ITEMS && oldInvModelId != -1 ? oldInvModelId : 381556007 * ((ItemDefinitions) this).invModelId, 0);
			if (null == class64)
				return null;
			if (class64.version < 13)
				class64.method755(2);
			if (null != ((ItemDefinitions) this).originalModelColors) {
				for (int i_32_ = 0; i_32_ < ((ItemDefinitions) this).originalModelColors.length; i_32_++) {
					if (((ItemDefinitions) this).aByteArray5708 != null && i_32_ < ((ItemDefinitions) this).aByteArray5708.length)
						class64.recolour((((ItemDefinitions) this).originalModelColors[i_32_]), aShortArray5757[(((ItemDefinitions) this).aByteArray5708[i_32_]) & 0xff]);
					else
						class64.recolour((((ItemDefinitions) this).originalModelColors[i_32_]), (((ItemDefinitions) this).modifiedModelColors[i_32_]));
				}
			}
			if (null != ((ItemDefinitions) this).originalTextureColors) {
				for (int i_33_ = 0; i_33_ < ((ItemDefinitions) this).originalTextureColors.length; i_33_++)
					class64.retexture(((ItemDefinitions) this).originalTextureColors[i_33_], (((ItemDefinitions) this).modifiedTextureColors[i_33_]));
			}
			if (null != class366) {
				for (int i_34_ = 0; i_34_ < 10; i_34_++) {
					for (int i_35_ = 0; i_35_ < Class366.aShortArrayArray3970[i_34_].length; i_35_++) {
						if (class366.anIntArray3973[i_34_] < (Class22.aShortArrayArrayArray278[i_34_][i_35_]).length)
							class64.recolour((Class366.aShortArrayArray3970[i_34_][i_35_]), (Class22.aShortArrayArrayArray278[i_34_][i_35_][(class366.anIntArray3973[i_34_])]));
					}
				}
			}
			int i_36_ = 2048;
			...
			Model class387 = class_ra.createModel(class64, i_36_, 64, (((ItemDefinitions) this).anInt5761 * 856370373 + 64), 768 + (((ItemDefinitions) this).anInt5762 * 1055603853));
			...
			class222_40_.method2064((float) (252709809 * anInt5717 << 2), (float) ((((Class220.SINE[330519029 * anInt5714 << 3]) * i_38_) >> 14) - class387.YA() / 2 + (-1811316489 * anInt5718 << 2)), (float) ((((Class220.COSINE[330519029 * anInt5714 << 3]) * i_38_) >> 14) + (anInt5718 * -1811316489 << 2)));
		...
		try {
			...
			if (bool) {
				if (class464 != null && class464.anIntArray5695 != null) {
					...
					i_53_ = Class477.OLD_ITEMS && oldFemaleEquipModelId2 != -1 ? oldFemaleEquipModelId2 : ((ItemDefinitions) this).femaleEquipModelId2 * -1284247975;
					i_54_ = Class477.OLD_ITEMS && oldFemaleEquipModelId3 != -1 ? oldFemaleEquipModelId3 : ((ItemDefinitions) this).femaleEquipModelId3 * -1767718263;
				}
			} else if (class464 != null && null != class464.anIntArray5694) {
				...
				i_53_ = Class477.OLD_ITEMS && oldMaleEquipModelId2 != -1 ? oldMaleEquipModelId2 : ((ItemDefinitions) this).maleEquipModelId2 * 34210967;
				i_54_ = Class477.OLD_ITEMS && oldMaleEquipModelId3 != -1 ? oldMaleEquipModelId3 : ((ItemDefinitions) this).maleEquipModelId3 * 1313278521;
			}
			if (-1 == i_52_)
				return true;
			boolean bool_55_ = true;
			if (!((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992.containsFile(i_52_, 0))
				bool_55_ = false;
			if (i_53_ != -1 && !((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992.containsFile(i_53_, 0))
				bool_55_ = false;
			if (i_54_ != -1 && !((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992.containsFile(i_54_, 0))
				bool_55_ = false;
			return bool_55_;
		}
		catch (RuntimeException runtimeexception) {
	...
	public final boolean method6035(boolean bool, Class464 class464, byte i) {
		try {
			...
			if (!((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992.containsFile(i_56_, 0))
				bool_58_ = false;
			if (-1 != i_57_ && !((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992.containsFile(i_57_, 0))
				bool_58_ = false;
			return bool_58_;
		}
		catch (RuntimeException runtimeexception) {
	...
	void method6036(ItemDefinitions class468_59_, ItemDefinitions class468_60_, int i) {
		try {
			anInt5721 = 0;
			((ItemDefinitions) this).invModelId = 1 * ((ItemDefinitions) class468_59_).invModelId;
			...
			((ItemDefinitions) this).originalModelColors = ((ItemDefinitions) class468_60_).originalModelColors;
			((ItemDefinitions) this).modifiedModelColors = ((ItemDefinitions) class468_60_).modifiedModelColors;
			((ItemDefinitions) this).aByteArray5708 = ((ItemDefinitions) class468_60_).aByteArray5708;
			((ItemDefinitions) this).originalTextureColors = ((ItemDefinitions) class468_60_).originalTextureColors;
			((ItemDefinitions) this).modifiedTextureColors = ((ItemDefinitions) class468_60_).modifiedTextureColors;
			...
			((ItemDefinitions) this).maleEquipModelId2 = 1 * ((ItemDefinitions) class468_60_).maleEquipModelId2;
			((ItemDefinitions) this).maleEquipModelId3 = ((ItemDefinitions) class468_60_).maleEquipModelId3 * 1;
			femaleEquipModelId1 = 1 * class468_60_.femaleEquipModelId1;
			((ItemDefinitions) this).femaleEquipModelId2 = ((ItemDefinitions) class468_60_).femaleEquipModelId2 * 1;
			((ItemDefinitions) this).femaleEquipModelId3 = 1 * ((ItemDefinitions) class468_60_).femaleEquipModelId3;
	...
	void decode(RsByteBuffer stream, int opcode) {
		try {
			if (1 == opcode)
				((ItemDefinitions) this).invModelId = (stream.readBigSmart(1235052657)) * -1019082089;// model
			// id
			else if (2 == opcode)
				...
				maleEquipModelId1 = (stream.readBigSmart(1235052657)) * -1612514031;
			else if (opcode == 24)
				((ItemDefinitions) this).maleEquipModelId2 = (stream.readBigSmart(1235052657)) * 582597415;
			else if (25 == opcode)
				femaleEquipModelId1 = (stream.readBigSmart(1235052657)) * -1430077763;
			else if (26 == opcode)
				((ItemDefinitions) this).femaleEquipModelId2 = (stream.readBigSmart(1235052657)) * -336299543;
			else if (242 == opcode)
				oldInvModelId = stream.readBigSmart(1235052657);
			else if (243 == opcode)
				oldMaleEquipModelId3 = stream.readBigSmart(1235052657);
			else if (244 == opcode)
				oldFemaleEquipModelId3 = stream.readBigSmart(1235052657);
			else if (245 == opcode)
				oldMaleEquipModelId2 = stream.readBigSmart(1235052657);
			else if (246 == opcode)
				oldFemaleEquipModelId2 = stream.readBigSmart(1235052657);
			else if (247 == opcode)
				oldMaleEquipModelId1 = stream.readBigSmart(1235052657);
			else if (248 == opcode)
				oldFemaleEquipModelId1 = stream.readBigSmart(1235052657);
			else if (opcode == 27)
				...
				((ItemDefinitions) this).originalModelColors = new short[i_65_];
				((ItemDefinitions) this).modifiedModelColors = new short[i_65_];
				for (int i_66_ = 0; i_66_ < i_65_; i_66_++) {
					((ItemDefinitions) this).originalModelColors[i_66_] = (short) stream.readUnsignedShort();
					((ItemDefinitions) this).modifiedModelColors[i_66_] = (short) stream.readUnsignedShort();
				}
			} else if (41 == opcode) {
				int i_67_ = stream.readUnsignedByte();
				((ItemDefinitions) this).originalTextureColors = new short[i_67_];
				((ItemDefinitions) this).modifiedTextureColors = new short[i_67_];
				for (int i_68_ = 0; i_68_ < i_67_; i_68_++) {
					((ItemDefinitions) this).originalTextureColors[i_68_] = (short) stream.readUnsignedShort();
					((ItemDefinitions) this).modifiedTextureColors[i_68_] = (short) stream.readUnsignedShort();
				}
			} else if (251 == opcode) {
				int i_65_ = stream.readUnsignedByte();
				((ItemDefinitions) this).oldoriginalModelColors = new short[i_65_];
				((ItemDefinitions) this).oldmodifiedModelColors = new short[i_65_];
				for (int i_66_ = 0; i_66_ < i_65_; i_66_++) {
					((ItemDefinitions) this).oldoriginalModelColors[i_66_] = (short) stream.readUnsignedShort();
					((ItemDefinitions) this).oldmodifiedModelColors[i_66_] = (short) stream.readUnsignedShort();
				}
			} else if (252 == opcode) {
				int i_67_ = stream.readUnsignedByte();
				((ItemDefinitions) this).oldoriginalTextureColors = new short[i_67_];
				((ItemDefinitions) this).oldmodifiedTextureColors = new short[i_67_];
				for (int i_68_ = 0; i_68_ < i_67_; i_68_++) {
					((ItemDefinitions) this).oldoriginalTextureColors[i_68_] = (short) stream.readUnsignedShort();
					((ItemDefinitions) this).oldmodifiedTextureColors[i_68_] = (short) stream.readUnsignedShort();
				}
				...
				((ItemDefinitions) this).maleEquipModelId3 = (stream.readBigSmart(1235052657)) * 756401161;
			else if (opcode == 79)
				((ItemDefinitions) this).femaleEquipModelId3 = (stream.readBigSmart(1235052657)) * 2098680761;
			else if (opcode == 90)
				...
				((ItemDefinitions) this).anInt5749 = (stream.readBigSmart(1235052657)) * -1935344449;
			else if (93 == opcode)
				((ItemDefinitions) this).anInt5764 = (stream.readBigSmart(1235052657)) * -1194369871;
			else if (opcode == 94)
			stream.readUnsignedShort();
				...
				anInt5704 = 126481113 * 2;
			} else if (opcode == 242) {
				stream.readBigSmart(0);
			} else if (opcode == 243) {
				stream.readBigSmart(0);
			} else if (opcode == 244) {
				stream.readBigSmart(0);
				...
				if (null == ((ItemDefinitions) this).aClass437_5766) {
					int i_74_ = Class416.nextPowerOfTwo(i_73_, (byte) 16);
					((ItemDefinitions) this).aClass437_5766 = new HashTable(i_74_);
				}
				for (int i_75_ = 0; i_75_ < i_73_; i_75_++) {// client script
					// map
					boolean isString = stream.readUnsignedByte() == 1;
					int key = stream.read24BitUnsignedInteger((byte) 15);
					Class298 value;
					if (isString)
						value = new Class298_Sub29(stream.readString(-1208778402));
					else {
						int valueInt = stream.readInt((byte) 0);
						if (key == 4329)
							key = 687;
						else if (key == 686) {
							valueInt -= 14920;
							if (valueInt == 22 && name.contains("salamander"))
								valueInt = 21;
							else if (valueInt == 17 && name.equals("Skull sceptre"))
								valueInt = 3;
							else if (valueInt == 13 && (name.equals("Scythe") || name.equals("Golden scythe")
									|| name.equals("Christmas scythe")))
								valueInt = 22;
							else if (valueInt == 13 && (name.equals("Granite maul") || name.equals("Tzhaar-ket-om")))
								valueInt = 10;
							else if (valueInt < WEAPON_STYLES.length)
								valueInt = WEAPON_STYLES[valueInt];
						}
						value = new Class298_Sub35(valueInt);
					}
					((ItemDefinitions) this).aClass437_5766.method5817(value, (long) key);
				}
			}
		}
		catch (RuntimeException runtimeexception) {
	...
	private static final int[] WEAPON_STYLES = { 0, // Empty Handed
			5, // Dagger
			5, // Sword
			6, // Longsword
			6, // Scimitar 4
	...
	void method6039(ItemDefinitions class468_77_, ItemDefinitions class468_78_, int i) {
		try {
			anInt5721 = 0;
			((ItemDefinitions) this).invModelId = 1 * ((ItemDefinitions) class468_77_).invModelId;
			...
			((ItemDefinitions) this).originalModelColors = ((ItemDefinitions) class468_78_).originalModelColors;
			((ItemDefinitions) this).modifiedModelColors = ((ItemDefinitions) class468_78_).modifiedModelColors;
			((ItemDefinitions) this).aByteArray5708 = ((ItemDefinitions) class468_78_).aByteArray5708;
			((ItemDefinitions) this).originalTextureColors = ((ItemDefinitions) class468_78_).originalTextureColors;
			((ItemDefinitions) this).modifiedTextureColors = ((ItemDefinitions) class468_78_).modifiedTextureColors;
			...
			((ItemDefinitions) this).maleEquipModelId2 = ((ItemDefinitions) class468_78_).maleEquipModelId2 * 1;
			((ItemDefinitions) this).maleEquipModelId3 = 1 * ((ItemDefinitions) class468_78_).maleEquipModelId3;
			femaleEquipModelId1 = 1 * class468_78_.femaleEquipModelId1;
			((ItemDefinitions) this).femaleEquipModelId2 = ((ItemDefinitions) class468_78_).femaleEquipModelId2 * 1;
			((ItemDefinitions) this).femaleEquipModelId3 = ((ItemDefinitions) class468_78_).femaleEquipModelId3 * 1;
	...
	public final ModelDecoder method6040(boolean bool, Class464 class464, int i) {
		try {
			int i_80_;
			int i_81_;
			if (bool) {
			...
			if (-1 == i_80_)
				return null;
			ModelDecoder class64 = ModelDecoder.getModel((((Class477) (((ItemDefinitions) this).aClass477_5751)).aClass243_5992), i_80_, 0);
			if (class64.version < 13)
				class64.method755(2);
			if (-1 != i_81_) {
				ModelDecoder class64_82_ = ModelDecoder.getModel((((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992), i_81_, 0);
				if (class64_82_.version < 13)
					class64_82_.method755(2);
				ModelDecoder[] class64s = { class64, class64_82_ };
				class64 = new ModelDecoder(class64s, 2);
			}
			if (null != ((ItemDefinitions) this).originalModelColors) {
				short[] is;
				if (class464 != null && null != class464.aShortArray5698)
					...
					is = ((ItemDefinitions) this).modifiedModelColors;
				for (int i_83_ = 0; i_83_ < ((ItemDefinitions) this).originalModelColors.length; i_83_++)
					class64.recolour(((ItemDefinitions) this).originalModelColors[i_83_], is[i_83_]);
			}
			if (null != ((ItemDefinitions) this).originalTextureColors) {
				short[] is;
				if (null != class464 && class464.aShortArray5699 != null)
					...
					is = ((ItemDefinitions) this).modifiedTextureColors;
				for (int i_84_ = 0; i_84_ < ((ItemDefinitions) this).originalTextureColors.length; i_84_++)
					class64.retexture(((ItemDefinitions) this).originalTextureColors[i_84_], is[i_84_]);
			}
			return class64;
		}
		catch (RuntimeException runtimeexception) {
	...
	ItemDefinitions() {
		...
		((ItemDefinitions) this).maleEquipModelId2 = -582597415;
		...
		oldFemaleEquipModelId3 = -1;
		oldInvModelId = -1;
		((ItemDefinitions) this).femaleEquipModelId2 = 336299543;
		((ItemDefinitions) this).maleEquipModelId3 = -756401161;
		((ItemDefinitions) this).femaleEquipModelId3 = -2098680761;
	...
	public static int method6043(int i, int i_90_, int i_91_) {
		try {
			...
			try {
				...
				Class139.method1548(Tradution.aClass470_5789.method6049(Class321.aClass429_3357, -875414210), true, Class373.activeToolkit, Class343.aClass264_3673, Class422_Sub2.aClass505_8369, (byte) 5);
				ModelDecoder class64 = ModelDecoder.getModel(WorldTile.idx7, (-1919698893 * HashTable.aClass371_5520.anInt4035), 0);
				long l = Class122.method1319((byte) 1);
				Class373.activeToolkit.L();
				pb.aClass222_8871.method2062(0.0F, 256.0F, 0.0F);
				Class373.activeToolkit.method5043(pb.aClass222_8871);
				Class233 class233 = Class373.activeToolkit.method5036();
				class233.method2152((float) (dimension.width / 2), (float) (dimension.height / 2), 512.0F, 512.0F, (float) pb.aClass283_8716.method2634((byte) -121), (float) pb.aClass283_8716.method2635(1789119116), (float) dimension.width, (float) dimension.height);
				Class373.activeToolkit.method5182(class233);
				Class373.activeToolkit.IA(1.0F);
				Class373.activeToolkit.m(16777215, 0.5F, 0.5F, 20.0F, -50.0F, 30.0F);
				Model class387 = Class373.activeToolkit.createModel(class64, 2048, 64, 64, 768);
				int i_93_ = 0;
				while_107_: for (int i_94_ = 0; i_94_ < 500; i_94_++) {
					Class373.activeToolkit.ba(3, 0);
					for (int i_95_ = 15; i_95_ >= 0; i_95_--) {
						for (int i_96_ = 0; i_96_ <= i_95_; i_96_++) {
							pb.aClass222_8968.method2062((float) (int) (512.0F * ((float) i_96_ - (float) i_95_ / 2.0F)), 0.0F, (float) ((1 + i_95_) * 512));
							class387.method4739(pb.aClass222_8968, null, 0);
							i_93_++;
				...
				Class373.activeToolkit.method5075();
