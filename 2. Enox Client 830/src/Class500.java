...
public class Class500 {
	...
	((Class500) this).anInt6115 = (((Class500) this).aClass243_6114.getFileCountForArchive((-1006924897 * (ConfigEntry.aClass120_1431.anInt1460)), -1837337583) * 1005943745);
	if (bool) {
		...
		synchronized (((Class500) this).aClass243_6114) {
		    is = (((Class500) this).aClass243_6114.getFile(-1006924897 * ConfigEntry.aClass120_1431.anInt1460, i));
		}
	...
	try {
	    ...
	    Player class365_sub1_sub1_sub2_sub2 = pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i];
	    if (0 == i_2_) {
		if (bool)
		    class365_sub1_sub1_sub2_sub2.aBoolean10217 = false;
		else {
		    if (-442628795 * pb.playerIndex == i)
			throw new RuntimeException();
		    Class410 class410 = Class10.aClass410Array138[i] = new Class410();
		    ((Class410) class410).anInt5288 = (1896571807 * (((class365_sub1_sub1_sub2_sub2.scenePositionYQueue[0] + class341.y * 283514611) >> 6) + ((class365_sub1_sub1_sub2_sub2.plane << 28) + ((-1760580017 * class341.x + (class365_sub1_sub1_sub2_sub2.scenePositionXQueue[0])) >> 6 << 14))));
		    ...
		    ((Class410) class410).aBoolean5289 = class365_sub1_sub1_sub2_sub2.isClanMember;
		    if (class365_sub1_sub1_sub2_sub2.anInt10214 * 780357347 > 0)
			Class_v.method3670(class365_sub1_sub1_sub2_sub2, (byte) -66);
		    pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i] = null;
		...
		if (0 == i_9_) {
		    ...
		    if (pb.aClass283_8716.method2654(-232228879).method2320(i_14_, i_15_, 1039567132))
			class365_sub1_sub1_sub2_sub2.aByte7724++;
		    if (-442628795 * pb.playerIndex == i && (Class99.anInt952 * 1855729883 != class365_sub1_sub1_sub2_sub2.plane))
		    ...
		    int i_20_ = ((i_18_ + (-1760580017 * class341.x + (class365_sub1_sub1_sub2_sub2.scenePositionXQueue[0])) & 0x3fff) - class341.x * -1760580017);
		    int i_21_ = ((i_19_ + (class341.y * 283514611 + (class365_sub1_sub1_sub2_sub2.scenePositionYQueue[0])) & 0x3fff) - class341.y * 283514611);
		    if (bool) {
		    ...
		    if (pb.aClass283_8716.method2654(934483887).method2320(i_20_, i_21_, 624472586))
			class365_sub1_sub1_sub2_sub2.aByte7724++;
		    if (i == pb.playerIndex * -442628795)
			Class99.anInt952 = (-85701805 * class365_sub1_sub1_sub2_sub2.plane);
		}
	    }
	}
