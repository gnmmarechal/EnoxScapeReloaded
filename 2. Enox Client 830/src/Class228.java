...
public class Class228 {
	...
	try {
	    ...
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = stringbuilder.toString();
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		pb.aShort8934 = Class87.aShort792;
		pb.aShort8935 = Class315.aShort3306;
		pb.aShort8839 = Class51.aShort504;
		pb.aShort8743 = Class396.aShort5193;
    ...
    public static void method2119(AnimationDefinition class391, int i, int i_2_) {
	try {
		...
		if (null != class391.anIntArray4183 && class391.anIntArray4190 != null)
		    i_7_ = AnimationDefinition.method4888(class391.anIntArray4183[i], class391.anIntArray4190[i], 1444813491);
