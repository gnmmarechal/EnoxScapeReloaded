...
public class Class385 {
    ...
    void method4705(Toolkit class_ra, Class385 class385_1_, Class385 class385_2_, float f, int i) {
	try {
	...
	try {
	    ...
	    if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub15_7560.method5684(-1934130167) == 1 && Class373.activeToolkit.method5048() > 0) {
		if (0 != (i_3_ & 0x1))
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = pb.aByte8959;
	    if (pb.aByte8959 != -1)
		pb.aByte8959 = (byte) -6;
	}
	catch (RuntimeException runtimeexception) {
