...
public abstract class Class343 {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class128.aClass148_6331.method250(i_0_, (byte) 38);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7582.method5726(-2143352335);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    pb.anInt8713 += -75983735;
	    pb.aBoolean8714 = true;
	    return true;
	}
	catch (RuntimeException runtimeexception) {
