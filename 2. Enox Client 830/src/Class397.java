...
public class Class397 {
	...
	try {
	    Class399.method4926((((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]), -1104898137);
	}
	...
	try {
	    if (-1 != -591434031 * pb.anInt8768 && pb.anInt8769 * -839811113 != -1) {
		int i_0_ = (((pb.anInt8857 * 892197957 * (pb.anInt8774 * 1714001937 - 1049339515 * pb.anInt8852)) >> 16) + 1049339515 * pb.anInt8852);
		pb.anInt8857 += 283956877 * i_0_;
		if (pb.anInt8857 * 892197957 >= 65535) {
		    pb.anInt8857 = -979359373;
		    if (!pb.aBoolean8776)
			pb.aBoolean8775 = true;
		    else
			pb.aBoolean8775 = false;
		    pb.aBoolean8776 = true;
		} else {
		    pb.aBoolean8775 = false;
		    pb.aBoolean8776 = false;
		}
		float f = (float) (pb.anInt8857 * 892197957) / 65535.0F;
		float[] fs = new float[3];
		int i_1_ = pb.anInt8770 * 1872262310;
		for (int i_2_ = 0; i_2_ < 3; i_2_++) {
		    int i_3_ = 3 * (pb.anIntArrayArrayArray8767[pb.anInt8768 * -591434031][i_1_][i_2_]);
		    int i_4_ = ((pb.anIntArrayArrayArray8767[-591434031 * pb.anInt8768][1 + i_1_][i_2_]) * 3);
		    int i_5_ = ((pb.anIntArrayArrayArray8767[pb.anInt8768 * -591434031][2 + i_1_][i_2_]) - ((pb.anIntArrayArrayArray8767[pb.anInt8768 * -591434031][3 + i_1_][i_2_]) - (pb.anIntArrayArrayArray8767[-591434031 * pb.anInt8768][i_1_ + 2][i_2_]))) * 3;
		    int i_6_ = (pb.anIntArrayArrayArray8767[-591434031 * pb.anInt8768][i_1_][i_2_]);
		    int i_7_ = i_4_ - i_3_;
		    int i_8_ = i_3_ - 2 * i_4_ + i_5_;
		    int i_9_ = i_4_ + ((pb.anIntArrayArrayArray8767[pb.anInt8768 * -591434031][i_1_ + 2][i_2_]) - i_6_) - i_5_;
		    fs[i_2_] = (f * ((float) i_7_ + ((float) i_8_ + (float) i_9_ * f) * f) + (float) i_6_);
		}
		WorldTile class341 = pb.aClass283_8716.method2628(681479919);
		Class367.anInt4000 = 547882953 * ((int) fs[0] - 526163456 * class341.x);
		Class110.anInt6403 = (int) fs[1] * -1078403147;
		Class146.anInt1575 = 309839105 * ((int) fs[2] - class341.y * -869407232);
		float[] fs_10_ = new float[3];
		int i_11_ = pb.anInt8771 * 977380166;
		for (int i_12_ = 0; i_12_ < 3; i_12_++) {
		    int i_13_ = ((pb.anIntArrayArrayArray8767[-839811113 * pb.anInt8769][i_11_][i_12_]) * 3);
		    int i_14_ = ((pb.anIntArrayArrayArray8767[pb.anInt8769 * -839811113][1 + i_11_][i_12_]) * 3);
		    int i_15_ = 3 * ((pb.anIntArrayArrayArray8767[pb.anInt8769 * -839811113][2 + i_11_][i_12_]) - ((pb.anIntArrayArrayArray8767[-839811113 * pb.anInt8769][3 + i_11_][i_12_]) - (pb.anIntArrayArrayArray8767[-839811113 * pb.anInt8769][2 + i_11_][i_12_])));
		    int i_16_ = (pb.anIntArrayArrayArray8767[-839811113 * pb.anInt8769][i_11_][i_12_]);
		    int i_17_ = i_14_ - i_13_;
		    int i_18_ = i_15_ + (i_13_ - i_14_ * 2);
		    int i_19_ = i_14_ + ((pb.anIntArrayArrayArray8767[pb.anInt8769 * -839811113][2 + i_11_][i_12_]) - i_16_) - i_15_;
		...
		pb.anInt8756 = ((int) (Math.atan2((double) f_21_, d) * 2607.5945876176133) & 0x3fff) * -648269561;
		Class135.anInt6384 = ((int) (-Math.atan2((double) f_20_, (double) f_22_) * 2607.5945876176133) & 0x3fff) * -1587695039;
		Class229.anInt6458 = ((pb.anIntArrayArrayArray8767[-591434031 * pb.anInt8768][i_1_][3]) + ((((pb.anIntArrayArrayArray8767[-591434031 * pb.anInt8768][2 + i_1_][3]) - (pb.anIntArrayArrayArray8767[pb.anInt8768 * -591434031][i_1_][3])) * (892197957 * pb.anInt8857)) >> 16)) * -851711283;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (Class298_Sub1.anInt7164 * -863531439 == 2)
		    i_28_ = (int) pb.aFloat8949 & 0x3fff;
		else
		    i_28_ = (1227356013 * pb.anInt8801 + (int) pb.aFloat8949) & 0x3fff;
		int i_29_ = Class220.SINE[i_28_];
		int i_30_ = Class220.COSINE[i_28_];
		if (Class298_Sub1.anInt7164 * -863531439 != 2) {
		    i_29_ = 256 * i_29_ / (256 + pb.anInt8749 * 356727603);
		    i_30_ = i_30_ * 256 / (356727603 * pb.anInt8749 + 256);
		}
		int i_31_ = i_30_ * i_24_ + i_25_ * i_29_ >> 14;
		int i_32_ = i_30_ * i_25_ - i_24_ * i_29_ >> 14;
		Sprite class57 = Class74.aClass57Array699[i_26_];
