...
public class Class313 {
    ...
    public static Sprite aClass57_3299;
	...
	try {
		...
		if (!pb.aBoolean8806)
		    SunDefinition.method1395(i, bool, 1982223094);
		else {
		    Class298_Sub49 class298_sub49 = (new Class298_Sub49(i, new Class308_Sub1(4096, Class517.idx36, i), i_0_, bool));
	...
	try {
	    int[] is = null;
	    if (GraphicDefinition.method4920(946432351 * (((Class298_Sub37_Sub15) class298_sub37_sub15).anInt9662), (short) 300))
		...
		Class298_Sub29 class298_sub29 = ((Class298_Sub29) (pb.aClass437_8696.get((long) (int) (2236412381003659263L * ((Class298_Sub37_Sub15) class298_sub37_sub15).aLong9661))));
		...
		ObjectDefinitions class432 = (pb.aClass283_8716.method2641(150013546).getObjectDefinitions((int) (2236412381003659263L * (((Class298_Sub37_Sub15) class298_sub37_sub15).aLong9661) >>> 32 & 0x7fffffffL)));
