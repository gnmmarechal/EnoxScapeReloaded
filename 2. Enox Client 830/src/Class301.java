...
public class Class301 {
    ...
    static void method3689(Toolkit class_ra, int i, int i_0_, int i_1_, int i_2_) {
	...
	for (int i_5_ = 0; i_5_ < i_3_; i_5_++) {
		...
		if (i_9_ < 0 || i_9_ >= anInt3239) {
			...
			int i_14_;
			if (((MapDetails) aClass298_Sub37_Sub13_3218).anInt9639 * -717907215 != -1)
			    i_14_ = ~0xffffff | (((MapDetails) aClass298_Sub37_Sub13_3218).anInt9639) * -717907215;
			...
			if (i_18_ > 0) {
				...
				if ((((MapDetails) aClass298_Sub37_Sub13_3218).anInt9639 * -717907215) != -1)
				    i_21_ = (~0xffffff | (((MapDetails) aClass298_Sub37_Sub13_3218).anInt9639) * -717907215);
    ...
    public static void method3690(JS5 class243, Class375 class375, Class451 class451, Class433 class433, Class339 class339, Class487 class487, Interface23 interface23) {
	idx23 = class243;
	...
	if (is != null) {
		...
		dungeonMaps.method5817(class298_sub37_sub13, (long) ((class298_sub37_sub13.fileId) * -947282109));
	    }
	}
	...
	aClass298_Sub37_Sub13_3218 = (MapDetails) dungeonMaps.get((long) i);
    }
	...
	for (MapDetails class298_sub37_sub13 = ((MapDetails) dungeonMaps.method5816(1759050770)); class298_sub37_sub13 != null; class298_sub37_sub13 = ((MapDetails) dungeonMaps.method5815((byte) -2))) {
	    if (((MapDetails) class298_sub37_sub13).load && class298_sub37_sub13.method3450(i, i_59_, (byte) 1))
		class461.add(class298_sub37_sub13, (byte) -123);
	}
	return class461;
    }
	...
	if (i_62_ >= 0 && interface_ma.getTexture(i_62_, 1570476781).isGroundMesh)
	    i_62_ = -1;
	int i_63_;
	if (class373.anInt4059 * 1728947183 >= 0) {
	    ...
	    i_63_ = (~0xffffff | (Class379.anIntArray4096[BillBoardDefinitions.method1823(Class343.method4161(i_66_, 96, (byte) 86), (byte) 0) & 0xffff]));
	} else if (i_62_ >= 0)
	    i_63_ = (~0xffffff | (Class379.anIntArray4096[BillBoardDefinitions.method1823(Class343.method4161((interface_ma.getTexture(i_62_, 201088475).color), 96, (byte) 61), (byte) 0) & 0xffff]));
	    ...
	    i_63_ = (~0xffffff | (Class379.anIntArray4096[BillBoardDefinitions.method1823(Class343.method4161(i_69_, 96, (byte) 22), (byte) 0) & 0xffff]));
	}
	return i_63_;
    }

    static void method3695(Toolkit class_ra, RsByteBuffer class298_sub53, int i, int i_70_, int i_71_, int i_72_, int[] is, int[] is_73_) {
	...
	for (int i_97_ = -5; i_97_ < anInt3239; i_97_++) {
		...
		if (i_98_ < anInt3239) {
			...
			is_92_[i_100_] += class443.hue * 838046775;
			is_93_[i_100_] += class443.saturation * -620399085;
			is_94_[i_100_] += class443.lightness * 656695887;
			is_95_[i_100_] += class443.chroma * -813159285;
			is_96_[i_100_]++;
		    }
		}
		if (i_99_ >= 0) {
		...
		for (int i_108_ = -5; i_108_ < anInt3240; i_108_++) {
			...
			if ((is[i_97_ + i_108_ * anInt3239] & 0xff) == 0) {
			    ...
			    int i_116_ = (Class379.anIntArray4096[(BillBoardDefinitions.method1823(Class290.method2749(i_114_, 96, 1291456097), (byte) 0)) & 0xffff]);
    ...
    static void method3698(Toolkit class_ra) {
    ...
    static void method3699(Toolkit class_ra, int i, int i_120_) {
    ...
    static void method3700(Toolkit class_ra, int i, int i_147_, int i_148_, int i_149_, int i_150_, int i_151_, int i_152_, int[] is, byte[] is_153_, boolean bool) {
    ...
    static void method3701(Toolkit class_ra, int i, int i_165_, int i_166_, int i_167_, int[] is, byte[] is_168_) {
	if (is != null) {
		...
		if (i_170_ != -1) {
		    MapIconDefinitions mapIconDefinitions = aClass487_3225.method6159(i_170_, -2130050645);
		    Sprite class57 = mapIconDefinitions.method6198(class_ra, (class432.aBoolean5401 ? is_168_[i_169_] >> 6 & 0x3 : 0), (class432.aBoolean5440 ? class432.mirrorModel : false), (byte) -47);
		    if (class57 != null) {
			int i_171_ = i_166_ * class57.method271() >> 2;
			int i_172_ = i_167_ * class57.method626() >> 2;
			if (mapIconDefinitions.aBoolean6098) {
			...
			if (i_171_ != 0 && i_172_ != 0) {
			    if (mapIconDefinitions.anInt6096 * -2012904123 != 0)
				class57.method634(i, i_165_ - i_172_ + i_167_, i_171_, i_172_, 0, (~0xffffff | (mapIconDefinitions.anInt6096 * -2012904123)), 1);
			    else
    ...
    static Class453 method3702(Toolkit class_ra) {
	int i = anInt3252 - anInt3230;
    ...
    static Class453 method3703(Toolkit class_ra, int i, int i_179_, int i_180_, int i_181_) {
    ...
    static void method3704(Toolkit class_ra, Class298_Sub52 class298_sub52, int i, int i_182_, int i_183_, int i_184_) {
	...
	return (MapDetails) dungeonMaps.get((long) i);
    }
	...
	for (MapDetails class298_sub37_sub13 = ((MapDetails) dungeonMaps.method5816(1588897265)); class298_sub37_sub13 != null; class298_sub37_sub13 = ((MapDetails) dungeonMaps.method5815((byte) -24))) {
	    if (((MapDetails) class298_sub37_sub13).load && class298_sub37_sub13.method3450(i, i_187_, (byte) -105))
    ...
    static void method3711(Toolkit class_ra, Class298_Sub52 class298_sub52, Class352 class352) {
