...
public class Class119 {
	...
	try {
	    ...
	    if((i & 0xffff) > aClass105Array1405.length)
		return aClass105Array1405[aClass105Array1405.length-1];
	...
	try {
	    ...
	    class105.anInt1151 = -127794683 * pb.playerIndex;
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub8_7566.method5654(-1747444886);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ObjectDefinitions class432 = pb.aClass283_8716.method2641(-1623210152).getObjectDefinitions(interface3.method32((byte) 18));
		...
		l_6_ |= l_5_;
	    if (class432.holdsItemPiles * 512737201 == 1)
		l_6_ |= l;
	...
	try {
	    ((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 - 2] = (Class316.aClass362_3318.method4307((((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 - 2]), 245040087).anIntArray4016[(((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1])]);
