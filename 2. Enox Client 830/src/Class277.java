...
public class Class277 {
	...
	public void method2583(int i, int i_0_, int i_1_) {
		try {
			...
			((Class277) this).anInt2961 = -1739514523 * (i * (i_0_ - -1519560585 * (((Class277) this).anInt2947)) / 255
					+ -1519560585 * ((Class277) this).anInt2947);
	...
	public boolean method2588(Toolkit class_ra, int i, int i_3_, int i_4_) {
		try {
			if (-51566561 * ((Class277) this).anInt2963 != i) {
				...
				if (null != ((Class277) this).aClass276Array2949) {
					...
					for (int i_6_ = 0; i_6_ < ((Class277) this).aClass276Array2949.length; i_6_++) {
						...
						if (class276.method2579(((Class277) this).anInt2957 * 1173193129,
								796478559 * ((Class277) this).anInt2948, -226559159 * ((Class277) this).anInt2962,
								((Class277) this).anInt2963 * -51566561)) {
							is[((Class277) this).anInt2945 * 1858024591] = ((Class276) class276).anInt2919;
							((Class277) this).aClass276Array2953[((((Class277) this).anInt2945 += 400255599)
									* 1858024591) - 1] = class276;
						}
					}
					Class419.method5602(is, ((Class277) this).aClass276Array2953, 0,
							(1858024591 * ((Class277) this).anInt2945) - 1, -641027314);
				}
			...
			if (((Class277) this).aBoolean2954) {
				...
				for (int i_7_ = ((Class277) this).anInt2945 * 1858024591 - 1; i_7_ >= 0; i_7_--) {
					boolean bool_8_ = (((Class277) this).aClass276Array2953[i_7_].method2575(class_ra,
	...
	void method2589(Toolkit class_ra, int i) {
		try {
			try {
				boolean bool = Class465.aClass243_6520.method2291((-680590445 * (((Class277) this).anInt2956)),
						581664063);
				if (bool) {
					class_ra.m(16777215, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F);
					ModelDecoder class64 = ModelDecoder.getModel(Class465.aClass243_6520,
							(((Class277) this).anInt2956 * -680590445), 0);
					((Class277) this).aClass387_2941 = class_ra.createModel(class64, 1099776, 0, 255, 1);
	...
	public void method2590(Toolkit class_ra, int i, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_,
	...
	public void method2591(Toolkit class_ra, int i, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_,
			int i_25_, int i_26_, boolean bool, boolean bool_27_, byte i_28_) {
		try {
			int i_29_ = 0;
			if (((Class277) this).aBoolean2959)
			...
			if (null != ((Class277) this).aClass277_2960) {
				...
				class277_30_.method2593(class_ra, i, i_19_, i_20_, i_21_, i_22_, i_23_, i_24_, i_25_, i_26_, bool,
						bool_27_, i_29_, 2089062848);
				class277_31_.method2593(class_ra, i, i_19_, i_20_, i_21_, i_22_, i_23_, i_24_, i_25_, i_26_, false,
						bool_27_, 255 - i_29_, 357729081);
			} else
				method2593(class_ra, i, i_19_, i_20_, i_21_, i_22_, i_23_, i_24_, i_25_, i_26_, bool, bool_27_, i_29_,
						1191709910);
		} catch (RuntimeException runtimeexception) {
	...
	void method2592(Toolkit class_ra, int i, int i_32_, int i_33_, int i_34_, int i_35_) {
		try {
	...
	void method2593(final Toolkit class_ra, final int i, final int i_38_, final int i_39_, final int i_40_,
			final int i_41_, final int i_42_, int i_43_, final int i_44_, final int i_45_, final boolean bool,
			final boolean bool_46_, final int i_47_, final int i_48_) {
		try {
			final int i_49_ = 255 - i_47_;
			if (this.aClass387_2941 == null) {
				class_ra.ba(2, 0);
				i_43_ = i_43_ + i & 0x3fff;
				if (this.anInt2940 * 1461948177 != -1 && this.anInt2946 * -1994130525 != 0) {
					final TextureMetrics class53 = anInterface_ma2955.getTexture(((this.anInt2940) * 1461948177), 0);
					if (null == this.aClass57_2950 && anInterface_ma2955.method170(class53.textureId, 0)) {
						final int[] is = (2 == -2138060883 * class53.blendType
								? (anInterface_ma2955.method172(class53.textureId, 0.7F, class53.bitLoad,
										class53.bitLoad, false, 0))
								: (anInterface_ma2955.method171(class53.textureId, 0.7F, class53.bitLoad,
										class53.bitLoad, false, 0)));
						this.anInt2939 = is[0] * 1667694183;
						this.anInt2952 = 918308719 * is[is.length - 1];
						this.aClass57_2950 = class_ra.method5031(is, 0, (this.anInt2946 * -1994130525),
								(this.anInt2946 * -1994130525), (this.anInt2946 * -1994130525), 0);
					}
					final int i_50_ = (i_49_ == 255 ? class53.blendType * -2138060883 == 2 ? 1 : 0 : 1);
					if (1 == i_50_ && bool)
					...
					if (this.aClass57_2950 != null) {
						...
						if (this.aClass320_2944 == Class320.aClass320_6547) {
							for (int i_53_ = i_52_ - i_41_; i_53_ < i_40_; i_53_ += i_41_)
								this.aClass57_2950.method634(i_38_ + i_53_, i_51_ + i_39_, i_41_, i_41_, 0,
										i_49_ << 24 | 0xffffff, i_50_);
							if ((150420823 * this.anInt2939 & ~0xffffff) != 0)
								class_ra.method5015(0, 0, i_40_, 1 + (i_39_ + i_51_), (150420823 * (this.anInt2939)),
										(byte) 0);
							if (0 != (this.anInt2952 * 1184429967 & ~0xffffff))
								class_ra.method5015(0, i_51_ + i_39_ + i_41_, i_40_, i_41_ - (i_41_ + (i_51_ + i_39_)),
										this.anInt2952 * 1184429967, (byte) 0);
						} else {
							...
							for (int i_54_ = i_52_ - i_41_; i_54_ < i_40_; i_54_ += i_41_) {
								for (int i_55_ = i_51_ - i_41_; i_55_ < i_41_; i_55_ += i_41_)
									this.aClass57_2950.method634(i_38_ + i_54_, i_39_ + i_55_, i_41_, i_41_, 0,
											i_49_ << 24 | 0xffffff, i_50_);
							}
						}
					}
				...
				final Class233 class233 = class_ra.method5045();
				final Class233 class233_56_ = class_ra.method5045();
			...
			for (int i_57_ = this.anInt2945 * 1858024591 - 1; i_57_ >= 0; i_57_--)
				this.aClass276Array2953[i_57_].method2577(class_ra, i_38_, i_39_, i_40_, i_41_, i_42_, i_43_,
						1173193129 * this.anInt2957, this.anInt2948 * 796478559, this.anInt2962 * -226559159, i_49_);
			class_ra.ba(2, 0);
	...
	public Class277(int i, Class276[] class276s, int i_58_, int i_59_, int i_60_, int i_61_, Class320 class320,
			int i_62_) {
		((Class277) this).aBoolean2954 = true;
	...
	static final void method2594(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
		try {
			class105.anInt1306 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689)
					* 681479919]) * -216431639;
	...
	static Class298_Sub36 createWalkPacket(int localX, int localY, int type) {
		try {
			...
			if (0 == type)
				packet = Class18.method359(OutcommingPacket.WALKING_PACKET, pb.aClass25_8711.aClass449_330, (byte) 51);
			if (type == 1)
				packet = Class18.method359(OutcommingPacket.MINI_WALKING_PACKET, pb.aClass25_8711.aClass449_330,
						(byte) 28);
			WorldTile class341 = pb.aClass283_8716.method2628(681479919);
			packet.aClass298_Sub53_Sub2_7396.writeShort128(class341.x * -1760580017 + localX);
			packet.aClass298_Sub53_Sub2_7396.write128Byte(Class151.method1644(-545107710) ? 1 : 0, (byte) 1);
			packet.aClass298_Sub53_Sub2_7396.writeShort128(localY + class341.y * 283514611);
	...
	static final void method2600(Class403 class403, byte i) {
		try {
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393
					- 1)] = new StringBuilder()
							.append(Class465.method6017(
									(long) (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689)
											* 681479919]) * 60000L,
									Class321.aClass429_3357.getType(694163818), true, -1759893587))
							.append(" UTC").toString();
		} catch (RuntimeException runtimeexception) {
