...
public class Class100 {
	...
	try {
	    IComponentDefinition class105 = Class50.getIComponentDefinitions((((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]), (byte) -124);
	...
	try {
	    MapDetails.method3455((((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]), -1482618001);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Toolkit.aClass256_5315.method2441(i_0_, 537859491).anIntArray9598[i_1_]);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (!Class373.activeToolkit.method5032())
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 3;
	    else
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub13_7549.method5612(i_2_, 1352882135);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = class456s.length;
	    } else
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class229.method2123(1029121048);
	}
	catch (RuntimeException runtimeexception) {
