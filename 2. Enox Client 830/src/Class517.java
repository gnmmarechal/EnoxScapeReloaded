...
public class Class517 {
	...
	try {
		...
		is = (((Class517) this).aClass243_6269.getFile(ConfigEntry.aClass120_1452.anInt1460 * -1006924897, i));
	    }
	    class520 = new Class520();
	    if (is != null)
		class520.method6321(new RsByteBuffer(is), -1099657695);
	    synchronized (((Class517) this).aClass348_6267) {
		((Class517) this).aClass348_6267.put(class520, (long) i);
	    }
	    return class520;
	}
	catch (RuntimeException runtimeexception) {
	...
	if (((Class517) this).aClass243_6269 != null)
	    anInt6268 = (((Class517) this).aClass243_6269.getFileCountForArchive(-1006924897 * ConfigEntry.aClass120_1452.anInt1460, 650803238)) * 2084802537;
	else
	    anInt6268 = 0;
    }

    static void method6308(Toolkit class_ra, int i) {
	try {
		...
		if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571.method5677(-627187888) == 0) {
			...
			Class522.aClass_ra6285 = Class523.method6334(0, canvas, Class253.anInterface_ma2785, Class82_Sub6.idx31, 0, -753690122);
			Class522.aClass264_6284 = (Class522.aClass_ra6285.method5092(Class322.method3931(BillBoardDefinitions.idx29, (399302739 * Class74.anInt691), 0, (byte) 78), IndexedImage.method993(Class158.idx8, Class74.anInt691 * 399302739, 0), true));
		    }
		    for (Class298_Sub14 class298_sub14 = (Class298_Sub14) Class522.aClass453_6283.method5939(1766612795); null != class298_sub14; class298_sub14 = ((Class298_Sub14) Class522.aClass453_6283.method5944(49146))) {
	...
	try {
	    ...
	    int i_2_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
		...
		((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = Class15.aClass507_224.method6269(i_2_, 745591351).method6245(i_3_, class497.aString6101, 1273707892);
	    else
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = (Class15.aClass507_224.method6269(i_2_, 1830480683).method6239(i_3_, -388931549 * class497.anInt6100, (byte) 106));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (ObjectOverride.method5804(pb.anInt8752 * -1233866115, (byte) -21)) {
