...
public abstract class Class481 {
	...
	try {
	    ...
	    for (int i_0_ = 0; i_0_ < pb.anInt8808 * -976358333; i_0_++) {
		int npcIndex = pb.anIntArray8706[i_0_];
		NPC npc = ((NPC) (((Class298_Sub29) pb.aClass437_8696.get((long) npcIndex)).anObject7366));
		...
		if ((mask & 0x80000) != 0) { // Unidentified - ordinal 2
		    ...
		    npc.anInt10105 = ((pb.ticketCycle * 443738891 + stream.readUnsignedShortLE128(1478539457)) * 1828453179);
		    npc.anInt10106 = ((pb.ticketCycle * 443738891 + stream.readUnsignedShortLE128(1478539457)) * -473408095);
		}
		...
		if (0 != (mask & 0x4)) { // Hit ? ordinal 7
			...
			for (int i_11_ = 0; i_11_ < i_10_; i_11_++) {
			    ...
			    npc.method4420(i_15_, i_13_, i_12_, i_14_, pb.ticketCycle * 443738891, i_16_, i_17_, (byte) 6);
			}
		    }
		}
		...
		if ((mask & 0x400) != 0) {// ordinal 13 other bar thing
		    ...
		    npc.anInt10086 = (npc.anInt10088 * 1195117671 + (pb.ticketCycle * 1208636921 + (-1132907677 * npc.anInt10087)));
		}
		...
		if ((mask & 0x800) != 0) {// Force movement ordinal 15
		    ...
		    npc.anInt10095 = (stream.readUnsignedShortLE((byte) -54) + 443738891 * pb.ticketCycle) * 996079737;
		    npc.anInt10103 = (stream.readUnsignedShortLE128(1478539457) + pb.ticketCycle * 443738891) * 1000906529;
		...
		if ((mask & 0x1) != 0) {// Transform NPC id - ordinal 22
			...
			AnimationDefinition.method4884(npc.plane, npc.scenePositionXQueue[0], npc.scenePositionYQueue[0], 0, null, npc, null, (byte) 68);
		    }
		}
	    }
	}
