...
public abstract class Class30 {
    ...
    boolean aBoolean379;
    int anInt380;
    GLToolkit aClass_ra_Sub2_381;
    static int[] anIntArray382 = new int[1];

    Class30(GLToolkit class_ra_sub2, int i, Class55 class55, Class77 class77, int i_0_, boolean bool) {
	...
	if (((Class30) this).anInt376 > 0) {
	    ((GLToolkit) ((Class30) this).aClass_ra_Sub2_381).anInt8175 -= method416();
	    int[] is = new int[1];
	...
	((GLToolkit) ((Class30) this).aClass_ra_Sub2_381).anInt8175 -= i;
	((GLToolkit) ((Class30) this).aClass_ra_Sub2_381).anInt8175 += method416();
    }
	...
	for (;;) {
	    OpenGL.glTexImage2Dub(i, i_30_, i_26_, i_27_, i_28_, 0, GLToolkit.method5228(class55), 5121, is_34_, 0);
	    if (i_31_ <= 1)
		break;
    ...
    boolean method413() {
	if (((GLToolkit) ((Class30) this).aClass_ra_Sub2_381).framebuffer_obj) {
	    int i = method416();
	    ((Class30) this).aClass_ra_Sub2_381.method5256(this);
	...
	for (;;) {
	    OpenGL.glTexImage2Df(i, i_49_, i_45_, i_46_, i_47_, 0, GLToolkit.method5228(class55), 5126, fs_53_, 0);
	    if (i_50_ <= 1)
		break;
    ...
    void method417() {
	if (((Class30) this).anInt376 > 0) {
	    ((Class30) this).aClass_ra_Sub2_381.deleteTex(((Class30) this).anInt376, method416());
	    ((Class30) this).anInt376 = 0;
	}
    }
}
