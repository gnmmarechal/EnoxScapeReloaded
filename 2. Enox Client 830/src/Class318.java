...
public abstract class Class318 {
    ...
    public abstract int available(int i) throws IOException;
    ...
    public abstract void write(byte[] is, int i, int i_7_, int i_8_) throws IOException;
	...
	try {
		...
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = -2;
	    else if (pb.anInt8942 * 1131012101 == 1)
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = -1;
	    else
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = pb.anInt8941 * -1054937867;
	}
	...
	try {
	    ...
	    int i_10_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]);
	    int i_11_ = (((Class403) class403).anIntArray5244[1 + ((Class403) class403).anInt5239 * 681479919]);
	    int i_12_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 2]);
	    int i_13_ = (((Class403) class403).anIntArray5244[3 + 681479919 * ((Class403) class403).anInt5239]);
	    int i_14_ = (((Class403) class403).anIntArray5244[4 + ((Class403) class403).anInt5239 * 681479919]);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (i_11_ - i_10_) * (i_14_ - i_12_) / (i_13_ - i_12_) + i_10_;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    pb.aShort8928 = (short) (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
	    if (pb.aShort8928 <= 0)
		pb.aShort8928 = (short) 256;
	    pb.aShort8929 = (short) (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 1]);
	    if (pb.aShort8929 <= 0)
		pb.aShort8929 = (short) 205;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    class105.anInt1253 = -478399925 * (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
		...
		i_15_ = 4;
	    int i_16_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 3]);
	    if (i_16_ < 0)
		i_16_ = 0;
	    else if (i_16_ > 4)
		i_16_ = 4;
