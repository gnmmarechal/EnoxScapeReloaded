...
public class Class80 {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1162 * 457937409;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    for (Class302_Sub5 class302_sub5 = ((Class302_Sub5) pb.aClass442_8781.method5871((byte) 3)); null != class302_sub5; class302_sub5 = ((Class302_Sub5) pb.aClass442_8781.method5871((byte) 3)))
		Class152.method1655(class302_sub5, -1638035740);
	    int i_14_ = 0;
	    int i_15_ = 3;
	    if (0 == pb.anInt8724 * 1596783995) {
	...
	try {
	    ...
	    int i_18_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]);
	    int i_19_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 1]);
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] =  string == null ? 0 : string.substring(i_18_, i_19_);
	}
	catch (RuntimeException runtimeexception) {
