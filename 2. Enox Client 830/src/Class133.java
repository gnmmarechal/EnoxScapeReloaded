...
public class Class133 {
	...
	try {
	    ...
	    i_4_ -= -1760580017 * class341.x;
	    if (i_4_ < 0)
		i_4_ = 0;
	    else if (i_4_ >= pb.aClass283_8716.method2629(-1870653657))
		i_4_ = pb.aClass283_8716.method2629(-2106000427);
	    i_5_ -= class341.y * 283514611;
	    if (i_5_ < 0)
		i_5_ = 0;
	    else if (i_5_ >= pb.aClass283_8716.method2630(787275205))
		i_5_ = pb.aClass283_8716.method2630(11403406);
	    pb.anInt8753 = 672497503 * ((i_4_ << 9) + 256);
	    pb.anInt8755 = 957476733 * ((i_5_ << 9) + 256);
