...
public final class Class315 {
	...
	static final void method3834(SubIncommingPacket class206, short i) {
		try {
			RsBitsBuffer class298_sub53_sub2 = ((Class25) pb.aClass25_8711).aClass298_Sub53_Sub2_333;
			if (SubIncommingPacket.aClass206_2347 == class206) {
				...
				int i_9_ = i_8_ >> 2;
				int i_10_ = i_8_ & 0x3;
				int i_11_ = pb.anIntArray8739[i_9_];
				...
				if (pb.aClass283_8716.method2674(-586078948) != Class266.aClass266_2846)
				...
				int i_16_ = i_15_ >> 2;
				int i_17_ = pb.anIntArray8739[i_16_];
				...
				ObjectDefinitions class432 = pb.aClass283_8716.method2641(-527347356).getObjectDefinitions(i_21_);
				...
				int i_26_ = 0;
				if (null != class432.replacementColours)
					i_26_ = class432.replacementColours.length;
				int i_27_ = 0;
				if (null != class432.destTextures)
					i_27_ = class432.destTextures.length;
				if (1 == (i_22_ & 0x1))
					...
					Class370.method4579(-191892109 * Class375.basePlane, i_19_, i_20_, i_17_, i_21_, i_16_, new ObjectOverride((Class298_Sub1.aLong7163 * -5796734886992507517L), is, is_29_, is_31_), (byte) 8);
				...
				int i_34_ = i_33_ >> 2;
						int i_35_ = i_33_ & 0x3;
						int i_36_ = pb.anIntArray8739[i_34_];
						...
						if (pb.aClass283_8716.method2674(99999280).method2522((byte) -3) || (i_38_ >= 0 && i_39_ >= 0 && (i_38_ < pb.aClass283_8716.method2629(-1871735876)) && (i_39_ < pb.aClass283_8716.method2630(-164212893))))
				...
				int gfx = class298_sub53_sub2.readUnsignedShort();
				int startHieght = class298_sub53_sub2.readUnsignedByte() * 4;
				int endHeight = class298_sub53_sub2.readUnsignedByte() * 4;
				int delay = class298_sub53_sub2.readUnsignedShort();
				int delayAndSpeed = class298_sub53_sub2.readUnsignedShort();
				int angle = class298_sub53_sub2.readUnsignedByte();
				int fromSizeAndSlope = class298_sub53_sub2.readUnsignedShort();
				if (angle == 255)
					angle = -1;
				if (pb.aClass283_8716.method2674(-135283377) != Class266.aClass266_2846) {
					if (i_41_ >= 0 && i_42_ >= 0 && (i_41_ < pb.aClass283_8716.method2629(-2115187525)) && i_42_ < pb.aClass283_8716.method2630(1222512663) && i_43_ >= 0 && i_44_ >= 0 && (i_43_ < pb.aClass283_8716.method2629(-2121627992)) && (i_44_ < pb.aClass283_8716.method2630(-2081531222)) && gfx != 65535) {
						i_41_ = 256 + 512 * i_41_;
						i_42_ = 256 + 512 * i_42_;
						i_43_ = 256 + i_43_ * 512;
						i_44_ = i_44_ * 512 + 256;
						...
						endHeight <<= 2;
						fromSizeAndSlope <<= 2;
						Class365_Sub1_Sub1_Sub1 class365_sub1_sub1_sub1 = (new Class365_Sub1_Sub1_Sub1(pb.aClass283_8716.method2675(-1611682495), gfx, -191892109 * Class375.basePlane, Class375.basePlane * -191892109, i_41_, i_42_, startHieght, delay + pb.ticketCycle * 443738891, pb.ticketCycle * 443738891 + delayAndSpeed, angle, fromSizeAndSlope, 0, i_45_, endHeight, bool, -1));
						class365_sub1_sub1_sub1.method4405(i_43_, i_44_, Class356.method4271(i_43_, i_44_, (-191892109 * Class375.basePlane), -1671970391) - endHeight, 443738891 * pb.ticketCycle + delay, -53743739);
				...
				int i_55_ = i_54_ + class341.y * 283514611;
				int i_56_ = ClanSettings.baseTileX * 134435705 + (i_53_ >> 4 & 0x7);
				int i_57_ = class341.x * -1760580017 + i_56_;
				...
				boolean bool = (i_56_ >= 0 && i_54_ >= 0 && i_56_ < pb.aClass283_8716.method2629(-2010293889) && (i_54_ < pb.aClass283_8716.method2630(-747226515)));
				if (bool || pb.aClass283_8716.method2674(131556130).method2522((byte) -65)) {
					Class411.method5576(Class375.basePlane * -191892109, i_57_, i_55_, new Class298_Sub12(i_59_, i_58_), -369193084);
					if (bool)
						BillBoardDefinitions.method1820(-191892109 * Class375.basePlane, i_56_, i_54_, 1649431547);
				}
				...
				pb.aClass283_8716.method2641(267585287).getObjectDefinitions(i_60_).method5771(i_61_, (byte) 28);
				...
				int i_64_ = 283514611 * class341.y + i_63_;
				int i_65_ = (i_62_ >> 4 & 0x7) + 134435705 * ClanSettings.baseTileX;
				int i_66_ = i_65_ + -1760580017 * class341.x;
				...
				if (null != pb.aClass437_8685) {
					Class298_Sub2 class298_sub2 = ((Class298_Sub2) (pb.aClass437_8685.get((long) (-191892109 * Class375.basePlane << 28 | i_64_ << 14 | i_66_))));
					if (class298_sub2 != null) {
						...
						if (i_65_ >= 0 && i_63_ >= 0 && i_65_ < pb.aClass283_8716.method2629(-2131588637) && i_63_ < pb.aClass283_8716.method2630(-523876912))
							BillBoardDefinitions.method1820((-191892109 * Class375.basePlane), i_65_, i_63_, 1760601086);
					}
				}
				...
				if (pb.aClass283_8716.method2674(1533260419) != Class266.aClass266_2846)
				...
				int i_80_ = i_79_ >> 2;
						int i_81_ = i_79_ & 0x3;
						int i_82_ = pb.anIntArray8739[i_80_];
						int i_83_ = class298_sub53_sub2.readIntLE(-1674329814);
						if (pb.aClass283_8716.method2674(39788259).method2522((byte) 29) || (i_77_ >= 0 && i_78_ >= 0 && (i_77_ < pb.aClass283_8716.method2629(-2063854515)) && (i_78_ < pb.aClass283_8716.method2630(-1828303048))))
				...
				int i_89_ = class341.y * 283514611 + i_88_;
				int i_90_ = ClanSettings.baseTileX * 134435705 + (i_87_ >> 4 & 0x7);
				int i_91_ = -1760580017 * class341.x + i_90_;
				if (i_84_ != -442628795 * pb.playerIndex) {
					boolean bool = (i_90_ >= 0 && i_88_ >= 0 && i_90_ < pb.aClass283_8716.method2629(-2004210913) && i_88_ < pb.aClass283_8716.method2630(133385720));
					if (bool || pb.aClass283_8716.method2674(1297675002).method2522((byte) -41)) {
						Class411.method5576(-191892109 * Class375.basePlane, i_91_, i_89_, new Class298_Sub12(i_85_, i_86_), 1214818737);
						if (bool)
							BillBoardDefinitions.method1820((Class375.basePlane * -191892109), i_90_, i_88_, 1328737922);
					}
				}
				...
				if (i_107_ == 255)
					i_107_ = -1;
				if (pb.aClass283_8716.method2674(781301439) != Class266.aClass266_2846) {
					if (i_93_ >= 0 && i_94_ >= 0 && i_93_ < pb.aClass283_8716.method2629(-2097499815) * 2 && i_94_ < pb.aClass283_8716.method2629(-1925634796) * 2 && i_98_ >= 0 && i_99_ >= 0 && i_98_ < pb.aClass283_8716.method2630(-2066893296) * 2 && (i_99_ < pb.aClass283_8716.method2630(1895360083) * 2) && 65535 != i_102_) {
						i_93_ *= 256;
						i_94_ = 256 * i_94_;
						i_98_ = 256 * i_98_;
						i_99_ *= 256;
				...
				int i_114_ = i_113_ >> 4 & 0xf;
						...
						if (pb.aClass283_8716.method2674(569302746) != Class266.aClass266_2846) {
							if (i_110_ >= 0 && i_111_ >= 0 && (i_110_ < pb.aClass283_8716.method2629(-2099610751)) && (i_111_ < pb.aClass283_8716.method2630(-358830712))) {
								int i_119_ = 1 + i_114_;
				...
				if (pb.aClass283_8716.method2674(1544127575) != Class266.aClass266_2846) {
					if (i_121_ >= 0 && i_122_ >= 0 && (i_121_ < pb.aClass283_8716.method2629(-2060803867)) && (i_122_ < pb.aClass283_8716.method2630(210266167))) {
						if (-1 == i_123_) {
							Class298_Sub37_Sub3 class298_sub37_sub3 = ((Class298_Sub37_Sub3) (pb.aClass437_8825.get((long) (i_121_ << 16 | i_122_))));
							...
							if (i_129_ < 3 && pb.aClass283_8716.method2654(1627070231).method2320(i_121_, i_122_, 575492228))
								i_129_++;
							Class365_Sub1_Sub1_Sub3 class365_sub1_sub1_sub3 = (new Class365_Sub1_Sub1_Sub3(pb.aClass283_8716.method2675(-1611682495), i_123_, i_125_, -191892109 * Class375.basePlane, i_129_, i_127_, Class356.method4271(i_127_, i_128_, (Class375.basePlane * -191892109), -1861382449) - i_124_, i_128_, i_121_, i_121_, i_122_, i_122_, i_126_, false));
							pb.aClass437_8825.method5817((new Class298_Sub37_Sub3(class365_sub1_sub1_sub3)), (long) (i_121_ << 16 | i_122_));
						}
					}
				}
				...
				int i_135_ = i_134_ >> 4 & 0xf;
							...
							if (pb.aClass283_8716.method2674(39884684) != Class266.aClass266_2846) {
								if (i_131_ >= 0 && i_132_ >= 0 && (i_131_ < pb.aClass283_8716.method2629(-2049168352)) && (i_132_ < pb.aClass283_8716.method2630(91496889))) {
									int i_140_ = i_135_ + 1;
				...
				int i_144_ = 283514611 * class341.y + i_143_;
				int i_145_ = 134435705 * ClanSettings.baseTileX + (i_142_ >> 4 & 0x7);
				int i_146_ = i_145_ + -1760580017 * class341.x;
				Class298_Sub2 class298_sub2 = ((Class298_Sub2) (pb.aClass437_8685.get((long) (Class375.basePlane * -191892109 << 28 | i_144_ << 14 | i_146_))));
				if (class298_sub2 != null) {
					for (Class298_Sub12 class298_sub12 = (Class298_Sub12) class298_sub2.aClass453_7166.method5939(1766612795); class298_sub12 != null; class298_sub12 = (Class298_Sub12) class298_sub2.aClass453_7166.method5944(49146)) {
						if (i_141_ == class298_sub12.anInt7257 * 1768239597) {
							class298_sub12.method2839(-1460969981);
							break;
						}
					}
					...
					if (i_145_ >= 0 && i_143_ >= 0 && (i_145_ < pb.aClass283_8716.method2629(-1929078790)) && (i_143_ < pb.aClass283_8716.method2630(-999181271)))
						BillBoardDefinitions.method1820(Class375.basePlane * -191892109, i_145_, i_143_, 547814341);
				}
			} else {
