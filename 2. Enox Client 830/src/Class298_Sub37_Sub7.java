...
public class Class298_Sub37_Sub7 extends Class298_Sub37 {
	...
	try {
		...
		if (null == ((Class298_Sub37_Sub7) this).aClass437_9594) {
		    int i_5_ = Class416.nextPowerOfTwo(i_4_, (byte) 16);
	...
	try {
		...
		for (int i_15_ = 0; (0 != i_13_ && i_15_ < (class365_sub1_sub1_sub2.aClass438_Sub2_Sub1Array10112).length); i_13_ >>>= 1) {
			...
			AnimationDefinition class391 = Class501.aClass395_6122.getAnimationDefinition(i_12_, (byte) -80);
			int i_16_ = class391.replayMode * -1117238071;
	...
	try {
	    ...
	    int i_17_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]);
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = new StringBuilder().append(string).append(Class128_Sub1.method1440(i_17_, true, (byte) 8)).toString();
	}
	catch (RuntimeException runtimeexception) {
