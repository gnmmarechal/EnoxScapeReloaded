...
public class Class446 implements Iterator {
	...
	try {
		...
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 28445523 * class456s[i_0_].anInt5663;
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 262154323 * class456s[i_0_].anInt5665;
	    } else {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class374.anIntArray4078[(((Class403) class403).anIntArray5257[1883543357 * ((Class403) class403).anInt5259])]);
	}
	catch (RuntimeException runtimeexception) {
