...
public class IComponentDefinition {
    ...
    public ParticleSystem aClass351_1218;
    public IComponentSettings aClass298_Sub38_1219;
	...
	try {
		...
		return string;
	    Class298_Sub29 class298_sub29 = ((Class298_Sub29) ((IComponentDefinition) this).aClass437_1279.get((long) i));
	...
	try {
	    ...
	    aByte1148 = stream.readByte();
	    aByte1149 = stream.readByte();
	    aByte1146 = stream.readByte();
	    aByte1147 = stream.readByte();
		...
		aString1212 = CS2Replacer.filterLoad(stream.readString(332948556));
		
		/*else if (aString1212.equals("Log In")) {
		    aString1212 = "Login - Spawn";
		}else if ((-440872681 * ihash) == 39059509) {
		    aString1212 = "<u=C8C8C8>Login - Economy";
		}*/
	    ...
	    int settingsHash = stream.read24BitUnsignedInteger((byte) 8);
		...
		for (/**/; i_6_ != 0; i_6_ = stream.readUnsignedByte()) {
		    ...
		    if (i_6_ == 4095)
			i_6_ = -1;
		    byte i_8_ = stream.readByte();
		    if (i_8_ != 0)
			aBoolean1220 = true;
		    byte i_9_ = stream.readByte();
	    ...
	    int defaultHash = -1;
	    if (MagnetConfig.method784(settingsHash, (byte) 111) != 0) {
		defaultHash = stream.readUnsignedShort();
		if (defaultHash == 65535)
		    defaultHash = -1;
	    ...
	    aClass298_Sub38_1219 = new IComponentSettings(settingsHash, defaultHash);
	    if (newInt >= 0) {
	...
	try {
	    ...
	    aBoolean1238 = true;
	    if (Loader.BLOCK_IDS.length() > 0) {
		String[] ids = Loader.BLOCK_IDS.split("\\,");
    ...
    public void method1114(Toolkit class_ra, Model class387, Class222 class222, int i, int i_28_) {
	try {
		...
		aClass351_1218 = ParticleSystem.method4232(i, false);
    ...
    public Class117 method1116(Toolkit class_ra, int i) {
	try {
	    long l = ((long) (ihash * -440872681) << 32 | (long) (-1309843523 * anInt1154) & 0xffffffffL);
	...
	try {
	    if (null == ((IComponentDefinition) this).aClass437_1279)
		return i_39_;
	    Class298_Sub35 class298_sub35 = ((Class298_Sub35) ((IComponentDefinition) this).aClass437_1279.get((long) i));
	...
	try {
	    if (null == ((IComponentDefinition) this).aClass437_1279) {
		((IComponentDefinition) this).aClass437_1279 = new HashTable(16);
	...
	try {
		...
		Class298 class298 = ((IComponentDefinition) this).aClass437_1279.get((long) i);
		if (class298 != null)
    ...
    public Model method1124(Toolkit class_ra, int i, Class349 class349, Class144 class144, Class507 class507, Class477 class477, Class395 class395, Interface23 interface23, Class438 class438, Class366 class366, int i_48_) {
	try {
	    aBoolean1139 = false;
		...
		long l_52_ = ((long) (class_ra.id * 580915349) << 59 | (long) (anInt1184 * 1548853569) << 54 | (long) (anInt1151 * 572201537) << 38 | l & 0x3fffffffffL);
		Model class387 = (Model) aClass348_1138.get(l_52_);
		if (null == class387 || class_ra.method5017(class387.m(), i) != 0) {
		    if (class387 != null)
			i = class_ra.mergeFunctionMasks(i, class387.m());
		    ModelDecoder class64 = ModelDecoder.getModel((RuntimeException_Sub3.aClass243_6310), 572201537 * anInt1151, 0);
		    if (null == class64) {
			aBoolean1139 = true;
			return null;
		    }
			...
			class64.method755(2);
		    class387 = class_ra.createModel(class64, i, Class21.anInt275 * 951783317, 64, 768);
		...
		Model class387 = (class507.method6269(572201537 * anInt1151, -1438978079).method6237(class_ra, i, interface23, class438, aClass498_1307, 636300802));
		if (null == class387) {
		    aBoolean1139 = true;
		    return null;
		}
		...
		if (class366 == null)
		    return null;
		Model class387 = class366.method4543(class_ra, i, class144, class507, class477, class395, interface23, class438, -275612851);
		if (class387 == null) {
		    aBoolean1139 = true;
		    return null;
		}
		...
		Model class387 = class468.method6029(class_ra, i, 10, class366, class438, 0, 0, 0, 0, 2097526071);
		if (null == class387) {
		    aBoolean1139 = true;
		    return null;
		}
		...
		Model class387 = (class507.method6269(anInt1151 * 572201537, -2061874989).method6246(class_ra, i, class349, interface23, class438, null, null, null, 0, aClass498_1307, -884053309));
		if (class387 == null) {
		    aBoolean1139 = true;
		    return null;
		}
		...
		Model class387 = class366.method4544(class_ra, i, class144, class395, class438, i_55_, i_56_, i_57_, (byte) 0);
		if (null == class387) {
		    aBoolean1139 = true;
		    return null;
		}
	...
	anInt1217 = 0;
	aBoolean1246 = false;
	aClass298_Sub38_1219 = IComponentSettings.aClass298_Sub38_7415;
	aBoolean1220 = false;
	aString1228 = "";
	anInt1232 = 7527659;
	aClass105_1233 = null;
	...
	try {
	    aBoolean1139 = false;
	    long l = (((aBoolean1180 ? 1L : 0L) << 38) + (((aBoolean1182 ? 1L : 0L) << 35) + (long) (spriteId * 1411971043) + ((long) (anInt1178 * 547522005) << 36)) + ((aBoolean1181 ? 1L : 0L) << 39) + ((long) (anInt1251 * -2065110161) << 40));
	...
	try {
	    ((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1] = (Class316.aClass362_3318.method4307((((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1]), 245040087).method4563(Class128.aClass148_6331, pb.anIntArray8828, (byte) 76)) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2057, pb.aClass25_8711.aClass449_330, (byte) 37);
	    class298_sub36.aClass298_Sub53_Sub2_7396.writeShort(i_67_, 16711935);
	    pb.aClass25_8711.method390(class298_sub36, (byte) -67);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		((Class403) class403).myClanChannel = Class350.aClass298_Sub25_3757;
	    } else
