...
public abstract class Class309 {
	...
	try {
		...
		for (int i_3_ = 0; i_3_ < PlayerLookDefinitions.anIntArray1506.length; i_3_++) {
		    if (i_1_ == PlayerLookDefinitions.anIntArray1506[i_3_]) {
			Class287.myPlayer.aClass366_10209.method4538(i_3_, i_2_, Class212.aClass144_2433, -1907587275);
			return;
		    }
		}
		for (int i_4_ = 0; i_4_ < PlayerLookDefinitions.anIntArray1499.length; i_4_++) {
		    if (PlayerLookDefinitions.anIntArray1499[i_4_] == i_1_) {
	...
	try {
		...
		((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = class105.aString1228;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (Class158.idx8.fileLoaded((Class410.anInt5290 * 2131310071), -457216440))
		...
		if (Class158.idx8.fileLoaded(1636425877 * Class14.anInt174, -457216440))
		...
		if (Class158.idx8.fileLoaded((1475733439 * Class318.anInt3323), -457216440))
		    Class385.aClass89_4142 = IndexedImage.method979(Class158.idx8, Class318.anInt3323 * 1475733439);
		else
		    bool = false;
	    }
	    if (Class14.aClass505_176 == null) {
		if (BillBoardDefinitions.idx29.fileLoaded(Class14.anInt168 * -227610265, -457216440))
		    Class14.aClass505_176 = Class255.method2439(BillBoardDefinitions.idx29, Class14.anInt168 * -227610265, -1873768956);
		else
		    bool = false;
	    }
	    if (Class14.aClass89Array169 == null) {
		if (Class158.idx8.fileLoaded(-227610265 * Class14.anInt168, -457216440))
