...
public abstract class Class365_Sub1_Sub4 extends Class365_Sub1 {
    ...
    final void method4355(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_0_, int i_1_, boolean bool, int i_2_) {
	try {
    ...
    final void method4375(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_3_, int i_4_, boolean bool) {
	throw new IllegalStateException();
    }
    ...
    final void method4388(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_9_, int i_10_, boolean bool) {
	throw new IllegalStateException();
    }
