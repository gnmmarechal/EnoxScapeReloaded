...
public final class pb extends Class291 {
	...
	try {
		...
		for (int i = 0; i < class209s.length; i++) {
			...
			switch (Integer.parseInt(class209.aString2395)) {
				...
				break;
			    case 33:
				LookupTable.aString1369 = string;
				break;
			    default:
	...
	try {
		...
		if (Class319.method3902(-1233866115 * anInt8752, 476312339)) {
		    ...
		    else if (!Class373.activeToolkit.method5074() && aBoolean6478)
		...
		if (null == Class231.aFrame2589) {
			...
			if (null == Class373.activeToolkit || Class373.activeToolkit.method4995())
		...
		if ((Class373.activeToolkit != null && Class373.activeToolkit.method5074()) || Class190.method1859((byte) -122) != 1)
		...
		if (Class88.method976(-1233866115 * anInt8752, -1448819665))
			...
			Class139.method1548(new StringBuilder().append(Tradution.aClass470_5874.method6049(Class321.aClass429_3357, -875414210)).append(Class26.aString350).append("(").append(i_5_).append("%)").toString(), true, Class373.activeToolkit, Class343.aClass264_3673, Class422_Sub2.aClass505_8369, (byte) 20);
		    } else if (aClass283_8716.method2627((byte) 65) == Class273.aClass273_2904) {
			int i_6_ = 50 + aClass283_8716.method2670((byte) -20) / 2;
			Class139.method1548(new StringBuilder().append(Tradution.aClass470_5874.method6049(Class321.aClass429_3357, -875414210)).append(Class26.aString350).append("(").append(i_6_).append("%)").toString(), true, Class373.activeToolkit, Class343.aClass264_3673, Class422_Sub2.aClass505_8369, (byte) 38);
		    } else
			Class139.method1548((Tradution.aClass470_5874.method6049(Class321.aClass429_3357, -875414210)), true, Class373.activeToolkit, Class343.aClass264_3673, Class422_Sub2.aClass505_8369, (byte) 64);
		} else if (-1233866115 * anInt8752 == 0)
		    Class322.method3932(l);
		else if (5 == -1233866115 * anInt8752)
		    Class139.method1548(new StringBuilder().append(Tradution.aClass470_5876.method6049(Class321.aClass429_3357, -875414210)).append(Class26.aString350).append(Tradution.aClass470_5794.method6049(Class321.aClass429_3357, -875414210)).toString(), false, Class373.activeToolkit, Class343.aClass264_3673, Class422_Sub2.aClass505_8369, (byte) -78);
		else if (-1233866115 * anInt8752 == 13)
		    Class139.method1548(Tradution.aClass470_5788.method6049(Class321.aClass429_3357, -875414210), false, Class373.activeToolkit, Class343.aClass264_3673, Class422_Sub2.aClass505_8369, (byte) -34);
		if (anInt8956 * 2067224717 == 3) {
			...
			if (aBooleanArray8901[i_7_])
			    Class373.activeToolkit.method5014(rectangle.x, rectangle.y, rectangle.width, rectangle.height, -65281, -1154135078);
			else
			    Class373.activeToolkit.method5014(rectangle.x, rectangle.y, rectangle.width, rectangle.height, -16711936, -2005947871);
		    }
		}
		if (Class423.method5734(-268540899))
		    Class445.method5895(Class373.activeToolkit, (byte) 127);
		if (!Class88.method976(anInt8752 * -1233866115, 797947023) && !Class358.method4287(-1233866115 * anInt8752, 1114719498) && -1 != WINDOW_PANE_ID * -257444687) {
		    try {
			Class373.activeToolkit.method4988((byte) -94);
		    }
	...
	try {
	    ...
	    if (null != Class373.activeToolkit)
		Class373.activeToolkit.method5136(1233420487);
	...
	for (int i_11_ = 0; i_11_ < i; i_11_++) {
		...
		if (class365_sub1_sub1_sub2_sub2.aShort9798 < 0 || class365_sub1_sub1_sub2_sub2.aShort9795 < 0 || (class365_sub1_sub1_sub2_sub2.aShort9796 >= aClass283_8716.method2629(-1927739596)) || (class365_sub1_sub1_sub2_sub2.aShort9797 >= aClass283_8716.method2630(2032357288)))
			...
			if (class365_sub1_sub1_sub2_sub2.aBoolean10203 || class365_sub1_sub1_sub2_sub2.isClanMember)
			    i_12_ += 512;
			else {
	...
	for (int i_13_ = 0; i_13_ < -1230451913 * anInt8703; i_13_++) {
	    NPC class365_sub1_sub1_sub2_sub1 = ((NPC) (((Class298_Sub29) aClass437_8696.get((long) anIntArray8699[i_13_])).anObject7366));
	...
	for (int i_15_ = 0; i_15_ < aClass19Array8869.length; i_15_++) {
		...
		if (958933333 * class19.anInt266 == 1) {
		    Class298_Sub29 class298_sub29 = ((Class298_Sub29) aClass437_8696.get((long) (class19.anInt256 * -841622081)));
	...
	for (int i_20_ = 0; i_20_ < i_19_; i_20_++) {
		...
		if (i_20_ < i_16_)
		    ...
		    class365_sub1_sub1_sub2 = ((Entity) (((Class298_Sub29) aClass437_8696.get((long) anIntArray8699[i_20_ - i_16_])).anObject7366));
	...
	for (int i_35_ = 0; i_35_ < i_34_; i_35_++) {
		...
		if (i_35_ < i_31_)
		    ...
		    class365_sub1_sub1_sub2 = ((Entity) (((Class298_Sub29) aClass437_8696.get((long) anIntArray8699[i_35_ - i_31_])).anObject7366));
	...
	for (int i = 0; i < -1230451913 * anInt8703; i++) {
	    NPC class365_sub1_sub1_sub2_sub1 = ((NPC) (((Class298_Sub29) aClass437_8696.get((long) anIntArray8699[i])).anObject7366));
		...
		Entity class365_sub1_sub1_sub2 = AnimationDefinition.method4886((class365_sub1_sub1_sub2_sub1.plane), i_47_, i_48_, (byte) 88);
	...
	for (int i_51_ = 0; i_51_ < i_50_; i_51_++) {
		...
		if (i_51_ < i)
		    ...
		    class365_sub1_sub1_sub2 = ((Entity) (((Class298_Sub29) aClass437_8696.get((long) anIntArray8699[i_51_ - i])).anObject7366));
		if (648883167 * class365_sub1_sub1_sub2.anInt10071 < 0)
		    continue;
	    }
	...
	for (int i_61_ = 0; i_61_ < class105s.length; i_61_++) {
		...
		if (0 != -1215239439 * class105.type && !class105.aBoolean1238 && method2801(class105).anInt7416 * -1266165749 == 0 && aClass105_8712 != class105 && (907611645 * class105.anInt1145 != IComponentDefinition.anInt1265 * 310968271) && (405143323 * IComponentDefinition.anInt1129 != 907611645 * class105.anInt1145) && (-451364727 * IComponentDefinition.anInt1269 != 907611645 * class105.anInt1145) && (907611645 * class105.anInt1145 != -1997023283 * IComponentDefinition.anInt1123)) {
			...
			boolean bool = (class105.aBoolean1183 && 5 == -1215239439 * class105.type && class105.anInt1223 * -1993792969 == 0 && class105.anInt1283 * 925824753 < 0 && -1232467723 * class105.id == -1 && -1 == class105.anInt1289 * -324971993 && !class105.aBoolean1196 && 840270937 * class105.anInt1306 == 0);
			...
			if ((Class165.aClass319_6366.method3894((byte) -29) >= i_64_) && (Class165.aClass319_6366.method3883((byte) -71) >= i_65_) && (Class165.aClass319_6366.method3894((byte) 22) < i_66_) && (Class165.aClass319_6366.method3883((byte) 45) < i_67_)) {
			    if (bool) {
				Class117 class117 = class105.method1116((Class373.activeToolkit), 1065695472);
			...
			if (null != class298_sub50 && class298_sub50.method3546(-1372966703) == 0 && class298_sub50.method3547((byte) -35) >= i_64_ && class298_sub50.method3560(-2145889865) >= i_65_ && class298_sub50.method3547((byte) 43) < i_66_ && (class298_sub50.method3560(-2006325499) < i_67_)) {
			    if (bool) {
				Class117 class117 = class105.method1116((Class373.activeToolkit), 1959642657);
			...
			if (class105.aByteArray1185 != null && !Class423.method5734(-1797996523)) {
				...
				if (!Class372.aClass323_4052.pressingKey(class105.aByteArray1185[i_79_], 2064123957)) {
				    ...
				    if (0 == i_80_ || (((i_80_ & 0x8) == 0 || (!(Class372.aClass323_4052.pressingKey(86, -229313729)) && !(Class372.aClass323_4052.pressingKey(82, 328550876)) && !(Class372.aClass323_4052.pressingKey(81, 1628571302)))) && ((i_80_ & 0x2) == 0 || (Class372.aClass323_4052.pressingKey(86, -1332099546))) && (0 == (i_80_ & 0x1) || (Class372.aClass323_4052.pressingKey(82, 343135989))) && ((i_80_ & 0x4) == 0 || (Class372.aClass323_4052.pressingKey(81, 883110115))))) {
					if (i_79_ < 10)
			...
			if (class105.aBoolean1238 || 0 != class105.anInt1145 * 907611645) {
			    if (bool_70_ && 0 != mouseWheelScroll * 1170859143 && class105.anObjectArray1229 != null) {
				Class298_Sub46 class298_sub46 = new Class298_Sub46();
				class298_sub46.aBoolean7533 = true;
				class298_sub46.aClass105_7525 = class105;
				class298_sub46.anInt7527 = -1937115609 * mouseWheelScroll;
				...
				if ((-451364727 * IComponentDefinition.anInt1269 == 907611645 * class105.anInt1145) || (907611645 * class105.anInt1145 == IComponentDefinition.anInt1123 * -1997023283)) {
					...
					class385.method4710((byte) -126).method2588(Class373.activeToolkit, class105.anInt1162 * 457937409, Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub19_7567.method5695(-1741518508), 1359487645);
					...
					Class98.method1055((Class373.activeToolkit), i_59_, i_60_, 132816560);
					...
					Class298_Sub29 class298_sub29 = ((Class298_Sub29) aClass437_8696.get((long) i_85_));
				...
				if (310968271 * IComponentDefinition.anInt1265 == 907611645 * class105.anInt1145) {
				    Class117 class117 = class105.method1116((Class373.activeToolkit), 842748651);
					...
					if (i_86_ >= i_88_ && i_86_ <= (class117.anIntArray1395[i_87_]) + i_88_) {
						...
						if (class105_97_ != null)
						    Class234.method2174(aString8838, new StringBuilder().append(" ").append(Class26.aString351).toString(), (697885143 * (Class240.anInt2704)), 59, (-1232467723 * (class105.id)), 1L, i_94_, i_95_, true, false, (long) (((-1309843523 * (class105.anInt1154)) << 32) | ((class105.ihash) * -440872681)), true, -1552213884);
						else
						    Class144.method1587((byte) 4);
					    } else {
				...
				if (class105.anInt1145 * 907611645 == 826979979 * IComponentDefinition.anInt1126) {
					...
					if (null != class298_sub37_sub13) {
					    ...
					    if (null != is) {
						if ((Class372.aClass323_4052.pressingKey(82, 1232426176)) && (1806357379 * playerRights > 0)) {
					...
					if (2 == -651858367 * anInt8864) {
					    aBoolean8865 = true;
					    Class77.method842(((Class401.anInt6562 * 100354019) + (int) ((double) ((-98735103 * anInt8734) - (Class165.aClass319_6366.method3894((byte) 13))) * 2.0 / (double) (Class301.aFloat3234))), (short) 1347);
					    Class352.method4246(((-1026644091 * Class441.anInt5589) - (int) ((double) ((-938469429 * anInt8853) - (Class165.aClass319_6366.method3883((byte) -70))) * 2.0 / (double) (Class301.aFloat3234))), (byte) 44);
					}
				    } else {
			...
			if (class105.type * -1215239439 == 5 && -1 != 925824753 * class105.anInt1283)
			    class105.method1121(ConfigDefinitions.aClass317_3472, Class138_Sub1.aClass131_7010, 1204090508).method2588(Class373.activeToolkit, class105.anInt1162 * 457937409, Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub19_7567.method5695(-1741518508), 961658636);
			...
			if (class105.type * -1215239439 == 0) {
			    ...
			    Interface class298_sub51 = (Interface) (aClass437_8841.get((long) (class105.ihash * -440872681)));
	...
	IComponentSettings class298_sub38 = ((IComponentSettings) aClass437_8896.get((long) (-1309843523 * class105.anInt1154) + ((long) (class105.ihash * -440872681) << 32)));
	...
	String string = " ";
	try {
	    WorldTile class341 = aClass283_8716.method2628(681479919);
	    string = new StringBuilder().append(string).append(class341.x * -1760580017).append(Class26.aString353).append(283514611 * class341.y).append(Class26.aString353).append(aClass283_8716.method2629(-2128021636)).append(Class26.aString353).append(aClass283_8716.method2630(-1076815167)).append(" ").toString();
	    if (Class287.myPlayer != null)
		string = new StringBuilder().append(string).append(1855729883 * Class99.anInt952).append(Class26.aString353).append(-1760580017 * class341.x + (Class287.myPlayer.scenePositionXQueue[0])).append(Class26.aString353).append((Class287.myPlayer.scenePositionYQueue[0]) + class341.y * 283514611).append(" ").toString();
	    else
		...
		if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571.method5677(-1738416059) == 2) {
		    ...
		    Vector vector = (Vector) field.get(pb.class.getClassLoader());
	...
	try {
	    WorldTile class341 = aClass283_8716.method2628(681479919);
	    string = new StringBuilder().append(string).append(class341.x * -1760580017).append(Class26.aString353).append(283514611 * class341.y).append(Class26.aString353).append(aClass283_8716.method2629(-2102644604)).append(Class26.aString353).append(aClass283_8716.method2630(-955929187)).append(" ").toString();
	    if (Class287.myPlayer != null)
		string = new StringBuilder().append(string).append(1855729883 * Class99.anInt952).append(Class26.aString353).append(-1760580017 * class341.x + (Class287.myPlayer.scenePositionXQueue[0])).append(Class26.aString353).append((Class287.myPlayer.scenePositionYQueue[0]) + class341.y * 283514611).append(" ").toString();
	    else
		string = new StringBuilder().append(string).append(Class99.anInt952 * 1855729883).append(Class26.aString353).append(Class99.anInt952 * 1855729883).append(Class26.aString353).append(1855729883 * Class99.anInt952).append(Class26.aString353).append(" ").toString();
	...
	try {
	    WorldTile class341 = aClass283_8716.method2628(681479919);
	    string = new StringBuilder().append(string).append(class341.x * -1760580017).append(Class26.aString353).append(283514611 * class341.y).append(Class26.aString353).append(aClass283_8716.method2629(-1917252704)).append(Class26.aString353).append(aClass283_8716.method2630(-659381111)).append(" ").toString();
	    if (Class287.myPlayer != null)
		string = new StringBuilder().append(string).append(1855729883 * Class99.anInt952).append(Class26.aString353).append(-1760580017 * class341.x + (Class287.myPlayer.scenePositionXQueue[0])).append(Class26.aString353).append((Class287.myPlayer.scenePositionYQueue[0]) + class341.y * 283514611).append(" ").toString();
	    else
		string = new StringBuilder().append(string).append(Class99.anInt952 * 1855729883).append(Class26.aString353).append(Class99.anInt952 * 1855729883).append(Class26.aString353).append(1855729883 * Class99.anInt952).append(Class26.aString353).append(" ").toString();
	...
	try {
		...
		if (Class373.activeToolkit != null)
		    Class373.activeToolkit.method4993((int) Class122.method1319((byte) 1));
		anInt8894 = 0;
		anInt8687 = 0;
		...
		for (Class298_Sub50 class298_sub50 = Class165.aClass319_6366.method3879(-1183106665); null != class298_sub50; class298_sub50 = Class165.aClass319_6366.method3879(390773081)) {
			...
			//scroll
			mouseWheelScroll += (class298_sub50.method3548(2127682803) * 815898935);
		...
		else if (ObjectOverride.method5804(anInt8752 * -1233866115, (byte) 9) && !Class358.method4287(anInt8752 * -1233866115, 1200358903))
		...
		Class517.method6308(Class373.activeToolkit, -828057261);
	...
	if (null != Class373.activeToolkit)
	    Class373.activeToolkit.method5136(295313203);
	if (Class452.aBoolean5642 && Class231.aFrame2589 != null) {
	...
	try {
	    ...
	    try {
		WorldTile class341 = aClass283_8716.method2628(681479919);
		string = new StringBuilder().append(string).append(class341.x * -1760580017).append(Class26.aString353).append(283514611 * class341.y).append(Class26.aString353).append(aClass283_8716.method2629(-2133877490)).append(Class26.aString353).append(aClass283_8716.method2630(-932420747)).append(" ").toString();
		if (Class287.myPlayer != null)
		    string = new StringBuilder().append(string).append(1855729883 * Class99.anInt952).append(Class26.aString353).append(-1760580017 * class341.x + (Class287.myPlayer.scenePositionXQueue[0])).append(Class26.aString353).append((Class287.myPlayer.scenePositionYQueue[0]) + class341.y * 283514611).append(" ").toString();
		else
		    string = new StringBuilder().append(string).append(Class99.anInt952 * 1855729883).append(Class26.aString353).append(Class99.anInt952 * 1855729883).append(Class26.aString353).append(1855729883 * Class99.anInt952).append(Class26.aString353).append(" ").toString();
	...
	try {
		...
		if (-1740717447 * Class367.anInt4000 >> 9 < 14 || (-1740717447 * Class367.anInt4000 >> 9 >= aClass283_8716.method2629(-2005655322) - 14) || Class146.anInt1575 * -299812095 >> 9 < 14 || (-299812095 * Class146.anInt1575 >> 9 >= aClass283_8716.method2630(-281479847) - 14))
		    aClass283_8716.sendMapScene(new Class267((Class266.LOAD_MAP_SCENE_BACKGROUND), null), -1991819579);
	    }
	    for (;;) {
	    ...
	    if (null != aClass105_8850)
		TextureMetrics.method602(-587743288);
		...
		if ((long) (-1505693583 * ((Class302_Sub2) class302_sub2).anInt7647) < Class122.method1319((byte) 1) / 1000L - 5L) {
			...
			ChecksumTableEntry.method2282(5, 0, "", "", "", new StringBuilder().append(((Class302_Sub2) class302_sub2).aString7648).append(Tradution.aClass470_5901.method6049(Class321.aClass429_3357, -875414210)).toString(), -1638737966);
		    if (((Class302_Sub2) class302_sub2).aShort7646 == 0)
			ChecksumTableEntry.method2282(5, 0, "", "", "", new StringBuilder().append(((Class302_Sub2) class302_sub2).aString7648).append(Tradution.aClass470_5902.method6049(Class321.aClass429_3357, -875414210)).toString(), 750491919);
	...
	if (null != Class373.activeToolkit)
	    Class373.activeToolkit.method5136(1124301967);
	if (Class452.aBoolean5642 && Class231.aFrame2589 != null) {
	...
	if (null != Class373.activeToolkit)
	    Class373.activeToolkit.method5136(761781050);
	if (Class452.aBoolean5642 && Class231.aFrame2589 != null) {
	...
	try {
		...
		try {
			...
			Class423.aSocket5355 = Class474.aClass471_5979.craeteSocket(false);
			anInt8692 += -244111349;
		    }
			...
			Class365_Sub1_Sub5_Sub2.aClass318_9940.write(class298_sub53.buffer, 0, i_164_ + 2, 2087409715);
			anInt8692 += -244111349;
			...
			if (Class365_Sub1_Sub5_Sub2.aClass318_9940.isAvailable(i_166_, (byte) -56)) {
			    System.out.println("Connected js5!");
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class100.anInt1079 * -1537941929;
	}
	catch (RuntimeException runtimeexception) {
