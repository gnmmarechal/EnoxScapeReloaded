...
public class Class60 {
    ...
    ObjectOverride aClass435_597;
    boolean aBoolean598;
    Shadow aClass_na599;
    boolean aBoolean600;
    int anInt601;
    ParticleSystem aClass351_602;
    byte aByte603;
    ...
    void method698(ObjectOverride class435, int i) {
	try {
    ...
    final Model method700(Toolkit class_ra, int i, boolean bool, boolean bool_1_, byte i_2_) {
	try {
		...
		class432 = class432.method5777((0 == 1596783995 * pb.anInt8724 ? (Interface23) (Class87.anInterface23_796) : Class128.aClass148_6331), 1333630702);
	    if (class432 == null) {
		method707(class_ra, -475225909);
		((Class60) this).anInt595 = -1646192771;
		return null;
	    }
	    if (!((Class60) this).aBoolean592 && (-72440277 * ((Class60) this).anInt595 != class432.objectId * 1181652947)) {
	    ...
	    if (bool && !bool_1_) {
		((Class60) this).anInt595 = -722933511 * class432.objectId;
		return null;
	    }
	    ...
	    Ground class_xa = class331.aClass_xaArray3517[((Class60) this).aByte588];
	    Ground class_xa_3_;
		...
		if (bool_1_)
		    i |= 0x40000;
		class387 = (class432.method5774(class_ra, i, (11 != ((Class60) this).anInt589 * -1598457753 ? -1598457753 * ((Class60) this).anInt589 : 10), (11 == -1598457753 * ((Class60) this).anInt589 ? 4 + ((Class60) this).anInt590 * 748228569 : 748228569 * ((Class60) this).anInt590), class_xa, class_xa_3_, (int) class217.aFloat2451, class_xa.averageHeight((int) class217.aFloat2451, (int) class217.aFloat2454, -1408801129), (int) class217.aFloat2454, ((Class60) this).aClass438_593, ((Class60) this).aClass435_597, (byte) 18));
		if (null != class387) {
		    if (bool_1_) {
		...
		((Class60) this).aClass387_584 = null;
	    } else if (((Class60) this).aClass387_584 == null || (((Class60) this).aClass387_584.m() & i) != i || (-72440277 * ((Class60) this).anInt595 != 1181652947 * class432.objectId)) {
		if (((Class60) this).aClass387_584 != null)
		    i |= ((Class60) this).aClass387_584.m();
		Tuple class454 = (class432.method5785(class_ra, i, (((Class60) this).anInt589 * -1598457753 != 11 ? -1598457753 * ((Class60) this).anInt589 : 10), (11 == ((Class60) this).anInt589 * -1598457753 ? 748228569 * ((Class60) this).anInt590 + 4 : 748228569 * ((Class60) this).anInt590), class_xa, class_xa_3_, (int) class217.aFloat2451, class_xa.averageHeight((int) class217.aFloat2451, (int) class217.aFloat2454, -1367024792), (int) class217.aFloat2454, bool_1_, ((Class60) this).aClass435_597, -105046202));
		if (class454 != null) {
		    ((Class60) this).aClass387_584 = class387 = (Model) class454.first;
		    if (bool_1_) {
			((Class60) this).aClass_na599 = (Shadow) class454.second;
			((Class60) this).aBooleanArray596 = null;
	    ...
	    ((Class60) this).anInt595 = class432.objectId * -722933511;
	    return class387;
	}
	catch (RuntimeException runtimeexception) {
    ...
    void method701(Toolkit class_ra, Model class387, Class222 class222, int i, int i_4_, int i_5_, int i_6_, boolean bool, int i_7_) {
	try {
	    EmitterConfig[] class85s = class387.method4781();
	    MagnetConfig[] class68s = class387.method4728();
	    if ((((Class60) this).aClass351_602 == null || ((Class60) this).aClass351_602.aBoolean3772) && (null != class85s || class68s != null)) {
		ObjectDefinitions class432 = (((Class60) this).aClass433_585.getObjectDefinitions(1686561661 * ((Class60) this).anInt601));
		if (class432.morphisms != null)
		    class432 = (class432.method5777((pb.anInt8724 * 1596783995 == 0 ? (Interface23) Class87.anInterface23_796 : Class128.aClass148_6331), 1897177328));
		if (null != class432)
		    ((Class60) this).aClass351_602 = ParticleSystem.method4232(pb.ticketCycle * 443738891, true);
	    }
	    if (null != ((Class60) this).aClass351_602) {
		class387.method4786(class222);
		if (bool)
		    ((Class60) this).aClass351_602.method4231(class_ra, (long) (pb.ticketCycle * 443738891), class85s, class68s, false);
		else
		    ((Class60) this).aClass351_602.method4233((long) (443738891 * pb.ticketCycle));
    ...
    void method702(Toolkit class_ra, int i) {
	try {
    ...
    Class60(Toolkit class_ra, Class433 class433, ObjectDefinitions class432, int i, int i_8_, int i_9_, int i_10_, Class365_Sub1 class365_sub1, boolean bool, int i_11_) {
	((Class60) this).anInt586 = 0;
	((Class60) this).aBoolean592 = false;
	((Class60) this).aBoolean600 = false;
	((Class60) this).aClass433_585 = class433;
	((Class60) this).anInt601 = -2096584305 * class432.objectId;
	...
	try {
		...
		if (((Class60) this).aClass438_593.method5822((pb.ticketCycle * 443738891 - -735091231 * ((Class60) this).anInt594), 1976097000)) {
	    ...
	    ((Class60) this).anInt594 = -803072405 * pb.ticketCycle;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (class432.morphisms != null)
		    class432 = (class432.method5777((1596783995 * pb.anInt8724 == 0 ? (Interface23) Class87.anInterface23_796 : Class128.aClass148_6331), 1802349433));
		if (class432 == null)
		    return;
		...
		if (class432.method5779(934270378)) {
			...
			return;
		    if (1181652947 * class432.objectId != -72440277 * ((Class60) this).anInt595)
			...
			return;
		    if (((Class60) this).anInt595 * -72440277 != 1181652947 * class432.objectId)
		...
		((Class60) this).anInt594 = pb.ticketCycle * -803072405;
		((Class60) this).aBoolean600 = false;
		((Class60) this).aClass387_584 = null;
	    }
	}
    ...
    void method707(Toolkit class_ra, int i) {
	try {
	    if (null != ((Class60) this).aClass_na599) {
		Class217 class217 = (((Class60) this).aClass365_Sub1_587.method4337().aClass217_2599);
		pb.aClass283_8716.method2675(-1611682495).method4047(((Class60) this).aClass_na599, ((Class60) this).aByte588, (int) class217.aFloat2451, (int) class217.aFloat2454, ((Class60) this).aBooleanArray596, 677085165);
		((Class60) this).aBooleanArray596 = null;
		((Class60) this).aClass_na599 = null;
	    }
	}
	...
	try {
		...
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = Toolkit.aClass256_5315.method2441(i_17_, 2082342727).method3431((char) i_18_, 166344309);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_21_).anInt5720) * 1764050979;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (pb.aString8804 != null)
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = -1801543887 * Class489.anInt6071;
	    else
