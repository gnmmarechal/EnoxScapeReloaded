...
public abstract class Class98 {
    ...
    static void method1055(Toolkit class_ra, int i, int i_14_, int i_15_) {
	try {
		...
		if (pb.aClass283_8716.method2675(-1611682495) != null && (!pb.aBoolean8835 || (-112110875 * Class298.anInt3192 & 0x40) != 0)) {
		    int i_18_ = -1;
		    int i_19_ = -1;
		    ...
		    float f_27_ = ConfigEntry.method1312(f_21_, f_22_, f_23_, f_24_, f_25_, f_26_, 4, 1869450178);
		    if (f_27_ > 0.0F) {
			...
			if (i_32_ < 3 && ((pb.aClass283_8716.method2654(-86337284).aByteArrayArrayArray2731[1][i_30_ >> 9][i_31_ >> 9]) & 0x2) != 0)
			    i_32_++;
		    }
		    if (-1 != i_18_ && -1 != i_19_) {
			if (pb.aBoolean8835 && (-112110875 * Class298.anInt3192 & 0x40) != 0) {
			    IComponentDefinition class105 = Class140.method1558((Class379.anInt4099 * 1262526353), (392084321 * pb.anInt8836), -156511736);
			    if (class105 != null)
				Class234.method2174(pb.aString8838, new StringBuilder().append(" ").append(Class26.aString351).append(" ").toString(), Class240.anInt2704 * 697885143, 59, -1, 0L, i_18_, i_19_, true, false, (long) (i_18_ << 32 | i_19_), true, -1555484950);
			    else
			    ...
			    Class234.method2174(Class82_Sub6.aString6845, "", pb.anInt8822 * -1471730241, 23, -1, 0L, i_18_, i_19_, true, false, (long) (i_18_ << 32 | i_19_), true, -1114825452);
			}
		    }
		}
		Class324 class324 = (pb.aClass283_8716.method2675(-1611682495).aClass324_3528);
		int i_33_ = i;
		int i_34_ = i_14_;
		...
		while (iterator.hasNext()) {
		    ...
		    if (!pb.aBoolean8674 && ((Class287.myPlayer.plane) != class335.aClass365_Sub1_3616.plane)) {
			if (i_15_ == 202437353) {
			    /* empty */
			}
			...
			if (class335.aClass365_Sub1_3616 instanceof Player) {
				...
				for (int i_41_ = 0; i_41_ < -1230451913 * pb.anInt8703; i_41_++) {
				    Class298_Sub29 class298_sub29 = ((Class298_Sub29) (pb.aClass437_8696.get((long) pb.anIntArray8699[i_41_])));
					...
					if (443738891 * pb.ticketCycle != (class365_sub1_sub1_sub2_sub1.anInt10070) * 335731285) {
						...
						if (i_43_ >= i_39_ && (((class365_sub1_sub1_sub2_sub1.aClass503_10190.size) * -2095128707) <= ((class365_sub1_sub1_sub2_sub2.getSize()) - (i_43_ - i_39_ >> 9))) && i_44_ >= i_40_ && (((class365_sub1_sub1_sub2_sub1.aClass503_10190.size) * -2095128707) <= ((class365_sub1_sub1_sub2_sub2.getSize()) - (i_44_ - i_40_ >> 9)))) {
						    ...
						    class365_sub1_sub1_sub2_sub1.anInt10070 = (-339947553 * pb.ticketCycle);
						}
					    }
					}
				    }
				...
				for (int i_46_ = 0; i_46_ < i_45_; i_46_++) {
				    Player class365_sub1_sub1_sub2_sub2_47_ = (pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[is[i_46_]]);
				    if ((null != class365_sub1_sub1_sub2_sub2_47_) && (443738891 * pb.ticketCycle != (335731285 * (class365_sub1_sub1_sub2_sub2_47_.anInt10070))) && (class365_sub1_sub1_sub2_sub2 != class365_sub1_sub1_sub2_sub2_47_)) {
					if (!class365_sub1_sub1_sub2_sub2_47_.aBoolean10123) {
						...
						class365_sub1_sub1_sub2_sub2_47_.anInt10070 = (pb.ticketCycle * -339947553);
					    }
					}
				    }
				}
			    }
			    if (443738891 * pb.ticketCycle == 335731285 * (class365_sub1_sub1_sub2_sub2.anInt10070)) {
				if (i_15_ == 202437353) {
				    /* empty */
				}
				continue;
			    ...
			    class365_sub1_sub1_sub2_sub2.anInt10070 = -339947553 * pb.ticketCycle;
			}
			if (class335.aClass365_Sub1_3616 instanceof NPC) {
				...
				if ((0 == ((-2095128707 * (class365_sub1_sub1_sub2_sub1.aClass503_10190.size)) & 0x1) && 0 == ((int) class217.aFloat2451 & 0x1ff) && (((int) class217.aFloat2454 & 0x1ff) == 0)) || (((-2095128707 * (class365_sub1_sub1_sub2_sub1.aClass503_10190.size)) & 0x1) == 1 && (((int) class217.aFloat2451 & 0x1ff) == 256) && (((int) class217.aFloat2454 & 0x1ff) == 256))) {
				    ...
				    for (int i_53_ = 0; (i_53_ < pb.anInt8703 * -1230451913); i_53_++) {
					Class298_Sub29 class298_sub29 = ((Class298_Sub29) (pb.aClass437_8696.get((long) pb.anIntArray8699[i_53_])));
					if (class298_sub29 == null) {
					    ...
					    if (((335731285 * (class365_sub1_sub1_sub2_sub1_54_.anInt10070)) != (pb.ticketCycle * 443738891)) && (class365_sub1_sub1_sub2_sub1_54_ != class365_sub1_sub1_sub2_sub1)) {
						if (!class365_sub1_sub1_sub2_sub1_54_.aBoolean10123) {
							...
							class365_sub1_sub1_sub2_sub1_54_.anInt10070 = (-339947553 * (pb.ticketCycle));
						    }
						}
					    }
					}
					...
					Player class365_sub1_sub1_sub2_sub2 = (pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[is[i_59_]]);
					if ((null != class365_sub1_sub1_sub2_sub2) && ((335731285 * (class365_sub1_sub1_sub2_sub2.anInt10070)) != (pb.ticketCycle * 443738891))) {
				...
				if ((class365_sub1_sub1_sub2_sub1.anInt10070 * 335731285) == 443738891 * pb.ticketCycle) {
				    if (i_15_ == 202437353)
					throw new IllegalStateException();
				    continue;
				}
				Class140.method1555(class365_sub1_sub1_sub2_sub1, ((Class287.myPlayer.plane) != (class335.aClass365_Sub1_3616.plane)), (byte) -73);
				class365_sub1_sub1_sub2_sub1.anInt10070 = pb.ticketCycle * -339947553;
			    }
			}
			if (class335.aClass365_Sub1_3616 instanceof Class365_Sub1_Sub4_Sub1) {
			    int i_63_ = -1760580017 * class341.x + i_36_;
			    int i_64_ = 283514611 * class341.y + i_37_;
			    Class298_Sub2 class298_sub2 = ((Class298_Sub2) (pb.aClass437_8685.get((long) ((class335.aClass365_Sub1_3616.plane) << 28 | i_64_ << 14 | i_63_))));
				...
				while (class298_sub12 != null) {
				    ...
				    if (pb.aBoolean8835 && ((class335.aClass365_Sub1_3616.plane) == (Class287.myPlayer.plane))) {
					Class497 class497 = ((PlayerLookDefinitions.anInt1508 * 831522399 != -1) ? (Class92.aClass504_905.method6251((PlayerLookDefinitions.anInt1508 * 831522399), 1640464070)) : null);
					if (0 != ((Class298.anInt3192 * -112110875) & 0x1) && (null == class497 || ((class468.method6037((831522399 * PlayerLookDefinitions.anInt1508), (-388931549 * class497.anInt6100), -2028636758)) != (-388931549 * (class497.anInt6100)))))
					    Class234.method2174(pb.aString8838, new StringBuilder().append(pb.aString8754).append(" ").append(Class26.aString351).append(" ").append(Class285.method2709(i_66_, -1803338083)).append(class468.name).toString(), (Class240.anInt2704 * 697885143), 17, -1, (long) ((class298_sub12.anInt7257) * 1768239597), i_36_, i_37_, true, false, (long) i_65_, false, -1282887596);
				    }
					...
					for (int i_67_ = strings.length - 1; i_67_ >= 0; i_67_--) {
						...
						int i_68_ = 0;
						int i_69_ = (pb.anInt8690 * 1395924385);
						if (0 == i_67_)
						    i_68_ = 18;
						if (i_67_ == 1)
						    i_68_ = 19;
						...
						Class234.method2174(strings[i_67_], new StringBuilder().append(Class285.method2709(i_66_, -1300852022)).append(class468.name).toString(), i_69_, i_68_, -1, (long) ((class298_sub12.anInt7257) * 1768239597), i_36_, i_37_, true, false, (long) i_65_, false, -1707817875);
					    }
					}
				    }
			...
			if (class335.aClass365_Sub1_3616 instanceof Interface3) {
			    ...
			    ObjectDefinitions class432 = (pb.aClass283_8716.method2641(-151154213).getObjectDefinitions(interface3.method32((byte) 32)));
			    if (class432.morphisms != null)
				...
				if (pb.aBoolean8835 && (class335.aClass365_Sub1_3616.plane == (Class287.myPlayer.plane))) {
				    Class497 class497 = (831522399 * PlayerLookDefinitions.anInt1508 != -1 ? (Class92.aClass504_905.method6251(PlayerLookDefinitions.anInt1508 * 831522399, -616098570)) : null);
				    if (0 != (Class298.anInt3192 * -112110875 & 0x4) && (class497 == null || ((class432.method5776((831522399 * PlayerLookDefinitions.anInt1508), (class497.anInt6100 * -388931549), (byte) 2)) != (-388931549 * class497.anInt6100))))
				...
				if (class335.aClass365_Sub1_3616.plane == (Class287.myPlayer.plane)) {
					...
					for (int i_70_ = strings.length - 1; i_70_ >= 0; i_70_--) {
						...
						int i_71_ = 0;
						int i_72_ = (pb.anInt8690 * 1395924385);
						if (0 == i_70_)
						    i_71_ = 3;
						if (1 == i_70_)
						    i_71_ = 4;
	...
	try {
	    ...
	    int i_73_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
	    boolean bool = 1 == (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 1]);
	    int i_74_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 2]);
	    boolean bool_75_ = ((((Class403) class403).anIntArray5244[3 + 681479919 * ((Class403) class403).anInt5239]) == 1);
