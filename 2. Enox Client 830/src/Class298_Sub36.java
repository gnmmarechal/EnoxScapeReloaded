...
public class Class298_Sub36 extends Class298 {
	...
	try {
		...
		i_4_ = 100;
	    int i_5_ = (pb.aShort8928 + (pb.aShort8929 - pb.aShort8928) * i_4_ / 100);
	    int i_6_ = i_2_ * i_5_ * 512 / (i_1_ * 334);
	    if (i_6_ < pb.aShort8934) {
		i_6_ = pb.aShort8934;
		i_5_ = i_1_ * i_6_ * 334 / (512 * i_2_);
		if (i_5_ > pb.aShort8743) {
		    i_5_ = pb.aShort8743;
		    int i_7_ = i_2_ * i_5_ * 512 / (i_6_ * 334);
		    int i_8_ = (i_1_ - i_7_) / 2;
		    if (bool) {
			Class373.activeToolkit.L();
			Class373.activeToolkit.method5015(i, i_0_, i_8_, i_2_, -16777216, (byte) 7);
			Class373.activeToolkit.method5015(i_1_ + i - i_8_, i_0_, i_8_, i_2_, -16777216, (byte) 7);
		    }
		    i += i_8_;
		    i_1_ -= i_8_ * 2;
		}
	    } else if (i_6_ > pb.aShort8935) {
		i_6_ = pb.aShort8935;
		i_5_ = i_1_ * i_6_ * 334 / (i_2_ * 512);
		if (i_5_ < pb.aShort8839) {
		    i_5_ = pb.aShort8839;
		    int i_9_ = i_1_ * i_6_ * 334 / (i_5_ * 512);
		    int i_10_ = (i_2_ - i_9_) / 2;
		    if (bool) {
			Class373.activeToolkit.L();
			Class373.activeToolkit.method5015(i, i_0_, i_1_, i_10_, -16777216, (byte) 7);
			Class373.activeToolkit.method5015(i, i_0_ + i_2_ - i_10_, i_1_, i_10_, -16777216, (byte) 7);
		    }
		    i_0_ += i_10_;
		    i_2_ -= i_10_ * 2;
		}
	    }
	    pb.anInt8940 = i_5_ * i_2_ / 334 * 1463025151;
	    pb.anInt8936 = i * 1925400255;
	    pb.anInt8747 = i_0_ * -249668627;
	    pb.anInt8664 = -2079606657 * (short) i_1_;
	    pb.anInt8939 = (short) i_2_ * -34894995;
	}
	catch (RuntimeException runtimeexception) {
