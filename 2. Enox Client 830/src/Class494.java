...
public class Class494 {
	...
	anInt6090 = (((Class494) this).aClass243_6091.getFileCountForArchive((-1006924897 * (ConfigEntry.aClass120_1424.anInt1460)), -1214131434) * 1832969825);
    }
	...
	try {
		...
		is = (((Class494) this).aClass243_6091.getFile(ConfigEntry.aClass120_1424.anInt1460 * -1006924897, i));
	    }
	    class473 = new Class473();
	    if (is != null)
		class473.method6067(new RsByteBuffer(is), 1327711716);
	    synchronized (((Class494) this).aClass348_6089) {
		((Class494) this).aClass348_6089.put(class473, (long) i);
	    }
	    return class473;
	}
