...
public class Class4 {
    ...
    void method304(Toolkit class_ra, String string, int[] is, int i, int i_0_, int i_1_, boolean bool) {
	if (i_1_ == 0)
	    bool = false;
	i_1_ |= ~0xffffff;
    ...
    void method305(Toolkit class_ra, Font font, FontMetrics fontmetrics, char c, int i, boolean bool) {
    ...
    Class4(Toolkit class_ra, int i, boolean bool, Component component) {
	((Class4) this).aBoolean72 = false;
	((Class4) this).aClass57Array73 = new Sprite[256];
    ...
    void method308(Toolkit class_ra, String string, int i, int i_19_, int i_20_, boolean bool) {
