...
public class Class298_Sub44 extends Class298 {
	...
	try {
	    int i_1_ = 38;
	    i_1_ += ConfigEntry.method1310(((Class298_Sub44) this).aString7502, (byte) -1);
	    i_1_ += ConfigEntry.method1310(((Class298_Sub44) this).aString7503, (byte) -1);
	    i_1_ += ConfigEntry.method1310(((Class298_Sub44) this).aString7482, (byte) -1);
	    i_1_ += ConfigEntry.method1310(((Class298_Sub44) this).aString7505, (byte) -1);
	    i_1_ += ConfigEntry.method1310(((Class298_Sub44) this).aString7496, (byte) -1);
	    i_1_ += ConfigEntry.method1310(((Class298_Sub44) this).aString7511, (byte) -1);
	    return i_1_;
	}
	catch (RuntimeException runtimeexception) {
	...
	if (bool) {
	    ...
	    int i_2_ = 0;
	    try {
		for (/**/; i < ConfigEntry.aString1462.length(); i++) {
		    int i_3_ = ConfigEntry.aString1462.charAt(i);
		    if (i_3_ < 48 || i_3_ > 57)
			break;
	    ...
	    i = ConfigEntry.aString1462.indexOf('.', 2) + 1;
	    i_2_ = 0;
	    try {
		for (/**/; i < ConfigEntry.aString1462.length(); i++) {
		    int i_4_ = ConfigEntry.aString1462.charAt(i);
		    if (i_4_ < 48 || i_4_ > 57)
			break;
	    ...
	    i = ConfigEntry.aString1462.indexOf('_', 4) + 1;
	    i_2_ = 0;
	    try {
		for (/**/; i < ConfigEntry.aString1462.length(); i++) {
		    int i_5_ = ConfigEntry.aString1462.charAt(i);
		    if (i_5_ < 48 || i_5_ > 57)
			break;
