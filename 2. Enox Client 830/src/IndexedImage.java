...
public class IndexedImage {
    ...
    public static IndexedImage method979(JS5 class243, int i) {
	byte[] is = class243.getTextureData(i, (byte) 17);
	if (is == null)
	    return null;
    ...
    public static IndexedImage[] method981(JS5 class243, int i) {
	byte[] is = class243.getTextureData(i, (byte) 80);
	if (is == null)
	    return null;
	return method982(is);
    }
	...
	int data = class298_sub53.readUnsignedShort();
	int i = data & 0x7FFF;
	boolean smiliesMod = (data & 0x8000) != 0;
	...
	if (smiliesMod) {
	    for (IndexedImage img : class89s)
		img.anInt815 = img.anInt811 = img.anInt814 = img.anInt813 = 0;
	}
    ...
    public static IndexedImage method987(JS5 class243, int i, int i_81_) {
    ...
    public static IndexedImage[] method993(JS5 class243, int i, int i_128_) {
