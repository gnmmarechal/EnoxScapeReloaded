...
public class Class227 {
	...
	try {
	    ...
	    int i_8_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]);
	    int i_9_ = (((Class403) class403).anIntArray5244[1 + 681479919 * ((Class403) class403).anInt5239]);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class298_Sub1.method2845(i_8_, i_9_, true, false, 1482071907);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    for (int i_14_ = 0; i_14_ < pb.anInt8686 * -112139815; i_14_++) {
		Rectangle rectangle = pb.aRectangleArray8902[i_14_];
		if (rectangle.x + rectangle.width > i && rectangle.x < i + i_11_ && rectangle.height + rectangle.y > i_10_ && rectangle.y < i_12_ + i_10_)
		    pb.aBooleanArray8900[i_14_] = true;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (pb.anInt8942 * 1131012101 == 2 && i_15_ < -1054937867 * pb.anInt8941)
		((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = pb.aStringArray8947[i_15_];
	    else
	...
	try {
	    String string = Class404.method4952(Toolkit.method5194(charsequence, (byte) -97));
	    if (null == string)
		string = "";
	    return string;
	}
