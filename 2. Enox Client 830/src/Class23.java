...
public class Class23 {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class352.anInt3817 * -804513353;
	}
    ...
    public static Sprite method376(Toolkit class_ra, int i, byte i_1_) {
	try {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = -278777595 * Class436.anInt5506;
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = 1592446965 * Class436.anInt5479;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    class298_sub53.writeSmart(is.length, (byte) 34);
