...
public class Class272 {
	...
	try {
	    ...
	    if (((Class272) this).aClass243_2901.getFileCountForArchive(i, -1941901563) == 1)
	...
	try {
	    ...
	    if (((Class272) this).aClass243_2900.getFileCountForArchive(i, -1796273847) == 1)
	...
	try {
	    ...
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2027, pb.aClass25_8711.aClass449_330, (byte) 34);
	    ...
	    pb.aClass25_8711.method390(class298_sub36, (byte) -1);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		i_11_ -= class341.x * -1760580017;
		if (i_11_ < 0)
		    i_11_ = 0;
		else if (i_11_ >= pb.aClass283_8716.method2629(-1866822819))
		    i_11_ = pb.aClass283_8716.method2629(-1973847066);
		i_12_ -= 283514611 * class341.y;
		if (i_12_ < 0)
		    i_12_ = 0;
		else if (i_12_ >= pb.aClass283_8716.method2630(922370140))
		    i_12_ = pb.aClass283_8716.method2630(271939870);
	...
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub2_7547, (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]) == 1 ? 1 : 0, 1031457025);
	    pb.aClass283_8716.method2667(2089019629);
