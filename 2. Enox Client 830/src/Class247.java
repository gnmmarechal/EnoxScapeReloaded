...
public abstract class Class247 {
    Class461 nonpriority_files;
    static int anInt2733 = 512;
    static int anInt2734 = 20;
    public volatile int anInt2735;
    Class461 aClass461_2736 = new Class461();
    RsByteBuffer header_buffer;
    Class461 aClass461_2738;
    static int anInt2739 = 50;
    int idle_timer;
    long aLong2741;
    Class461 priority_files = new Class461();
    byte aByte2743;
    RsByteBuffer conbuffer;
    public volatile int anInt2745;
    static int anInt2746 = 3;
    RemoteRequest aClass298_Sub37_Sub16_Sub1_2747;
    public static long aLong2748;
    
    
    public static final int PRIORITY_LIMIT = 50;
    public static final int NONPRIORITY_LIMIT = 20;
    

    abstract void method2337();

    RemoteRequest method2338(int i, int i_0_, byte i_1_, boolean bool, int i_2_) {
	try {
	    long l = ((long) i << 32) + (long) i_0_;
	    RemoteRequest class298_sub37_sub16_sub1 = new RemoteRequest();
	    class298_sub37_sub16_sub1.aLong7406 = 1476940603538232441L * l;
	    ((RemoteRequest) class298_sub37_sub16_sub1).aByte10003 = i_1_;
	    ((RemoteRequest) class298_sub37_sub16_sub1).aBoolean9672 = bool;
	    if (bool) {
		if (method2348(2080324549) >= PRIORITY_LIMIT)
		    throw new RuntimeException();
		((Class247) this).aClass461_2736.add(class298_sub37_sub16_sub1, (byte) -14);
	    } else {
		if (method2341(144457290) >= NONPRIORITY_LIMIT)
		    throw new RuntimeException();
		((Class247) this).aClass461_2738.add(class298_sub37_sub16_sub1, (byte) -22);
	    }
	...
	try {
	    return method2348(1959855858) >= PRIORITY_LIMIT;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return (((Class247) this).aClass461_2738.method5986((short) -13891) + ((Class247) this).nonpriority_files.method5986((short) -16314));
	}
	catch (RuntimeException runtimeexception) {
	...
	((Class247) this).nonpriority_files = new Class461();
	((Class247) this).conbuffer = new RsByteBuffer(6);
	((Class247) this).aByte2743 = (byte) 0;
	anInt2735 = 0;
	anInt2745 = 0;
	((Class247) this).header_buffer = new RsByteBuffer(10);
    }
	...
	try {
	    return method2341(-938507058) >= NONPRIORITY_LIMIT;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return (((Class247) this).aClass461_2736.method5986((short) -18478) + ((Class247) this).priority_files.method5986((short) -10486));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    class105.aBoolean1181 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]) == 1;
	...
	try {
		...
		return 1;
	    if (GraphicDefinition.method4920(i_5_, (short) 300))
		return 2;
	...
	try {
		...
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = -530122905 * class298_sub52.anInt7608;
	...
	try {
	    Class390.method4875(Shadow.method3476(1476588124), class403, (byte) 0);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (-1625219821 * pb.anInt8687 > 0) {
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_1994, pb.aClass25_8711.aClass449_330, (byte) 79);
		class298_sub36.aClass298_Sub53_Sub2_7396.writeShort(2089055308 * pb.anInt8687, 16711935);
		for (int i_9_ = 0; i_9_ < pb.anInt8687 * -1625219821; i_9_++) {
		    Interface16 interface16 = pb.anInterface16Array8688[i_9_];
		...
		pb.aClass25_8711.method390(class298_sub36, (byte) -79);
	    }
	    if (ClientScriptsExecutor.anInt4120 * -2116412357 > 0)
		ClientScriptsExecutor.anInt4120 -= -1604952845;
	    if (pb.aBoolean8763 && ClientScriptsExecutor.anInt4120 * -2116412357 <= 0) {
		ClientScriptsExecutor.anInt4120 = -2034285828;
		pb.aBoolean8763 = false;
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.MOVE_CAMERA_PACKET, pb.aClass25_8711.aClass449_330, (byte) 50);
		class298_sub36.aClass298_Sub53_Sub2_7396.writeShort128((int) pb.aFloat8757 >> 3);
		class298_sub36.aClass298_Sub53_Sub2_7396.writeShortLE((int) pb.aFloat8949 >> 3, 1908840395);
		pb.aClass25_8711.method390(class298_sub36, (byte) -20);
	    }
		...
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2063, pb.aClass25_8711.aClass449_330, (byte) 90);
		class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(Class422_Sub7.aBoolean8385 ? 1 : 0);
		pb.aClass25_8711.method390(class298_sub36, (byte) -44);
	    }
	    if (!pb.aBoolean8666) {
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2003, pb.aClass25_8711.aClass449_330, (byte) 9);
		...
		pb.aClass25_8711.method390(class298_sub36, (byte) -84);
    ...
    static void method2372(Toolkit class_ra, int i, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_) {
	try {
	    if ((null == Class486.aClass57_6062 || null == Class501.aClass57_6123 || Class367.aClass57_4001 == null) && Class158.idx8.fileLoaded(ClanSettings.anInt1680 * 1049272911, -457216440) && Class158.idx8.fileLoaded(Class361.anInt3914 * -745532315, -457216440) && Class158.idx8.fileLoaded((-684155443 * Class260.anInt2820), -457216440)) {
		...
		Class486.aClass57_6062 = (class_ra.method5125(IndexedImage.method987(Class158.idx8, 1049272911 * ClanSettings.anInt1680, 0), true));
	...
	try {
	    ...
	    int i_21_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
	    int i_22_ = (((Class403) class403).anIntArray5244[1 + ((Class403) class403).anInt5239 * 681479919]);
	    Class461 class461 = Class301.method3693(i_21_ >> 14 & 0x3fff, i_21_ & 0x3fff);
	    boolean bool = false;
	    for (MapDetails class298_sub37_sub13 = (MapDetails) class461.first(1544902477); class298_sub37_sub13 != null; class298_sub37_sub13 = ((MapDetails) class461.next(1578702645))) {
	...
	try {
		...
		if (!ObjectOverride.method5804(pb.anInt8752 * -1233866115, (byte) 33)) {
		    if (0 == i_24_) {
			Class477.method6096(Class374_Sub1.idx6, -1256171511 * Class300.anInt3207, 0, i_23_, false, -2072200222);
