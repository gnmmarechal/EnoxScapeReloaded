...
public class Class314 {
    ...
    public Class314(Class411 class411, Class429 class429, JS5 class243) {
	...
	if (((Class314) this).aClass243_3302 != null) {
	    ...
	    ConfigEntry.aClass120_1406.method1306((short) 7909);
	    ((Class314) this).aClass243_3302.getFileCountForArchive(i, 967571472);
	}
    }
	...
	try {
	    ...
	    synchronized (((Class314) this).aClass348_3303) {
		class327 = (ConfigDefinitions) ((Class314) this).aClass348_3303.get((long) i);
	    }
	    if (null != class327)
		return class327;
	    byte[] is;
	    synchronized (((Class314) this).aClass243_3302) {
		is = (((Class314) this).aClass243_3302.getFile(ConfigEntry.aClass120_1406.method1307(i, -1343831720), ConfigEntry.aClass120_1406.method1305(i, 39933071)));
	    }
	    class327 = new ConfigDefinitions();
	    if (null != is)
		class327.method3975(new RsByteBuffer(is), 16711680);
	    synchronized (((Class314) this).aClass348_3303) {
		((Class314) this).aClass348_3303.put(class327, (long) i);
	    }
	    return class327;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if ((((Class403) class403).aLongArray5251[1685767703 * ((Class403) class403).anInt5245]) <= (((Class403) class403).aLongArray5251[((Class403) class403).anInt5245 * 1685767703 + 1]))
	...
	try {
	    ...
	    class298_sub36.aClass298_Sub53_Sub2_7396.writeShort(-2034569943 * ((Class403) class403).aClass177_5243.anInt1787, 16711935);
	    ((Class403) class403).aClass177_5243.aClass298_Sub37_Sub14_1788.method3464(class298_sub36.aClass298_Sub53_Sub2_7396, ((Class403) class403).aClass177_5243.anIntArray1789, 373327263);
