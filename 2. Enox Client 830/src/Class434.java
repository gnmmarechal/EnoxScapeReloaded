...
public class Class434 {
	...
	try {
	    return MouseIcon.method6184(Class144.aClass381_1563.aClass355_4115, 1089632340);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class390.method4867(i_2_, -1, -574024132) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
