...
public class Class477 {
	...
	public ItemDefinitions getItemDefinitions(int itemId) {
		try {
			...
			synchronized (((Class477) this).aClass243_5990) {
				is = (((Class477) this).aClass243_5990.getFile(ConfigEntry.aClass120_1429.method1307(itemId, -100335020), ConfigEntry.aClass120_1429.method1305(itemId, -1698958016)));
			}
			...
			if (!((Class477) this).aBoolean5999 && itemdefinition.aBoolean5731) {
				...
				if (null != ((ItemDefinitions) itemdefinition).aClass437_5766) {
					...
					for (Class298 class298 = ((ItemDefinitions) itemdefinition).aClass437_5766.method5816(1739772889); class298 != null; class298 = ((ItemDefinitions) itemdefinition).aClass437_5766.method5815((byte) -94)) {
						Class497 class497 = (((Class477) this).aClass504_5989.method6251((int) (class298.hash * 7051297995265073167L), -1474104007));
	...
	public Sprite method6085(Toolkit class_ra, int i, int i_1_, int i_2_, int i_3_, int i_4_, Class366 class366, int i_5_) {
		try {
			((Class465) ((Class477) this).aClass465_5996).anInt6519 = -973477563 * class_ra.id;
			...
			return (Sprite) aClass340_5995.method4134(((Class477) this).aClass465_5996);
		}
		catch (RuntimeException runtimeexception) {
	...
	public Sprite method6086(Toolkit class_ra, Toolkit class_ra_6_, int i, int i_7_, int i_8_, int i_9_, boolean bool, boolean bool_10_, int i_11_, Class264 class264, Class366 class366, int i_12_) {
		try {
			if (!bool_10_) {
				Sprite class57 = method6085(class_ra_6_, i, i_7_, i_8_, i_9_, i_11_, class366, 467134725);
				if (null != class57)
					return class57;
			}
			...
			if (!bool_10_) {
				...
				((Class465) class465).anInt6519 = -973477563 * class_ra_6_.id;
	...
	public Class477(Class411 class411, Class429 class429, boolean bool, Class504 class504, JS5 class243, JS5 class243_16_) {
		...
		if (null != ((Class477) this).aClass243_5990) {
			...
			if (true)
				...
				itemDefinitionsLength = (i * ConfigEntry.aClass120_1429.method1306((short) 15063) + ((Class477) this).aClass243_5990.getFileCountForArchive(i, -1996628421)) * -1797723349;
		}
		else
			itemDefinitionsLength = 0;
		if (((Class477) this).aClass411_5998 == Class411.game_rs)
	...
	static final void method6094(int i, byte i_18_) {
		try {
			...
			if (0 != i_19_) {
				...
				if (5 == i_19_)
					pb.anInt8830 = -941750943 * i_20_;
				if (6 == i_19_)
					pb.anInt8842 = i_20_ * 1034265279;
			}
		}
		catch (RuntimeException runtimeexception) {
	...
	static final void method6095(Class403 class403, int i) {
		try {
			Class298_Sub36.method3401(0, 0, (pb.aClass105_8819.anInt1156 * -2093041337), (pb.aClass105_8819.anInt1162 * 457937409), false, 1934343255);
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = -505673857 * pb.anInt8664;
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = 1387083365 * pb.anInt8939;
		}
		catch (RuntimeException runtimeexception) {
