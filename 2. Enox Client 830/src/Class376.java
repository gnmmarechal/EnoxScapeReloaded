...
public class Class376 {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub2_7547.method5629(-460328639) == 1 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		pb.aClass25_8693.method384((byte) 49);
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (int) (Class122.method1319((byte) 1) / 60000L);
	}
	catch (RuntimeException runtimeexception) {
