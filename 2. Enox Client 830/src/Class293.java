...
public class Class293 {
	...
	try {
	    ...
	    if ((((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]) > (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 1]))
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class348.method4197(i_0_, i_1_, true, (byte) 12);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = 816811163 * Class73.anInt689;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Class403) class403).aClass162_5252.aByte1658;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub19_7567.method5612(i_2_, 1352882135);
	}
	catch (RuntimeException runtimeexception) {
