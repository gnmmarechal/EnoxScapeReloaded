...
public class Class255 implements Runnable {
	...
	try {
		...
		for (Class298_Sub37_Sub16_Sub2 class298_sub37_sub16_sub2_2_ = ((Class298_Sub37_Sub16_Sub2) ((Class255) this).aClass461_2794.first(686363137)); class298_sub37_sub16_sub2_2_ != null; class298_sub37_sub16_sub2_2_ = ((Class298_Sub37_Sub16_Sub2) ((Class255) this).aClass461_2794.next(-852978429))) {
	...
	try {
	    synchronized (((Class255) this).aClass461_2794) {
		((Class255) this).aClass461_2794.add(class298_sub37_sub16_sub2, (byte) -98);
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub28_7573.method5725((byte) 12) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    pb.aCalendar8758.setTime(new Date(Class122.method1319((byte) 1)));
	    int i_5_ = pb.aCalendar8758.get(11);
	    int i_6_ = pb.aCalendar8758.get(12);
	    int i_7_ = pb.aCalendar8758.get(13);
	...
	try {
	    byte[] is = class243.getTextureData(i, (byte) 105);
	    if (null == is)
		return null;
