...
public class Class52_Sub2_Sub2_Sub1 extends Class52_Sub2_Sub2 {
    ...
    Class52_Sub2_Sub2_Sub1(HybridOglToolkit class_ra_sub3_sub1, Canvas canvas, long l) {
	super(class_ra_sub3_sub1);
	((Class52_Sub2_Sub2_Sub1) this).aCanvas9991 = canvas;
	((Class52_Sub2_Sub2_Sub1) this).anOpenGL9988 = ((HybridOglToolkit) class_ra_sub3_sub1).anOpenGL9826;
    ...
    Class52_Sub2_Sub2_Sub1(HybridOglToolkit class_ra_sub3_sub1, Canvas canvas) {
	this(class_ra_sub3_sub1, canvas, ((HybridOglToolkit) class_ra_sub3_sub1).anOpenGL9826.prepareSurface(canvas));
    }
