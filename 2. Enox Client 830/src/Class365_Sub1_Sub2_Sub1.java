...
public class Class365_Sub1_Sub2_Sub1 extends Class365_Sub1_Sub2 implements Interface3 {
	...
	try {
	    Model class387 = aClass60_9910.method700(class_ra, 131072, false, false, (byte) -17);
	    if (class387 == null)
		return false;
    ...
    boolean method4385(Toolkit class_ra, int i, int i_2_) {
	Model class387 = aClass60_9910.method700(class_ra, 131072, false, false, (byte) -18);
	if (class387 == null)
	    return false;
	...
	try {
	    Model class387 = aClass60_9910.method700(class_ra, 2048, false, true, (byte) 42);
	    if (null == class387)
		return null;
    ...
    public Class365_Sub1_Sub2_Sub1(Class331 class331, Toolkit class_ra, Class433 class433, ObjectDefinitions class432, int i, int i_5_, int i_6_, int i_7_, int i_8_, boolean bool, int i_9_, int i_10_) {
    ...
    final void method4355(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_11_, int i_12_, boolean bool, int i_13_) {
	try {
	    throw new IllegalStateException();
	}
	catch (RuntimeException runtimeexception) {
    ...
    boolean method4372(Toolkit class_ra, int i, int i_14_) {
	Model class387 = aClass60_9910.method700(class_ra, 131072, false, false, (byte) -51);
	if (class387 == null)
	    return false;
    ...
    final void method4388(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_15_, int i_16_, boolean bool) {
	throw new IllegalStateException();
    }

    public void method4495(ObjectOverride class435, byte i) {
	try {
	...
	Model class387 = aClass60_9910.method700(class_ra, 262144, true, true, (byte) 5);
	if (null != class387) {
	...
	Model class387 = aClass60_9910.method700(class_ra, 262144, true, true, (byte) -9);
	if (null != class387) {
	    Class217 class217 = method4337().aClass217_2599;
	    int i = (int) class217.aFloat2451 >> 9;
    ...
    boolean method4352(Toolkit class_ra, int i, int i_19_) {
	Model class387 = aClass60_9910.method700(class_ra, 131072, false, false, (byte) -102);
	if (class387 == null)
	    return false;
	return class387.method4787(i, i_19_, method4347(), false, 0);
    }

    final void method4375(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_20_, int i_21_, boolean bool) {
	throw new IllegalStateException();
    }
	...
	try {
	    Model class387 = aClass60_9910.method700(class_ra, 262144, true, true, (byte) -16);
	    if (null != class387) {
		Class217 class217 = method4337().aClass217_2599;
	...
	Model class387 = aClass60_9910.method700(class_ra, 2048, false, true, (byte) -3);
	if (null == class387)
	    return null;
	Class222 class222 = method4347();
	Class235 class235 = method4337();
	...
	try {
	    ...
	    class298_sub36.aClass298_Sub53_Sub2_7396.writeShort(((Class403) class403).aClass177_5243.anInt1787 * -2034569943, 16711935);
	    ((Class403) class403).aClass177_5243.aClass298_Sub37_Sub14_1788.method3464(class298_sub36.aClass298_Sub53_Sub2_7396, ((Class403) class403).aClass177_5243.anIntArray1789, 1820223429);
	...
	try {
	    ...
	    BillBoardDefinitions.method1826(-1182326447);
	    System.gc();
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Class425.method5741(is, 0, ((Class403) class403).anIntArray5244, 681479919 * ((Class403) class403).anInt5239, 3);
