	...
	public static void method322(RsByteBuffer buffer, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("ak.r(").append(')').toString());
		}
	}
