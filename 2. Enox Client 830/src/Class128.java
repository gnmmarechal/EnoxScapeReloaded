...
public class Class128 implements Interface5 {
	...
	try {
		...
		TextureMetrics.method599(class119, class105, (byte) -21);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    class105.aBoolean1183 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]) == 1;
	...
	try {
	    ...
	    int i_9_ = pb.GRAND_EXCHANGE_SLOTS[i_8_].method2400(-574288948);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_9_ == 2 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
