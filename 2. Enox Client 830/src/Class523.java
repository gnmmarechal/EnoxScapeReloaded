...
final class Class523 implements Interface17 {
	...
	try {
	    ...
	    int i_1_ = ((((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]) - 1);
	...
	try {
	    if (pb.aClass105_8850 == null && !Class436.aBoolean5478 && (null != class105 && Class419.method5603(class105, 1470456512))) {
		pb.aClass105_8850 = class105;
		pb.aClass105_8712 = Class331.method4063(class105, (byte) -122);
		pb.anInt8734 = -344812543 * i;
		pb.anInt8853 = i_2_ * -1376922141;
		Class82_Sub22.anInt6917 = 0;
		pb.aBoolean8863 = false;
	    }
	}
	catch (RuntimeException runtimeexception) {
    ...
    public static Toolkit method6334(int i, Canvas canvas, Interface_ma interface_ma, JS5 class243, int i_10_, int i_11_) {
	try {
	    int i_12_ = 0;
	    int i_13_ = 0;
	    if (null != canvas) {
