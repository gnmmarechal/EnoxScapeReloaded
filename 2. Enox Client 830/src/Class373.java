...
public class Class373 {
    ...
    public static Sprite aClass57_4070;
    public static Toolkit activeToolkit;
    public static ChecksumTableEntry[] aClass242_Sub1Array4072;
	...
	try {
	    if (i == 1)
		anInt4056 = LookupTable.method1240(class298_sub53.read24BitUnsignedInteger((byte) 45), (byte) 66) * -1294090885;
	    else if (i == 2)
		...
		anInt4059 = LookupTable.method1240(class298_sub53.read24BitUnsignedInteger((byte) -44), (byte) 71) * -1749423345;
	    else if (i == 8)
	...
	try {
	    ...
	    class105.anInt1214 = ((((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]) * -1733811909);
	    class105.anInt1124 = (210030285 * (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 1]));
	    class105.anInt1191 = ((((Class403) class403).anIntArray5244[2 + 681479919 * ((Class403) class403).anInt5239]) * 1629063197);
	...
	try {
	    ...
	    if (2 == pb.anInt8942 * 1131012101 && i_2_ < -1054937867 * pb.anInt8941)
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = pb.anIntArray8705[i_2_];
	    else
	...
	try {
	    boolean bool = false;
	    String string = "";
	    if (((Class403) class403).aClass214_5256 != null && ((Class403) class403).aClass214_5256.method1985(592860146)) {
		File file = ((Class403) class403).aClass214_5256.method1986((short) -10504);
		if (null != file) {
		    string = file.getPath();
		    if (string == null)
			string = "";
		...
		bool = true;
		((Class403) class403).aClass214_5256 = null;
	    }
	...
	try {
	    ...
	    pb.aClass283_8716.method2641(134727545).method5795(1599239758);
	    ...
	    ConfigEntry.aClass487_1463.method6162((byte) 81);
	    ...
	    Shadow.aClass491_9686.method6173((short) -15590);
	    ...
	    PlayerLookDefinitions.method1480((byte) -41);
	    pb.aClass348_8780.method4189();
	    pb.aClass348_8898.method4189();
	    pb.aClass348_8697.method4189();
	...
	try {
	    ...
	    int i_6_ = pb.GRAND_EXCHANGE_SLOTS[i_5_].method2400(-574288948);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = 1 == i_6_ ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
