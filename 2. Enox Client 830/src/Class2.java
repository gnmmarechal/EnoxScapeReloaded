...
public class Class2 {
	...
	final void method299(boolean flag, boolean flag1, boolean flag2, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11) {
		...
		if (aBoolean36) {
			aClass_ra_Sub1_31.method5018((int) f3, (int) f, (int) f4, (int) f1, Class379.anIntArray4096[(int) f9 & 0xffff], 0x828f2ffb);
			aClass_ra_Sub1_31.method5018((int) f4, (int) f1, (int) f5, (int) f2, Class379.anIntArray4096[(int) f9 & 0xffff], 0x859f5e57);
			aClass_ra_Sub1_31.method5018((int) f5, (int) f2, (int) f3, (int) f, Class379.anIntArray4096[(int) f9 & 0xffff], 0x8896140e);
			return;
		}
		float f12 = f4 - f3;
		float f13 = f1 - f;
	...
	final void method290(boolean flag, boolean flag1, boolean flag2, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, int i, int j, int k, int l, float f18, float f19, float f20, int i1, int j1) {
		...
		if (k1 != anInt37) {
			...
			if (anIntArray30 == null) {
				...
				anInt54 = 0;
				int l1 = Class379.anIntArray4096[BillBoardDefinitions.method1823(aClass_ra_Sub1_31.method5206(i1)) & 0xffff];
				int i2 = 0xff000000 | (i >> 16 & 0xff) * (l1 >> 16 & 0xff) << 8 & 0xff0000 | (i >> 8 & 0xff) * (l1 >> 8 & 0xff) & 0xff00 | (i & 0xff) * (l1 & 0xff) >> 8;
				method292(true, flag1, flag2, f, f1, f2, f3, f4, f5, f6, f7, f8, Class350.method4215(i2, l, f18, 0x2f9687f9), Class350.method4215(i2, l, f19, 0x65732cff), Class350.method4215(i2, l, f20, 0x99113c73));
				return;
			}
			anInt37 = k1;
	...
	final void method296(boolean flag, boolean flag1, boolean flag2, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, int i, int j, int k, int l, float f18, float f19, float f20, int i1, int j1, float f21, int k1, int l1, float f22, int i2, int j2, float f23) {
		...
		if (z1 != anInt37) {
			...
			if (anIntArray30 == null) {
				anInt37 = -1;
				anInt19 = 255 - (i >> 24 & 0xff);
				int l3 = Class379.anIntArray4096[BillBoardDefinitions.method1823(aClass_ra_Sub1_31.method5206(i1)) & 0xffff];
				int k4 = 0xff000000 | (i >> 16 & 0xff) * (l3 >> 16 & 0xff) << 8 & 0xff0000 | (i >> 8 & 0xff) * (l3 >> 8 & 0xff) & 0xff00 | (i & 0xff) * (l3 & 0xff) >> 8;
				method292(true, flag1, flag2, f, f1, f2, f3, f4, f5, f6, f7, f8, Class350.method4215(k4, l, f18, 0xd64ec645), Class350.method4215(k4, l, f19, 0xe7dd957e), Class350.method4215(k4, l, f20, 0xb2bf3ca));
				return;
			}
			anInt37 = z1;
			anInt39 = aClass_ra_Sub1_31.method5199(i1);
		...
		if (z2 != anInt44) {
			...
			if (anIntArray45 == null) {
				anInt44 = -1;
				anInt19 = 255 - (i >> 24 & 0xff);
				int i4 = Class379.anIntArray4096[BillBoardDefinitions.method1823(aClass_ra_Sub1_31.method5206(k1)) & 0xffff];
				int l4 = 0xff000000 | (i >> 16 & 0xff) * (i4 >> 16 & 0xff) << 8 & 0xff0000 | (i >> 8 & 0xff) * (i4 >> 8 & 0xff) & 0xff00 | (i & 0xff) * (i4 & 0xff) >> 8;
				method292(true, flag1, flag2, f, f1, f2, f3, f4, f5, f6, f7, f8, Class350.method4215(l4, l, f18, 0x2b709993), Class350.method4215(l4, l, f19, 0x6b610838), Class350.method4215(l4, l, f20, 0xb872d512));
				return;
			}
			anInt44 = z2;
		...
		if (z3 != anInt49) {
			...
			if (anIntArray50 == null) {
				anInt49 = -1;
				anInt19 = 255 - (i >> 24 & 0xff);
				int j4 = Class379.anIntArray4096[BillBoardDefinitions.method1823(aClass_ra_Sub1_31.method5206(i2)) & 0xffff];
				int i5 = 0xff000000 | (i >> 16 & 0xff) * (j4 >> 16 & 0xff) << 8 & 0xff0000 | (i >> 8 & 0xff) * (j4 >> 8 & 0xff) & 0xff00 | (i & 0xff) * (j4 & 0xff) >> 8;
				method292(true, flag1, flag2, (int) f, (int) f1, (int) f2, (int) f3, (int) f4, (int) f5, (int) f6, (int) f7, (int) f8, Class350.method4215(i5, l, f18, 0xcf015ccc), Class350.method4215(i5, l, f19, 0xedb62fd4), Class350.method4215(i5, l, f20, 0x38098961));
				return;
			}
			anInt49 = z3;
	...
	final void method292(boolean flag, boolean flag1, boolean flag2, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, int i, int j, int k) {
		...
		if (aBoolean36) {
			aClass_ra_Sub1_31.method5018((int) f3, (int) f, (int) f4, (int) f1, 0xff000000 | i, 0xaaa04ad7);
			aClass_ra_Sub1_31.method5018((int) f4, (int) f1, (int) f5, (int) f2, 0xff000000 | i, 0xacdced69);
			aClass_ra_Sub1_31.method5018((int) f5, (int) f2, (int) f3, (int) f, 0xff000000 | i, 0x85d44780);
			return;
		}
		float f9 = f4 - f3;
		float f10 = f1 - f;
	...
	Class2(SafeModeToolkit class106_sub2, Class15 class186) {
		aBoolean36 = false;
		aBoolean16 = true;
		aBoolean48 = false;
		anInt19 = 0;
	...
	final void method293(boolean flag, boolean flag1, boolean flag2, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, int i) {
		if (aBoolean36) {
			aClass_ra_Sub1_31.method5018((int) f3, (int) f, (int) f4, (int) f1, i, 0xa156520a);
			aClass_ra_Sub1_31.method5018((int) f4, (int) f1, (int) f5, (int) f2, i, 0x9c9fa2d6);
			aClass_ra_Sub1_31.method5018((int) f5, (int) f2, (int) f3, (int) f, i, 0xacc82ebf);
			return;
		}
		float f9 = f4 - f3;
		float f10 = f1 - f;
