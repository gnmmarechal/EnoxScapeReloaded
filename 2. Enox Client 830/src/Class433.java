...
public class Class433 {
    ModelDecoder[] aClass64Array5443;
    ...
    Class348 tuples = new Class348(30);
    int anInt5453;
    String[] aStringArray5454;
    Class411 aClass411_5455;
    Tuple aClass454_5456;
	...
	try {
	    ...
	    synchronized (((Class433) this).tuples) {
		((Class433) this).tuples.method4187();
	    }
	...
	try {
	    ...
	    ((Class433) this).aClass64Array5443 = new ModelDecoder[4];
	    ((Class433) this).aClass454_5456 = new Tuple(null, null);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    synchronized (((Class433) this).tuples) {
		((Class433) this).tuples.method4186(i, 466618917);
	    }
	    synchronized (((Class433) this).aClass348_5451) {
	...
	try {
	    ...
	    synchronized (((Class433) this).tuples) {
		((Class433) this).tuples.method4189();
	    }
	    synchronized (((Class433) this).aClass348_5451) {
	...
	if (null != ((Class433) this).aClass243_5446) {
	    ...
	    ConfigEntry.aClass120_1443.method1306((short) 23751);
	    ((Class433) this).aClass243_5446.getFileCountForArchive(i, -1017296855);
	}
	if (((Class433) this).aClass411_5455 == Class411.game_rs)
	...
	try {
		...
		is = (((Class433) this).aClass243_5446.getFile(ConfigEntry.aClass120_1443.method1307(objectId, -1875026798), ConfigEntry.aClass120_1443.method1305(objectId, -1955117131)));
	    }
	    class432 = new ObjectDefinitions();
	    class432.objectId = objectId * -950871973;
	    ((ObjectDefinitions) class432).provider = this;
		...
		//System.err.println("Object:" + objectId + " (" + class432.name + ") has weird flag set!");
	    ...
	    synchronized (((Class433) this).aClass348_5449) {
		((Class433) this).aClass348_5449.put(class432, (long) objectId);
	    }
	    return class432;
	}
	catch (RuntimeException runtimeexception) {
