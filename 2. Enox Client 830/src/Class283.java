...
public class Class283 {
    ...
    WorldTile aClass341_3006 = new WorldTile();
    WorldTile aClass341_3007 = new WorldTile();
    ...
    public WorldTile method2628(int i) {
	try {
	...
	try {
	    return ((Class283) this).mapWidth * -991330803;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return ((Class283) this).mapHeight * -1456212765;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		for (int i_1_ = 0; i_1_ < -991330803 * ((Class283) this).mapWidth >> 3; i_1_++) {
		    for (int i_2_ = 0; i_2_ < ((Class283) this).mapHeight * -1456212765 >> 3; i_2_++) {
			...
			if (-1 != i_3_) {
				...
				for (int i_9_ = 0; i_9_ < (((Class283) this).regionIds).length; i_9_++) {
				    if (i_8_ == (((Class283) this).regionIds[i_9_]) && null != is[i_9_]) {
					...
					class240_sub1.method2236(Class373.activeToolkit, class298_sub53, i_0_, 8 * i_1_, 8 * i_2_, i_4_, i_6_, i_7_, i_5_, -2145736118);
					break;
				    }
				}
			    }
		...
		for (int i_11_ = 0; i_11_ < -991330803 * ((Class283) this).mapWidth >> 3; i_11_++) {
		    for (int i_12_ = 0; (i_12_ < ((Class283) this).mapHeight * -1456212765 >> 3); i_12_++) {
	...
	try {
	    ((Class283) this).aClass364_3013 = new Class364(Class373.activeToolkit, -991330803 * ((Class283) this).mapWidth >> 3, ((Class283) this).mapHeight * -1456212765 >> 3);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class283) this).anInt3016 = ((int) (34.46 * (double) (-991330803 * ((Class283) this).mapWidth)) * -2038218047);
	    ((Class283) this).anInt3016 = ((2073578817 * ((Class283) this).anInt3016 << 2) * -2038218047);
	    if (Class373.activeToolkit.method4998())
	...
	try {
		...
		if (((Class283) this).aClass266_3001 == Class266.LOAD_MAP_SCENE_DYNAMIC || (((Class283) this).aClass266_3001 == Class266.aClass266_2845) || ((((Class283) this).aClass266_3004 != ((Class283) this).aClass266_3001) && ((Class266.LOAD_MAP_SCENE_NORMAL == ((Class283) this).aClass266_3001) || (((Class283) this).aClass266_3004 == Class266.LOAD_MAP_SCENE_NORMAL)))) {
		    pb.anInt8703 = 0;
		    pb.anInt8772 = 0;
		    pb.aClass437_8696.method5811((byte) -6);
		}
	...
	try {
	    ...
	    if (((Class283) this).aClass266_3001 == Class266.LOAD_MAP_SCENE_BACKGROUND) // background
	...
	try {
	    setMapBounds(Class94.method1020(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub11_7558.method5667(-369768513), 2010588610), 226677224);
	    int i_16_ = ((Class283) this).aClass341_3006.x * -1760580017;
	    int i_17_ = ((Class283) this).aClass341_3006.y * 283514611;
	    int chunkX = (Class367.anInt4000 * -1740717447 >> 12) + (i_16_ >> 3);
	    int chunkY =  (i_17_ >> 3) + (-299812095 * Class146.anInt1575 >> 12);
	    
	    Class287.myPlayer.plane = (byte) 0;
	    Class99.anInt952 = 0;
	    Class287.myPlayer.method4472(8, 8, -1960083958);
	    int regionsCount = 18;
	    ((Class283) this).regionArchiveKeys = new int[regionsCount][4];
	    ((Class283) this).regionIds = new int[regionsCount];
	    ((Class283) this).anIntArray3010 = new int[regionsCount];
	    ((Class283) this).anIntArray3033 = new int[regionsCount];
	    ((Class283) this).anIntArray3034 = new int[regionsCount];
	    ((Class283) this).aByteArrayArray3038 = new byte[regionsCount][];
	    ((Class283) this).aByteArrayArray3014 = new byte[regionsCount][];
	    ((Class283) this).aByteArrayArray3044 = new byte[regionsCount][];
	    ((Class283) this).anIntArray3035 = new int[regionsCount];
	    ((Class283) this).anIntArray3036 = new int[regionsCount];
	    ((Class283) this).aByteArrayArray3041 = new byte[regionsCount][];
	    ((Class283) this).aByteArrayArray3002 = new byte[regionsCount][];
	    regionsCount = 0;
	    for (int i_21_ = (chunkX - (((Class283) this).mapWidth * -991330803 >> 4)) / 8; i_21_ <= ((-991330803 * ((Class283) this).mapWidth >> 4) + chunkX) / 8; i_21_++) {
		for (int i_22_ = (chunkY - (((Class283) this).mapHeight * -1456212765 >> 4)) / 8; i_22_ <= ((-1456212765 * ((Class283) this).mapHeight >> 4) + chunkY) / 8; i_22_++) {
		    int regionId = (i_21_ << 8) + i_22_;
		    ((Class283) this).regionIds[regionsCount] = regionId;
		    ((Class283) this).anIntArray3010[regionsCount] = (Class65.idx5.getArchiveId(method2669(true, false, i_21_, i_22_, (byte) -40)));
		    ((Class283) this).anIntArray3033[regionsCount] = (Class65.idx5.getArchiveId(method2669(false, false, i_21_, i_22_, (byte) 85)));
		    ((Class283) this).anIntArray3034[regionsCount] = Class65.idx5.getArchiveId(new StringBuilder().append("n").append(i_21_).append('_').append(i_22_).toString());
		    ((Class283) this).anIntArray3035[regionsCount] = (Class65.idx5.getArchiveId(method2669(true, true, i_21_, i_22_, (byte) -47)));
		    ((Class283) this).anIntArray3036[regionsCount] = (Class65.idx5.getArchiveId(method2669(false, true, i_21_, i_22_, (byte) -30)));
		    if (((Class283) this).anIntArray3034[regionsCount] == -1) {
			((Class283) this).anIntArray3010[regionsCount] = -1;
			((Class283) this).anIntArray3033[regionsCount] = -1;
			((Class283) this).anIntArray3035[regionsCount] = -1;
			((Class283) this).anIntArray3036[regionsCount] = -1;
		    }
		    regionsCount++;
		}
	    }
	    for (int i_24_ = regionsCount; i_24_ < ((Class283) this).anIntArray3034.length; i_24_++) {
	    ...
	    int i_25_;
	    if (pb.anInt8752 * -1233866115 == 19)
		i_25_ = 1;
	    else if (18 == -1233866115 * pb.anInt8752)
		i_25_ = 16;
	    else if (14 == pb.anInt8752 * -1233866115)
		i_25_ = 15;
	    else if (pb.anInt8752 * -1233866115 == 8)
		i_25_ = 9;
	    else
		throw new RuntimeException(new StringBuilder().append("").append(-1233866115 * pb.anInt8752).toString());
	    loadMapScene(chunkX, chunkY, i_25_, false);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (!((Class283) this).aBoolean3018)
		method2649((byte) 38);
	    setMapBounds(Class94.method1020(mapSize, -1114771755), 226677224);
	    int regionsCount = ((class298_sub53_sub2.buffer.length - class298_sub53_sub2.index * 385051775) / 16);
	    ((Class283) this).regionArchiveKeys = new int[regionsCount][4];
	    for (int i_30_ = 0; i_30_ < regionsCount; i_30_++) {
		for (int i_31_ = 0; i_31_ < 4; i_31_++)
		    ((Class283) this).regionArchiveKeys[i_30_][i_31_] = class298_sub53_sub2.readInt((byte) 40);
	    }
	    ((Class283) this).regionIds = new int[regionsCount];
	    ((Class283) this).anIntArray3010 = new int[regionsCount];
	    ((Class283) this).anIntArray3033 = new int[regionsCount];
	    ...
	    ((Class283) this).aByteArrayArray3002 = new byte[regionsCount][];
	    regionsCount = 0;
	    for (int regionX = (chunkX - (((Class283) this).mapWidth * -991330803 >> 4)) / 8; regionX <= (chunkX + (((Class283) this).mapWidth * -991330803 >> 4)) / 8; regionX++) {
		for (int regionY = (chunkY - (-1456212765 * ((Class283) this).mapHeight >> 4)) / 8; regionY <= ((((Class283) this).mapHeight * -1456212765 >> 4) + chunkY) / 8; regionY++) {
		    ((Class283) this).regionIds[regionsCount] = regionY + (regionX << 8);
		    ((Class283) this).anIntArray3010[regionsCount] = (Class65.idx5.getArchiveId(method2669(true, false, regionX, regionY, (byte) -113)));
		    ((Class283) this).anIntArray3033[regionsCount] = (Class65.idx5.getArchiveId(method2669(false, false, regionX, regionY, (byte) -82)));
		    ((Class283) this).anIntArray3035[regionsCount] = (Class65.idx5.getArchiveId(method2669(true, true, regionX, regionY, (byte) -99)));
		    ((Class283) this).anIntArray3036[regionsCount] = (Class65.idx5.getArchiveId(method2669(false, true, regionX, regionY, (byte) -80)));
		    regionsCount++;
		}
	    }
	    loadMapScene(chunkX, chunkY, 17, forceRefresh);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (!((Class283) this).aBoolean3018)
		method2649((byte) 124);
	    setMapBounds(Class94.method1020(mapSize, 1925270996), 226677224);
	    stream.initBitAccess(-1836176958);
	    for (int i_39_ = 0; i_39_ < 4; i_39_++) {
		for (int i_40_ = 0; i_40_ < -991330803 * ((Class283) this).mapWidth >> 3; i_40_++) {
		    for (int i_41_ = 0; (i_41_ < -1456212765 * ((Class283) this).mapHeight >> 3); i_41_++) {
	    ...
	    ((Class283) this).regionArchiveKeys = new int[i_43_][4];
	    for (int i_44_ = 0; i_44_ < i_43_; i_44_++) {
		for (int i_45_ = 0; i_45_ < 4; i_45_++)
		    ((Class283) this).regionArchiveKeys[i_44_][i_45_] = stream.readInt((byte) -51);
	    }
	    ((Class283) this).regionIds = new int[i_43_];
		...
		for (int i_47_ = 0; i_47_ < -991330803 * ((Class283) this).mapWidth >> 3; i_47_++) {
		    for (int i_48_ = 0; (i_48_ < -1456212765 * ((Class283) this).mapHeight >> 3); i_48_++) {
			...
			if (i_49_ != -1) {
				...
				if (i_52_ == (((Class283) this).regionIds[i_53_])) {
				    i_52_ = -1;
				    break;
				}
			    }
			    if (-1 != i_52_) {
				((Class283) this).regionIds[i_43_] = i_52_;
				int i_54_ = i_52_ >> 8 & 0xff;
				int i_55_ = i_52_ & 0xff;
				((Class283) this).anIntArray3010[i_43_] = (Class65.idx5.getArchiveId(method2669(true, false, i_54_, i_55_, (byte) -94)));
				((Class283) this).anIntArray3033[i_43_] = (Class65.idx5.getArchiveId(method2669(false, false, i_54_, i_55_, (byte) -94)));
				((Class283) this).anIntArray3035[i_43_] = (Class65.idx5.getArchiveId(method2669(true, true, i_54_, i_55_, (byte) 105)));
				((Class283) this).anIntArray3036[i_43_] = (Class65.idx5.getArchiveId(method2669(false, true, i_54_, i_55_, (byte) 23)));
				i_43_++;
			    }
			}
		    }
    ...
    void setMapBounds(Class115 class115, int i) {
	try {
	    if (class115 != ((Class283) this).aClass115_3003) {
		((Class283) this).mapWidth = (((Class283) this).mapHeight = class115.anInt1382 * 723673737) * -116821329;
		((Class283) this).anIntArrayArrayArray3043 = (new int[4][-991330803 * ((Class283) this).mapWidth >> 3][-1456212765 * ((Class283) this).mapHeight >> 3]);
		((Class283) this).anIntArrayArray3023 = (new int[((Class283) this).mapWidth * -991330803][-1456212765 * ((Class283) this).mapHeight]);
		((Class283) this).anIntArrayArray3026 = (new int[-991330803 * ((Class283) this).mapWidth][-1456212765 * ((Class283) this).mapHeight]);
		for (int i_56_ = 0; i_56_ < 4; i_56_++)
		    ((Class283) this).SCENE_CLIP_DATA_PLANES[i_56_] = Class16.method354((-991330803 * ((Class283) this).mapWidth), (((Class283) this).mapHeight * -1456212765), -617039163);
		((Class283) this).aByteArrayArrayArray3032 = (new byte[4][-991330803 * ((Class283) this).mapWidth][((Class283) this).mapHeight * -1456212765]);
		((Class283) this).aClass244_3012 = new Class244(4, -991330803 * ((Class283) this).mapWidth, ((Class283) this).mapHeight * -1456212765);
    ...
    void loadMapScene(int chunkX, int chunkY, int type, boolean forceRefresh) {
	try {
	    if (1596783995 * pb.anInt8724 == 2) {
		if (((Class283) this).aBoolean3018)
		    throw new IllegalStateException();
		pb.anInt8724 = -1334571751;
		pb.anInt8870 = -221729505;
	    }
	    if (forceRefresh || ((Class283) this).anInt3030 * 19679283 != chunkX || chunkY != ((Class283) this).anInt3009 * 306966675) {
		((Class283) this).anInt3030 = chunkX * -1135086853;
		((Class283) this).anInt3009 = chunkY * -1928942181;
		if (!((Class283) this).aBoolean3018) {
		    Class439.method5851(type, 430070283);
		    Class139.method1548(Tradution.aClass470_5874.method6049(Class321.aClass429_3357, -875414210), true, Class373.activeToolkit, Class343.aClass264_3673, Class422_Sub2.aClass505_8369, (byte) 103);
		}
		if (((Class283) this).aClass341_3006 != null)
		    ((Class283) this).aClass341_3007 = ((Class283) this).aClass341_3006;
		else
		    ((Class283) this).aClass341_3007 = new WorldTile(0, 0, 0);
		((Class283) this).aClass341_3006 = new WorldTile(0, 8 * (((Class283) this).anInt3030 * 19679283 - ((-991330803 * ((Class283) this).mapWidth) >> 4)), 8 * (306966675 * ((Class283) this).anInt3009 - ((((Class283) this).mapHeight * -1456212765) >> 4)));
		((Class283) this).aClass298_Sub37_Sub13_3017 = Class301.method3708(-1760580017 * (((Class283) this).aClass341_3006.x), (((Class283) this).aClass341_3006.y) * 283514611);
		((Class283) this).aClass296_3005 = null;
		if (!((Class283) this).aBoolean3018)
		    method2663(type, 1177231331);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (null != is_63_) {
		    ...
		    int i_64_ = ((Class283) this).regionIds[i_62_] >> 8;
		    int i_65_ = ((Class283) this).regionIds[i_62_] & 0xff;
		    int i_66_ = (64 * i_64_ - (((Class283) this).aClass341_3006.x * -1760580017));
		    int i_67_ = 64 * i_65_ - 283514611 * (((Class283) this).aClass341_3006.y);
		    if (!((Class283) this).aBoolean3018)
			Class247.method2365(408539711);
		    class240_sub1.method2215(class298_sub53, i_66_, i_67_, -1760580017 * (((Class283) this).aClass341_3006.x), (((Class283) this).aClass341_3006.y) * 283514611, (((Class283) this).SCENE_CLIP_DATA_PLANES), -391880689);
		    class240_sub1.method2235(Class373.activeToolkit, class298_sub53, i_66_, i_67_, (byte) -72);
		}
	    }
	    for (int i_68_ = 0; i_68_ < i_61_; i_68_++) {
		int i_69_ = ((((Class283) this).regionIds[i_68_] >> 8) * 64 - (((Class283) this).aClass341_3006.x * -1760580017));
		int i_70_ = ((((Class283) this).regionIds[i_68_] & 0xff) * 64 - (((Class283) this).aClass341_3006.y * 283514611));
	...
	try {
		...
		if (is_74_ != null) {
		    int i_75_ = (64 * (((Class283) this).regionIds[i_73_] >> 8) - (-1760580017 * ((Class283) this).aClass341_3006.x));
		    int i_76_ = ((((Class283) this).regionIds[i_73_] & 0xff) * 64 - 283514611 * (((Class283) this).aClass341_3006.y));
		    if (!((Class283) this).aBoolean3018)
			Class247.method2365(-802890876);
		    class240_sub1.method2237(Class373.activeToolkit, is_74_, i_75_, i_76_, (((Class283) this).SCENE_CLIP_DATA_PLANES), 1861855341);
		    if (((Class283) this).aBoolean3018)
	...
	try {
		...
		if (((Class283) this).aByteArrayArray3044[i_78_] == null) {
		    ...
		    int i_79_ = -1;
		    for (int i_80_ = 0; i_80_ < pb.anInt8721 * -160072615; i_80_++) {
			if (((Class283) this).regionIds[i_78_] == pb.anIntArray8751[i_80_]) {
			    i_79_ = i_80_;
			    break;
			}
		    }
		    if (i_79_ == -1) {
			pb.anIntArray8751[pb.anInt8721 * -160072615] = ((Class283) this).regionIds[i_78_];
			i_79_ = (pb.anInt8721 += 424283113) * -160072615 - 1;
		    }
			...
			if (pb.anInt8703 * -1230451913 >= 1023) {
			    if (i <= -1776092464) {
				/* empty */
			    }
			    break;
			...
			int i_87_ = (64 * (((Class283) this).regionIds[i_78_] >> 8) - (((Class283) this).aClass341_3006.x * -1760580017) + i_85_);
			int i_88_ = (i_86_ + (64 * (((Class283) this).regionIds[i_78_] & 0xff) - (((Class283) this).aClass341_3006.y * 283514611)));
			NPCDefinitions class503 = (Class15.aClass507_224.method6269(class298_sub53.readUnsignedShort(), -806262033));
			Class298_Sub29 class298_sub29 = ((Class298_Sub29) pb.aClass437_8696.get((long) i_82_));
			if (class298_sub29 == null && (class503.aByte6170 & 0x1) > 0 && i_87_ >= 0 && (-2095128707 * class503.size + i_87_ < -991330803 * ((Class283) this).mapWidth) && i_88_ >= 0 && (i_88_ + class503.size * -2095128707 < ((Class283) this).mapHeight * -1456212765)) {
			    ...
			    pb.aClass437_8696.method5817(class298_sub29_89_, (long) i_82_);
			    pb.aClass298_Sub29Array8816[((pb.anInt8772 += -118843751) * 1962237353) - 1] = class298_sub29_89_;
			    pb.anIntArray8699[((pb.anInt8703 += -409937273) * -1230451913) - 1] = i_82_;
			    class365_sub1_sub1_sub2_sub1.anInt10075 = pb.ticketCycle * -128551287;
	...
	try {
	    int i_91_ = (((Class283) this).aClass341_3006.x * -1760580017 - ((Class283) this).aClass341_3007.x * -1760580017);
	    int i_92_ = (((Class283) this).aClass341_3006.y * 283514611 - 283514611 * ((Class283) this).aClass341_3007.y);
	    if (17 == i) {
		for (int i_93_ = 0; i_93_ < 1962237353 * pb.anInt8772; i_93_++) {
		    Class298_Sub29 class298_sub29 = pb.aClass298_Sub29Array8816[i_93_];
		...
		boolean bool = false;
		pb.anInt8703 = 0;
		int i_95_ = -755230208 * ((Class283) this).mapWidth - 512;
		int i_96_ = ((Class283) this).mapHeight * 1743373824 - 512;
		for (int i_97_ = 0; i_97_ < pb.anInt8772 * 1962237353; i_97_++) {
		    Class298_Sub29 class298_sub29 = pb.aClass298_Sub29Array8816[i_97_];
		    if (null != class298_sub29) {
			NPC class365_sub1_sub1_sub2_sub1 = ((NPC) class298_sub29.anObject7366);
			Class217 class217 = Class217.method2005(class365_sub1_sub1_sub2_sub1.method4337().aClass217_2599);
			class217.aFloat2451 -= (float) (512 * i_91_);
			...
			if ((int) class217.aFloat2451 < 0 || (int) class217.aFloat2451 > i_95_ || (int) class217.aFloat2454 < 0 || (int) class217.aFloat2454 > i_96_) {
				...
				if ((class365_sub1_sub1_sub2_sub1.scenePositionXQueue[i_99_]) < 0 || ((class365_sub1_sub1_sub2_sub1.scenePositionXQueue[i_99_]) >= (((Class283) this).mapWidth * -991330803)) || (class365_sub1_sub1_sub2_sub1.scenePositionYQueue[i_99_]) < 0 || ((class365_sub1_sub1_sub2_sub1.scenePositionYQueue[i_99_]) >= (((Class283) this).mapHeight * -1456212765)))
				    bool_98_ = false;
			    }
			    if (bool_98_)
				pb.anIntArray8699[((pb.anInt8703 += -409937273) * -1230451913) - 1] = (class365_sub1_sub1_sub2_sub1.anInt10064 * 1888274983);
			    else {
		...
		if (bool) {
		    pb.anInt8772 = (pb.aClass437_8696.method5814(2145683355) * -118843751);
		    int i_100_ = 0;
		    Iterator iterator = pb.aClass437_8696.iterator();
		    while (iterator.hasNext()) {
			Class298_Sub29 class298_sub29 = (Class298_Sub29) iterator.next();
			pb.aClass298_Sub29Array8816[i_100_++] = class298_sub29;
		    }
		}
	    }
	    for (int i_101_ = 0; i_101_ < 2048; i_101_++) {
		Player class365_sub1_sub1_sub2_sub2 = pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_101_];
		...
		if (((Class283) this).aClass266_3001 != Class266.aClass266_2850 && (class298_sub1.anInt7150 * 634196087 < 0 || -2146829167 * class298_sub1.anInt7155 < 0 || (634196087 * class298_sub1.anInt7150 >= ((Class283) this).mapWidth * -991330803) || (-2146829167 * class298_sub1.anInt7155 >= ((Class283) this).mapHeight * -1456212765)))
		...
		if (((Class283) this).aClass266_3001 != Class266.aClass266_2850 && (634196087 * class298_sub1.anInt7150 < 0 || -2146829167 * class298_sub1.anInt7155 < 0 || (class298_sub1.anInt7150 * 634196087 >= ((Class283) this).mapWidth * -991330803) || (-2146829167 * class298_sub1.anInt7155 >= -1456212765 * ((Class283) this).mapHeight)))
		    class298_sub1.method2839(-1460969981);
	    }
	    for (Class298_Sub2 class298_sub2 = ((Class298_Sub2) pb.aClass437_8685.method5816(1670233657)); null != class298_sub2; class298_sub2 = (Class298_Sub2) pb.aClass437_8685.method5815((byte) -33)) {
		...
		int i_106_ = i_105_ - (-1760580017 * ((Class283) this).aClass341_3006.x);
		int i_107_ = (int) ((class298_sub2.hash * 7051297995265073167L >> 14) & 0x3fffL);
		int i_108_ = i_107_ - 283514611 * (((Class283) this).aClass341_3006.y);
		if (null != ((Class283) this).aClass331_3037) {
		    if (i_106_ < 0 || i_108_ < 0 || i_106_ >= -991330803 * ((Class283) this).mapWidth || i_108_ >= ((Class283) this).mapHeight * -1456212765 || i_106_ >= (((Class283) this).aClass331_3037.anInt3514) * 1988988347 || i_108_ >= 1340714547 * (((Class283) this).aClass331_3037.anInt3549)) {
	    ...
	    if (17 == i) {
		pb.anInt8753 -= i_91_ * 721337856;
		pb.anInt8755 -= i_92_ * 601815552;
	...
	try {
	    ((Class283) this).aClass266_3004 = ((Class283) this).aClass266_3001;
	    setMapBounds(Class115.aClass115_1383, 226677224);
	    for (int i_110_ = 0; i_110_ < 4; i_110_++) {
		for (int i_111_ = 0; i_111_ < ((Class283) this).mapWidth * -991330803 >> 3; i_111_++) {
		    for (int i_112_ = 0; (i_112_ < -1456212765 * ((Class283) this).mapHeight >> 3); i_112_++)
	    ...
	    ((Class283) this).regionIds = new int[i_129_];
		...
		for (int i_134_ = i_130_ >>> 3; i_134_ <= i_132_; i_134_++) {
			...
			for (int i_137_ = 0; i_137_ < i_129_; i_137_++) {
			    if (((Class283) this).regionIds[i_137_] == i_136_) {
				if (i >= 0) {
				    /* empty */
				}
				continue while_71_;
			...
			((Class283) this).regionIds[i_129_] = i_136_;
			((Class283) this).anIntArray3010[i_129_] = (Class65.idx5.getArchiveId(method2669(true, false, i_134_, i_135_, (byte) -52)));
			((Class283) this).anIntArray3033[i_129_] = (Class65.idx5.getArchiveId(method2669(false, false, i_134_, i_135_, (byte) 111)));
			((Class283) this).anIntArray3035[i_129_] = (Class65.idx5.getArchiveId(method2669(true, true, i_134_, i_135_, (byte) 24)));
			((Class283) this).anIntArray3036[i_129_] = (Class65.idx5.getArchiveId(method2669(false, true, i_134_, i_135_, (byte) 86)));
			i_129_++;
		    }
		}
	    }
	    ((Class283) this).regionArchiveKeys = Class298_Sub37.anIntArrayArray7407;
	    Class298_Sub37.anIntArrayArray7407 = null;
	    loadMapScene(-991330803 * ((Class283) this).mapWidth >> 4, -1456212765 * ((Class283) this).mapHeight >> 4, 17, false);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class283) this).aClass341_3006 = new WorldTile();
	...
	try {
		...
		Class283 class283_138_ = pb.aClass283_8716;
		((Class283) this).regionIds = ((Class283) class283_138_).regionIds;
		...
		((Class283) this).regionArchiveKeys = ((Class283) class283_138_).regionArchiveKeys;
		...
		((Class283) this).mapWidth = ((Class283) class283_138_).mapWidth * 1;
		((Class283) this).mapHeight = ((Class283) class283_138_).mapHeight * 1;
	    } else if (19 == -1233866115 * pb.anInt8752)
		Class439.method5851(1, -193120332);
	    else if (pb.anInt8752 * -1233866115 == 14)
		Class439.method5851(15, 1644134026);
	    else if (pb.anInt8752 * -1233866115 == 18)
		Class439.method5851(16, 1118439953);
	    else if (0 == -1233866115 * pb.anInt8752)
		Class439.method5851(17, 1835904519);
	    else if (8 == pb.anInt8752 * -1233866115)
	...
	try {
		...
		for (int i_144_ = 0; i_144_ < -991330803 * ((Class283) this).mapWidth >> 3; i_144_++) {
		    for (int i_145_ = 0; (i_145_ < -1456212765 * ((Class283) this).mapHeight >> 3); i_145_++) {
			...
			if (-1 != i_146_) {
				...
				for (int i_152_ = 0; i_152_ < (((Class283) this).regionIds).length; i_152_++) {
				    if ((((Class283) this).regionIds[i_152_]) == i_151_ && null != is[i_152_]) {
					class240_sub1.method2238(Class373.activeToolkit, is[i_152_], i_143_, 8 * i_144_, i_145_ * 8, i_147_, 8 * (i_149_ & 0x7), (i_150_ & 0x7) * 8, i_148_, (((Class283) this).SCENE_CLIP_DATA_PLANES), -174685332);
					break;
				    }
				}
			    }
	...
	try {
		...
		if (-1 != ((Class283) this).anIntArray3010[i_153_] && ((Class283) this).aByteArrayArray3038[i_153_] == null) {
		    ((Class283) this).aByteArrayArray3038[i_153_] = Class65.idx5.getFile((((Class283) this).anIntArray3010[i_153_]), 0);
		...
		if (-1 != ((Class283) this).anIntArray3033[i_153_] && null == ((Class283) this).aByteArrayArray3014[i_153_]) {
		    ((Class283) this).aByteArrayArray3014[i_153_] = (Class65.idx5.method2289(((Class283) this).anIntArray3033[i_153_], 0, ((Class283) this).regionArchiveKeys[i_153_], -1251594466));
		...
		if (((Class283) this).anIntArray3035[i_153_] != -1 && null == ((Class283) this).aByteArrayArray3041[i_153_]) {
		    ((Class283) this).aByteArrayArray3041[i_153_] = Class65.idx5.getFile((((Class283) this).anIntArray3035[i_153_]), 0);
		...
		if (((Class283) this).anIntArray3036[i_153_] != -1 && ((Class283) this).aByteArrayArray3002[i_153_] == null) {
		    ((Class283) this).aByteArrayArray3002[i_153_] = Class65.idx5.getFile((((Class283) this).anIntArray3036[i_153_]), 0);
		...
		if (null != ((Class283) this).anIntArray3034 && null == ((Class283) this).aByteArrayArray3044[i_153_] && ((Class283) this).anIntArray3034[i_153_] != -1) {
		    ((Class283) this).aByteArrayArray3044[i_153_] = (Class65.idx5.method2289(((Class283) this).anIntArray3034[i_153_], 0, ((Class283) this).regionArchiveKeys[i_153_], -1874141869));
		    if (null == ((Class283) this).aByteArrayArray3044[i_153_])
			((Class283) this).anInt3027 += -427342251;
		}
	    }
	    if (((Class283) this).aClass296_3005 == null) {
		if (null != ((Class283) this).aClass298_Sub37_Sub13_3017 && (Class_v.idx23.method2295(new StringBuilder().append(((Class283) this).aClass298_Sub37_Sub13_3017.namehash).append("_staticelements").toString(), -400372089))) {
		    if (!Class_v.idx23.method2312(new StringBuilder().append(((Class283) this).aClass298_Sub37_Sub13_3017.namehash).append("_staticelements").toString(), -2144896080))
			((Class283) this).anInt3027 += -427342251;
		    else
			((Class283) this).aClass296_3005 = (WorldMap.getMapKeys(Class_v.idx23, new StringBuilder().append(((Class283) this).aClass298_Sub37_Sub13_3017.namehash).append("_staticelements").toString(), pb.isMemberWorld, 565671699));
		} else
		    ((Class283) this).aClass296_3005 = new MapKeys(0);
	    }
		...
		if (is != null) {
		    int i_155_ = ((((Class283) this).regionIds[i_154_] >> 8) * 64 - (-1760580017 * ((Class283) this).aClass341_3006.x));
		    int i_156_ = ((((Class283) this).regionIds[i_154_] & 0xff) * 64 - (((Class283) this).aClass341_3006.y * 283514611));
		    if (((Class283) this).aClass266_3001.allowDynamicMapScene(-1692375482)) {
			i_155_ = 10;
			i_156_ = 10;
		    }
		    int i_157_ = (Class82_Sub13.method910(((Class283) this).aClass433_3040, is, i_155_, i_156_, ((Class283) this).mapWidth * -991330803, -1456212765 * ((Class283) this).mapHeight, (byte) -75));
		    if (i_157_ > 0)
			((Class283) this).anInt3021 += i_157_ * 94764029;
		}
		is = ((Class283) this).aByteArrayArray3002[i_154_];
		if (is != null) {
		    int i_158_ = (64 * (((Class283) this).regionIds[i_154_] >> 8) - (((Class283) this).aClass341_3006.x * -1760580017));
		    int i_159_ = (64 * (((Class283) this).regionIds[i_154_] & 0xff) - (((Class283) this).aClass341_3006.y * 283514611));
		    if (((Class283) this).aClass266_3001.allowDynamicMapScene(-105390577)) {
			i_158_ = 10;
			i_159_ = 10;
		    }
		    int i_160_ = (Class82_Sub13.method910(((Class283) this).aClass433_3040, is, i_158_, i_159_, ((Class283) this).mapWidth * -991330803, -1456212765 * ((Class283) this).mapHeight, (byte) 54));
		    if (i_160_ > 0)
		...
		Class139.method1548(new StringBuilder().append(Tradution.aClass470_5874.method6049(Class321.aClass429_3357, -875414210)).append(Class26.aString350).append("(100%)").toString(), true, Class373.activeToolkit, Class343.aClass264_3673, Class422_Sub2.aClass505_8369, (byte) -16);
	    ((Class283) this).aClass273_3025 = Class273.aClass273_2907;
	    if (!((Class283) this).aBoolean3018)
		Class247.method2365(-1142860499);
	    if (!((Class283) this).aBoolean3018) {
		for (int i_161_ = 0; i_161_ < 2048; i_161_++) {
		    Player class365_sub1_sub1_sub2_sub2 = (pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_161_]);
		    if (class365_sub1_sub1_sub2_sub2 != null)
			class365_sub1_sub1_sub2_sub2.aClass331_7722 = null;
		}
		for (int i_162_ = 0; i_162_ < pb.aClass298_Sub29Array8816.length; i_162_++) {
		    Class298_Sub29 class298_sub29 = pb.aClass298_Sub29Array8816[i_162_];
	    ...
	    method2664((byte) 12);
	    ((Class283) this).aClass331_3037 = new Class331(Class373.activeToolkit, 9, 4, ((Class283) this).mapWidth * -991330803, ((Class283) this).mapHeight * -1456212765, i_164_, bool, Class373.activeToolkit.method5048() > 0);
	    ((Class283) this).aClass331_3037.method4052(false, -740850409);
	    ((Class283) this).aClass331_3037.method4007(pb.anInt8814 * -2081556469, (byte) -26);
	    if (0 != pb.anInt8814 * -2081556469)
		((Class283) this).aClass331_3037.method4008(Class298_Sub46.aClass264_7534, -972568309);
	    else
	    ...
	    ((Class283) this).aClass240_Sub1_3029 = new Class240_Sub1(((Class283) this).aClass331_3037, ((Class283) this).aClass433_3040, 4, -991330803 * ((Class283) this).mapWidth, -1456212765 * ((Class283) this).mapHeight, false, ((Class283) this).aClass244_3012, ((Class283) this).aClass364_3013);
	    ...
	    ((Class283) this).aClass364_3013.method4321(((Class283) this).mapWidth * -991330803 >> 4, -1456212765 * ((Class283) this).mapHeight >> 4, 1532552397);
	    ((Class283) this).aClass364_3013.method4323(this, 1783211969);
	    if (bool) {
		((Class283) this).aClass331_3037.method4052(true, -740850409);
		((Class283) this).aClass240_Sub1_3000 = new Class240_Sub1(((Class283) this).aClass331_3037, ((Class283) this).aClass433_3040, 1, (-991330803 * ((Class283) this).mapWidth), (-1456212765 * ((Class283) this).mapHeight), true, ((Class283) this).aClass244_3012, ((Class283) this).aClass364_3013);
		...
		((Class283) this).aClass240_Sub1_3000.method2218(Class373.activeToolkit, null, null, (byte) -27);
		((Class283) this).aClass331_3037.method4052(false, -740850409);
		if (((Class283) this).aBoolean3018)
		    method2658(50, (byte) 33);
	    }
	    ((Class283) this).aClass240_Sub1_3029.method2218(Class373.activeToolkit, bool ? (((Class283) this).aClass240_Sub1_3000.anIntArrayArrayArray2653) : null, ((Class283) this).SCENE_CLIP_DATA_PLANES, (byte) 23);
	    ...
	    ((Class283) this).aClass240_Sub1_3029.method2219(Class373.activeToolkit, (bool ? ((Class283) this).aClass331_3037.aClass_xaArray3521[0] : null), null, (byte) -119);
	    if (((Class283) this).aBoolean3018)
		method2658(75, (byte) 18);
	    ((Class283) this).aClass240_Sub1_3029.method2242(Class373.activeToolkit, false, 1773155741);
	    if (((Class283) this).aBoolean3018)
		...
		((Class283) this).aClass240_Sub1_3000.method2219(Class373.activeToolkit, null, ((Class283) this).aClass331_3037.aClass_xaArray3519[0], (byte) 43);
		((Class283) this).aClass240_Sub1_3000.method2242(Class373.activeToolkit, true, 1773155741);
		if (!((Class283) this).aBoolean3018)
		...
		while (!Class373.activeToolkit.method5041(2085922748))
		    method2658(1, (byte) -1);
	    }
	    boolean bool_165_ = false;
	    if (((Class283) this).aBoolean3018) {
		Class283 class283_166_ = pb.aClass283_8716;
		method2668(class283_166_, (byte) -125);
		Class62.aClass248_612.method2381(class283_166_, -1651604);
		bool_165_ = true;
		Class122.method1319((byte) 1);
		synchronized (pb.anObject8661) {
		    pb.aBoolean8717 = true;
		    try {
			pb.anObject8661.wait();
		    }
		    catch (InterruptedException interruptedexception) {
			/* empty */
		    }
		}
		pb.aClass283_8716 = this;
		...
		for (int i_168_ = 0; i_168_ < ((Class283) this).mapWidth * -991330803; i_168_++) {
		    for (int i_169_ = 0; i_169_ < -1456212765 * ((Class283) this).mapHeight; i_169_++)
			BillBoardDefinitions.method1820(i_167_, i_168_, i_169_, 814827061);
		}
	    }
	    for (int i_170_ = 0; i_170_ < pb.aClass299Array8671.length; i_170_++) {
		if (pb.aClass299Array8671[i_170_] != null)
		    pb.aClass299Array8671[i_170_].method3676(((Class283) this).aClass331_3037, 1790221759);
	    }
	    Class475.method6075((short) -8812);
	    Class420.method5608(2113027902);
	    if (Class389.method4865((byte) -6) == Class292.aClass292_3162 && pb.aClass25_8711.method387(537308016) != null && 17 == pb.anInt8752 * -1233866115) {
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2040, pb.aClass25_8711.aClass449_330, (byte) 55);
		class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(1057001181, -2024753870);
		pb.aClass25_8711.method390(class298_sub36, (byte) -45);
	    }
	    if (!((Class283) this).aClass266_3001.allowDynamicMapScene(1503430704)) {
		int i_171_ = ((19679283 * ((Class283) this).anInt3030 - (((Class283) this).mapWidth * -991330803 >> 4)) / 8);
		int i_172_ = ((19679283 * ((Class283) this).anInt3030 + (((Class283) this).mapWidth * -991330803 >> 4)) / 8);
		int i_173_ = ((306966675 * ((Class283) this).anInt3009 - (((Class283) this).mapHeight * -1456212765 >> 4)) / 8);
		int i_174_ = ((306966675 * ((Class283) this).anInt3009 + (-1456212765 * ((Class283) this).mapHeight >> 4)) / 8);
		for (int i_175_ = i_171_ - 1; i_175_ <= 1 + i_172_; i_175_++) {
			...
			if (i_175_ >= i_171_ && i_175_ <= i_172_ && i_176_ >= i_173_ && i_176_ <= i_174_) {
			    ...
			    Class65.idx5.method2304(method2669(true, false, i_175_, i_176_, (byte) 34), -1752946353);
			    Class65.idx5.method2304(method2669(false, false, i_175_, i_176_, (byte) -61), -1482810579);
			    Class65.idx5.method2304(method2669(true, true, i_175_, i_176_, (byte) -69), -1377878894);
			    Class65.idx5.method2304(method2669(false, true, i_175_, i_176_, (byte) -104), -180643080);
			}
		    }
		}
	    }
	    if (-1233866115 * pb.anInt8752 == 1)
		Class439.method5851(19, 1314741993);
	    else if (pb.anInt8752 * -1233866115 == 15)
		Class439.method5851(14, 1781016763);
	    else if (16 == pb.anInt8752 * -1233866115)
		Class439.method5851(18, 1023292756);
	    else if (-1233866115 * pb.anInt8752 == 9)
		Class439.method5851(8, 6222714);
	    else {
		Class439.method5851(0, 2061499324);
		if (pb.aClass25_8711.method387(537308016) != null) {
		    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.DONE_LOADING_REGION_PACKET, pb.aClass25_8711.aClass449_330, (byte) 9);
		    pb.aClass25_8711.method390(class298_sub36, (byte) -71);
		}
	    }
	    ...
	    if (bool_165_) {
		synchronized (pb.anObject8718) {
		    pb.anObject8718.notify();
		}
	    }
	    return true;
	}
    ...
    public static Model method2678(Toolkit class_ra, int i, int i_178_, int i_179_, int i_180_, int i_181_, Model class387, int i_182_, int i_183_, int i_184_, int i_185_, Class438 class438, int i_186_) {
	try {
	    if (null == class387)
		return null;
	    int i_187_ = 2055;
		...
		class387_188_ = (Model) Class462.aClass348_5682.get(l);
	    }
	    if (class387_188_ == null || class_ra.method5017(class387_188_.m(), i_187_) != 0) {
		if (class387_188_ != null)
		    i_187_ = class_ra.mergeFunctionMasks(i_187_, class387_188_.m());
		int i_189_;
		if (i_181_ == 1)
		    i_189_ = 9;
		else if (2 == i_181_)
		...
		int i_190_ = 3;
		int[] is = { 64, 96, 128 };
		ModelDecoder class64 = new ModelDecoder(1 + i_190_ * i_189_, 2 * (i_190_ * i_189_) - i_189_, 0);
		...
		class387_188_ = class_ra.createModel(class64, i_187_, 161976139 * Class419.anInt5341, 64, 768);
		synchronized (Class462.aClass348_5682) {
