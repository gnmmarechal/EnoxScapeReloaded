...
public class Routes {
    ...
    static final void findGroundItemRoute(int dstX, int dstY) {
        try {
            if (pb.gametype != Class411.game_stellardawn) {
    ...
    static final void findObjectRoute(int dstX, int dstY, long objdata) {
        try {
        	...
        	ObjectDefinitions definitions = pb.aClass283_8716.method2641(-1208362615).getObjectDefinitions(objid);
        	int sizeX;
        	int sizeY;
         ...
         //   System.err.println("id:" + objid + ", type:" + objtype + ", rotation:" + objrot + ", ctype:" + client.aClass283_8716.method2641(-1208362615).getObjectDefinitions(objid).clip_type);
            ...
            System.err.println("id:" + id + ", type:" + type + ", rotation:" + rotation);
            
            
            int cflag_rot = definition.test_cflag;
            System.err.println("cflag of route:"+ cflag_rot + " (" + ((cflag_rot & 0x1) != 0 ? "0x1," : "") + ((cflag_rot & 0x2) != 0 ? "0x2," : "") + ((cflag_rot & 0x4) != 0 ? "0x4," : "") + ((cflag_rot & 0x8) != 0 ? "0x8" : "") + ")");
	    if (rotation != 0) {
		// rotate the flag (expermental)
		cflag_rot = ((cflag_rot << rotation) & 0xF) + (cflag_rot >> (4 - rotation));
		System.err.println("Rotated cflag of route:"+ cflag_rot + " (" + ((cflag_rot & 0x1) != 0 ? "0x1," : "") + ((cflag_rot & 0x2) != 0 ? "0x2," : "") + ((cflag_rot & 0x4) != 0 ? "0x4," : "") + ((cflag_rot & 0x8) != 0 ? "0x8" : "") + ")");
	    }
	    if ((cflag_rot & ~(0x1 | 0x2 | 0x4 | 0x8)) != 0)
		System.err.println("Invalid cflag??");
    ...
    static final boolean findRoute(int dstX, int dstY, boolean findAlternative, PathStrategy strategy) {
        try {
            ...
            if (srcX < 0 || srcX >= pb.aClass283_8716.method2629(-2029828730) || srcY < 0 || srcY >= pb.aClass283_8716.method2630(911412275))
        	return false;
            if (dstX < 0 || dstX >= pb.aClass283_8716.method2629(-2140756422) || dstY < 0 || dstY >= pb.aClass283_8716.method2630(1432313507))
        	return false;
            int steps = pb.lastPathStepsCount = (Class298_Sub37.calculateRoute(srcX, srcY, Class287.myPlayer.getSize(), strategy, (pb.aClass283_8716.getSceneClipDataPlane(Class287.myPlayer.plane)), findAlternative, pb.pathBufferX, pb.pathBufferY));
            if (steps < 1)
        	return false;
            // minimap flag update
            Class3.anInt62 = pb.pathBufferX[steps - 1] * -1129029761;
            Class3.anInt54 = pb.pathBufferY[steps - 1] * -1835291189;
    ...
    public static PathStrategy createObjectCloseStrategy(int dstX, int dstY, int sizeX, int sizeY, GameObjectType type, int rotation) {
        try {
            ...
            ((ObjectCheckStrategyClosest) Class315.objcheckstrategyclosest).aClass424_7712 = type;
            ((ObjectCheckStrategyClosest) Class315.objcheckstrategyclosest).anInt7711 = rotation * 393356885;
    ...
    public static PathStrategy createObjectExactStrategy(int dstX, int dstY, int sizeX, int sizeY, GameObjectType type, int rotation) {
        try {
            ...
            ((ObjectCheckStrategyExact) Class315.objcheckstrategyexact).aClass424_7713 = type;
            ((ObjectCheckStrategyExact) Class315.objcheckstrategyexact).anInt7714 = -2142070477 * rotation;
    ...
    public static PathStrategy createEntityStrategy(int dstX, int dstY, int sizeX, int sizeY, int blockflag) {
        try {
            ...
            ((EntityStrategy) Class315.entitystrategy).anInt7715 = 89792661 * blockflag;
    ...
    public static PathStrategy createLobbyNpcsPathStrategy(int dstX, int dstY, int sizeX, int sizeY, int itsactualyblockflagnub) {
        try {
            ...
            ((LobbyPathStrategy) Class315.lobbynpcsstrategy).dkkstopcallingfieldstorandomnamesplskay = -1073204575 * itsactualyblockflagnub;
	...
	if (!Loader.useRoute)
	    return;
        int stepsCount = pb.lastPathStepsCount;
        if (stepsCount > 0) { // dont need to waste bw by sending empty packets
            Class298_Sub36 packet = Class18.method359(OutcommingPacket.WALKING_PACKET, pb.aClass25_8711.aClass449_330, (byte) 51);
            packet.aClass298_Sub53_Sub2_7396.writeByte(5 + stepsCount * 2);
            WorldTile class341 = pb.aClass283_8716.method2628(681479919);
            packet.aClass298_Sub53_Sub2_7396.writeShort128(class341.x * -1760580017);
            packet.aClass298_Sub53_Sub2_7396.write128Byte(Class151.method1644(-545107710) ? 1 : 0, (byte) 1);
            packet.aClass298_Sub53_Sub2_7396.writeShort128(class341.y * 283514611);
            ...
            pb.aClass25_8711.method390(packet, (byte) -115);
        }
    }
	...
	if (!Loader.useRoute)
        ...
        int stepsCount = pb.lastPathStepsCount;
        if (stepsCount > 0) { // dont need to waste bw by sending empty packets
            Class298_Sub36 packet = Class18.method359(OutcommingPacket.MINI_WALKING_PACKET, pb.aClass25_8711.aClass449_330, (byte) 28);
            packet.aClass298_Sub53_Sub2_7396.writeByte(5 + stepsCount * 2);
            WorldTile class341 = pb.aClass283_8716.method2628(681479919);
            packet.aClass298_Sub53_Sub2_7396.writeShort128(class341.x * -1760580017);
            packet.aClass298_Sub53_Sub2_7396.write128Byte(Class151.method1644(-545107710) ? 1 : 0, (byte) 1);
	...
	if (Loader.useRoute)
	    return;
        Class298_Sub36 packet = Class18.method359(OutcommingPacket.WALKING_PACKET, pb.aClass25_8711.aClass449_330, (byte) 51);
        packet.aClass298_Sub53_Sub2_7396.writeByte(7);
        WorldTile class341 = pb.aClass283_8716.method2628(681479919);
        packet.aClass298_Sub53_Sub2_7396.writeShort128(class341.x * -1760580017);
        packet.aClass298_Sub53_Sub2_7396.write128Byte(Class151.method1644(-545107710) ? 1 : 0, (byte) 1);
        packet.aClass298_Sub53_Sub2_7396.writeShort128(class341.y * 283514611);
    	packet.aClass298_Sub53_Sub2_7396.writeByte(dstX);
    	packet.aClass298_Sub53_Sub2_7396.writeByte(dstY);
        pb.aClass25_8711.method390(packet, (byte) -115);
    }
