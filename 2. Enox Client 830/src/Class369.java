...
public class Class369 {
	...
	try {
		...
		if (((Class369) this).aClass437_4018 == null) {
		    int i_17_ = Class416.nextPowerOfTwo(i_16_, (byte) 16);
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Class403) class403).aClass162_5252.anIntArray1666[i_39_];
	}
	catch (RuntimeException runtimeexception) {
