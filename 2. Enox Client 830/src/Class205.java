...
public class Class205 {
	...
	try {
		...
		is = (((Class205) this).aClass243_2338.getFile(-1006924897 * ConfigEntry.aClass120_1421.anInt1460, i));
	    }
	    class207 = new Class207();
	    if (null != is)
		class207.method1927(new RsByteBuffer(is), 27685189);
	    synchronized (((Class205) this).aClass348_2340) {
		((Class205) this).aClass348_2340.put(class207, (long) i);
	    }
	    return class207;
	}
	...
	if (null != ((Class205) this).aClass243_2338)
	    anInt2339 = (((Class205) this).aClass243_2338.getFileCountForArchive(ConfigEntry.aClass120_1421.anInt1460 * -1006924897, 487068051)) * 1946957321;
	else
	    anInt2339 = 0;
    }
