...
public class Class390 {
	...
	try {
	    return (((Class390) this).aClass119_4167.method1297(((Class390) this).aClass105_4168.ihash * -440872681, (short) 10433));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class301_Sub1.aBoolean7635 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]) == 1;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Toolkit class_ra = Class523.method6334(0, canvas, null, null, 0, -1071815074);
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1262 * -1086526073;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (int) pb.aFloat8757 >> 3;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class247.method2366(class298_sub37_sub15, (byte) -65);
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = Class73.method822(class298_sub37_sub15, 533229453);
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = Class104.method1107(class298_sub37_sub15, (byte) 14);
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = Class207.method1933(class298_sub37_sub15, -532801249);
	}
	catch (RuntimeException runtimeexception) {
