...
public class Class372 {
	...
	try {
	    ...
	    int i_3_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 3]);
	    WorldTile class341 = pb.aClass283_8716.method2628(681479919);
	    Class97_Sub1.method1043(((i_0_ >> 14 & 0x3fff) - class341.x * -1760580017), ((i_0_ & 0x3fff) - 283514611 * class341.y), i_1_ << 2, i_2_, i_3_, false);
	}
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub25_7569.method5716((byte) -30);
	}
	catch (RuntimeException runtimeexception) {
    ...
    public static JS5 method4590(Class111 class111, boolean bool, int i, boolean bool_5_, int i_6_) {
	try {
	    if (null == Class373.aClass242_Sub1Array4072)
		Class373.aClass242_Sub1Array4072 = new ChecksumTableEntry[Class356.method4268(1608416895)];
	    Class329 class329 = null;
	    int i_7_ = class111.method1233(958180062);
	    if (null != pb.aClass484_6476)
		class329 = new Class329(i_7_, pb.aClass484_6476, Class497.aClass484Array6106[i_7_], 1500000);
	...
	try {
	    ...
	    SubIncommingPacket.radar_mark_icons = null;
