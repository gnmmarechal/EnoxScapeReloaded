...
public class Class102 {
	...
	try {
	    ...
	    anInt1085 = -1698852737 * pb.ticketCycle;
	...
	anInt1085 = pb.ticketCycle * -1698852737;
	anInt1087 = i * 392659741;
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = 1243777389 * Class360.anInt3866;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    class105.anInt1173 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]) * -1041514725;
