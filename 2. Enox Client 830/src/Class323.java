...
public abstract class Class323 {
    ...
    public abstract boolean pressingKey(int i, int i_0_);
	...
	try {
	    ...
	    int i_2_ = 1953279233 * Textures.anInt6465;
	    int i_3_ = -1;
    ...
    static void method3948(Toolkit class_ra, int i, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, byte i_10_) {
	try {
	...
	try {
	    ...
	    int i_11_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
	    int i_12_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 1]);
	    Class505 class505 = Class322.method3931(BillBoardDefinitions.idx29, i_12_, 0, (byte) 49);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class505.method6259(string, i_11_, Class130_Sub2.aClass57Array6959, -1274509130);
	}
	catch (RuntimeException runtimeexception) {
