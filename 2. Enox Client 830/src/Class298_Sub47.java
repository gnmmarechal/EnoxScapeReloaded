...
public class Class298_Sub47 extends Class298 {
	...
	try {
		...
		if (class365_sub1_sub1_sub2_sub2 == Class287.myPlayer) {
		    if (pb.aBoolean8835 && (Class298.anInt3192 * -112110875 & 0x10) != 0)
			...
			String string_3_ = (pb.gametype == Class411.game_stellardawn ? (Tradution.aClass470_5928.method6049(Class321.aClass429_3357, -875414210)) : (Tradution.aClass470_5911.method6049(Class321.aClass429_3357, -875414210)));
		    ...
		    if (pb.aBoolean8835 && !bool && (-112110875 * Class298.anInt3192 & 0x8) != 0)
			...
			for (int i_4_ = 7; i_4_ >= 0; i_4_--) {
			    if (pb.aStringArray8820[i_4_] != null) {
				short i_5_ = 0;
				if ((pb.gametype == Class411.game_rs) && (pb.aStringArray8820[i_4_].equalsIgnoreCase(Tradution.aClass470_5906.method6049(Class321.aClass429_3357, -875414210)))) {
				    if (pb.aBoolean8815 && ((class365_sub1_sub1_sub2_sub2.anInt10206) * 696798311 > (Class287.myPlayer.anInt10206) * 696798311))
					i_5_ = (short) 2000;
				    if ((0 != (Class287.myPlayer.team) * -1473655357) && (-1473655357 * (class365_sub1_sub1_sub2_sub2.team)) != 0) {
					if ((class365_sub1_sub1_sub2_sub2.team) * -1473655357 == (Class287.myPlayer.team) * -1473655357)
					    i_5_ = (short) 2000;
					else
					    i_5_ = (short) 0;
				    } else if (class365_sub1_sub1_sub2_sub2.isClanMember)
					i_5_ = (short) 2000;
				} else if (pb.aBooleanArray8821[i_4_])
				    i_5_ = (short) 2000;
				short i_6_ = (short) (i_5_ + pb.aShortArray8818[i_4_]);
				int i_7_ = (-1 != pb.anIntArray8904[i_4_] ? pb.anIntArray8904[i_4_] : pb.anInt8690 * 1395924385);
				Class234.method2174(pb.aStringArray8820[i_4_], new StringBuilder().append(Class285.method2709(16777215, -1822012281)).append(string).toString(), i_7_, i_6_, -1, (long) (1888274983 * (class365_sub1_sub1_sub2_sub2.anInt10064)), 0, 0, true, false, (long) ((class365_sub1_sub1_sub2_sub2.anInt10064) * 1888274983), false, -1451194858);
			    }
			}
		    } else
