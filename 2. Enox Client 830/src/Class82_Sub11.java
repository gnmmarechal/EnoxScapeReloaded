...
public class Class82_Sub11 extends Class82 {
    int anInt6859;
    String aString6860;
    static Sprite[] aClass57Array6861;

    public void method866(int i) {
	try {
	    if (577335585 * pb.anInt8870 != -1)
		Class70.method803(577335585 * pb.anInt8870, ((Class82_Sub11) this).aString6860, 607881685 * ((Class82_Sub11) this).anInt6859, 2017220990);
	}
	...
	if (577335585 * pb.anInt8870 != -1)
	    Class70.method803(577335585 * pb.anInt8870, ((Class82_Sub11) this).aString6860, 607881685 * ((Class82_Sub11) this).anInt6859, 1486270976);
    }

    public void method869() {
	if (577335585 * pb.anInt8870 != -1)
	    Class70.method803(577335585 * pb.anInt8870, ((Class82_Sub11) this).aString6860, 607881685 * ((Class82_Sub11) this).anInt6859, 1478832260);
    }

    public static final void method906(int i) {
	try {
	    for (int i_0_ = 0; i_0_ < 5; i_0_++)
		pb.aBooleanArray8684[i_0_] = false;
	    pb.anInt8768 = -1723181617;
	    pb.anInt8769 = 2694169;
    ...
    static void method907(Toolkit class_ra, int i) {
	try {
		...
		Class65.aClass264_664 = (Class264) (Class497.aClass197_6105.method1883(pb.anInterface10_8700, Class242.anInt2710 * -2085188617, true, true, -2063324548));
		Class211.aClass505_2420 = (Class497.aClass197_6105.method1879(pb.anInterface10_8700, -2085188617 * Class242.anInt2710, -203887938));
		...
		int i_12_ = 0;
		for (Class298_Sub37_Sub5 class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass461_5482.first(324606134)); null != class298_sub37_sub5; class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass461_5482.next(2083970273))) {
		...
		if (Class436.aClass298_Sub37_Sub5_5472 != null) {
		    ...
		    i_12_ = 0;
		    for (Class298_Sub37_Sub15 class298_sub37_sub15 = ((Class298_Sub37_Sub15) ((Class298_Sub37_Sub5) Class436.aClass298_Sub37_Sub5_5472).aClass461_9584.first(473884533)); class298_sub37_sub15 != null; class298_sub37_sub15 = ((Class298_Sub37_Sub15) ((Class298_Sub37_Sub5) Class436.aClass298_Sub37_Sub5_5472).aClass461_9584.next(1876214432))) {
		...
		for (Class298_Sub37_Sub15 class298_sub37_sub15 = ((Class298_Sub37_Sub15) Class436.aClass453_5480.method5939(1766612795)); class298_sub37_sub15 != null; class298_sub37_sub15 = ((Class298_Sub37_Sub15) Class436.aClass453_5480.method5944(49146))) {
		    ...
		    Toolkit.method5192(i_8_, i_9_, i_1_, i_2_, i_3_, i_4_, i_16_, class298_sub37_sub15, class264, class505, (-1067973831 * Class343.anInt3674 | ~0xffffff), 1697857463 * (Class298_Sub40_Sub2.anInt9693) | ~0xffffff, 549127677);
		    i_15_++;
		}
	    } else {
		int i_17_ = 0;
		for (Class298_Sub37_Sub5 class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass461_5482.first(-476899641)); null != class298_sub37_sub5; class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass461_5482.next(81519453))) {
		...
		if (Class436.aClass298_Sub37_Sub5_5472 != null) {
		    i_17_ = 0;
		    for (Class298_Sub37_Sub15 class298_sub37_sub15 = ((Class298_Sub37_Sub15) ((Class298_Sub37_Sub5) Class436.aClass298_Sub37_Sub5_5472).aClass461_9584.first(45096692)); null != class298_sub37_sub15; class298_sub37_sub15 = ((Class298_Sub37_Sub15) ((Class298_Sub37_Sub5) Class436.aClass298_Sub37_Sub5_5472).aClass461_9584.next(1092020370))) {
			int i_19_ = (i_17_ * (Class436.anInt5467 * -411680299) + (1 + (class505.anInt6202 * 1110385787 + (Class501.anInt6119 * -1370784315 + i_5_))));
			Toolkit.method5192(i_8_, i_9_, 805710735 * Class461.anInt5681, Class501.anInt6119 * -1370784315, 2054409059 * Class420.anInt5345, -1855216229 * Class389.anInt4166, i_19_, class298_sub37_sub15, class264, class505, (Class343.anInt3674 * -1067973831 | ~0xffffff), (Class298_Sub40_Sub2.anInt9693 * 1697857463) | ~0xffffff, -316918375);
			i_17_++;
		    }
		}
	    }
	...
	try {
	    IComponentDefinition.method1135((((Class403) class403).aClass365_Sub1_Sub4_Sub1_5253), class403, -1596344570);
	}
	catch (RuntimeException runtimeexception) {
