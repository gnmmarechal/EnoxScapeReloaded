...
public class Class375 {
	...
	try {
		...
		return class373;
	    byte[] is;
	    synchronized (((Class375) this).idx2) {
		is = (((Class375) this).idx2.getFile(ConfigEntry.aClass120_1439.anInt1460 * -1006924897, i));
	    }
	    ...
	    synchronized (((Class375) this).aClass348_4079) {
		((Class375) this).aClass348_4079.put(class373, (long) i);
	    }
	    return class373;
	}
	...
	((Class375) this).idx2 = class243;
	anInt4081 = (((Class375) this).idx2.getFileCountForArchive((-1006924897 * (ConfigEntry.aClass120_1439.anInt1460)), 774356441) * 1970250293);
    }
	...
	try {
	    ...
	    int i_4_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 2]);
	    if (i_3_ == -1)
	    ...
	    if (is != null)
		i_5_ = is.length;
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_5_;
	}
	catch (RuntimeException runtimeexception) {
