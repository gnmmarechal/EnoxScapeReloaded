...
public final class ItemDefinitions {
	...
	public String getStreetPrice() {
		try {
			for (String lines : FileUtilities.readFile(System.getProperty("user.home") + "/Dropbox/streetprice/streetprice.txt")) {
				String[] data = lines.split(" - ");
				if (Integer.parseInt(data[0]) == id)
					return data[1];
			}
	...
	public String obtainedItem() {
		try {
			for (String lines : FileUtilities.readFile(System.getProperty("user.home") + "/Dropbox/streetprice/guide.txt")) {
				String[] data = lines.split(" - ");
				if (Integer.parseInt(data[0]) == id)
					return data[1];
			}
	...
	public String usesForItem() {
		try {
			for (String lines : FileUtilities.readFile(System.getProperty("user.home") + "/Dropbox/streetprice/uses.txt")) {
				String[] data = lines.split(" - ");
				if (Integer.parseInt(data[0]) == id)
					return data[1];
			}
	...
	public HashMap<Integer, Integer> getWearingSkillRequiriments() {
		...
		if (itemRequiriments == null) {
			...
			else if (getId() == 26579 || getId() == 26584 || getId() == 26587 || getId() == 26591 || getId() == 26595 || getId() == 26599)
	...
	public String getEquipType(Item item) {
		if (item.getDefinitions().name.contains("sword") || item.getDefinitions().name.contains("dagger") || item.getDefinitions().name.contains("scimitar") || item.getDefinitions().name.contains("whip") || item.getDefinitions().name.contains("spear") || item.getDefinitions().name.contains("mace") || item.getDefinitions().name.contains("battleaxe") || item.getDefinitions().name.contains("staff") || item.getDefinitions().name.contains("Staff") || item.getDefinitions().name.contains("battleaxe") || item.getDefinitions().name.contains("hatchet") || item.getDefinitions().name.contains("pickaxe")) {
			return "wielded in the right hand";
		}
		if (item.getDefinitions().name.contains("plate") || item.getDefinitions().name.contains("body") || item.getDefinitions().name.contains("apron") || item.getDefinitions().name.contains("chest")) {
		...
		if (item.getDefinitions().name.contains("shield") || item.getDefinitions().name.contains("2h") || item.getDefinitions().name.contains("maul") || item.getDefinitions().name.contains("claws")) {
	...
	public String getItemType(Item item) {
		if (item.getDefinitions().name.contains("sword") || item.getDefinitions().name.contains("dagger") || item.getDefinitions().name.contains("scimitar") || item.getDefinitions().name.contains("maul") || item.getDefinitions().name.contains("whip") || item.getDefinitions().name.contains("claws") || item.getDefinitions().name.contains("spear") || item.getDefinitions().name.contains("mace") || item.getDefinitions().name.contains("battleaxe")) {
		...
		if (item.getDefinitions().name.contains("body") || item.getDefinitions().name.contains("legs") || item.getDefinitions().name.contains("robe") || item.getDefinitions().name.contains("priest") || item.getDefinitions().name.contains("helm")) {
			return "a piece of apparel";
		}
		if (item.getDefinitions().name.contains("shield")) {
			return "a shield";
		}
		if (item.getDefinitions().name.contains("arrow") || item.getDefinitions().name.contains("bolt") || item.getDefinitions().name.contains("ball")) {
