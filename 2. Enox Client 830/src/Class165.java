...
public class Class165 implements Interface5 {
	...
	try {
	    ...
	    /*
	     * int[] is = new
	     * int[(Class298_Sub32_Sub14.aClass477_9400.itemDefinitionsLength *
	     * -888767613)]; int i_9_ = 0; for (int i_10_ = 0; i_10_ <
	     * (-888767613 *
	     * Class298_Sub32_Sub14.aClass477_9400.itemDefinitionsLength);
	     * i_10_++) { ItemDefinitions class468 =
	     * Class298_Sub32_Sub14.aClass477_9400 .getItemDefinitions(i_10_);
	     * if (1343198193 * class468.maleEquipModelId1 >= 0 || 1585491093 *
	     * class468.femaleEquipModelId1 >= 0) is[i_9_++] = i_10_; }
	     * Class519.anIntArray6274 = new int[i_9_]; for (int i_11_ = 0;
	     * i_11_ < i_9_; i_11_++) Class519.anIntArray6274[i_11_] =
	     * is[i_11_];
	     */
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    int i_13_ = -1;
	    int i_14_ = -1;
	    Class117 class117 = class105.method1116(Class373.activeToolkit, 1559428350);
	    if (null != class117) {
		i_13_ = class117.anInt1393 * 1633695381;
		i_14_ = -60174999 * class117.anInt1394;
	    }
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_13_;
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_14_;
	}
	catch (RuntimeException runtimeexception) {
