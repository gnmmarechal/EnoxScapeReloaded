...
public class Class117 {
	...
	try {
	    return MouseIcon.method6184(Class144.aClass381_1563.aClass355_4116, -1677177503);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ObjectOverride.method5804(-1233866115 * pb.anInt8752, (byte) -20) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    CS2Replacer.filterCrashUrl(string);
	    Class346.method4172(string, false, Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571.method5677(-2014540467) == 5, pb.aBoolean8867, pb.aBoolean8651, (byte) 37);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.DIALOGUE_CONTINUE_PACKET, pb.aClass25_8711.aClass449_330, (byte) 84);
	    ...
	    pb.aClass25_8711.method390(class298_sub36, (byte) -5);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = 1484045541 * Class301_Sub1.anInt7625;
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class413.anInt6590 * 1464638883;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (class105 == pb.aClass105_8819) {
		int i_15_ = Class10.anInt129 * 1168366243;
		int[] is = Class10.anIntArray135;
		for (int i_16_ = 0; i_16_ < i_15_; i_16_++) {
		    Player class365_sub1_sub1_sub2_sub2 = (pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[is[i_16_]]);
		    if (class365_sub1_sub1_sub2_sub2 != null)
			class365_sub1_sub1_sub2_sub2.method4442(i_13_, i_14_, bool, 1554634008);
		}
		for (int i_17_ = 0; i_17_ < pb.anInt8703 * -1230451913; i_17_++) {
		    int i_18_ = pb.anIntArray8699[i_17_];
		    Class298_Sub29 class298_sub29 = ((Class298_Sub29) pb.aClass437_8696.get((long) i_18_));
	...
	try {
	    ...
	    int i_19_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]);
	    int i_20_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 1]);
	...
	try {
		...
		if (2 == -431456739 * ((Class298_Sub1) class298_sub1).anInt7157)
		    interface3 = ((Interface3) (class331.method4035((2108312995 * ((Class298_Sub1) class298_sub1).anInt7151), class298_sub1.anInt7150 * 634196087, -2146829167 * class298_sub1.anInt7155, pb.anInterface17_8960, -2076271452)));
