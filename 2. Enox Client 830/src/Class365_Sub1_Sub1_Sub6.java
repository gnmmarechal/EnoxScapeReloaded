...
public class Class365_Sub1_Sub1_Sub6 extends Class365_Sub1_Sub1 implements Interface3 {
    Model aClass387_9879;
    byte aByte9880;
    Shadow aClass_na9881;
	...
	if (null == ((Class365_Sub1_Sub1_Sub6) this).aClass_na9881 && ((Class365_Sub1_Sub1_Sub6) this).aBoolean9887) {
	    Tuple class454 = method4492(class_ra, 262144, true, -1968877061);
    ...
    Model method4491(Toolkit class_ra, int i, int i_0_) {
	try {
	    ...
	    Tuple class454 = method4492(class_ra, i, false, -1828314772);
	    if (class454 != null)
	...
	Shadow class_na;
	if (null == ((Class365_Sub1_Sub1_Sub6) this).aClass_na9881 && ((Class365_Sub1_Sub1_Sub6) this).aBoolean9887) {
	    Tuple class454 = method4492(class_ra, 262144, true, -1624110229);
	    class_na = (Shadow) (null != class454 ? class454.second : null);
	} else {
	    class_na = ((Class365_Sub1_Sub1_Sub6) this).aClass_na9881;
	    ((Class365_Sub1_Sub1_Sub6) this).aClass_na9881 = null;
	}
    ...
    boolean method4350(Toolkit class_ra, int i, int i_1_, byte i_2_) {
	try {
	    Model class387 = method4491(class_ra, 131072, -114494856);
	    if (null != class387) {
    ...
    void method4355(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_3_, int i_4_, boolean bool, int i_5_) {
	try {
	...
	Shadow class_na;
	if (null == ((Class365_Sub1_Sub1_Sub6) this).aClass_na9881 && ((Class365_Sub1_Sub1_Sub6) this).aBoolean9887) {
	    Tuple class454 = method4492(class_ra, 262144, true, -1865263954);
	    class_na = (Shadow) (class454 != null ? class454.second : null);
	} else {
	    class_na = ((Class365_Sub1_Sub1_Sub6) this).aClass_na9881;
	    ((Class365_Sub1_Sub1_Sub6) this).aClass_na9881 = null;
	...
	Shadow class_na;
	if (null == ((Class365_Sub1_Sub1_Sub6) this).aClass_na9881 && ((Class365_Sub1_Sub1_Sub6) this).aBoolean9887) {
	    Tuple class454 = method4492(class_ra, 262144, true, -1678242522);
	    class_na = (Shadow) (class454 != null ? class454.second : null);
	} else {
	    class_na = ((Class365_Sub1_Sub1_Sub6) this).aClass_na9881;
	    ((Class365_Sub1_Sub1_Sub6) this).aClass_na9881 = null;
    ...
    public Class365_Sub1_Sub1_Sub6(Class331 class331, Toolkit class_ra, Class433 class433, ObjectDefinitions class432, int i, int i_7_, int i_8_, int i_9_, int i_10_, boolean bool, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_, int i_16_, boolean bool_17_) {
	super(class331, i, i_7_, i_8_, i_9_, i_10_, i_11_, i_12_, i_13_, i_14_, 512737201 * class432.holdsItemPiles == 1, Class79.method848(i_15_, i_16_, (byte) 27));
	((Class365_Sub1_Sub1_Sub6) this).aClass433_9884 = class433;
	((Class365_Sub1_Sub1_Sub6) this).anInt9883 = class432.objectId * 1514496897;
	aByte7724 = (byte) i_7_;
	...
	if (class432.aBoolean5441)
	    i_18_ |= 0x80000;
	Tuple class454 = method4492(class_ra, i_18_, ((Class365_Sub1_Sub1_Sub6) this).aBoolean9887, -1835687018);
	if (null != class454) {
	    ((Class365_Sub1_Sub1_Sub6) this).aClass387_9879 = (Model) class454.first;
	    ((Class365_Sub1_Sub1_Sub6) this).aClass_na9881 = (Shadow) class454.second;
		...
		if (class432.aBoolean5441) {
		    Class287 class287 = pb.aClass283_8716.method2632(-1997873817);
    ...
    Tuple method4492(Toolkit class_ra, int i, boolean bool, int i_19_) {
	try {
	    ...
	    Class217 class217 = method4337().aClass217_2599;
	    return (class432.method5785(class_ra, i, ((((Class365_Sub1_Sub1_Sub6) this).aByte9880 != GameObjectType.T11.type * -1976050083) ? (int) ((Class365_Sub1_Sub1_Sub6) this).aByte9880 : GameObjectType.T10.type * -1976050083), ((GameObjectType.T11.type * -1976050083 == ((Class365_Sub1_Sub1_Sub6) this).aByte9880) ? (int) (((Class365_Sub1_Sub1_Sub6) this).aByte9885 + 4) : ((Class365_Sub1_Sub1_Sub6) this).aByte9885), class_xa, class_xa_20_, (int) class217.aFloat2451, (int) class217.aFloat2455, (int) class217.aFloat2454, bool, null, -920698887));
	}
	catch (RuntimeException runtimeexception) {
    ...
    boolean method4372(Toolkit class_ra, int i, int i_21_) {
	Model class387 = method4491(class_ra, 131072, -259800971);
	if (null != class387) {
	    Class222 class222 = method4347();
    ...
    boolean method4385(Toolkit class_ra, int i, int i_22_) {
	Model class387 = method4491(class_ra, 131072, 547557370);
	if (null != class387) {
	    Class222 class222 = method4347();
    ...
    boolean method4352(Toolkit class_ra, int i, int i_23_) {
	Model class387 = method4491(class_ra, 131072, -943107376);
	if (null != class387) {
	    Class222 class222 = method4347();
    ...
    void method4375(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_24_, int i_25_, boolean bool) {
	if (class365_sub1 instanceof Class365_Sub1_Sub5_Sub1) {
	    Class365_Sub1_Sub5_Sub1 class365_sub1_sub5_sub1 = (Class365_Sub1_Sub5_Sub1) class365_sub1;
	    if (null != ((Class365_Sub1_Sub1_Sub6) this).aClass387_9879 && null != (((Class365_Sub1_Sub5_Sub1) class365_sub1_sub5_sub1).aClass387_9893))
    ...
    void method4388(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_27_, int i_28_, boolean bool) {
	if (class365_sub1 instanceof Class365_Sub1_Sub5_Sub1) {
	    Class365_Sub1_Sub5_Sub1 class365_sub1_sub5_sub1 = (Class365_Sub1_Sub5_Sub1) class365_sub1;
	    if (null != ((Class365_Sub1_Sub1_Sub6) this).aClass387_9879 && null != (((Class365_Sub1_Sub5_Sub1) class365_sub1_sub5_sub1).aClass387_9893))
	...
	try {
	    ...
	    Shadow class_na;
	    if (null == ((Class365_Sub1_Sub1_Sub6) this).aClass_na9881 && ((Class365_Sub1_Sub1_Sub6) this).aBoolean9887) {
		Tuple class454 = method4492(class_ra, 262144, true, -2139710295);
		class_na = (Shadow) (class454 != null ? class454.second : null);
	    } else {
		class_na = ((Class365_Sub1_Sub1_Sub6) this).aClass_na9881;
		((Class365_Sub1_Sub1_Sub6) this).aClass_na9881 = null;
	...
	try {
	    ...
	    Shadow class_na;
	    if (null == ((Class365_Sub1_Sub1_Sub6) this).aClass_na9881 && ((Class365_Sub1_Sub1_Sub6) this).aBoolean9887) {
		Tuple class454 = method4492(class_ra, 262144, true, -1616676956);
		class_na = (Shadow) (null != class454 ? class454.second : null);
	    } else {
		class_na = ((Class365_Sub1_Sub1_Sub6) this).aClass_na9881;
		((Class365_Sub1_Sub1_Sub6) this).aClass_na9881 = null;
    ...
    static void method4494(Toolkit class_ra, int i) {
	try {
	    if ((Class287.myPlayer.plane != -1694437021 * Class3.anInt57) && pb.aClass283_8716.method2675(-1611682495) != null) {
