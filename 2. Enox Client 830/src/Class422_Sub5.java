...
public class Class422_Sub5 extends Class422 {
		...
		try {
			if (pb.aBoolean8835) {
				if (class105.anObjectArray1247 != null) {
					IComponentDefinition class105_2_ = Class140.method1558(Class379.anInt4099 * 1262526353,
							392084321 * pb.anInt8836, -156511736);
					if (class105_2_ != null) {
				...
				Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.ITEM_ON_ITEM,
						pb.aClass25_8711.aClass449_330, (byte) 35);
				class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(-1232467723 * class105.id, 16711935);
				...
				class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(-440872681 * class105.ihash, -1060289644);
				...
				pb.aClass25_8711.method390(class298_sub36, (byte) -64);
			}
		} catch (RuntimeException runtimeexception) {
	...
	static final void method5644(int i) {
		try {
			for (int i_3_ = Class128.aClass148_6331.method1607(true,
					-2004625733); i_3_ != -1; i_3_ = Class128.aClass148_6331.method1607(false, -1890624062)) {
				Class477.method6094(i_3_, (byte) -94);
				pb.anIntArray8874[((pb.anInt8783 += -1763975993) * -1667357449) - 1 & 0x1f] = i_3_;
			}
			for (Class298_Sub37_Sub12 class298_sub37_sub12 = Class97_Sub1
					.method1045((byte) 12); class298_sub37_sub12 != null; class298_sub37_sub12 = Class97_Sub1
							.method1045((byte) 12)) {
				int opcode = class298_sub37_sub12.getOpcode(766012260);
				long hash = class298_sub37_sub12.getHash(-391880689);
				if (1 == opcode) {
					Class374.anIntArray4078[(int) hash] = 479598359
							* ((Class298_Sub37_Sub12) class298_sub37_sub12).type;
					pb.aBoolean8736 |= Class254.aBooleanArray2790[(int) hash];
					pb.anIntArray8876[((pb.anInt8877 += 163718667) * 116700579) - 1 & 0x1f] = (int) hash;
				} else if (2 == opcode) {
					ClientScriptsExecutor.aStringArray4126[(int) hash] = (((Class298_Sub37_Sub12) class298_sub37_sub12).aString9611);
					pb.anIntArray8787[((pb.anInt8879 += -646054651) * -466597939) - 1 & 0x1f] = (int) hash;
				} else if (opcode == 3) {
					...
					if (class105.aBoolean1246 != (1 == 479598359
							* ((Class298_Sub37_Sub12) class298_sub37_sub12).type)) {
						class105.aBoolean1246 = 1 == (((Class298_Sub37_Sub12) class298_sub37_sub12).type) * 479598359;
						Tradution.method6054(class105, 130202608);
					}
				} else if (4 == opcode) {
					IComponentDefinition class105 = Class50.getIComponentDefinitions((int) hash, (byte) -20);
					int i_5_ = ((((Class298_Sub37_Sub12) class298_sub37_sub12).type) * 479598359);
					int i_6_ = ((((Class298_Sub37_Sub12) class298_sub37_sub12).value) * -1447843633);
					int i_7_ = -1074324071 * ((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9609;
					if (class105.anInt1184 * 1548853569 != i_5_ || i_6_ != class105.anInt1151 * 572201537
							|| i_7_ != 1148770405 * class105.anInt1140) {
					...
					if (class105.anInt1290 * 1347982601 != (((Class298_Sub37_Sub12) class298_sub37_sub12).type)
							* 479598359) {
						if (479598359 * ((Class298_Sub37_Sub12) class298_sub37_sub12).type != -1) {
							if (null == class105.aClass438_1152)
								class105.aClass438_1152 = new Class438_Sub1();
							class105.aClass438_1152.method5821(
									(((Class298_Sub37_Sub12) class298_sub37_sub12).type) * 479598359, -1984687950);
						} else
							class105.aClass438_1152 = null;
						class105.anInt1290 = (((Class298_Sub37_Sub12) class298_sub37_sub12).type) * 1256289055;
						Tradution.method6054(class105, -2102110719);
					}
				} else if (6 == opcode) {
					int i_8_ = ((((Class298_Sub37_Sub12) class298_sub37_sub12).type) * 479598359);
					...
					boolean bool = 1 == 479598359 * ((Class298_Sub37_Sub12) class298_sub37_sub12).type;
					...
					if ((479598359 * ((Class298_Sub37_Sub12) class298_sub37_sub12).type != class105.anInt1190 * 7329457)
							|| ((((Class298_Sub37_Sub12) class298_sub37_sub12).value)
									* -1447843633 != class105.anInt1262 * -1086526073)
							|| (-1074324071
									* ((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9609 != class105.anInt1284
											* -261021353)) {
						class105.anInt1190 = (((Class298_Sub37_Sub12) class298_sub37_sub12).type) * -161133497;
						class105.anInt1262 = (((Class298_Sub37_Sub12) class298_sub37_sub12).value) * 752254073;
						...
						if (-1232467723 * class105.id != -1) {
							if (-692202853 * class105.anInt1221 > 0)
								class105.anInt1284 = (class105.anInt1284 * 237251296 / (-692202853 * class105.anInt1221)
										* -1066050969);
							else if (class105.anInt1253 * 1769572195 > 0)
								class105.anInt1284 = (class105.anInt1284 * 237251296 / (class105.anInt1253 * 1769572195)
										* -1066050969);
						}
					...
					if (((((Class298_Sub37_Sub12) class298_sub37_sub12).type) * 479598359 != class105.id * -1232467723)
							|| (-1447843633 * ((Class298_Sub37_Sub12) class298_sub37_sub12).value != -66163287
									* class105.anInt1281)) {
						class105.id = (((Class298_Sub37_Sub12) class298_sub37_sub12).type) * 1795180635;
						class105.anInt1281 = (((Class298_Sub37_Sub12) class298_sub37_sub12).value) * 1181892023;
						Tradution.method6054(class105, 748648909);
					}
				} else if (opcode == 10) {
					IComponentDefinition class105 = Class50.getIComponentDefinitions((int) hash, (byte) 88);
					if ((-407676483 * class105.anInt1297 != (((Class298_Sub37_Sub12) class298_sub37_sub12).type)
							* 479598359)
							|| ((((Class298_Sub37_Sub12) class298_sub37_sub12).value) * -1447843633 != -1523987341
									* class105.anInt1248)
							|| (1004185785 * class105.anInt1192 != -1074324071
									* (((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9609))) {
						class105.anInt1297 = 1482071907 * ((Class298_Sub37_Sub12) class298_sub37_sub12).type;
						class105.anInt1248 = -2128996555 * ((Class298_Sub37_Sub12) class298_sub37_sub12).value;
					...
					class105.anInt1143 = ((class105.anInt1286 = 1890691465
							* ((Class298_Sub37_Sub12) class298_sub37_sub12).type) * -1672688609);
					class105.aByte1147 = (byte) 0;
					class105.anInt1155 = (class105.anInt1159 = (((Class298_Sub37_Sub12) class298_sub37_sub12).value)
							* -1822519589) * 705123139;
					Tradution.method6054(class105, -429816482);
				} else if (opcode == 12) {
					IComponentDefinition class105 = Class50.getIComponentDefinitions((int) hash, (byte) 43);
					int i_13_ = 479598359 * ((Class298_Sub37_Sub12) class298_sub37_sub12).type;
					...
					class105.spriteId = 947110461 * ((Class298_Sub37_Sub12) class298_sub37_sub12).type;
				} else if (15 == opcode) {
					Class3.aBoolean63 = true;
					Class3.anInt62 = (((Class298_Sub37_Sub12) class298_sub37_sub12).type) * 20118889;
					Class3.anInt54 = (((Class298_Sub37_Sub12) class298_sub37_sub12).value) * 1038073637;
				} else if (opcode == 16) {
					IComponentDefinition class105 = Class50.getIComponentDefinitions((int) hash, (byte) -2);
					class105.anInt1210 = 861383641 * ((Class298_Sub37_Sub12) class298_sub37_sub12).type;
				} else if (opcode == 20) {
					IComponentDefinition class105 = Class50.getIComponentDefinitions((int) hash, (byte) -1);
					class105.aBoolean1211 = 1 == (((Class298_Sub37_Sub12) class298_sub37_sub12).type) * 479598359;
				} else if (21 == opcode) {
					IComponentDefinition class105 = Class50.getIComponentDefinitions((int) hash, (byte) -52);
					class105.aBoolean1183 = 1 == 479598359 * ((Class298_Sub37_Sub12) class298_sub37_sub12).type;
				} else if (opcode == 17) {
					IComponentDefinition class105 = Class50.getIComponentDefinitions((int) hash, (byte) 62);
					class105.anInt1289 = -696165999 * ((Class298_Sub37_Sub12) class298_sub37_sub12).type;
				} else if (opcode == 18) {
					IComponentDefinition class105 = Class50.getIComponentDefinitions((int) hash, (byte) 3);
					int i_14_ = (int) (hash >> 32);
					class105.method1126(i_14_,
							(short) (479598359 * (((Class298_Sub37_Sub12) class298_sub37_sub12).type)),
							(short) (-1447843633 * (((Class298_Sub37_Sub12) class298_sub37_sub12).value)), -1799363747);
				} else if (19 == opcode) {
					IComponentDefinition class105 = Class50.getIComponentDefinitions((int) hash, (byte) -87);
					int i_15_ = (int) (hash >> 32);
					class105.method1120(i_15_,
							(short) ((((Class298_Sub37_Sub12) class298_sub37_sub12).type) * 479598359),
							(short) (-1447843633 * (((Class298_Sub37_Sub12) class298_sub37_sub12).value)), 571287910);
				}
			}
		} catch (RuntimeException runtimeexception) {
			/*
