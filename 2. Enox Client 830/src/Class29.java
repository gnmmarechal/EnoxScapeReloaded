...
public class Class29 {
    int anInt365;
    GLToolkit aClass_ra_Sub2_366;
    static int[] anIntArray367 = new int[2];
    
    @Override
    public void finalize() throws Throwable {
	aClass_ra_Sub2_366.deleteShad((long)anInt365);
	super.finalize();
    }

    static Class29 method406(GLToolkit class_ra_sub2, Class48[] class48s) {
    ...
    Class29(GLToolkit class_ra_sub2, int i, Class48[] class48s) {
