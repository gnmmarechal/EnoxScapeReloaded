...
public class Class197 {
	...
	try {
		...
		if (((Class197) this).idx32_34.fileLoaded(i_2_, -457216440))
		    i_0_++;
		if (((Class197) this).aClass243_1988.fileLoaded(i_2_, -457216440))
		    i_0_++;
	    }
	    return i_0_;
	}
	...
	try {
	    Tuple class454 = method1885(interface10, i, true, true, -160012913);
	    if (null == class454)
		return null;
	    return (Class505) class454.second;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		byte[] is = ((Class197) this).idx32_34.getTextureData(i_6_, (byte) 82);
		Object object = interface10.method131(is, class505, true, -2012626904);
		((Class197) this).aMap1990.put(Integer.valueOf(i_5_), new Tuple(object, class505));
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Tuple class454 = method1885(interface10, i, bool, bool_7_, 229227815);
	    if (class454 == null)
		return null;
	    return class454.first;
	}
	catch (RuntimeException runtimeexception) {
    ...
    Tuple method1885(Interface10 interface10, int i, boolean bool, boolean bool_9_, int i_10_) {
	try {
	    if (-1 == i)
		return null;
	    if (((Class197) this).anIntArray1991 != null) {
		for (int i_11_ = 0; i_11_ < ((Class197) this).anIntArray1991.length; i_11_++) {
			...
			return (Tuple) ((Class197) this).aMap1990.get(Integer.valueOf(i_11_));
		}
	    }
	    Tuple class454 = ((Tuple) ((Class197) this).aClass348_1989.get((long) (i << 1 | (bool_9_ ? 1 : 0))));
	    if (null != class454) {
		if (bool && class454.second == null) {
		    Class505 class505 = Class255.method2439(((Class197) this).aClass243_1988, i, -221293891);
		    if (null == class505)
			return null;
		    class454.second = class505;
		}
		return class454;
	    }
	    byte[] is = ((Class197) this).idx32_34.getTextureData(i, (byte) 54);
	    if (null == is)
		return null;
		...
		return null;
	    if (bool)
		class454 = new Tuple(interface10.method131(is, class505, bool_9_, -1761009560), class505);
	    else
		class454 = new Tuple(interface10.method131(is, class505, bool_9_, -2090037397), null);
	...
	((Class197) this).idx32_34 = class243;
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = -1086526073 * class105.anInt1262;
	}
	catch (RuntimeException runtimeexception) {
