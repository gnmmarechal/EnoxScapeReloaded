...
public abstract class Class264 {
    ...
    public int method2475(String string, int i, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, Sprite[] class57s, int[] is, Class_ta class_ta, int i_12_, int i_13_, int i_14_) {
	try {
    ...
    public int method2476(String string, int i, int i_15_, int i_16_, int i_17_, int i_18_, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_, Sprite[] class57s, int[] is, Class_ta class_ta, int i_24_, int i_25_, int i_26_) {
	try {
	    if (null == string)
		return 0;
    ...
    public int method2480(String string, int i, int i_55_, int i_56_, int i_57_, Random random, int i_58_, Sprite[] class57s, int[] is, int i_59_) {
	try {
	    if (null == string)
		return 0;
	...
	try {
		...
		if (string.startsWith("col="))
		    anInt2828 = (-882366071 * anInt2828 & ~0xffffff | (GraphicDefinition.method4924(string.substring(4), 16, (byte) -57) & 0xffffff)) * -1158210375;
		...
		if (string.startsWith("argb="))
		    anInt2828 = GraphicDefinition.method4924(string.substring(5), 16, (byte) 61) * -1158210375;
		else if (string.equals("/argb"))
		    anInt2828 = anInt2826 * -134884105;
		else if (string.startsWith("str="))
		    anInt2830 = (anInt2828 * -882366071 & ~0xffffff | GraphicDefinition.method4924(string.substring(4), 16, (byte) -24)) * 2103918561;
		else if (string.equals("str"))
		    anInt2830 = (anInt2828 * -882366071 & ~0xffffff | 0x800000) * 2103918561;
		else if (string.equals("/str"))
		    anInt2830 = -2103918561;
		else if (string.startsWith("u="))
		    anInt2837 = (anInt2828 * -882366071 & ~0xffffff | GraphicDefinition.method4924(string.substring(2), 16, (byte) -57)) * -1869530301;
		    ...
		    anInt2835 = (anInt2828 * -882366071 & ~0xffffff | GraphicDefinition.method4924(string.substring(5), 16, (byte) 67)) * -1352863677;
    ...
    void method2484(String string, int i, int i_70_, Sprite[] class57s, int[] is, Class_ta class_ta, int i_71_, int i_72_, int i_73_) {
	try {
    ...
    public int method2485(String string, int i, int i_82_, int i_83_, int i_84_, int i_85_, int i_86_, int i_87_, int i_88_, Random random, int i_89_, int[] is, Sprite[] class57s, int[] is_90_, int i_91_) {
	try {
	    if (null == string)
		return 0;
    ...
    Class264(Toolkit class_ra, Class505 class505) {
    ...
    void method2487(String string, int i, int i_108_, Sprite[] class57s, int[] is, int[] is_109_, int[] is_110_, int i_111_) {
	try {
		...
		if (c == 60)
			...
			if (string_117_.equals("lt"))
				...
				try {
				    ...
				    Sprite class57 = class57s[i_120_];
	...
	try {
		...
		EmitterConfig.method957(2087182163);
	...
	try {
	    ...
	    int i_141_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
	    int i_142_ = (((Class403) class403).anIntArray5244[1 + 681479919 * ((Class403) class403).anInt5239]);
	    Class390 class390;
	    if (((Class403) class403).aBoolean5261)
		class390 = ((Class403) class403).aClass390_5247;
	    else
		class390 = ((Class403) class403).aClass390_5246;
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class390.method4866((((Class403) class403).aClass365_Sub1_Sub1_Sub2_5242.aClass119_10131), i_141_, i_142_, 867608709) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    int i_143_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]);
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (((Class403) class403).myClanChannel.members[i_143_].aByte1683);
	}
	catch (RuntimeException runtimeexception) {
