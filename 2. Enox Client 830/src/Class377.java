...
public class Class377 {
    ...
    public static JS5 idx12;

    public Class377(JS5 class243) {
	byte[] is = class243.getTextureData((Class380.aClass380_4100.anInt4108 * -363169051), (byte) 11);
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub10_7548.method5660(-575221319) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    class105.aBoolean1182 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]) == 1;
	...
	try {
	    ...
	    if (2 == 1131012101 * pb.anInt8942 && i_5_ >= 0 && i_5_ < pb.anInt8941 * -1054937867)
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = pb.aBooleanArray8722[i_5_] ? 1 : 0;
	    else
	...
	try {
	    ...
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = ((Class403) class403).aClass162_5252.bannedMembersDisplayNames[i_6_];
	}
	catch (RuntimeException runtimeexception) {
