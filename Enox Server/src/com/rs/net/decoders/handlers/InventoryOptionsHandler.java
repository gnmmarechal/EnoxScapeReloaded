...
public class InventoryOptionsHandler {
	...
	public static void handleItemOption1(final Player player, final int slotId,
		...
		if (itemId == 15073) {
			if (player.isPker) {
				player.getPackets().sendGameMessage("Pkers cannot use the Assassin's Skill.");
				return;
			}
		...
		if (itemId == 6199) {
			Random r = new Random();
			int RandomItems[] = {10548, 10551,4151,6655,6656,6654,10055, 10057, 10059, 10061, 10063, 10065, 10067,4012,4012,4012,4012,4012,4012,4012,4012};
			//int[] RandomItems = {6654, 6655, 6656, 10053, 10055, 10057, 10059, 10061, 10063, 10065, 10067, 6180, 6181, 6182, 6188, 6184, 6185, 6186, 6187, 3057, 3058, 3059, 3060, 3061, 8950, 2997, }; //Other ids go in there as well
			player.getInventory().deleteItem(6199, 1);
			player.getInventory().addItem(RandomItems[r.nextInt(RandomItems.length)], 1);
			//World.sendWorldMessage(Utils.formatPlayerNameForDisplay(player.getUsername()) + " <img=3><shad=7401DF> has just opened a godwars box</shad> <img=3>", false);
		...
		int randomnesttt = Utils.getRandom(34);
		int[] randomnestt = {14589, 5100,5099,5098,
				5097,5096, 5321, 5323, 5320, 
				5322, 5324, 5319, 5318, 5291, 
				5292, 5293, 5294, 5295, 5296, 
				5297, 5298, 14870, 5299, 5300, 
				5301, 5302, 5303, 5304, 21621
				, 5374, 5373, 5372, 5371, 5370};
		int randomnestID = randomnestt[randomnesttt];
		if (itemId == 5070) {
			//player.sendMessage("Test");
			player.getInventory().deleteItem(5070, 1);
			player.getInventory().addItem(randomnestID, 3);
		}
		...
		// mining \\
			...
			player.getPackets().sendGameMessage("You place a portable forge infront of you.");
			WorldTasksManager.schedule(new WorldTask() {
			    int ticks;
			    @Override
			    public void run() {
				ticks++;
			if(ticks == 1){
				player.getInventory().deleteItem(31041, 1);
				final WorldObject divinerune = new WorldObject(89767,10, 0, player.getX() + 1, player.getY(), player.getPlane()); // object spawning
				player.faceObject(divinerune); // forces player to face where he is putting the object
				World.spawnTemporaryObject(divinerune, 60000); // dont touch
				stop();
			}
			    return;
			    }  
	...
	public static void handleItemOnItem(final Player player, InputStream stream) {
		...
		if (interfaceId == Inventory.INVENTORY_INTERFACE
			...
			if((itemUsed.getId() == 20772 && usedWith.getId() == 20771) || (itemUsed.getId() == 20771 && usedWith.getId() == 20772)) {
				if (player.getInventory().containsItem(20772, 1) && player.getInventory().containsItem(20771, 1)) {
				player.getInventory().deleteItem(20772, 1);
				player.getInventory().deleteItem(20771, 1);
				player.getInventory().addItem(32153, 1);
				player.sendMessage("You succesfully attached the hood to your cape");
				} else {
				player.sendMessage("You need both parts to make this into a hooded cape.");
				}
			        return;
			}
			if((itemUsed.getId() == 20770 && usedWith.getId() == 20769) || (itemUsed.getId() == 20769 && usedWith.getId() == 20770)) {
				if (player.getInventory().containsItem(20770, 1) && player.getInventory().containsItem(20769, 1)) {
				player.getInventory().deleteItem(20770, 1);
				player.getInventory().deleteItem(20769, 1);
				player.getInventory().addItem(32152, 1);
				player.sendMessage("You succesfully attach the hood to your cape");
				} else {
				player.sendMessage("You need both parts to make this into a hooded cape.");
				}
			        return;
			}
			if((itemUsed.getId() == 31721 && usedWith.getId() == 31724) || (itemUsed.getId() == 31724 && usedWith.getId() == 31721)) {
				if (player.getInventory().containsItem(31721, 1) && player.getInventory().containsItem(31724, 1)) {
				player.getInventory().deleteItem(31721, 1);
				player.getInventory().deleteItem(31724, 1);
				player.getInventory().addItem(31733, 1);
				player.sendMessage("You succesfully attach the web to the spider leg");
				} else {
				player.sendMessage("You need both parts to make this weapon.");
				}
			        return;
			}
			if((itemUsed.getId() == 31721 && usedWith.getId() == 31723) || (itemUsed.getId() == 31723 && usedWith.getId() == 31721)) {
				if (player.getInventory().containsItem(31721, 1) && player.getInventory().containsItem(31723, 1)) {
				player.getInventory().deleteItem(31721, 1);
				player.getInventory().deleteItem(31723, 1);
				player.getInventory().addItem(31729, 1);
				player.sendMessage("You succesfully attach the eye to the spider leg");
				} else {
				player.sendMessage("You need both parts to make this weapon.");
				}
			        return;
			}
			if((itemUsed.getId() == 31721 && usedWith.getId() == 31722) || (itemUsed.getId() == 31722 && usedWith.getId() == 31721)) {
				if (player.getInventory().containsItem(31721, 1) && player.getInventory().containsItem(31722, 1)) {
				player.getInventory().deleteItem(31721, 1);
				player.getInventory().deleteItem(31722, 1);
				player.getInventory().addItem(31725, 1);
				player.sendMessage("You succesfully attach the fang to the spider leg");
				} else {
				player.sendMessage("You need both parts to make this weapon.");
				}
			        return;
			}
			if((itemUsed.getId() == 20768 && usedWith.getId() == 20767) || (itemUsed.getId() == 20767 && usedWith.getId() == 20768)) {
				if (player.getInventory().containsItem(20768, 1) && player.getInventory().containsItem(20767, 1)) {
			...
			/**
			 * Dye armor ( shadow , third age, barrows )
			 */
			//if (itemUsed.getId() == 33296 && usedWith.getId() == 31725){ // shadow dye noxious staff
				if (usedWith.getId() == 33296 || usedWith.getId() == 31725) {
				//player.sendMessage("test");
				if (player.getInventory().containsItem(33296, 1) && player.getInventory().containsItem(31725, 1)) {
					player.getInventory().deleteItem(33296, 1);
					player.getInventory().deleteItem(31725, 1);
					player.getInventory().addItem(33396, 1);
					player.sendMessage("You succesfully dye your your noxious staff.");
				} 
			}
			/**
			 * Flask Making
            ...
            if (itemUsed.getId() == 11690 || usedWith.getId() == 13746) {
                if (player.getInventory().containsItem(11690, 1)
                        ...
                        player.getInventory().addItem(29961, 1);
            ...
            if (itemUsed.getId() == 11690 || usedWith.getId() == 13748) {
                if (player.getInventory().containsItem(11690, 1)
                        ...
                        player.getInventory().addItem(29960, 1);
            ...
            if (itemUsed.getId() == 11690 || usedWith.getId() == 13752) {
                if (player.getInventory().containsItem(11690, 1)
                        ...
                        player.getInventory().addItem(29958, 1);
