...
public class Class422_Sub10 extends Class422 {
    ...
    static void method5662(Toolkit class_ra, int i, int i_2_, IComponentDefinition class105, Class_ta class_ta, int i_3_, int i_4_, int i_5_) {
	try {
	    for (int i_6_ = 0; i_6_ < pb.anInt8703 * -1230451913; i_6_++) {
		Class298_Sub29 class298_sub29 = ((Class298_Sub29) pb.aClass437_8696.get((long) pb.anIntArray8699[i_6_]));
		if (class298_sub29 != null) {
			...
			if (null != class503 && class503.aBoolean6148 && class503.aBoolean6163) {
				...
				Class443.method5883(class105, class_ta, i_3_, i_4_, i_7_, i_8_, (SubIncommingPacket.radar_mark_icons[1]), (byte) -17);
			}
		    }
		}
	    }
    ...
    public static Sprite method5663(JS5 class243, int i, byte i_9_) {
	try {
	    Sprite class57 = (Sprite) Class229.aClass348_6452.get((long) i);
	    if (null == class57) {
		if (Class230.aBoolean2567)
		    class57 = (Class373.activeToolkit.method5125(IndexedImage.method979(class243, i), true));
		else
		    class57 = Class223.method2081(class243.getTextureData(i, (byte) 15), -161656424);
