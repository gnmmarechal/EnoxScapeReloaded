...
public class Class140 implements Runnable {
	...
	try {
		...
		BufferedReader bufferedreader = (new BufferedReader(new InputStreamReader(new DataInputStream(new URL(new StringBuilder().append("http://").append(Class474.aClass471_5976.address).append(":").append(i).append("/news.ws?game=").append(-937307905 * (pb.gametype.gameType)).toString()).openStream()))));
	...
	try {
		...
		if (class503.aBoolean6163) {
		    ...
		    if (pb.aBoolean8835 && !bool) {
			Class497 class497 = (831522399 * PlayerLookDefinitions.anInt1508 != -1 ? (Class92.aClass504_905.method6251(831522399 * PlayerLookDefinitions.anInt1508, 1875400558)) : null);
			if ((Class298.anInt3192 * -112110875 & 0x2) != 0 && (null == class497 || (class503.method6239((PlayerLookDefinitions.anInt1508 * 831522399), (-388931549 * class497.anInt6100), (byte) 47) != class497.anInt6100 * -388931549)))
			...
			if (null != strings) {
				...
				if (strings[i_4_] != null && (0 == class503.aByte6158 || (!(strings[i_4_].equalsIgnoreCase(Tradution.aClass470_5906.method6049(Class321.aClass429_3357, -875414210))) && !(strings[i_4_].equalsIgnoreCase(Tradution.aClass470_5905.method6049(Class321.aClass429_3357, -875414210)))))) {
				    int i_5_ = 0;
				    int i_6_ = 1395924385 * pb.anInt8690;
				    if (i_4_ == 0)
					i_5_ = 9;
				    if (i_4_ == 1)
					i_5_ = 10;
				...
				for (int i_7_ = 0; i_7_ < strings.length; i_7_++) {
					...
					if ((1817570317 * (class365_sub1_sub1_sub2_sub1.anInt10189)) > (Class287.myPlayer.anInt10206) * 696798311)
					    i_8_ = (short) 2000;
					short i_9_ = 0;
					int i_10_ = 1395924385 * pb.anInt8690;
					if (0 == i_7_)
					    i_9_ = (short) 9;
					if (1 == i_7_)
					    i_9_ = (short) 10;
