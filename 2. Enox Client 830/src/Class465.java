...
public class Class465 implements Interface18 {
	...
	try {
		...
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = class350.anIntArray3712[i_10_];
	    } else
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = -809747019 * class350.anInt3711;
	}
	catch (RuntimeException runtimeexception) {
