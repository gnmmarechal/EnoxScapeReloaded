...
public class Player extends Entity {
	...
	public final void sendAppearence(RsByteBuffer stream, byte i) {
		try {
			 ...
			 * 1806357379 * client.playerRights >= 2) hidden = false;
			 */
			int i_5_ = -1;
			team = 0;
			int[] is = new int[EquipmentDefaults.aClass405_6892.anIntArray5267.length];
			Class464[] class464s = (new Class464[EquipmentDefaults.aClass405_6892.anIntArray5267.length]);
			ItemDefinitions[] class468s = (new ItemDefinitions[EquipmentDefaults.aClass405_6892.anIntArray5267.length]);
			for (int i_6_ = 0; i_6_ < EquipmentDefaults.aClass405_6892.anIntArray5267.length; i_6_++) {
				if (1 != EquipmentDefaults.aClass405_6892.anIntArray5267[i_6_]) {
					...
					if (0 == i_7_)
						...
						if (i_6_ == 0 && 65535 == firstShort) {
							...
							team = (stream.readUnsignedByte() * 1076333291);
							break;
						}
						if (firstShort >= 16384) {
							firstShort -= 16384;
			...
			if (-1 == i_5_) {
				...
				int i_12_ = 0;
				for (int i_13_ = 0; (i_13_ < EquipmentDefaults.aClass405_6892.anIntArray5267.length); i_13_++) {
					if (0 != (EquipmentDefaults.aClass405_6892.anIntArray5267[i_13_])) {
						if (i != 3)
							return;
					}
					else {
			...
			aClass366_10209.method4546(method4432(-1515602233), is, class464s, is_14_, 1 == gender, i_5_, 775068819);
			if (i_23_ != i_5_) {
			...
			if (pb.playerIndex * -442628795 == anInt10064 * 1888274983 && null != is_24_) {
		...
		try {
			...
			if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub18_7561.method5693(-591782935) == 1) {
				...
				if (class350.aBoolean3756 && (164936249 * aClass366_10209.anInt3974 == -1 || (Class15.aClass507_224.method6269(aClass366_10209.anInt3974 * 164936249, -465726953).aBoolean6165))) {
					...
					Model class387 = (Class283.method2678(class_ra, i_27_, -155466425 * (((Player) this).anInt10097), -197572281 * (((Player) this).anInt10073), -104151209 * (((Player) this).anInt10074), 1, aClass387Array10082[0], 0, 0, 160, 240, class438_29_ != null ? class438_29_ : class438, 1812843484));
					if (null != class387) {
			...
			if (this == Class287.myPlayer) {
				for (int i_30_ = pb.aClass19Array8869.length - 1; i_30_ >= 0; i_30_--) {
					Class19 class19 = pb.aClass19Array8869[i_30_];
					if (null != class19 && class19.anInt263 * 408071539 != -1) {
						if (958933333 * class19.anInt266 == 1) {
							Class298_Sub29 class298_sub29 = ((Class298_Sub29) (pb.aClass437_8696.get((long) (-841622081 * class19.anInt256))));
						...
						if (10 == class19.anInt266 * 958933333 && -841622081 * class19.anInt256 >= 0 && (-841622081 * class19.anInt256 < (pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805).length)) {
							Player class365_sub1_sub1_sub2_sub2_35_ = (pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[class19.anInt256 * -841622081]);
			...
			anInt10066 = pb.anInt8777 * -815465993;
			return class335;
		}
		catch (RuntimeException runtimeexception) {
	...
	void method4468(Toolkit class_ra, Class222 class222, Model class387, long l, long l_40_, int i, long l_41_) {
		try {
			...
			if (l_42_ >= 262144L && l_42_ <= l_41_) {
				...
				Model class387_44_ = (Class219.method2044(class_ra, i_43_, (((Player) this).anInt10097 * -155466425), (-197572281 * ((Player) this).anInt10073), (((Player) this).anInt10074 * -104151209), i, -2134746538));
	...
	boolean method4469(Toolkit class_ra, int i, byte i_45_) {
		try {
			int i_46_ = i;
			...
			boolean bool = (0 != aByte10130 && 443738891 * pb.ticketCycle >= anInt10105 * 1920148979 && 443738891 * pb.ticketCycle < 1953154657 * anInt10106);
			if (bool)
				i |= 0x80000;
			Model class387 = (aClass387Array10082[0] = (aClass366_10209.method4545(class_ra, i, Class94.aClass349_913, Class212.aClass144_2433, Class15.aClass507_224, Class298_Sub32_Sub14.aClass477_9400, Class501.aClass395_6122, Class128.aClass148_6331, class438, class438_47_, aClass438_Sub2_Sub1Array10112, anIntArray10085, i_50_, true, EquipmentDefaults.aClass405_6892, 1284357526)));
			...
			if (Class242.aClass401_2708 != Class401.aClass401_6557 && i_51_ < 50) {
				int i_52_;
				for (i_52_ = 50 - i_51_; i_52_ > -837572863 * pb.anInt8677; pb.anInt8677 += 836589825)
					Class98.aByteArrayArray949[pb.anInt8677 * -837572863] = new byte[102400];
				while (i_52_ < -837572863 * pb.anInt8677) {
					pb.anInt8677 -= 836589825;
					Class98.aByteArrayArray949[-837572863 * pb.anInt8677] = null;
				}
			}
	...
	public final void method4471(int i, int i_53_, byte i_54_, int i_55_) {
		try {
			if (aClass438_10078.method5819((byte) -119) && (aClass438_10078.method5820(1546485881).walkingPrecedence * -882531177) == 1) {
			...
			for (int i_56_ = 0; i_56_ < currentGraphics.length; i_56_++) {
				if (-1 != currentGraphics[i_56_].id * -967533709) {
					GraphicDefinition class398 = (Class158_Sub1.aClass389_8568.getGraphicDefinition(-967533709 * currentGraphics[i_56_].id, -1891757366));
					if (class398.aBoolean5215 && 1505778629 * class398.animation != -1 && (Class501.aClass395_6122.getAnimationDefinition(class398.animation * 1505778629, (byte) 83).walkingPrecedence) * -882531177 == 1) {
			...
			anInt10221 = 1530078181;
			if (i < 0 || i >= pb.aClass283_8716.method2629(-1987519551) || i_53_ < 0 || i_53_ >= pb.aClass283_8716.method2630(1479162339))
				method4472(i, i_53_, -2049230528);
			else if (scenePositionXQueue[0] < 0 || (scenePositionXQueue[0] >= pb.aClass283_8716.method2629(-1906686754)) || scenePositionYQueue[0] < 0 || (scenePositionYQueue[0] >= pb.aClass283_8716.method2630(-964068282)))
	...
	public void method4472(int i, int i_57_, int i_58_) {
		try {
			...
			class217.method2006();
			if (this == Class287.myPlayer)
				pb.aClass283_8716.method2640((byte) 35).method4324(-1515011512);
			if (null != ((Player) this).aClass351_10067)
				((Player) this).aClass351_10067.method4220();
		}
		catch (RuntimeException runtimeexception) {
	...
	final void method4388(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_64_, int i_65_, boolean bool) {
	...
	final void method4355(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_68_, int i_69_, boolean bool, int i_70_) {
		try {
			throw new IllegalStateException();
		}
		catch (RuntimeException runtimeexception) {
	...
	boolean method4385(Toolkit class_ra, int i, int i_71_) {
	...
	Class335 method4370(Toolkit class_ra) {
		...
		if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub18_7561.method5693(-1650118723) == 1) {
			...
			if (class350.aBoolean3756 && (164936249 * aClass366_10209.anInt3974 == -1 || (Class15.aClass507_224.method6269(aClass366_10209.anInt3974 * 164936249, -824172978).aBoolean6165))) {
				...
				Model class387 = (Class283.method2678(class_ra, i, (-155466425 * ((Player) this).anInt10097), (-197572281 * ((Player) this).anInt10073), (-104151209 * ((Player) this).anInt10074), 1, aClass387Array10082[0], 0, 0, 160, 240, class438_76_ != null ? class438_76_ : class438, 1812843484));
				if (null != class387) {
					if (null == aClass302_Sub1Array7726 || (aClass302_Sub1Array7726.length < 1 + aClass387Array10082.length))
		...
		if (this == Class287.myPlayer) {
			for (int i_77_ = pb.aClass19Array8869.length - 1; i_77_ >= 0; i_77_--) {
				Class19 class19 = pb.aClass19Array8869[i_77_];
				if (null != class19 && class19.anInt263 * 408071539 != -1) {
					if (958933333 * class19.anInt266 == 1) {
						Class298_Sub29 class298_sub29 = ((Class298_Sub29) (pb.aClass437_8696.get((long) (-841622081 * class19.anInt256))));
						if (null != class298_sub29) {
					...
					if (10 == class19.anInt266 * 958933333 && -841622081 * class19.anInt256 >= 0 && (-841622081 * class19.anInt256 < (pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805).length)) {
						Player class365_sub1_sub1_sub2_sub2_82_ = (pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[class19.anInt256 * -841622081]);
		...
		try {
			if (null != ((Player) this).aClass62_10118) {
				if (null == ((Class62) (((Player) this).aClass62_10118)).aString608)
					return null;
				if (0 == pb.anInt8837 * -1168328513 || -1168328513 * pb.anInt8837 == 3 || (pb.anInt8837 * -1168328513 == 1 && Class494.method6192(aString10195, -1511804216)))
	...
	boolean method4352(Toolkit class_ra, int i, int i_87_) {
	...
	final void method4375(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_90_, int i_91_, boolean bool) {
		throw new IllegalStateException();
	}
	...
	boolean method4350(Toolkit class_ra, int i, int i_92_, byte i_93_) {
		try {
	...
	public Class62 method4443() {
		if (null != ((Player) this).aClass62_10118) {
			if (null == ((Class62) (((Player) this).aClass62_10118)).aString608)
				return null;
			if (0 == pb.anInt8837 * -1168328513 || -1168328513 * pb.anInt8837 == 3 || (pb.anInt8837 * -1168328513 == 1 && Class494.method6192(aString10195, -1800657283)))
				return ((Player) this).aClass62_10118;
		}
		return null;
	}
	...
	boolean method4372(Toolkit class_ra, int i, int i_97_) {
