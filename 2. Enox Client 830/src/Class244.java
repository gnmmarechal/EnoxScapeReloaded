...
public class Class244 {
	...
	try {
	    ...
	    class105.anInt1193 = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]) * 437213185;
	    class105.anInt1194 = (1266800241 * (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 1]));
	...
	try {
	    ...
	    Interface class298_sub51 = ((Interface) pb.aClass437_8841.get((long) i_14_));
	    if (null != class298_sub51 && 3 == 27137839 * class298_sub51.clipped)
		BillBoardDefinitions.method1821(class298_sub51, true, true, -113822480);
	}
	catch (RuntimeException runtimeexception) {
