...
public class NPC extends Entity {
    ...
    boolean method4454(Toolkit class_ra, int i, int i_8_) {
	try {
	    int i_9_ = i;
		...
		i |= 0x7;
	    boolean bool = (0 != aByte10130 && 443738891 * pb.ticketCycle >= anInt10105 * 1920148979 && pb.ticketCycle * 443738891 < anInt10106 * 1953154657);
	    if (bool)
		i |= 0x80000;
	    int i_13_ = aClass386_10084.method4719((byte) 0);
	    Model class387 = (aClass387Array10082[0] = aClass503_10190.method6236(class_ra, i, Class94.aClass349_913, Class128.aClass148_6331, class438, class438_10_, aClass438_Sub2_Sub1Array10112, anIntArray10085, i_13_, aClass498_10181, method4432(-1491129226), false, -679459424));
	    if (null == class387)
		return false;
	...
	try {
	    ...
	    if (aClass438_10078.method5819((byte) -128) && (aClass438_10078.method5820(1057375366).walkingPrecedence * -882531177) == 1) {
		...
		if (currentGraphics[i_18_].id * -967533709 != -1) {
		    GraphicDefinition class398 = (Class158_Sub1.aClass389_8568.getGraphicDefinition(-967533709 * currentGraphics[i_18_].id, -1708083255));
		    if (class398.aBoolean5215 && class398.animation * 1505778629 != -1 && (Class501.aClass395_6122.getAnimationDefinition(class398.animation * 1505778629, (byte) -23).walkingPrecedence) * -882531177 == 1) {
	...
	try {
	    ...
	    if (pb.aClass283_8716.method2654(1132456995).method2320(i_20_, i_21_, 1587070733))
		aByte7724++;
	    if (aClass438_10078.method5819((byte) -33) && (aClass438_10078.method5820(1592092831).walkingPrecedence * -882531177) == 1) {
		anIntArray10093 = null;
		...
		if (-1 != currentGraphics[i_24_].id * -967533709) {
		    GraphicDefinition class398 = (Class158_Sub1.aClass389_8568.getGraphicDefinition(-967533709 * currentGraphics[i_24_].id, -1738473272));
		    if (class398.aBoolean5215 && -1 != 1505778629 * class398.animation && (Class501.aClass395_6122.getAnimationDefinition(class398.animation * 1505778629, (byte) 83).walkingPrecedence) * -882531177 == 1) {
    ...
    boolean method4350(Toolkit class_ra, int i, int i_28_, byte i_29_) {
	try {
    ...
    boolean method4372(Toolkit class_ra, int i, int i_46_) {
    ...
    boolean method4385(Toolkit class_ra, int i, int i_52_) {
    ...
    final void method4355(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_59_, int i_60_, boolean bool, int i_61_) {
	try {
	    throw new IllegalStateException();
	}
	catch (RuntimeException runtimeexception) {
    ...
    final void method4375(Toolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_62_, int i_63_, boolean bool) {
	throw new IllegalStateException();
    }
    ...
    boolean method4352(Toolkit class_ra, int i, int i_65_) {
