...
public class Class322 {
	...
	try {
	    ...
	    if (pb.aString8804 != null && i_0_ < -1801543887 * Class489.anInt6071)
		((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = Class82_Sub6.aClass7Array6846[i_0_].aString96;
	    else
	...
	try {
		...
		Class443.method5884(-257444687 * pb.WINDOW_PANE_ID, -333860368);
	    for (int i = 0; i < -112139815 * pb.anInt8686; i++) {
		pb.aBooleanArray8901[i] = pb.aBooleanArray8900[i];
		pb.aBooleanArray8900[i] = false;
	    }
	    pb.anInt8832 = pb.ticketCycle * -1390800553;
	    ...
	    Class463.method6013(Class373.activeToolkit, (byte) 38);
	    int i = Class298_Sub17_Sub4.method2926(695848123);
	    if (-1 == i)
		i = pb.anInt8937 * -1808468501;
	    if (i == -1)
		i = pb.anInt8831 * 1203044105;
	    ...
	    WorldTile.method4144((Class287.myPlayer.plane), i_3_ + (int) class217.aFloat2451, (int) class217.aFloat2454 + i_3_, pb.anInt8961 * 614680345, (short) 8192);
	    pb.anInt8961 = 0;
	}
	catch (RuntimeException runtimeexception) {
