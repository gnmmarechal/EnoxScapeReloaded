...
public class Class344 {
    ...
    static Particle[] aClass302_Sub3_Sub1_Sub1Array3676;
    static int anInt3677;
    static int anInt3678 = 0;
    static ParticleSystem[] aClass351Array3679;
	...
	try {
	    ...
	    i_1_ <<= 3;
	    i_2_ <<= 3;
	    pb.aFloat8757 = (float) i;
	    pb.aFloat8949 = (float) i_1_;
	    if (Class298_Sub1.anInt7164 * -863531439 == 3) {
		pb.anInt8756 = -648269561 * i;
