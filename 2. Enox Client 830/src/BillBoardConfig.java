...
public class BillBoardConfig {
	...
	BillBoardConfig translateFace(int i) {
		try {
			return new BillBoardConfig(1834782277 * type, i, -1606786303 * priority, magnitude * 2010148771);
		}
	...
	static final void method948(Class403 class403, int i) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.COLOR_ID_PACKET, pb.aClass25_8711.aClass449_330, (byte) 54);
			class298_sub36.aClass298_Sub53_Sub2_7396.writeShort(i_13_, 16711935);
			pb.aClass25_8711.method390(class298_sub36, (byte) -99);
		}
		catch (RuntimeException runtimeexception) {
	...
	static final void method951(Class403 class403, int i) {
		try {
			IComponentDefinition class105 = (((Class403) class403).aClass365_Sub1_Sub1_Sub2_5242.aClass119_10131.method1297((((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]), (short) 13294));
