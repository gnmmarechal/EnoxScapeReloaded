...
public class Class260 {
	...
	try {
		...
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 512449113 * class343_sub1.anInt7720;
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub11_7558.method5666(-391880689) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    short i_3_ = (short) (((Class403) class403).anIntArray5244[1 + 681479919 * ((Class403) class403).anInt5239]);
	    short i_4_ = (short) (((Class403) class403).anIntArray5244[2 + 681479919 * ((Class403) class403).anInt5239]);
	    if (i_2_ >= 0 && i_2_ < 5) {
		...
		if (class105.anInt1154 * -1309843523 == -1 && !class119.aBoolean1403)
		    EmitterConfig.method958(-440872681 * class105.ihash, i_2_, (byte) 1);
	    }
	}
	catch (RuntimeException runtimeexception) {
