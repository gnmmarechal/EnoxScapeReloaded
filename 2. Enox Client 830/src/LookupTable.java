...
public class LookupTable {
	...
	try {
	    int i_1_ = (((LookupTable) this).anIntArray1368.length >> 1) - 1;
	    int i_2_ = i & i_1_;
	    for (;;) {
		int i_3_ = ((LookupTable) this).anIntArray1368[i_2_ + i_2_ + 1];
		if (i_3_ == -1)
		    return -1;
		if (i == ((LookupTable) this).anIntArray1368[i_2_ + i_2_])
		    return i_3_;
		i_2_ = i_2_ + 1 & i_1_;
	    }
	}
	...
	((LookupTable) this).anIntArray1368 = new int[i + i];
	for (int i_4_ = 0; i_4_ < i + i; i_4_++)
	    ((LookupTable) this).anIntArray1368[i_4_] = -1;
	for (int i_5_ = 0; i_5_ < is.length; i_5_++) {
	    int i_6_;
	    for (i_6_ = is[i_5_] & i - 1; ((LookupTable) this).anIntArray1368[1 + (i_6_ + i_6_)] != -1; i_6_ = i_6_ + 1 & i - 1) {
		/* empty */
	    }
	    ((LookupTable) this).anIntArray1368[i_6_ + i_6_] = is[i_5_];
	    ((LookupTable) this).anIntArray1368[1 + (i_6_ + i_6_)] = i_5_;
	}
    }
	...
	try {
	    ((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393 - 1)] = Class22.method371(-1872384633).toString();
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ParticleDefinitions.aClass243_1821 = class243;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eo.a(").append(')').toString());
	}
	...
	try {
	    ...
	    ((Class298_Sub37_Sub12) class298_sub37_sub12).type = 1274450087 * i_9_;
	}
	catch (RuntimeException runtimeexception) {
