...
public class Class469 {
	...
	if (null != ((Class469) this).aClass243_5778)
	    anInt5775 = (((Class469) this).aClass243_5778.getFileCountForArchive(1, -331738803) * -1970727647);
	if (((Class469) this).aClass243_5776 != null)
	    anInt5777 = (((Class469) this).aClass243_5776.getFileCountForArchive(1, 1090973479) * 1286548437);
    }
	...
	try {
	    Class298_Sub37_Sub14 class298_sub37_sub14 = ((Class298_Sub37_Sub14) ((Class469) this).aClass348_5779.get((long) i));
	    if (null != class298_sub37_sub14)
		return class298_sub37_sub14;
	    byte[] is;
	    if (i >= 32768)
		is = ((Class469) this).aClass243_5776.getFile(1, i & 0x7fff);
	    else
		is = ((Class469) this).aClass243_5778.getFile(1, i);
	    ...
	    ((Class469) this).aClass348_5779.put(class298_sub37_sub14, (long) i);
	    return class298_sub37_sub14;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static void method6047(Toolkit class_ra, Interface_ma interface_ma, int i, int i_5_, int i_6_, int i_7_, int i_8_) {
	try {
		...
		class_ra.method5019(i_10_ - 152, i_11_, 304, 34, pb.aColorArray8701[745003679 * pb.anInt8971].getRGB(), 0);
		class_ra.B(i_10_ - 150, i_11_ + 2, Class301_Sub1.anInt7624 * 426783931, 30, pb.aColorArray8689[745003679 * pb.anInt8971].getRGB(), 0);
		Class101.aClass264_1084.method2490(Tradution.aClass470_5938.method6049(Class321.aClass429_3357, -875414210), i_10_, i_11_ + i_9_, pb.aColorArray8691[pb.anInt8971 * 745003679].getRGB(), -1, -863370132);
	    } else {
