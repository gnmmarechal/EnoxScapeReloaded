...
public abstract class Class263 implements Interface9 {
    ...
    HybridOglToolkit aClass_ra_Sub3_Sub1_6422;
    static int anInt6423 = 32879;
    static int[] anIntArray6424 = new int[1];

    public void method123() {
	int i = ((Class263) this).aClass_ra_Sub3_Sub1_6422.method5386();
	int i_0_ = (((HybridOglToolkit) ((Class263) this).aClass_ra_Sub3_Sub1_6422).anIntArray9831[i]);
	if (i_0_ != ((Class263) this).anInt6415) {
	    ...
	    ((HybridOglToolkit) ((Class263) this).aClass_ra_Sub3_Sub1_6422).anIntArray9831[i] = ((Class263) this).anInt6415;
	}
	...
	int i = ((Class263) this).aClass_ra_Sub3_Sub1_6422.method5386();
	int i_1_ = (((HybridOglToolkit) ((Class263) this).aClass_ra_Sub3_Sub1_6422).anIntArray9831[i]);
	...
	for (;;) {
	    OpenGL.glTexImage2Di(i, i_4_, HybridOglToolkit.method5533(((Class263) this).aClass55_6419, (((Class263) this).aClass77_6420)), i_2_, i_3_, 0, 32993, ((HybridOglToolkit) ((Class263) this).aClass_ra_Sub3_Sub1_6422).anInt9841, is_8_, 0);
	    if (i_5_ <= 1)
		break;
	    int i_10_ = 0;
	    int i_11_ = 0;
	...
	for (;;) {
	    OpenGL.glTexImage2Df(i, i_27_, HybridOglToolkit.method5533(((Class263) this).aClass55_6419, (((Class263) this).aClass77_6420)), i_24_, i_25_, 0, HybridOglToolkit.method5532(((Class263) this).aClass55_6419), 5126, fs_31_, 0);
	    if (i_28_ <= 1)
		break;
	...
	int i = ((Class263) this).aClass_ra_Sub3_Sub1_6422.method5386();
	int i_41_ = (((HybridOglToolkit) ((Class263) this).aClass_ra_Sub3_Sub1_6422).anIntArray9831[i]);
	...
	int i = ((Class263) this).aClass_ra_Sub3_Sub1_6422.method5386();
	int i_42_ = (((HybridOglToolkit) ((Class263) this).aClass_ra_Sub3_Sub1_6422).anIntArray9831[i]);
	...
	for (;;) {
	    OpenGL.glTexImage2Dub(i, i_46_, HybridOglToolkit.method5533(((Class263) this).aClass55_6419, (((Class263) this).aClass77_6420)), i_43_, i_44_, 0, HybridOglToolkit.method5532(((Class263) this).aClass55_6419), 5121, is_50_, 0);
	    if (i_47_ <= 1)
		break;
    ...
    Class263(HybridOglToolkit class_ra_sub3_sub1, int i, Class55 class55, Class77 class77, int i_61_, boolean bool) {
