...
public class Class298_Sub40_Sub1 extends Class298_Sub40 {
	...
	class162.addMember(((Class298_Sub40_Sub1) this).aString9689, (31082448682122173L * ((Class298_Sub40_Sub1) this).aLong9688), 0, -783761378);
    }
	...
	try {
	    ...
	    ((Class298_Sub40_Sub1) this).aString9689 = class298_sub53.readJNullString(-517364695);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class282.method2624(-333964684).getType(694163818);
	}
	catch (RuntimeException runtimeexception) {
