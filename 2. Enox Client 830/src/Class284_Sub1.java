...
public class Class284_Sub1 extends Class284 {
	...
	try {
	    ...
	    if (BillBoardDefinitions.method1818(i, -2116869304) != 1)
		method2684(Class416.nextPowerOfTwo(i, (byte) 16), 1699827460);
	    else {
		((Class284_Sub1) this).aSourceDataLine7142 = null;
	...
	try {
	    ...
	    if (BillBoardDefinitions.method1818(i, -409743758) != 1)
		method2684(Class416.nextPowerOfTwo(i, (byte) 16), 1094341768);
	    else {
		((Class284_Sub1) this).aSourceDataLine7142 = null;
		throw lineunavailableexception;
	    }
	...
	try {
	    ...
	    if (BillBoardDefinitions.method1818(i, 970764696) != 1)
		method2684(Class416.nextPowerOfTwo(i, (byte) 16), 1535957198);
	    else {
		((Class284_Sub1) this).aSourceDataLine7142 = null;
		throw lineunavailableexception;
	    }
