...
public class Class335 {
    ...
    public boolean method4084(Toolkit class_ra, int i, int i_0_, int i_1_) {
	try {
	...
	try {
	    if (Class373.activeToolkit.method5051()) {
		Class373.activeToolkit.method5002(Class52_Sub2_Sub1.aCanvas9079, 1231237984);
		Class267.method2528(600492820);
		Dimension dimension = Class52_Sub2_Sub1.aCanvas9079.getSize();
		Class373.activeToolkit.method5163((Class52_Sub2_Sub1.aCanvas9079), dimension.width, dimension.height, 900330778);
		Class373.activeToolkit.method5003(Class52_Sub2_Sub1.aCanvas9079, (byte) -92);
	    } else
	...
	try {
	    ...
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Character.toUpperCase((char) i_4_);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Class298_Sub37_Sub8 class298_sub37_sub8 = Toolkit.aClass256_5315.method2441(i_5_, -1382788353);
		...
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = class298_sub37_sub8.anIntArray9599.length;
	}
	catch (RuntimeException runtimeexception) {
