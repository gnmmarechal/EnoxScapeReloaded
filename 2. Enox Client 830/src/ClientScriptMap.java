...
public class ClientScriptMap {
	...
	try {
		...
		string = "www-wti";
	    String string_13_ = "";
	    if (pb.aString8927 != null)
		string_13_ = new StringBuilder().append("/p=").append(pb.aString8927).toString();
	    String string_14_ = new StringBuilder().append(pb.gametype.aString5317).append(".com").toString();
	    return new StringBuilder().append("http://").append(string).append(".").append(string_14_).append("/l=").append(Class321.aClass429_3357).append("/a=").append(pb.anInt8665 * -1154804873).append(string_13_).append("/").toString();
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class298_Sub37_Sub12) class298_sub37_sub12).type = 1274450087 * i_15_;
	    ((Class298_Sub37_Sub12) class298_sub37_sub12).value = i_16_ * 293101103;
	}
	catch (RuntimeException runtimeexception) {
