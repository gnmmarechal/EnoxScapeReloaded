...
public class Class380 {
	...
	try {
	    ...
	    Class298_Sub37_Sub8 class298_sub37_sub8 = Toolkit.aClass256_5315.method2441(i_0_, 7133861);
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571.method5677(-706712654);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.SWITCH_INTERFACE_ITEM_PACKET, pb.aClass25_8711.aClass449_330, (byte) 44);
	    class298_sub36.aClass298_Sub53_Sub2_7396.writeShortLE128(class105_3_.id * -1232467723);
	    class298_sub36.aClass298_Sub53_Sub2_7396.writeIntV1(class105.ihash * -440872681, (byte) -22);
	    class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(class105_3_.ihash * -440872681, -855626208);
	    ...
	    class298_sub36.aClass298_Sub53_Sub2_7396.writeShortLE(class105.id * -1232467723, 1472780126);
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub7_7581.method5648(1496111936) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (!pb.method2801(class105).method3498(i, (byte) -47) && class105.anObjectArray1264 == null)
		return null;
