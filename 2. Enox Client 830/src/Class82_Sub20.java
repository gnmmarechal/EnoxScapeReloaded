...
public class Class82_Sub20 extends Class82 {
	...
	try {
	    Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.RECEIVE_PACKET_COUNT_PACKET, pb.aClass25_8711.aClass449_330, (byte) 17);
	    class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(pb.anInt8713 * -2059460167, -1112529192);
	    pb.aClass25_8711.method390(class298_sub36, (byte) -106);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    ((Class298_Sub37_Sub12) class298_sub37_sub12).type = 1274450087 * i_2_;
	    ((Class298_Sub37_Sub12) class298_sub37_sub12).value = i_3_ * 293101103;
	}
	catch (RuntimeException runtimeexception) {
