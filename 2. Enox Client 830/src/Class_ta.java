...
public abstract class Class_ta {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub13_7549.method5675(-26344378);
	}
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (-407713023 * (((NPC) ((Class403) class403).aClass365_Sub1_Sub1_Sub2_5242).aClass503_10190.anInt6126));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    BillBoardDefinitions.aClass243_1756 = class243;
	}
	catch (RuntimeException runtimeexception) {
