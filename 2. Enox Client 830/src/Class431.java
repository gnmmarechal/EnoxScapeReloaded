...
public class Class431 implements Interface15 {
	...
	try {
		...
		pb.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i_15_] = null;
	    Class287.myPlayer = null;
	    for (int i_16_ = 0; i_16_ < 1962237353 * pb.anInt8772; i_16_++) {
		Entity class365_sub1_sub1_sub2 = ((Entity) pb.aClass298_Sub29Array8816[i_16_].anObject7366);
		...
		pb.aBooleanArray8900[i_17_] = true;
	...
	try {
		...
		if (bool_23_ && class438.method5819((byte) -38)) {
		    AnimationDefinition class391 = class365_sub1_sub1_sub2.aClass438_10078.method5820(1190945096);
		    int i_25_ = class391.replayMode * -1117238071;
		    if (1 == i_25_)
		...
		if (is[i_27_] != -1)
		    bool_26_ = false;
		if (null == class365_sub1_sub1_sub2.anIntArray10093 || -1 == class365_sub1_sub1_sub2.anIntArray10093[i_27_] || ((Class501.aClass395_6122.getAnimationDefinition(is[i_27_], (byte) -62).priority) * -1445588039 >= (Class501.aClass395_6122.getAnimationDefinition(class365_sub1_sub1_sub2.anIntArray10093[i_27_], (byte) -47).priority) * -1445588039)) {
